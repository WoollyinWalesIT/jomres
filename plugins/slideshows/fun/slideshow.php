...
/**
#
 * Constructs and displays the 'fun' slideshow
#
...
function constructSlideshow($imageData,$propertyName,$slideshowImgs_RelPath,$slideshowRelpath)
	...
	if ($numberOfImages>0)
		...
		{
		// Commented out due to conversion to composite property details. Don't want to output anything until we're ready.
