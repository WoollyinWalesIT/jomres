...
define('_JOMRES_COM_MR_GENERALCONFIGDESC','Konfiguracja systemu');
define('_JOMRES_COM_MR_BACK','Wróć');
define('_JOMRES_COM_MR_YES','Tak');
define('_JOMRES_COM_MR_NO','Nie');
define('_JOMRES_COM_MR_NEWTARIFF','Dodaj');
define('_JOMRES_COM_MR_NEWPROPERTY','Nowa oferta');
define('_JOMRES_COM_MR_NEWPROPERTYFEATURE','Nowe cechy ofert');
...
define('_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL','Oferta domyślna');
...
define('_JOMRES_COM_MR_ASSIGNUSER_LEVEL_ADMIN','Manager ofert');
define('_JOMRES_COM_MR_EDITBOOKING_ADMIN_TITLE','Manager rezerwacji');
...
define('_JOMRES_COM_MR_EB_ROOM_BOOKINGSPECIALREQ','Informacje dla personelu');
define('_JOMRES_COM_MR_EB_ROOM_BOOKINGSPECIALREQ_DISCLAIMER','Uwaga! Prosimy zauważyć, że dodatkowe usługi do oferty wiązać mogą się z naliczeniem dodatkowych kosztów.');
...
define('_JOMRES_COM_MR_EB_GUEST_JOMRES_TOWN_EXPL','Miejscowość');
define('_JOMRES_COM_MR_EB_GUEST_JOMRES_POSTCODE_EXPL','Kod pocztowy');
define('_JOMRES_COM_MR_EB_GUEST_JOMRES_LANDLINE_EXPL','Telefon stacjonarny');
...
define('_JOMRES_COM_MR_EB_GUEST_CANCELLED','Rezerwacja została anulowana.');
...
define('_JOMRES_COM_MR_EB_PAYM_DEPOSITREQUIRED','Wysokość przedpłaty');
define('_JOMRES_COM_MR_EB_PAYM_DEPOSITSAVEMESSAGE','Przedpłata zapisana');
define('_JOMRES_COM_MR_QUICKRES_STEP2_TITLE','Dostępność');
define('_JOMRES_COM_MR_QUICKRES_STEP2_PROPERTYNAME','Oferta');
...
define('_JOMRES_COM_MR_DISPGUEST_LANDLINE','Telefon stacjonarny');
...
define('_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE','Cechy oferty i pokoju');
...
define('_JOMRES_COM_MR_VRCT_TAB_PROPERTYS','Oferta');
define('_JOMRES_COM_MR_VRCT_TAB_PROPERTYFEATURES','Cechy ofert');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_TELEPHONE','Telefon stacjonarny');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT','Zapisz dane oferty');
define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_UPDATE','Aktualizuj dane oferty');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_LINK','Cechy ofert');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_ABBV','Wersja skrócona cech ofert');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_DESC','Opis cech ofert');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_INSERT','Zapisz cechę ofert');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_UPDATE','Aktualizuj cechę ofert');
define('_JOMRES_COM_MR_LISTTARIFF_TITLE','Ceny');
...
define('_JOMRES_COM_MR_LISTTARIFF_MINPEOPLE','Minimum gości');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAGUESTIN','Zameldowanie gości');
define('_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAGUESTOUT','Wymeldowanie gości');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_PROPERTYADMIN','Edycja ofert');
...
define('_JOMRES_FRONT_MR_EB_GUEST_JOMRES_LANDLINE_EXPL','Telefon stacjonarny');
...
define('_JOMRES_FRONT_MR_EMAIL_TEXT_LANDLINE','Telefon stacjonarny:');
...
define('_JOMRES_FRONT_MR_BOOKIN_GUESTBOOKEDIN','Zamelduj gości');
...
define('_JOMRES_COM_A_TARIFFS','Ceny');
...
define('_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN','Nasza doba hotelowa trwa od 14:00 do 10:00 dnia następnego. Zamldowanie gości w godzinach od 14:00 do 20:00. W razie spodziewanego późniejszego przyjazdu prosimy o kontakt.');
define('_JOMRES_COM_CONFIRMATION_RESERVATION_LOOKFORWARD','Cieszymy się i oczekujemy Pani/Pana przyjazdu.');
define('_JOMRES_COM_CONFIRMATION_RESERVATION_HAVEAPLEASANTSTAY','Już teraz życzymy udanego pobytu.');
...
define('_JOMRES_COM_CONFIRMATION_PRINT','Drukuj potwierdzenie rezerwacji');
...
define('_JOMRES_COM_ADDSERVICE_BOOKINGDESC','Dodatkowe pozycje');
define('_JOMRES_COM_ADDSERVICE_TOTALVALUE','Suma dodatkowych pozycji:');
...
define('_JOMRES_FILE_ERROR_NAME','Nazwa pliku może zawierać tylko znaki a-z, A-Z, 0-9, proszę nie używać spacji w nazwach plików.');
define('_JOMRES_FILE_ERROR_SIZE','Ten plik jest niestety większy niż dopuszczalny rozmiar pliku.');
define('_JOMRES_FILE_NOT_UPLOADED','Plik nie został zapisany na serwerze.');
define('_JOMRES_FILE_UPDATED','Plik pomyślnie zaktualizowany na serwerze.');
define('_JOMRES_COM_A_JSCALENDAR','Kalendarz JS');
define('_JOMRES_COM_A_CALENDARLANGUAGE','Plik językowy dla kalendarza JS');
define('_JOMRES_COM_A_CALENDARLANGUAGE_DESC','Tutaj można ustawić wersję językową kalendarza JS.');
define('_JOMRES_COM_A_CALENDARCSS','Plik CSS dla kalendarza JS');
define('_JOMRES_COM_A_CALENDARCSS_DESC','Tutaj można ustawić plik CSS kalendarza JS.');
define('_JOMRES_COM_A_ODDS','Pozostałe');
...
define('_JOMRES_FILE_DELETED','Zdjęcie zostało usunięte.');
define('_JOMRES_COM_MR_QUICKRES_STEP1_ANYPROPERTY','Wszystkie oferty');
define('_JOMRES_COM_MR_ROOM_DELETE','Usuń');
...
define('_JOMRES_COM_MR_ROOM_DELETED','Pokój został usunięty.');
...
define('_JOMRES_COM_MR_ROOMFEATURE_DELETED','Ustawienia pokoju zostały usunięte.');
define('_JOMRES_COM_MR_PROPERTYFEATURE_DELETE','Usuń ustawienia oferty');
...
define('_JOMRES_COM_MR_PROPERTYFEATURE_DELETED','Ustawienia oferty zostały usunięte.');
define('_JOMRES_COM_MR_ROOMCLASS_DELETE','Usuń kategorie pokoju');
...
define('_JOMRES_COM_MR_ROOMCLASS_DELETED','Kategoria pokoju została usunięta.');
define('_JOMRES_COM_MR_PROPERTY_DELETE','Usuń ofertę');
define('_JOMRES_COM_MR_PROPERTY_DELETED','Oferta została usunięta.');
define('_JOMRES_COM_MR_PROPERTY_DELETE_NORIGHTS','Ta oferta nie może zostać usunięta. Nie posiadasz wystarczających uprawnień.');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION','Opis');
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_CHECKINTIMES','Zameldowanie w godzinach');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_POLICIESDISCLAIMERS','Warunki regulaminu');
...
define('_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC','Ustaw na Tak jeśli chcesz zezwolić na rezerwację on-line. W przeciwnym razie ustaw na Nie.');
define('_JOMRES_COM_A_FIXEDPERIODBOOKINGS','Stała długość pobytu?');
define('_JOMRES_COM_A_FIXEDPERIODBOOKINGS_DESC','Ustaw na Tak, jeżeli pobyt ma być dostępny tylko na z góry ustawiony okres.');
define('_JOMRES_COM_A_FIXEDPERIOD','Stała długość pobytu:');
define('_JOMRES_COM_A_BOOKING','Rezerwacje');
define('_JOMRES_COM_A_FIXEDPERIOD_NUMBEROFPERIODS','Maks cyklicznych rezerwacji, np: 3 x 7 cykli = 21 dni.');
define('_JOMRES_COM_A_SINGLEROOMPROPERTY','Rezerwacja dla jednej oferty?');
define('_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC','Jeśli Tak to rezerwować można cały obiekt np. domek letniskowy. Wybranie Nie umożliwia rezerwacje pojedynczych pokoi w np. hotelu.');
...
define('_JOMRES_COM_A_AVLCAL','Kalendarz');
...
define('_JOMRES_COM_AVLCAL_INBGCOLOUR','Kolor pól dla dni aktualnego miesiąca');
...
define('_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR','Kolor pól dla wolnych rezerwacji');
...
define('_JOMRES_COM_MR_FIXEDARRIVALDATE_YESNO','Dzień przyjazdu');
define('_JOMRES_COM_MR_FIXEDARRIVALDATE_YESNO_DESC','Tylko dla ofert ze stałą długością pobytu. Wybierz dzień tygodnia, w którm będzie możliwy przyjazd.');
define('_JOMRES_COM_MR_FIXEDARRIVALDATE_DAY','Dniem przyjazdu jest');
...
define('_JOMRES_FRONT_AVAILABILITY','Kalendarz');
...
define('_JOMRES_FRONT_DELETEGUEST_GUESTDELETED','Gość został usunięty.');
define('_JOMRES_FRONT_DELETEGUEST_UNABLETODELETEGUEST','Ten gość nie może zostać usunięty. Istnieją dane, które są do niego przypisane i to najpierw one muszą zostać usunięte.');
...
define('_JOMRES_COM_CALENDAROUTPUT','Format daty');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_AUDITTRAIL','Podsumowanie');
...
define('_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE','Cecha pokoju została utworzona.');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE','Cecha pokoju została zaktualizowana.');
define('_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE','Cecha pokoju została usunięta.');
define('_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE','Kategoria pokoju została utworzona.');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE','Kategoria pokoju została zaktualizowana.');
define('_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE','Kategoria pokoju została usunięta.');
define('_JOMRES_MR_AUDIT_INSERT_PROPERTY','Oferta została utworzona.');
define('_JOMRES_MR_AUDIT_UPDATE_PROPERTY','Oferta została zaktualizowana.');
define('_JOMRES_MR_AUDIT_DELETE_PROPERTY','Oferta została usunięta.');
define('_JOMRES_MR_AUDIT_INSERT_PROPERTY_FEATURE','Ustawienia oferty zostały utworzone.');
define('_JOMRES_MR_AUDIT_UPDATE_PROPERTY_FEATURE','Ustawienia oferty zostały zaktualizowane.');
define('_JOMRES_MR_AUDIT_DELETE_PROPERTY_FEATURE','Ustawienia oferty zostały usunięte.');
define('_JOMRES_MR_AUDIT_EDIT_PROPERTY_SETTINGS','Ustawienia oferty zostały zmienione.');
define('_JOMRES_MR_AUDIT_PUBLISH_PROPERTY','Oferta została opublikowana.');
define('_JOMRES_MR_AUDIT_INSERT_TARIFF','Cennik został utworzony.');
define('_JOMRES_MR_AUDIT_UPDATE_TARIFF','Cennik został zaktualizowany.');
define('_JOMRES_MR_AUDIT_DELETE_TARIFF','Cennik został usunięty.');
define('_JOMRES_MR_AUDIT_ADDSERVICE','Cena usługi dodatkowej została dodana.');
define('_JOMRES_MR_AUDIT_BOOKEDGUESTIN','Gość został zameldowany.');
define('_JOMRES_MR_AUDIT_BOOKEDGUESTOUT','Gość został wymeldowany.');
define('_JOMRES_MR_AUDIT_ENTEREDDEPOSIT','Dodaj przedpłatę');
define('_JOMRES_MR_AUDIT_INSERT_GUEST','Gość został dodany.');
define('_JOMRES_MR_AUDIT_UPDATE_GUEST','Gość został zaktualizowany.');
define('_JOMRES_MR_AUDIT_DELETE_GUEST','Gość został usunięty.');
define('_JOMRES_MR_AUDIT_BOOKED_ROOM','Pokój został zarezerwowany.');
define('_JOMRES_MR_AUDIT_INSERT_EXTRA','Usługa dodatkowa została utworzona.');
define('_JOMRES_MR_AUDIT_UPDATE_EXTRA','Usługa dodatkowa została zaktualizowana.');
define('_JOMRES_MR_AUDIT_DELETE_EXTRA','Usługa dodatkowa została usunięta.');
define('_JOMRES_MR_AUDIT_PUBLISH_EXTRA','Usługa dodatkowa została opublikowana.');
define('_JOMRES_MR_AUDIT_BLACKBOOKING','Wyłączenie zostało wykonane.');
define('_JOMRES_MR_AUDIT_BLACKBOOKING_DELETE','Wyłączenie zostało usunięte.');
...
define('_JOMRES_COM_MR_EXTRA_SAVE_UPDATED','Usługi dodatkowe zostały zaktualizowane.');
define('_JOMRES_COM_MR_EXTRA_LINKTEXT','Edytuj usługi dodatkowe');
define('_JOMRES_COM_MR_EXTRA_DELETED','Usługa dodatkowa została usunięta.');
define('_JOMRES_FRONT_MR_MENU_ADMIN_EXTRAS','Usługi dodatkowe');
define('_JOMRES_COM_A_EXTRAS','Pokaż usługi dodatkowe w procesie rezerwacji?');
define('_JOMRES_COM_A_EXTRAS_DESC','Ustaw na Tak, aby oferować usługi dodatkowe na etapie rezerwacji.');
...
define('_JOMRES_FRONT_MR_SEARCH_PROPERTYNAME','Szukaj wg nazw ofert:');
...
define('_JOMRES_COM_A_CLICKFORMOREINFORMATION','Informacje');
define('_JOMRES_COM_A_ADVANCEBOOKINGSLIMITYESNO','Ograniczenie czasu rezerwacji?');
define('_JOMRES_COM_A_ADVANCEBOOKINGSLIMITYESNO_DESC','Ustaw na Tak, aby ograniczyć czas rezerwacji do X dni do przodu. To oznacza, że jeżeli goście będą próbować wybrać datę, która leży dalej w przyszłości, system przestawi datę przyjazdu automatycznie na datę dzisiejszą.');
define('_JOMRES_COM_A_ADVANCEBOOKINGSLIMITDAYS','Możliwy czas rezerwacji ograniczyć do ilości dni:');
...
define('_JOMRES_COM_A_ROOMTAX_DESC','Stworzono na rynek amerykański. Cena pokoju będzie zwiększona o tą wartość. Możliwy jest wybór pomiędzy cenami ryczałtowymi, opodatkowanie procentowe albo kombinacja obu możliwości. Proszę jednak zauważyć, że ta wartość ma wpływ tylko na cenę pokoi.');
...
define('_JOMRES_FRONT_TARIFFS_ROOMTYPE','Rodzaj pokoju');
...
define('_JOMRES_FRONT_PREVIEW','Podgląd ofert');
...
define('_JOMRES_MR_AUDIT_UPDATECUSTOMTEXT','Tekst został zaktualizowany.');
...
define('_JOMRES_FRONT_PTYPE','Rodzaj ofertyy');
define('_JOMRES_COM_PTYPES_LIST_TITLE','Rodzaje ofert');
define('_JOMRES_COM_PTYPES_LIST_TITLE_EDIT','Edytuj rodzaje ofert');
define('_JOMRES_COM_PTYPES_PTYPE','Rodzaj ofertyy');
define('_JOMRES_COM_PTYPES_PTYPE_DESC','Opis rodzaju ofert');
define('_JOMRES_COM_PTYPES_SAVED','Rodzaj ofertyy został zapisany.');
define('_JOMRES_COM_PTYPES_UNABLETO_DELETE','Anulowanie rodzaju ofert jest niemożliwe. Rodzaj ofertyy jest przypisany do jednej lub więcej ofert. Usuń to przypisanie i spróbuj ponownie.');
define('_JOMRES_COM_PTYPES_DELETED','Rodzaj ofertyy został anulowany.');
...
define('_JOMRES_COM_CHARGING_FULLAMT','Pełna kwota');
define('_JOMRES_COM_CHARGING_CONFIG','Kwota pobrana w czasie rezerwacji');
...
define('_JOMRES_COM_MONTHSTOSHOW','Ilość miesięcy');
define('_JOMRES_COM_MONTHSTOSHOW_DESC','Ilość miesięcy pokazywanych w kalendarzu.');
define('_JOMRES_INVOICE_SIGNEDONBEHALFOF','Podpisane w imieniu');
define('_JOMRES_COM_A_GATEWAYLIST','Płatności');
...
define('_JOMRES_COM_A_GATEWAY_USEGATEWAYS_DESC','Ustaw na Tak, jeżeli chcesz korzystać z płatności elektronicznych.');
...
define('_JOMRES_MR_AUDIT_PLUGINS_UPDATE','Ustawienia wtyczek zostały zmienione.');
define('_JOMRES_MR_AUDIT_PLUGINS_INSERT','Ustawienie wtyczek zostało dodane.');
define('_JOMRES_FRONT_GALLERYLINK','Zobacz tą ofertę');
define('_JOMRES_COM_A_GALLERYLINK','Link');
define('_JOMRES_COM_A_GALLERYLINK_DESC','Możesz umieścić tu link do swojej strony.');
define('_JOMRES_MR_AUDIT_CREDITCARD_VIEWED','Karta kredytowa została zweryfikowana.');
define('_JOMRES_MR_AUDIT_CREDITCARD_UPDATED','Karta kredytowa została zaktualizowana.');
define('_JOMRES_MR_CREDITCARD_EDIT','Edytuj dane karty kredytowej');
define('_JOMRES_COM_A_EDITICON','Edytuj rozmiar ikony');
define('_JOMRES_JR_A_IMAGEHANDLING_BATCHUPLOAD','Transfer zdjęć oferty na serwer');
define('_JOMRES_JR_A_IMAGEHANDLING_IMAGESALREADYINDIR','Istniejące zdjęcia');
define('_JOMRES_COM_A_SLIDESHOWS','Slajdy');
...
define('_JOMRES_FRONT_SLIDESHOW','Slajdy');
define('_JOMRES_COM_A_SLIDESHOWS_NOIMAGES','<br />Brak zdjęć tej oferty.');
define('_JOMRES_COM_A_TARIFFS_SHOWTARIFFSLINK','Pokaż odsyłacz do cennika?');
define('_JOMRES_COM_A_POPUPSALLOWED','Wyskakujące okna dozwolone?');
define('_JOMRES_COM_A_POPUPSALLOWED_DESC','Jeżeli Nie, to odsyłacz który normalnie otwiera nowe okno będzie otwierany w ramach strony.');
define('_JOMRES_FRONT_IMAGEUPLOADS','Transfer zdjęć');
define('_JOMRES_FRONT_IMAGEUPLOADS_INFO','Użyj tego formularza, aby przetransferować zdjęcia oferty na serwer.
					<br />
...
define('_JOMRES_A','Konfiguracja systemu');
define('_JOMRES_A_GLOBALPFEATURES','Używaj globalnych cech ofert');
define('_JOMRES_A_GLOBALPFEATURES_DESC','Ustaw na Tak, jeżeli chcesz wymusić używanie przez wszystkie oferty tylko cech zdefiniowanych przez administratora strony.');
...
define('_JOMRES_FRONT_NORESULTS','<b>Twoje wyszukiwanie nie dało żadnych rezultatów. Zmień kryteria i spróbuj ponownie.</b>');
define('_JOMRES_AREYOUSURE','Czy jesteś pewny/a?');
define('_JOMRES_FRONT_MR_MENU_BOOKTHISPROPERTY','Rezerwacja');
define('_JOMRES_COM_MR_DISPGUEST_CCV','Kod CCV (kod bezpieczeństwa karty)');
define('_JOMRES_COM_A_TARIFFS_SHOWTARIFFSINLINE','Pokazuj cennik w ramach strony?');
...
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWDETAILS_TITLE','Pokaż informację o ofercie pod tym odsyłaczem');
...
define('_JOMRES_COM_PROPERTYLISTDESC','Długość skruconego opisu');
define('_JOMRES_COM_PROPERTYLISTDESC_DESC',"Podaj ilość znaków wyświetlanych w ramach skróconego opisu na listach ofert.");
define('_JOMRES_COM_A_DATEFORMATSTYLE','Własny format daty');
...
define('_JOMRES_COM_MR_VRCT_PUBLISH','Kliknij aby opublikować ofertę w portalu');
define('_JOMRES_COM_MR_VRCT_UNPUBLISH','Cofnij publikację oferty z portalu');
define('_JOMRES_A_GLOBALROOMTYPES','Używaj globalnych typów pokoi');
define('_JOMRES_A_GLOBALROOMTYPES_DESC','Ustaw na Tak, jeżeli chcesz aby wszystkie oferty używały tylko typów pokoi zdefiniowanych przez administratora.  Należy ustawić na Tak, jeżeli ma być możliwe wyszukiwanie wg typów pokoi.');
...
define('_JOMRES_COM_CONFIGCOUNTRIES','Domyślny kraj w formularzu rezerwacji');
define('_JOMRES_JAVASCRIPT_','Pozycje zaznaczone czerwoną gwiazdką są wymagane.');
define('_JOMRES_COM_SELFREGISTRATION','Użytkownicy mogą dodawać swoje oferty?');
define('_JOMRES_COM_SELFREGISTRATION_DESC','Ustaw na Tak, jeżeli chcesz aby użytkownicy mogli dodawać swoje oferty bez interwencji administratora strony.');
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1','Proszę wybrać kraj i region swojej oferty.');
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_1','Proszę wprowadzić dane oferty.');
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_2','Pozycje zaznaczone czerwoną gwiazdką są wymagane.');
define('_JOMRES_REGISTRATION_AUDIT_CREATEPROPERTY','Oferta została dodana.');
define('_JOMRES_REGISTRATION_NOTALLOWED',"Przykro nam, ale nie możesz dodać oferty do systemu. Musisz być zarejestrowanym i zalogowanym użytkownikiem.");
define('_JOMRES_REGISTRATION_CREATEDPROPERTY','Dodana oferta:');
define('_JOMRES_REGISTRATION_CREATEDPROPERTY_FORUSER','Właściciel:');
define('_JOMRES_COM_MONTHS_STARTOFYEAR','Kalendarz od początku roku');
define('_JOMRES_COM_MONTHS_STARTOFYEAR_DESC','Pokazywany kalendarz rozpoczyna się od początku bieżącego roku.');
define('_JOMRES_NUMBEROFROOMSAVAILABLE','Ilość dostępnych pokoi');
define('_JOMRES_BACKTOPROPERTYDETAILSLINK','Powrót do informacji o ofercie');
define('_JOMRES_FRONT_ROOMTYPES','Rodzajepokoi');
...
define('_JOMRES_COM_ALLOWHTMLEDITOR','Pozwól użytkownikom używać edytora HTML?');
...
define('_JOMRES_AJAXFORM_PARTICULARS_DESC','Określ szczegóły Twojej rezerwacji.');
define('_JOMRES_AJAXFORM_AVAILABLE','Dostępność');
define('_JOMRES_AJAXFORM_AVAILABLE_DESC','Wybierz pokój');
define('_JOMRES_AJAXFORM_AVAILABLE_DESC_SRP','Sprawdź tutaj, czy oferta jest dostępna w tym okresie.');
define('_JOMRES_AJAXFORM_EXTRAS','Usługi dodatkowe');
...
define('_JOMRES_AJAXFORM_ADDRESS','Dane bilingowe');
define('_JOMRES_AJAXFORM_ADDRESS_DESC','Podaj swoje dane.');
...
define('_JOMRES_AJAXFORM_BILLING_TOTAL','Koszt całkowity:');
...
define('_JOMRES_CONFIG_VARIANCES_CUSTOMERTYPES','Rodzaje gości');
define('_JOMRES_VARIANCES_TYPE','Rodzaj');
define('_JOMRES_VARIANCES_TYPE_TT','Rodzaje gości, np. dzieci w wieku 5 - 10 lat, student.');
define('_JOMRES_VARIANCES_NOTES','Uwagi');
define('_JOMRES_VARIANCES_NOTES_TT','Uwagi dotyczące danego rodzaju gości.');
...
define('_JOMRES_MR_AUDIT_REORDER_CUSTOMERTYPE','Rodzaj gości został zmodyfikowany.');
define('_JOMRES_MR_AUDIT_PUBLISH_CUSTOMERTYPE','Rodzaj gości został opublikowany.');
define('_JOMRES_MR_AUDIT_DELETE_CUSTOMERTYPE','Rodzaj gości został usunięty.');
define('_JOMRES_MR_AUDIT_INSERT_CUSTOMERTYPE','Rodzaj gości został utworzony.');
define('_JOMRES_MR_AUDIT_UPDATE_CUSTOMERTYPE','Rodzaj gości został zmieniony.');
define('_JOMRES_COM_MR_CUSTOMERTYPE_UPDATED','Rodzaj gości został zmieniony.');
define('_JOMRES_COM_A_SHOWROOMSLISTLINK','Pokazać odsyłacz do listy pokoi na stronie informacyjnej ofert?');
define('_JOMRES_COM_A_SHOWONLYAVLCAL','Pokazać  <b>tylko</b> kalendarz dostępności/listę pokoi?');
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Ustaw na Tak, jeżeli nie chcesz wyświetlać informacji o ofercie (listy pokoi i ich dostępności) w części informacyjnej ofert. Przeznaczone dla użytkowników mających oferty typu apartament, domek letniskowy itp.');
define('_JOMRES_COM_A_MINIMUMINTERVAL','Minimum długość pobytu');
define('_JOMRES_COM_A_MINIMUMINTERVAL_DESC','Minimalna długość pobytu oferowana w formularzu rezerwacyjnym (tym samym w ofercie).');
...
define('_JOMRES_COM_A_DEFAULTNUMBEROFFIRSTGUESTTYPE','Domyślny rodzaj gości');
define('_JOMRES_COM_A_DEFAULTNUMBEROFFIRSTGUESTTYPEDESC','Domyślny rodzaj gości (o ile używasz rozróżnienia rodzajów gości), nadawany pierwszemu gościowi w formularzu rezerwacyjnym.');
define('_JOMRES_COM_A_REGISTEREDUSERSONLYBOOK','Rezerwacji on-line może dokonać tylko zarejestrowany użytkownik?');
define('_JOMRES_REGISTEREDUSERSONLYBOOK','Musisz być zarejestrowanym i zalogowanym użytkownikiem, aby móc rezerwować on-line. Kliknij tutaj, aby się zarejestrować lub zalogować.');
...
define('_JOMRES_COM_A_TARIFFPRICESAREWEEKLY_DESC','Masz możliwość zapisać cennik jako opłaty dzienne lub tygodniowe. Jeżeli chcesz zapisać cennik tygodniowy ustaw na Tak.');
...
define('_JOMRES_BOOKINGFORM_MONITORING_BOOKING_TOO_SHORT1','Okres rezerwacji jest zbyt krótki. Między datą przyjazdu i wyjazdu musi być minimum dni:');
define('_JOMRES_BOOKINGFORM_MONITORING_BOOKING_TOO_SHORT2','Twój okres rezerwacji wynosi:');
define('_JOMRES_BOOKINGFORM_MONITORING_GUEST_TYPE_INCORRECT','Błędny rodzaj gościa');
define('_JOMRES_BOOKINGFORM_MONITORING_SELECT_GUEST_NUMBERS','Wybierz odpowiednią ilość/rodzaj gościa');
...
define('_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS','Zbyt dużo osób w stosunku do dostępnych miejsc w tej ofercie.');
...
define('_JOMRES_SRP_WEHAVEVACANCIES','Mamy jeszcze wolne miejsca.');
...
define('_JOMRES_COM_DUMPTEMPLATEDATA_DESC','Uaktywnij, aby umożliwić wpisywanie zmiennych DHTML w szablonie strony. Pomocne, jeżeli chcesz widzieć, czy ten konkretny element jest dostępny w danym szablonie.');
...
define('_JOMRES_COM_JRCONFIG_GLOBALEDITING_DESC','Jeśli jest ustawione na Tak, wtedy tryb edycji wpłynie na indywidualny tekst dla wszystkich ofert w systemie. Będą zastosowane teksty globalne.');
...
define('_JOMRES_COM_JRCONFIG_ISWRAPPED_DESC','Ustaw na Tak, jeśli element jest owinięty tak, że moduł i nagłówek nie są widoczne.');
define('_JOMRES_COM_USERIS_SUPERPROPERTYMANAGER','Główny manager ofert');
...
define('_JOMRES_TARIFFSFROM','Ceny już od');
...
define('_JOMRES_SEARCH_AVL_INFO','Podaj datę przyjazdu i wyjazdu a następnie naciśnij przycisk, aby znaleźć oferty, które mają jeszcze wolne miejsca w wybranym zakresie dat.');
define('_JOMRES_SEARCH_PTYPES','Lista wszystkich właściwości ze względu na rodzaj ofert.');
...
define('_JOMRES_SORTORDER_PROPERTYNAME','Nazwa oferty');
define('_JOMRES_SORTORDER_PROPERTYREGION','Region oferty');
define('_JOMRES_SORTORDER_PROPERTYTOWN','Miejscowość oferty');
define('_JOMRES_SORTORDER_STARS','Ilość gwiazdek');
define('_JOMRES_PATHWAY_PROPERTYLIST','Lista ofert');
define('_JOMRES_PATHWAY_PROPERTYDETAILS','Szczegóły');
...
define('JOMRES_COM_A_AVAILABLELOGS','Rodzajeoperacji');
...
define('JOMRES_COM_A_TARIFFMODE_DESC',"<b>Ostrzeżenie! Przełączanie pomiędzy różnymi rodzajami taryf może spowodować utratę danych, przeczytaj poniższe uwagi.</b>
					...
					<br />
					");
define('_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS','lista pokoi na stronie szczegółów ofert?');
define('JOMRES_PROPERTYTYPE','Typ ofert');
...
define('_JOMCOMP_BOOKINGNOTES_AUDITMESSAGE','Notatka została dodana.');
define('_JOMCOMP_BOOKINGNOTES_AUDITMESSAGE_EDIT','Notatka została zmieniona.');
define('_JOMCOMP_BOOKINGNOTES_AUDITMESSAGE_DELETE','Notatka została usunięta.');
...
define('_JOMCOMP_MYUSER_PROPERTYTYPE','Rodzaj ofertyy');
define('_JOMCOMP_MYUSER_PUBLISHEDPROPERTIES','Oferta na stronie');
define('_JOMCOMP_WISEPRICE_TITLE','Last minute');
...
define('_JOMCOMP_WISEPRICE_NOTDISCOUNTED','Podsumowanie Twojej płatności.');
define('JOMRES_COM_A_MAPSKEY','Klucz API map Google');
define('JOMRES_COM_A_MAPSKEY_DESC','Klucz API map Google można wygenerować tu: <a href="https://code.google.com/apis/consol" target="_blank">Mapy Google</a>. Po wprowadzeniu klucza API map Google, mapy będą wyświetlane na stronie szczegółów danego ofert.');
...
define('_JOMCOMP_LASTMINUTE_PROPERTYLIST_PRE','Oferta Last Minute ze zniżkami od : ');
define('_JOMCOMP_LASTMINUTE_PROPERTYLIST_MID','%, dla rezerwacji dokonanej przed : ');
define('_JOMCOMP_LASTMINUTE_ORMORE','% lub więcej dla rezerwacji dokonanej przed : ');
...
define('JOMRES_COM_A_VERBOSETARIFFINTO_DESC','Ustaw na Tak, aby pokazać bardziej szczegółowe informacje taryfowe w szczegółach ofert/taryfy w oknie popup.');
define('JOMRES_COM_A_MINIMALCONFIG','Minimum opcji konfiguracyjnych');
define('_JOMCOMP_AMEND','Zmień rezerwacje - Wybór ofert');
define('_JOMCOMP_AMEND_SELECTPROPERTY','Wybór nowej oferty');
...
define('_JRPORTAL_CPANEL','Mój kokpit');
define('_JRPORTAL_CONFIG_DEFAULT_CRATE','Domyślna stawka prowizji');
define('_JRPORTAL_CONFIG_DEFAULT_CRATE_DESC','Wybierz domyślną stawkę prowizji, która będzie stosowana dla ofert w przypadku, gdy inna stawka prowizji nie jest inaczej ustawiona.');
...
define('_JRPORTAL_CPANEL_LISTPROPERTIES','Lista ofert');
define('_JRPORTAL_PROPERTIES_PROPERTYNAME','Nazwa oferty');
define('_JRPORTAL_PROPERTIES_PROPERTYADDRESS','Adres oferty');
define('_JRPORTAL_PROPERTIES_LEGEND','Oferty które mają kolor tła czerwony jeszcze nie zostały zatwierdzone.');
define('_JRPORTAL_STATS_PATETITLE','Statystyki');
define('_JRPORTAL_STATS_STATTYPE','Statystyka dla:');
define('_JRPORTAL_STATS_STATTYPE_PROPERTIES','Oferta - Kliknięcia');
define('_JRPORTAL_PROPERTIES_VIEWPROPERTY','Widok ofert');
...
define('_JRPORTAL_LISTBOOKINGS_HEADER_PROPERTY_ID','Id oferty');
...
define('_JRPORTAL_ADD_ADHOC_ITEM_CHOOSEPROPERTY','Powiązane oferty (jeśli dotyczy)');
...
define('_JOMRES_EDITPROPERTY_CONNOTDELETE1','Nie możesz usunąć tej oferty ponieważ jest to podstawowa oferta do której masz dostęp. Jeśli chcesz ją wyłączyć, skorzystaj z funkcji nie-publikowania w pasku narzędzi.');
define('_JOMRES_EDITPROPERTY_CONNOTDELETE2','Jeśli jest to instalacja demo i zamierzasz uaktualnić system do Jomres Solo (tylko obsługa jednej oferty) należy utworzyć nową ofertę a następnie usunąć ją przed zmianą klucza licencyjnego do wersji Solo.');
...
define('_JOMRES_COM_ISTHISANMRP',"Czy to oferta typu hotel/pensjonat/dom wczasowy?");
define('_JOMRES_COM_ISTHISANMRP_DESC',"Opcje konfiguracji różnią się w zależności czy są to wynajmowane pokoje w ofercie (np. hotel) lub cała oferta (np. domek letniskowy). Wybierz MRP jeśli oferujesz wynajem pokoii w ofercie, wybierz SRP, jeśli oferujesz do wynajęcia całą ofertę.");
...
define('_JOMRES_AJAXFORM_ACCOMMODATION_NIGHTS',"Noc/y");
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM',"Za pokój");
define('_JOMRES_AJAXFORM_EXTRAS_TOTAL',"Usługi dodatkowe");
define('_JOMRES_AJAXFORM_PRICE_SUMMARY',"Podsumowanie płatności");
...
define('_JOMRES_CONFIRMATION_AMENDTEXT',"Jeśli musisz zmienić jakiekolwiek z powyższych informacji kliknij w przycisk.");
define('_JOMRES_CONFIRMATION_AMEND',"Zmień dane rezerwacji");
define('_JOMRES_CONFIRMATION_SPECIALS',"W miejscu tym można wpisać dodatkowe informacje dla personelu.");
define('_JOMRES_CONFIRMATION_TERMS_PRETEXT',"Potwierdzam, że powyższe informacje są poprawne i akceptuję");
...
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL','Kontakt');
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_SUBJECT','Badanie ofert od');
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_THANKS','Dziękujemy za kontakt z nami. Twoja wiadomość została wysłana do właściciela tej oferty i na Twój adres e-mail. Spodziewaj się szybkiej odpowiedzi.');
...
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC','Minimalna liczba pokoi już wybranych w rezerwacji przed taryfa/pokój combo typu może być oferowany. Pozwala to mieć zniżki taryf, gdy więcej niż pomieszczeń X są');
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS','Pokoje max już wybrane');
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC','Maksymalna liczba pokoi już wybranych w rezerwacji przed taryfa/pokój combo nie są już oferowane. Umożliwia zaprzestanie oferowania tego typu pokoju/taryfy.');
...
define('_JOMRES_COM_SEF_TASK_ALIAS_VIEWPROPERTY','Alias oferty');
define('_JOMRES_COM_SEF_TASK_ALIAS_VIEWPROPERTY_DESC','Alias do strony oferty.');
...
define('_JOMRES_COM_SEF_PROPERTY_URL_PTYPE','Dodaj rodzaj ofert do URL');
define('_JOMRES_COM_SEF_PROPERTY_URL_PTYPE_DESC','Dodaje rodzaj ofert do adresu URL.');
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME','Dodaj nazwę oferty do URL');
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME_DESC','Dodaje nazwę oferty do adresu URL.');
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID','Dołącz ID do nazwy oferty w URL');
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID_DESC','Jeśli nazwa oferty jest ustawiona na Nie, to ID nie będzie używany. Jeśli jest włączony to URL będzie taki ...moja-oferta-1 .');
...
define('_JOMRES_COM_SEF_DEFAULT_COUNTRY_DESC','Jeśli wszystkie oferty są w jednym kraju, to nie będzie on wyświetlany w URL wyniku szukania. Wprowadź tu kraj domyślny jeśli chcesz wyświetlić go w URL.');
define('_JOMRES_COM_SEF_SEARCH_URL_REGION','Struktura URL Szukaj - Dodaj region do URL');
define('_JOMRES_COM_SEF_SEARCH_URL_REGION_DESC','Dodaje region do URL wyniku szukania.');
define('_JOMRES_COM_SEF_DEFAULT_REGION','Struktura URL Szukaj - Region domyślny');
define('_JOMRES_COM_SEF_DEFAULT_REGION_DESC','Jeśli wszystkie oferty są w jednym regionie to nie będzie on wyświetlany w URL wyniku szukania. Wprowadź tu region domyślny jeśli chcesz wyświetlić go w URL.');
...
define('_JOMRES_COM_SEF_DEFAULT_TOWN_DESC','Jeśli wszystkie oferty są w jednej miejscowości to nie będzie ona wyświetlana w URL wyniku szukania. Wprowadź tu miejscowość domyślną jeśli chcesz wyświetlić ją w URL.');
define('_JOMRES_COM_SEF_SEARCH_URL_PTYPE','Struktura URL Szukaj - Rodzaj ofertyyy');
define('_JOMRES_COM_SEF_SEARCH_URL_PTYPE_DESC','Dodaje rodzaj oferty do URL wyniku szukania.');
define('_JOMRES_COM_SEF_DEFAULT_PTYPE','Struktura URL Szukaj - Domyślny rodzaj oferty');
define('_JOMRES_COM_SEF_DEFAULT_PTYPE_DESC','Używany w URL, jeśli poszukiwanie jest dla wszystkich rodzajów ofert.');
define('_JOMRES_COM_SEF_NOTINSTALLED','Komponent she404sef nie jest zainstalowany. Czy masz przekopiowane '.JOMRESCONFIG_ABSOLUTE_PATH.JRDS.'jomres'.JRDS.'libraries'.JRDS.'jomres'.JRDS.'cms_specific'.JRDS.'joomla15'.JRDS.'other_component_files'.JRDS.'sh404sef'.JRDS.'com_jomres.php do '.JOMRESCONFIG_ABSOLUTE_PATH.JRDS.'components'.JRDS.'com_sh404sef'.JRDS.'sef_ext. Po zainstalowaniu sh404sef i/lub skopiowaniu pliku, będzie można skonfigurować adresy URL SEF tutaj.');
...
define('_JOMRES_REGISTRYREBUILD','Odbuduj rejestr wtyczek');
...
define('_JOMRES_REGISTRYREBUILD_SUCCESS','Rejestr wtyczek został przebudowany poprawnie.');
define('_JOMRES_REGISTRYREBUILD_FAILURE','Wystąpił błąd przy odbudowie rejestru wtyczek. Powinieneś sprawdzić błąd w dzienniku Jomres, aby sprawdzić, czy istnieje zapis mówiący o tym, co spowodowało błąd.');
define('_JOMRES_SEARCH_PRICERANGES','Szukaj w przedziale cenowym.');
define('JOMRES_WORD_SAVING','Zapisywanie...');
define('_JOMRES_COM_COMPOSITE_PROPERTY_DETAILS','Użyj kompozytowych szczegółów ofert?');
define('_JOMRES_COM_COMPOSITE_PROPERTY_DETAILS_DESC','Jomres 3,3 wprowadził kompozytowe szczegóły ofert, gdzie wszystkie szczegóły wyjścia są przesyłane do jednego szablonu pliku (composite_property_details.html). Jeśli nie chcesz używać tej funkcji ustaw ją na Nie (tylko istniejący użytkownicy powinni ustawić na Nie, nowi użytkownicy będą prawdopodobnie chcieli pozostawić ustawiony na Tak).');
define('_JOMRES_PROFILELIST_INSTRUCTIONS','To jest lista wszystkich użytkowników w systemie. Użytkownicy bez własnych ofert oznaczeni są ikoną Gość. Manager ofert oznaczeni są ikoną Satelity/Manager.
					<br />
...
define('_JOMRES_COM_LOGGING_SYSTEM','Logi dodatkowe systemu');
...
define('_JOMRES_COM_A_LISTLIMIT','Limit ofert na liście');
define('_JOMRES_COM_A_LISTLIMIT_DESC','Liczba ofert pokazywanych na stronie wyszukiwania.');
define('_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE','Wyszukiwarka');
define('_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE_DESC','Zintegrowana funkcja wyszukiwania pozwala użytkownikom przeszukiwać oferty zgodnie z zestawem funkcji. Jeśli już korzystałeś z funkcji wyszukiwania w Jomres w Joomla zapoznaj się z tymi ustawieniami.
					<br />
...
define('_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE_DESC','Jeśli Tak, to każde zapytanie do Jomres pokazuje listę ofert i wszystkie opcje wyszukiwania.');
...
define('_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME',"Szukaj według nazwy oferty");
define('_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME_DESC',"Szukanie przez wpisanie nazwy oferty.");
...
define('_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE',"Wyszukiwanie według rodzaju ofert");
define('_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE_DESC',"Szukanie przez wpisanie rodzaju oferty.");
...
define('_JOMRES_A_GLOBAL_SEARCHOPTION_RANDOMLIMIT_DESC','Domyślnie, jeśli oferta nie została wybrana zostanie przeprowadzone wyszukiwanie. Jeżeli wyniki wyszukiwania nie zostały wywołane przez moduł wyszukiwania, wyszukiwanie będzie produkować losowe wyniki (celowo).');
...
define('_JRPORTAL_INVOICES_INITTOTAL',"Znakomita całkowita");
...
define('_JRPORTAL_INVOICES_PAYPAL_SETTINGS_OVERRIDE',"Zastępują standardowe ustawienia?");
...
define('_JRPORTAL_COUPONS_TITLE',"Kody rabatowe");
...
define('_JOMRES_AJAXFORM_COUPON_INSTRUCTIONS','Jeśli masz kod promocyjny, wprowadź go w polu i kliknij przycisk "Zapisz kod".');
define('_JOMRES_AJAXFORM_COUPON_APPLYBUTTON','Zapisz kod');
define('_JOMRES_AJAXFORM_COUPON_COUPONSAVED','Kod został zapisany dla rezerwacji.');
define('_JOMRES_AJAXFORM_COUPON_COUPONNOTFOUND','Nie znaleziono takiego kodu rabatowego.');
define('_JOMRES_AJAXFORM_COUPON_DISCOUNTVALUE','Wartość kodu rabatowego');
...
define('_JOMRES_COM_MR_EDITBOOKING_ADMIN_HISTORICBOOKINGS','Anulowane rezerwacje');
...
define('_JOMRES_MR_AUDIT_UPDATE_COUPON','Kod rabatowy został zapisany.');
define('_JOMRES_MR_AUDIT_DELETE_COUPON','Kod rabatowy został usunięty.');
...
define('_JRPORTAL_SMS_CLICKATELL_TITLE',"SMS Clickatell");
...
define('_JRPORTAL_SMS_CLICKATELL_NOTIFICATION_MOBILENUMBER',"Numer telefonu komórkowego dla powiadomień SMS");
define('_JRPORTAL_SMS_CLICKATELL_NOTIFICATION_MOBILENUMBER_DESC',"Proszę używać formatu 'kod kraju, numer telefonu'. Na przykład polski numer telefonu komórkowego '48500600700'. Zostaw puste jeśli nie chcesz otrzymywać żadnych powiadomień SMS.");
...
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_TITLE',"Pakiety abonamentowe");
...
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_TRIALPERIOD',"Okres testowy");
...
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_PROPERTYLIMIT',"Limit ofert");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_FREQUENCY_DESC',"Częstotliwość: M/Q/B/A - Monthly/Quarterly/Bianually/Anually");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_TRIALPERIOD_DESC',"Okres testowy: 0 (zero) nie ustawiać, 1 (jeden miesiąc), 2 (dwa miesiące) itd.");
...
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES1',"Abonament musi być ważny aby dodawać nowe oferty. Został zakupiony na");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES2',"opublikowane.");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES3',"Można zwiększyć liczbę ofert, które można tworzyć przez <a href='".JOMRES_SITEPAGE_URL."&task=list_subscription_packages'>zakup pakietu abonamentowego tutaj</a>.");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES4',"Użyłeś");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES5',"sloty ofert.");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES6',"Aby zobaczyć listę bieżących ofert kliknij <a href='".JOMRES_SITEPAGE_URL."&task=listyourproperties'>tutaj</a>.");
...
define('_JRPORTAL_SUBSCRIPTIONS_PUBLISHERROR',"Niestety, nie można opublikować tej oferty, osiągnięto maksymalną liczbę dostępnych slotów ofert w Twoim abonamencie.");
define('_JRPORTAL_SUBSCRIBERS_SUBSCRIBED',"Dziękujemy za zamówienie abonamentu. <a href='".JOMRES_SITEPAGE_URL."&task=registerProp_step1'>Kliknij tutaj, aby kontynuować.</a>");
define('_JRPORTAL_SUBSCRIBERS_CANCED_SUBSCRIBE',"Z przykrością informujemy, że nie zdecydowałeś się zapisać w naszym serwisie. Daj nam znać, jeśli istnieje jakikolwiek sposób, w który możemy Ci pomóc.");
...
define('_JRPORTAL_SUBSCRIPTIONS_USE',"Obsługa abonamentów");
define('_JOMRES_COM_NEWUSER','Utwórz nowego użytkownika');
define('_JOMRES_COM_NEWUSER_DESC','Utwórz nowe konto użytkownika.');
define('_JOMRES_CLICKTOREGISTER','Dodaj nową ofertę');
define('_JRPORTAL_SUBSCRIPTIONS_SUBSCRIPTIONS_TITLE',"Aktywne abonamenty");
...
define('_JOMRES_LATLONG_DESC',"Użyj myszki do poruszania się po mapie, a następnie przeciągnij wskaźnik do lokalizacji oferty, aby ustawić długość i szerokość geograficzną.");
define('_JOMRES_CONTROLPANEL','Mój kokpit');
define('_JOMRES_COM_FAUXHEADERS','Nagłówki Jomres Javascript w BODY HTML?');
define('_JOMRES_COM_FAUXHEADERS_DESC','Ustaw na Tak, jeśli masz problemy z konfliktem Mootools i Jomres jQuery w IE. To zmusi Jomres do wyprowadzania JavaScript w BODY zamiast w HEAD. Powinno to rozwiązać problem z jQuery i Mootools sprzecznymi ze sobą.');
define('_JOMRES_MANAGER_SHOWINVOICE','Pokaż fakturę');
define('_JOMRES_MANAGER_SHOWINVOICES','Faktury rezerwacji');
define('_JOMRES_USER_LISTMYPROPERTY','Dodaj nową ofertę');
define('_JOMRES_WARNINGS_DANGERWILLROBINSON','Ostrzeżenie:');
define('_JRPORTAL_SUBSCRIPTIONS_SUBSCRIBING_FREEBIENOTES',"Możesz mieć jeden darmowy pakiet abonamentowy w systemie. Jeśli chcesz, możesz ustawić pakiet by zarówno ilość próbna i pełna kwota na 0,00.");
define('_JRPORTAL_SUBSCRIPTIONS_SUBSCRIBING_ERROR_NOPACKAGEID',"Przykro nam, ale ID pakietu abonamentowego nie został rozpoznany.");
define('_JRPORTAL_SUBSCRIPTIONS_SUBSCRIBING_ERROR_ALREADYSUBSCRIBEDTOFREEBIE',"Przykro nam, jesteś już zapisany do darmowego pakietu abonamentowego, nie można zapisać się do tego pakietu ponownie.");
define('_JRPORTAL_SUBSCRIPTIONS_STATUS_EXPL',"Status <b>0:</b> Do czasu zapłaty <b>1:</b> Stworzony <b>2:</b> Anulowane <b>3:</b> Koniec.");
define('_JRPORTAL_SUBSCRIPTIONS_MYSUBSCRIPTIONS',"Moje abonamenty");
...
define('_JOMRES_FRONT_BLACKBOOKING_SRP_CANNOTBLACKBOOK','Przepraszamy, nie możesz zablokować rezerwacji tej oferty w wybranym terminie.');
define('_JOMRES_FRONT_BLACKBOOKING_SRP_CANBLACKBOOK','Możesz zablokować rezerwację tej oferty w wybranym terminie.');
define('_JOMRES_WARNINGS_PERPERSONPERNIGHT_NOGUESTTYPES','Twoja oferta jest skonfigurowana do pobierania płatności za osobę za noc, ale nie masz utworzonych lub opublikowanych żadnych rodzajów gości. Należy stworzyć i opublikować jeden lub więcej rodzaj gości.');
define('_JOMRES_WARNINGS_TARIFFS_NOTARIFFS','Jeśli nie masz jeszcze skonfigurowanych taryf, nie będzie można składać żadnych rezerwacji w ofercie.');
...
define('_JOMRES_CONTACTOWNER_TO_ADMIN_DESC','Ustaw na Tak, jeśli chcesz wysyłać wiadomości e-mail na alternatywny adres podany poniżej. Zostaw ustawione na Nie, aby wysyłać maile na adres określony w obszarze konfiguracji ofert.');
define('_JOMRES_CONTACTOWNER_TO_ADMIN_ALTERNATIVE','Alternatywny adres e-mail.');
define('_JOMRES_CONFIRMATION_EMAIL_SENT','Wiadomość e-mail z potwierdzeniem została wysłana. Możesz zamknąć to okno.');
define('_JOMRES_REALESTATE_TITLE','Prawdziwy wykaz ofert');
define('_JOMRES_REALESTATE_YESNO','Czy jest to pojedyńcza oferta?');
define('_JOMRES_REALESTATE_YESNO_DESC','Wybierz Tak, jeśli oferójesz możliwość rezerwacji całej oferty (domek letniskowy), wybierz Nie, jeśli twoja oferta to hotel/pensjonat/dom wczasowy gdzie wynajmowane będą pomieszczenia w ofercie.');
define('_JOMRES_FRONT_MR_MENU_CONTACT_AGENT','Kontakt');
...
define('_JOMRES_AUTOTRANSLATE_DESC','Funkcja ta jest nowa i eksperymentalna, więc używaj jej na własne ryzyko. Celem funkcji jest zapytanie narzędzia do tłumaczenia Google, by automatycznie skonfigurować tłumaczenia dla danej oferty.<br />');
define('_JOMRES_SINGLEPROPERTYINSTALLATION_TITLE','Czy to pojedyncza instalacja dla jednej oferty?');
define('_JOMRES_SINGLEPROPERTYINSTALLATION_DESC','Jeśli opcja ta jest ustawiona na Tak, wtedy widok nakładki z Jomres dla użytkowników nieautoryzowanych jest znacznie uproszczony. Idealne jeśli chcesz mieć tylko jedną ofertę i przyjmować rezerwacje tylko dla niej.<br />');
...
define('_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO','Ograniczenie rejestracji ofert do jednego kraju?');
define('_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO_DESC','Można ograniczyć rejestracje ofert do jednego kraju, poprzez ustawienie tej opcji na Tak i ustawienie kraju w następnej opcji.');
define('_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_COUNTRY','Oferty znajdują się w tym kraju:');
define('_JOMRES_JQUERYTHEME','Szablon graficzny');
define('_JOMRES_JQUERYTHEME_DESC','Wybierz szablon graficzny wykorzystywany w ramach systemu Jomres.');
define('_JOMRES_PROPERTYNOTOUBLISHED','Przykro nam, ale ta oferta nie jest obecnie dostępna.');
define('_JOMRES_REVIEWS','Recenzje');
define('_JOMRES_REVIEWS_TITLE','Tytuł recenzji');
define('_JOMRES_REVIEWS_DATE','Recenzja dodana');
define('_JOMRES_REVIEWS_NOREVIEWS','Brakuje jeszcze recenzji dla tej oferty.');
define('_JOMRES_REVIEWS_NOREVIEWS_BETHEFIRST','Chcesz być pierwszą osobą, która wyrazi swoją opinię na temat tej oferty?');
...
define('_JOMRES_REVIEWS_ADD_REVIEW_NOTLOGGEDIN','Musisz być zalogowany aby dodać recenzję.');
define('_JOMRES_REVIEWS_REVIEWBODY','Powiedz nam co myślisz o tej ofercie:');
define('_JOMRES_REVIEWS_REVIEWBODY_SAID','Ten recenzent powiedział nam:');
define('_JOMRES_REVIEWS_PROS','Plusy oferty:');
define('_JOMRES_REVIEWS_CONS','Minusy oferty:');
...
define('_JOMRES_REVIEWS_THANKS_FOR_CONFIRM','Dziękujemy za podzielenie się opinią o tej ofercie.');
define('_JOMRES_REVIEWS_ALREADY_CONFIRMED','Dziękujemy, ale już wyraziłeś swoją opinię o tej ofercie.');
define('_JOMRES_REVIEWS_COMPLETEALLFIELDS','Prosimy się upewnić, że wszystkie pola zostały wypełnione.');
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_TITLE','Prosimy podsumować swoją recenzję wpisując jej tytuł.');
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_DESCRIPTION','Prosimy wprowadzić bardziej szczegółowy komentarz w polu opisu.');
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_PROS','Prosimy wprowadzić plusy tej oferty.');
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_CONS','Prosimy wprowadzić minusy tej oferty.');
...
define('_JOMRES_REVIEWS_ADDREVIEW_SUMMARY','Podsumowanie recenzji');
...
define('_JOMRES_REVIEWS_ADMIN_TESTMODE_DESC','Normalnie manager nie może przeglądać ofert. W włączonym trybie testowym. Oczywiście nie jest to idealne rozwiązanie w środowisku produkcyjnym.');
define('_JOMRES_REVIEWS_ADMIN_PROPERTYLISTINFO','Jest to lista wszystkich ofert. Aby zobaczyć recenzje oferty kliknij na tej ofercie. Stamtąd będziesz mógł opublikować lub usunąć recenzję.');
...
define('_JOMRES_REVIEWS_SUBMIT','Wyślij');
...
define('_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS','Pokaż formularz rezerwacji na stronie szczegółów oferty?');
define('_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS_DESC','Ustaw na Tak, aby pokazać formularz rezerwacji na stronie szczegółów oferty. Jeśli ustawisz na Nie, wówczas pojawi się link do formularza zamiast formularza rezerwacji.');
...
define('_JOMRES_AJAXFORM_BILLING_TAX_EXTRAS','VAT - Usługi dodatkowe');
...
define('_JOMRES_SANITY_CHECK_NOT_PUBLISHED',"Należy pamiętać, że oferta nie została jeszcze opublikowana. Odwiedzający nie będą mogli jej zobaczyć.");
...
define('_JOMRES_ROOMMSLIST_STYLE_ROOMTYPES','Rodzajepokoi');
...
define('_JOMRES_REVIEWS_ADMIN_GUESTSONLY','Tylko goście ofert mogą recenzować?');
define('_JOMRES_REVIEWS_ADMIN_GUESTSONLY_DESC','Ustaw na Tak, jeśli chcesz ograniczyć recenzje tylko do tych użytkowników, którzy byli już gośćmi danych ofert.');
...
define('_JOMRES_PROPERTYMANAGEMENTPROCESS',"Tryb zarządzania ofertami");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_DESC',"Istnieją różne tryby zarządzania ofertami w zależności od sposobu, który chcesz stosować w swoim biznesie.");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL',"Wynajem");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL_DESC',"Wybierz wynajem jeśli chcesz oferować możliwość rezerwacji swojej oferty.");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE',"Aukcja");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE_DESC',"Wybierz aukcję jeśli chcesz sprzedać jakiś przedmiot.");
define('JOMRES_COM_A_MINIMALCONFIG_DESC','Ustaw na Tak, aby zmniejszyć liczbę opcji dostępnych dla managera oferty w sekcji General Configuration.');
define('_JOMRES_AJAXFORM_EXTRAS_SELECT','Proszę wybrać opcję rezerwacji');
define('_JOMRES_COM_ALLOWHTMLEDITOR_DESC','Włącza edytor HTML w szczegółach ofert. Dodatkowo, jeśli jest ustawione na Nie, wówczas wszystkie znaczniki HTML z wyjątkiem p oraz br zostaną usunięte z wszystkich wprowadzanych i wyświetlanych tekstów.');
...
define('_JOMRES_COM_TIMEZONE_SWITCHER',"Pokaż timezone switcher managera oferty na pasku narzędzi?");
define('_JOMRES_PARTNER_DISCOUNT',"Rabat partnera");
...
define('_JOMRES_PARTNER_CHOOSE_EXISTING_INSTRUCTIONS',"Wybierz partnera, który ma być edytowany na stronie administracji partnerami.");
define('_JOMRES_PARTNER_SHOW_TITLE',"Partner:");
define('_JOMRES_PARTNER_SHOW_SEARCHTITLE',"Szukaj oferty");
define('_JOMRES_PARTNER_SHOW_SEARCHINSTRUCTIONS',"Wpisz kilka znaków z nazwy oferty i wybierz odpowiednią.
					<br />
...
define('_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES',"Aktualna oferta");
define('_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES_INSTRUCTIONS',"Kliknij na ofercie by edytować rabaty partnera dla tej oferty.");
define('_JOMRES_SUSPENSIONS_TITLE',"Zawieszone?
					<br />
					Kliknij, aby zawiesić managera, będzie to cofnięcie wszystkich jego ofert.");

define('_JOMRES_SUSPENSIONS_MANAGERLIST_INFO',"Kliknij wstrzymaj (ikona z człowiekiem i zielonymi kleszczami) by zawiesić managera. Oznacza to, że manager nie będzie w stanie wykonywać funkcji zarządzania ofertami, a wszystkie ich właściwości będą publikowane. Super Manager nie może zostać zawieszony.");
define('_JOMRES_SUSPENSIONS_MANAGER_SUSPENDED',"To konto zostało zawieszone, nie jest obecnie możliwe administrowanie ofertami używając tego konta.");
define('_JOMRES_SUSPENSIONS_SUSPENDED_EMAIL_TITLE',"Zawieszone konto managera");
define('_JOMRES_SUSPENSIONS_UNSUSPENDED_EMAIL_TITLE',"Odwieszone konto managera");
define('_JOMRES_SUSPENSIONS_MANAGER_SUSPENDED_EMAIL',"Pamiętaj, że Twoje konto managera ofert zostało zawieszone. Nie będziesz w stanie wykonywać żadnych funkcji zarządzania ofertami aż konto zostanie przywrócone.");
define('_JOMRES_SUSPENSIONS_MANAGER_UNSUSPENDED_EMAIL',"Pamiętaj, że Twoje konto managera ofert jest już aktywne. Możesz nadal wykonywać wszelkie funkcje zarządzania ofertami.");
define('_JOMCOMP_MYUSER_REMOVE','Usuń z ulubionych');
define('_JOMRES_DATA_ARCHIVE_TITLE','Archiwum danych');
define('_JOMRES_DATA_ARCHIVE_TITLE_DESC','Archiwum danych rezerwacji jest to zrzut informacji rezerwacji zrobiony po naciśnięciu przycisku rezerwacja. Najedź na datę aby zobaczyć surowy zrzut danych. Informacje te są przechowywane w tabeli XXX__jomres_booking_data_archive .');
define('_JOMRES_MY_ACCOUNT_EDIT','Moje dane');
...
define('_JOMRES_MANAGER_CHOOSE_EXISTING_INSTRUCTIONS',"Wybierz managera aby zostać przeniesionym na stronę administracji.");
...
define('_JRPORTAL_INVOICES_COMMISSION_TITLE',"Faktury prowizyjne");
define('_JOMRES_CHOOSEMANAGER_NUMBEROFPROPERTIES_ASSIGNED',"Liczba ofert");
define('_JOMRES_CONFIG_JQUERY',"Obciążenie Jomres biblioteki jQuery?");
define('_JOMRES_CONFIG_JQUERY_DESC',"Można ustawić na Nie jeśli masz szablon, który używa jQuery. Może to rozwiązać problemy z jQuery i konflikty na niektórych szablonach, ale nie wszystkie.");
...
define('_JOMRES_COM_THUMBNAIL_SMALL_WIDTH_DESC','Małe miniaturki są używane w wykazie ofert, podczas gdy średnie miniatury są używane w nagłówku ofert.');
...
define('_JOMRES_TOUCHTEMPLATES','Tłumaczenie');
define('_JRPORTAL_ROI_TAB',"Abonamenty");
define('_JRPORTAL_INVOICES_COMMISSION_USE',"Obsługa faktur prowizyjnych");
define('_JRPORTAL_INVOICES_COMMISSION_USE_DESC',"Ustaw na Tak, aby uruchomić obsługę faktur prowizyjnych.");
define('_JRPORTAL_INVOICES_COMMISSION_MANAGER_TRIGGERS',"Obsługa faktur rezerwacji");
define('_JRPORTAL_INVOICES_COMMISSION_MANAGER_TRIGGERS_DESC',"Ustaw na Tak, aby uruchomić obsługę faktur rezerwacji.");
...
define('_JRPORTAL_INVOICES_COMMISSION_AUTOSUSPEND',"Automatycznie zawieś oferty z przekroczonym terminem płatności");
define('_JRPORTAL_INVOICES_COMMISSION_AUTOSUSPEND_THREASHOLD',"Automatycznie zawiesić gdy przekroczono");
define('_JRPORTAL_INVOICES_COMMISSION_AUTOSUSPEND_THREASHOLD_DESC',"Jest to liczba dni w czasie jakim manager musi zapłacić fakturę, zanim zostanie on zawieszony, a jego oferty wyłączone z publikacji w portalu.");
...
define('_JOMRES_COM_ADVANCED_SITE_CONFIG_DESC','Ustaw opcję na Tak, jeśli chcesz korzystać z zaawansowanych opcji konfiguracyjnych witryny. Jeśli dopiero zaczynasz z Jomres, to radzimy zostawić ustawione na Nie.');
...
define('_JOMRES_BOOKINGFORM_PRICINGOUTPUT','Podsumowanie płatności i szacunki powinny być wycenione jako za dobę/za tydzień/miesiąc, za?');
...
define('_JOMRES_A_GLOBAL_SEARCHOPTION_PEOPLENUMBERS_DESC','Dotyczy wszystkich modułów wyszukiwania. Podczas korzystania z funkcji wyszukiwania gościa numer, powinien wyglądać funkcja szukaj ofert, które taryfy będą obsługiwać gości numerów i równa wybrany numer, dokładnie równy numer wybrany lub numer wybrany i większe?');
define('_JOMRES_PAYPAL_REDIRECTMESSAGE','Proszę czekać, zamówienie jest przetwarzane.
					<br />
					W celu dokonania płatności zostaniesz przekierowany do serwisu transakcyjnego PayPal.');

define('_JOMRES_PAYPAL_REDIRECTMESSAGE_IFNOTREDIRECTED','Jeśli automatycznie nie zostałeś przekierowany do systemu PayPal w przeciągu 5 sekund...');
define('_JOMRES_PAYPAL_REDIRECTMESSAGE_CLICKHERE','Kliknij Tutaj');
define('_JRPORTAL_COUPONS_BOOKING_VALIDFROM',"Rezerwacja ważna od");
...
define('_JOMRES_LINEITEM_TOTAL_INCLUDINGTAX',"Razem brutto");
define('_JOMRES_MR_AUDIT_UNPUBLISH_PROPERTY','Oferta nie opublikowana');
define('_JOMRES_CONVERSION_TITLE',"Użyj funkcji konwersji");
define('_JOMRES_CONVERSION_TITLE_DESC',"Użyj funkcji konwersji on-line Jomres. Pozwoli to oferować wybór waluty z listy rozwijanej dla użytkowników i wyświetlanie cen w ich walucie.");
...
define('_JOMRES_IP_DETECTION_API_KEY_DESC','Aby automatycznie ustawić kod waluty na liście rozwijanej Jomres jest w stanie wykorzystać bezpłatną usługę o nazwie IPinfoDB, która pozwala wykryć kraj gośća. Musisz jednak zarejestrować się na stronie <a href="http://ipinfodb.com/register.php" target="_blank">IPinfoDB</a> i zdobyć klucz API.');
define('_JOMRES_DEBUGGING_TAB','Debugowanie');
define('_JOMRES_BOOKINGORM_MODALPOPUP','Pokaż formularz rezerwacji w oknie popup?');
define('_JOMRES_BOOKINGORM_MODALPOPUP_DESC','Jeśli opcja pokazywania formularza rezerwacji w szczegółach ofert jest ustawiona na Nie, wówczas, gdy strona otwiera się formularz rezerwacji może zostać pokazany w oknie popup.');
...
define('_JOMRES_BOOKINGORM_ROOMTOTAL_EX_TAX','VAT - Zakwaterowanie');
define('_JOMRES_BOOKINGORM_ROOMTOTAL_INC_TAX','Zakwaterowanie cena za osobę dorosłą');
define('_JOMRES_AJAXFORM_BILLING_TAX_ACCOM','VAT - Pokoje');
define('_JOMRES_AJAXFORM_BUTTON_OPEN_BOOKINGFORM','Otwórz formularz rezerwacji');
define('_JOMRES_AJAXFORM_BUTTON_BACK_TO_PROPERTY_DETAILS','Wróć do szczegółów oferty');
define('_JOMRES_COM_MR_EXTRA_AUTO_SELECT','Automatycznie wybrany?');
define('_JOMRES_BOOKINGORM_ROOMTOTAL_BALANCE','Po przedpłacie');
...
define('_JOMRES_COM_MR_VIEWBOOKINGS_DEPARTURE_WHOLEDAY','Wyjazd');
define('_JOMRES_AJAXFORM_ACCOMMODATION_NIGHTS_WHOLEDAY',"dzień/i przy");
define('_JOMRES_BOOKINGFORM_MONITORING_DEPARTUREDATE_INVALID_WHOLEDAY','Nieprawidłowa data wyjazdu.');
...
define('_JOMRES_COM_A_MINIMUMINTERVAL_WHOLEDAY','Przyjazd/Wyjazd minimum interwał');
...
define('_JOMRES_BOOKINGFORM_PRICINGOUTPUT_WHOLEDAY','Podsumowanie płatności i szacunki powinny być wycenione jako na dzień/za tydzień/miesiąc, za?');
define('_JOMRES_BOOKINGFORM_PRICINGOUTPUT_DAILY_WHOLEDAY','Za dzień');
define('_JOMRES_COM_A_DAYSBEFOREFIRSTBOOKING_WHOLEDAY','Dni przed terminem przyjazdu');
define('_JOMRES_COM_A_DAYSBEFOREFIRSTBOOKING_DESC_WHOLEDAY','Minimalna liczba dni, które muszą upłynąć od "dziś", przed datą przyjazdu.');
...
define('_JOMRES_COM_A_SHOWDEPARTUREINPUT_WHOLEDAY','Pokaż pole daty wyjazdu?');
define('_JOMRES_COM_A_SHOWDEPARTUREINPUT_DESC_WHOLEDAY',"Ustaw na Nie, jeśli nie chcesz pokazać pola daty wyjazdu.");
...
define('_JOMRES_COM_MR_FIXEDARRIVALDATE_RECURRING_WHOLEDAY','Stały dzień przyjazdu:');
define('_JOMRES_COM_MR_FIXEDARRIVALDATE_RECURRING_DESC_WHOLEDAY','Kiedy stałe dni przyjazdu są zaznaczone, liczba terminów, które mogą w terminach listy rozwijanej. Zauważ, że lista dat nie zawiera żadnych dat, jeśli rezerwacja nie jest możliwa ze względu na wcześniejsze rezerwacje, a lista będzie rzeczywiście dwa razy tak długo, jak wybranym numerem bo będzie miał podobną liczbę historycznych dat (jeśli jest dostępny).');
define('_JOMRES_COM_A_TARIFFS_PER_WHOLEDAY','Od osoby, za dzień');
define('_JOMRES_COM_A_TARIFFS_PER_DESC_WHOLEDAY','Wybierz Tak, jeśli chcesz pobierać opłaty za osobę za dzień. Jeśli Nie, wówczas koszty będą obliczane na podstawie za stawkę za dzień.');
...
define('_JOMCOMP_WISEPRICE_THREASHOLD_WHOLEDAY','Próg (liczba dni pomiędzy dniem przyjazdu a dniem składania rezerwacji)');
...
define('_JOMRES_COM_MR_VIEWBOOKINGS_DEPARTTODAY_WHOLEDAY','Przyjazd dzisiaj');
define('_JOMRES_COM_MR_VIEWBOOKINGS_STILLHERE_WHOLEDAY','Wyjazd zaległy');
...
define('_JOMRES_BOOKINGORM_SLIDERENABLED_DESC','Panel sumy będzie mógł zjechać w dół do formularza rezerwacji gdy użytkownik przewija stronę w dół. Możesz włączyć/wyłączyć tę funkcję w tym miejscu.');
define('_JOMRES_BOOKINGORM_EMAIL_NEWUSER_EMAIL_LOGIN_DETAILS','Powiadom nowych użytkowników o ich danych logowania?');
define('_JOMRES_BOOKINGORM_EMAIL_NEWUSER_EMAIL_LOGIN_DETAILS_DESC','Jeśli tak ustaw na Tak. Możesz ustawić tę opcję na Nie, aby mieć pewność, że dane logowania nie są wysyłane do użytkowników. Może to być przydatne, jeśli nie chcesz, aby użytkownicy rzeczywiście mogli się zalogować.');
define('_JOMRES_BOOKINGORM_TAX_OUTPUT','Pokaż kwotę podatku w kwocie rezerwacji w skróconej formie?');
...
define('_JOMRES_COM_A_ODDS_CANCELLATION_THREASHOLD','Anulowanie rezerwacji ilość dni');
define('_JOMRES_COM_A_ODDS_CANCELLATION_THREASHOLD_DESC','Zalogowani, zarejestrowani goście mogą anulować własne rezerwacje. Tutaj można ustawić ilość dni w których rezerwacja nie może być anulowana po upływie określonej liczby dni przed datą przyjazdu.');
define('_JOMRES_EDIT_PROFILE','Edytuj profil');
define('_JOMRES_PROPERTY_TYPE_ASSIGNMENT','Związek rodzaj ofert');
...
define('_JOMRES_CRATES_CLICKINITIAL','Kliknij literę, aby wyświetlić wszystkie oferty których nazwa rozpoczyna się od tego znaku. Gdy masz listę ofert można przypisać stawki prowizji do tych ofert lub kliknij na ich "edycji" ikonę, aby wyświetlić biznes statystyki.');
...
define('_JOMRES_PRODUCT_INFORMATION2','System ten jest idealnym rozwiązaniem dla każdego scenariusza, bez znaczenia jest to czy ma to być prosty formularz rezerwacji dla jednej oferty, czy ogromny portal z wieloma użytkownikami, w kilku językach i mnustwem ofert.');
define('_JOMRES_ROBBED_PORTALUI_CURRENT_PROPERTY',"Aktywna oferta");
define('_JOMRES_ROBBED_PORTALUI_SWITCH_PROPERTY',"Zmiana oferty");
define('_JOMRES_ROBBED_PORTALUI_CLICKINITIAL',"Kliknij znak, aby wyświetlić wszystkie oferty które zaczynają się od tej litery. Gdy zostaną wyświetlone kliknij na nazwę wybranej oferty, aby zmienić ją na aktywną ofertę.");
define('_JOMRES_CONFIG_ALTERNATE_SMTP_TITLE',"Alternatywne ustawienia SMTP");
define('_JOMRES_CONFIG_ALTERNATE_SMTP_DESC',"Ustaw na Tak, aby wykorzystać te alternatywne ustawienia SMTP.");
...
define('_JOMRES_QUICK_INFO',"Podgląd");
define('_JOMRES_MENU_SHOW',"Pokaż");
define('_JOMRES_MENU_HIDE',"Schowaj");
define('_JOMRES_MENU_SHOW_TITLE',"Użyj alternatywnego układu menu?");
...
define('_JOMRES_ACCESS_CONTROL_SANITYCHECK_WARNING',"Uwaga! Masz włączoną pełną kontrolę dostępu. System kontroli dostępu wykrył, że istnieją dodatki, do których dostęp nie został ograniczony. Jest to kwestia bezpieczeństwa Twojego serwisu. Musisz rozwiązać ten problem. Odwiedź strefę kontroli dostępu i ustal odpowiednie poziomy dostępu do poszczególnych obszarów systemu.");
define('_JOMRES_SHOWPROFILES_USERSWITHACCESS',"Użytkownicy z uprawnieniami administratora dla tej oferty");
define('_JOMRES_ADMIN_LISTALLUSERSINVOICES',"Wyświetl wszystkie faktury");
...
define('_JOMRES_FOUNDPROPERTIES',"Znajdź ofertę");
define('_JOMRES_REGISTRATION_STEP_1_OF_2',"Dodaj swoją ofertę: Krok 1 z 2");
define('_JOMRES_REGISTRATION_STEP_2_OF_2',"Dodaj swoją ofertę: Krok 2 z 2");
define('_JOMRES_MYPROPERTIES','Moje oferty');
...
define('_JOMRES_DEFAULT_LATLONGSTARTPOINT_DESC','Na mapie Google na stronie ofert jaka powinna być domyślna, startowa szerokość i długość geograficzna?');
...
define('_JOMRES_SYSTEM_EMAILS_DESC',"Pozostaw pole puste aby wyłączyć funkcję. Wiadomości do gości będą wysyłane z adresów e-mail. podanych w ofertach. Jeśli wprowadzisz adres e-mail w tym miejscu wiadomości do gości będą wysyłane z tego adresu.");
...
define('_JOMRES_COOKIEPOLICY_2',"Używamy plików cookies, aby nasza strona była łatwiejsza w użyciu.");
define('_JOMRES_COOKIEPOLICY_3',"Przeczytaj więcej...");
define('_JOMRES_COOKIEPOLICY_4',"Prawodawstwo UE wymaga, aby wszystkie strony wyraźnie informowały o stosowaniu i sposobie wykorzystywania plików cookies.");
define('_JOMRES_COOKIEPOLICY_5',"Mechanizm wyszukiwarki i rezerwacji wymaga użycia małego pliku cookies, który jednoznacznie identyfikuje przeglądarkę i umożliwia korzystanie z funkcjonalności naszego serwisu. Musisz zgodzić się na zapisanie tego pliku na Twoim komputerze. Jeśli nie wyrazisz zgody, dostęp do możliwości serwisu zostanie poważnie ograniczony.");
define('_JOMRES_COOKIEPOLICY_6',"Tak, zgadzam się z polityką cookies.");
define('_JOMRES_COM_A_DEPOSIT_FIRSTNIGHTCOST','Depozytem wymaganym jest koszt pierwszej nocy?');
define('_JOMRES_COM_A_DEPOSIT_FIRSTNIGHTCOST_DESC','Ceny są obliczane na podstawie za noc. Chcesz kaucję za jedną noc? Jeśli tak, to możesz zignorować poniższe opcje.');
...
define('_JOMRES_SAFEMODE_DESC',"Ustaw na Tak, aby uruchomić tryb awaryjny. Spowoduje to wyłączenie wszystkich wtyczek. Dostępne będą jedynie podstawowe funkcje systemu.");
define('_JOMRES_PRICE_ON_APPLICATION',"POA");
define('_JOMRES_USE_JOMRESEDITOR',"Użyj edytora WYSIWYG? (zalecane)");
define('_JOMRES_USE_JOMRESEDITOR_DESC',"Jeśli masz włączony edytor WYSIWYG, możesz skorzystać z edytora HTML dla CMS lub dostarczonego wraz z Jomres. Jest on zoptymalizowany pod kątem wykorzystania przez Managerów ofert i zaleca się, korzystanie z tego rozwiązania.");
define('COMMON_NEXT',"Dalej");
define('COMMON_CANCEL',"Anuluj");
define('COMMON_SUBMIT',"Wyślij");
define('COMMON_SAVE',"Zapisz");
define('COMMON_DELETE',"Usuń");
define('COMMON_RETURN',"Powrót");
define('COMMON_CLOSE',"Zamknij");
define('COMMON_BACK',"Cofnij");
define('COMMON_HOME',"Home");
define('COMMON_NEW',"Nowy");
define('COMMON_SEND',"Wyślij");
define('RECAPTCHA_TITLE',"reCaptcha");
define('RECAPTCHA_INFO',"Captcha jest używany do zabezpieczenia formularzy przed robotami spamującymi. Aby użyć tego mechanizmu musisz zarejestrować sie w <a href=\"http://www.google.com/recaptcha\" target=\"_blank\">Google reCaptcha</a> i zdobyć klucz publiczny i prywatny dla zabezpieczenia swojej domeny. Po otrzymaniu tych kluczy, wpisz je poniżej. Usługa reCapcha to bezpłatna usługa udostępniana przez Google.");
define('RECAPTCHA_PUBLIC_KEY',"Klucz publiczny (Public key)");
define('RECAPTCHA_PRIVATE_KEY',"Klucz prywatny (Private key)");
define('_JOMRES_BOOKINGFORM_LOCK_TITLE',"Czas blokady");
...
define('_JOMRES_BOOTSTRAPSWITCH',"Włącz szablony i funkcjonalność Bootstrap?");
define('_JOMRES_BOOTSTRAPSWITCH_DESC',"Jeśli używasz szablon Bootstrap na froncie strony, należy ustawić tę opcję na Tak.");
define('COMMON_ACTION',"Akcja");
define('COMMON_VIEW',"Widok");
define('BACKTOTOP',"Powrót do góry");
define('_JOMRES_INPUTFILTERING_LEVEL_WEAK',"Słaby");
define('_JOMRES_INPUTFILTERING_LEVEL_STRONG',"Silny");
define('_JOMRES_INPUTFILTERING',"Filtrowanie");
define('_JOMRES_INPUTFILTERING_LEVEL_TITLE',"Poziom filtrowania");
...
define('_JOMRES_INPUTFILTERING_PURIFIER_ALLOWED_TITLE',"Dozwolone tagi HTML");
define('_JOMRES_INPUTFILTERING_PURIFIER_ALLOWED_DESC',"Możesz edytować dozwolone tagi HTML. Domyślnie są to: 'p,b,strong,a[href],i' (czyli: Paragraph, Bold, Strong, Links oraz Italics). Więcej informacji na temat dozwolonych tagów znajdziesz w dokumentacji na stronie: <a href='http://htmlpurifier.org' target='_blank'>htmlpurifier.org</a>. Chociaż można zmienić to ustawienie, radzimy pozostawić wartości domyślne.");
define('_JOMRES_INPUTFILTERING_INPUTS_TITLE',"Filtrowane pola edycyjne");
define('_JOMRES_INPUTFILTERING_INPUTS_DESC',"Można określić, które pola formularza mają być filtrowane i oczyszczane ze niedozwolonych znaczników. Pola dodane do tej listy będą poddawane analizie przez HTML Purifier. Domyślnie są to: 'property_description property_checkin_times property_area_activities property_driving_directions property_airports property_othertransport property_policies_disclaimers'. Dodaj więcej pól poprzez wprowadzenie ich nazwy. Pola muszą być oddzielone spacją.");
define('_JOMRES_PROPERTYDETAILS_INTABS_TITLE',"Szczegółowe informacje w zakładkach?");
define('_JOMRES_PROPERTYDETAILS_INTABS_DESC',"Ustaw tę opcję na Tak, aby wyświetlić szczegółowe informacje w zakładkach. Ustaw na Nie, aby wyświetlić je bez zakładek.");
define('COMMON_PRINT',"Drukuj");
define('COMMON_EDIT',"Edytuj");
define('COMMON_COPY',"Kopiuj");
define('_JOMRES_BOOTSTRAPSWITCH_INFO',"Joomla 3 domyślnie korzysta z Twitter Bootstrap. Jomres również udostępnia szablony i funkcje, które korzystają z możliwości tej technologii. Domyślnie, jeśli używasz Jomres na Joomla 3 przełączniki te są ustawione na Tak, ale można je ustawić na Nie, jeśli jest taka potrzeba (nie zalecane). Jeśli używasz wersji niższej niż Joomla 3 możesz zdecydować się na stosowanie szablonów Jomres Bootstrap, jednak domyślnie opcje te są ustawione na Nie.");
define('_JOMRES_BOOTSTRAPSWITCH_FRONTEND',"Użyj szablonów Jomres Bootstrap na froncie?");
define('_JOMRES_BOOTSTRAPSWITCH_ADMINISTRATOR',"Użyj szablonów Jomres Bootstrap na zapleczu?");
define('_JOMRES_ALTERNATIVE_SEARCH_RESULTS',"Oto kilka alternatywnych opcji, które warto rozważyć.");
define('_JOMRES_BEEZ_WARNING',"Uwaga! Twój szablon na froncie jest aktualnie ustawiony na Beez3. Należy pamiętać, że nasze szablony nie są kompatybilne z Beez3 i radzimy przełączyć szablon witryny na szablon Bootstrapped np. Protostar.");
