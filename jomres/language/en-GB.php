...
define('_JOMRES_COM_MR_GENERALCONFIGDESC','Business Configuration');
...
define('_JOMRES_COM_MR_EDITBOOKING_TAB_ROOM','Resource');
...
define('_JOMRES_COM_MR_EB_ROOM_NAME','Resource name');
define('_JOMRES_COM_MR_EB_ROOM_NUMBER','Resource');
...
define('_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV','Resource/Business type');
define('_JOMRES_COM_MR_EB_ROOM_CLASS_DESC','Resource/business type description');
define('_JOMRES_COM_MR_EB_ROOM_FEATURES_LIST','Resource features list');
...
define('_JOMRES_COM_MR_QUICKRES_STEP2_TITLE','Our resources');
define('_JOMRES_COM_MR_QUICKRES_STEP2_PROPERTYNAME','Business');
define('_JOMRES_COM_MR_QUICKRES_STEP2_ROOMTYPE','Resource/business type');
...
define('_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE','View resources & business config');
define('_JOMRES_COM_MR_VRCT_TAB_ROOM','Resources');
...
define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_LINK','Resource');
...
define('_JOMRES_COM_MR_VRCT_ROOM_SAVE_INSERT','Resource added');
...
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_INSERT','Resource feature added');
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_UPDATE','Resource feature updated');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK','Resource type');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV','Resource/business type abbreviation');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC','Resource/business type description');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT','Resource/business type added');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE','Resource/business type updated');
...
define('_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS','Resource/business type');
...
define('_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE','There are no resources available able to satisfy the parameters specified');
...
define('_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM','Booking made for resource: ');
...
define('_JOMRES_COM_A_TARIFFS_PER_DESC','Select Yes if you want to charge per-person-per-night. If no, then costs will be calculated on a per-resource-per-night basis');
...
define('_JOMRES_COM_CONFIRMATION_RATE_RULES','Cost per night - per resource ');
...
define('_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN','Your resource will be held until your arrival, and check in is after 2pm.');
...
define('_JOMRES_COM_MR_ROOM_UNABLETODELETE','Unable to remove this resource, there are bookings against it. Cancel those bookings then retry.');
define('_JOMRES_COM_MR_ROOM_DELETED','Resource deleted');
define('_JOMRES_COM_MR_ROOMFEATURE_DELETE','Delete resource feature');
define('_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE','Unable to remove this resource feature, it is assigned to a resource or resources. Remove the feature from those resources and retry.');
define('_JOMRES_COM_MR_ROOMFEATURE_DELETED','Resource feature deleted');
...
define('_JOMRES_COM_MR_ROOMCLASS_DELETE','Delete resource/business type');
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS','Unable to remove this resource/business type, it is assigned to a resource. Try re-assigning the resource to another resource/business type then try again.');
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS','Unable to remove this resource/business type, it is assigned to a tariff. Try re-assigning the tariff to another resource/business type then try again.');
define('_JOMRES_COM_MR_ROOMCLASS_DELETED','Resource/business type deleted');
...
define('_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC','Set this to Yes to ensure that visitors can book resources online.');
...
define('_JOMRES_COM_A_BOOKING','Booking resources');
...
define('_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC','EG you are renting out a business, rather than resources in that business. If this is the case, then you must make sure that you only have the one resource registered against each business.');
...
define('_JOMRES_COM_AVLCAL_INBGCOLOUR','Cell bgcolour for days when business/resource is available');
...
define('_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR','Cell bgcolour for provisionally booked resources (bookings for which a deposit has not been taken)');
...
define('_JOMRES_FRONT_DELETEGUEST_UNABLETODELETEGUEST','Unable to delete this guest as they have bookings open against them with another business.');
define('_JOMRES_COM_INVOICE_ACTUALROOMCOST','Actual resource cost: ');
...
define('_JOMRES_MR_AUDIT_INSERT_ROOM','Created resource');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM','Updated resource');
define('_JOMRES_MR_AUDIT_DELETE_ROOM','Deleted resource');
define('_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE','Created resourcefeature');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE','Updated resourcefeature');
define('_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE','Deleted resourcefeature');
define('_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE','Inserted resourcetype');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE','Updated resourcetype');
define('_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE','Deleted resourcetype');
...
define('_JOMRES_MR_AUDIT_BOOKED_ROOM','Booked a resource');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR','There was an error attempting to book these resources, one or more of the resources you selected is not free.');
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT','Resources included in black booking');
...
define('_JOMRES_COM_A_ROOMTAX','Resource tax');
define('_JOMRES_COM_A_ROOMTAX_DESC','Designed for the American market. These are the resource tax amounts that will be charged to the guest. You can charge a combination and/or of fixed and percentage figures. Note that these taxes are only applied to the cost of the resource.');
...
define('_JOMRES_FRONT_TARIFFS_ROOMTYPE','Resource/business type');
...
define('_JOMRES_COM_PTYPES_UNABLETO_DELETE','Unable to delete business type. Business type is assigned to one or more businesses, please re-assign them before trying to delete');
...
define('_JOMRES_COM_MONTHSTOSHOW_DESC','In the resource availability, How many months of the calendar should be shown?');
...
define('_JOMRES_FRONT_GALLERYLINK','View this business\'s website');
...
define('_JOMRES_FRONT_MR_MENU_BOOKAROOM','Book a resource');
...
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS','Click for Resources and availability');
...
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE','Show resources and availability below this link');
...
define('_JOMRES_A_GLOBALROOMTYPES','Use global resource/business types');
...
define('_JOMRES_COM_SELFREGISTRATION','Users can register their businesses?');
...
define('_JOMRES_REGISTRATION_NOTALLOWED',"Sorry, you can't create a business on this system. You must be a logged in, registered user before you can proceed.");
...
define('_JOMRES_NUMBEROFROOMSAVAILABLE','Number of resources available');
define('_JOMRES_BACKTOPROPERTYDETAILSLINK','Back to business details');
define('_JOMRES_FRONT_ROOMTYPES','Resource/business types');
...
define('_JOMRES_AJAXFORM_AVAILABLE_DESC','Select the resources that you require');
...
define('_JOMRES_AJAXFORM_AVAILABLEROOMS','Available resources');
define('_JOMRES_AJAXFORM_SELECTEDROOMS','Selected resources');
...
define('_JOMRES_VARIANCES_ISPERCENTAGE_TT','The figure calculated is a percentage of the Base figure calculated for the resource. If this is set to no then the figure you specify is simply added or subtracted from the base resource value.');
define('_JOMRES_VARIANCES_POSNEG','Add variance?');
define('_JOMRES_VARIANCES_POSNEG_TT','The figure calculated is added to or removed from the Base figure calculated for the resource. Set this to No if you want this to be a discount from the base figure. ');
...
define('_JOMRES_COM_A_SHOWROOMSLISTLINK','Show link to resources list page in business details page?');
define('_JOMRES_COM_A_SHOWONLYAVLCAL','Show <b>only</b> Availability calendar?');
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Switch this to Yes to disable display of the business header and details, so that only the availability calendar is viewable in the business details section. Only really intended for users renting out single resource businesses (eg apartments, cottages etc).');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO','Booking form resource list show resource number');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME','Booking form resource list show resource name');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE','Booking form resource list show tariff title');
...
define('_JOMRES_COM_AVLCAL_BOOKING_KEY','Resource is booked');
...
define('_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS','You have chosen more resources than you have guests, click on a resource name to remove it from your selection');
define('_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS','Too many guests for the available beds');
define('_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS','You need to choose more resources');
define('_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM','Select a resource');
...
define('_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET','No resources selected yet');
...
define('_JOMRES_COM_LIMITROOMSLIST','Available resources/tariff limit');
define('_JOMRES_COM_LIMITROOMSLIST_DESC','Use this input to limit the number of available resources & tariffs that are listed in the booking form. Set it to zero if you do not want limiting enabled. ');
...
define('_JOMRES_COM_USERIS_SUPERPROPERTYMANAGER','Super Business Manager');
define('_JOMRES_COM_WEEKENDONLY','Weekends only');
define('_JOMRES_COM_WEEKENDDAYS','Weekend days');
define('_JOMRES_COM_WEEKENDDAYS_DESC','Set your weekend days. Tariffs that allow or disallow weekends will take this setting into account when generating the resources list.');
define('_JOMRES_EDITPROPERTY_SELECTCOUNTRY','Select your country before adding any business information');
define('_JOMRES_EDITPROPERTY_SAVEBEFOREUPLOAD','Save your business changes before uploading a business image');
...
define('_JOMRES_SEARCH_AVL_INFO','Please enter your intended arrival and departure dates and press the button to find businesses that have accommodation available on your chosen dates.');
define('_JOMRES_SEARCH_PTYPES','List all businesses by business type.');
define('_JOMRES_SEARCH_RTYPES','List all businesses by resource/business type.');
define('_JOMRES_SORTORDER_DEFAULT','Default');
define('_JOMRES_SORTORDER_PROPERTYNAME','Business Name');
define('_JOMRES_SORTORDER_PROPERTYREGION','Business Region');
define('_JOMRES_SORTORDER_PROPERTYTOWN','Business Town');
define('_JOMRES_SORTORDER_STARS','Stars');
define('_JOMRES_PATHWAY_PROPERTYLIST','Business list');
define('_JOMRES_PATHWAY_PROPERTYDETAILS','Business details ');
...
define('_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_RECHECKINGROOMAVIALABILITY','Re-checking resource availability<br/>(Resource selection will be reset)');
...
define('_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_CHANGINGROOMSELECTION','Changing your resource selection');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMIMAGE','Resource image');
...
define('_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS','Show resources list in business details page?');
define('JOMRES_PROPERTYTYPE','Business type');
define('JOMRES_COM_A_SRPONLY','SRP only');
define('JOMRES_MAXPEOPLEINROOM','Max people per resource');
...
define('JOMRES_COM_A_VERBOSETARIFFINTO_DESC','Set this to Yes to show more detailed tariff information in the business details/tariff popup');
define('JOMRES_COM_A_MINIMALCONFIG','Minimise configuration options');
define('_JOMCOMP_AMEND','Amend Booking - Business Selection');
define('_JOMCOMP_AMEND_SELECTPROPERTY','Select New Business');
...
define('_JRPORTAL_CPANEL_LISTPROPERTIES','List Businesses');
define('_JRPORTAL_PROPERTIES_PROPERTYNAME','Business name');
define('_JRPORTAL_PROPERTIES_PROPERTYADDRESS','Business address');
...
define('_JRPORTAL_LISTBOOKINGS_HEADER_PROPERTY_ID','Business id');
...
define('_JRPORTAL_ADD_ADHOC_ITEM_CHOOSEPROPERTY','Associated business (if applicable)');
...
define('_JOMRES_EDITPROPERTY_CONNOTDELETE1','You cannot delete this business as it is the only business that you have access to. If you want to disable it, please use the un-publish feature in your toolbar. ');
...
define('_JOMRES_COM_ISTHISANMRP',"Is this business a hotel/bed and breakfast/guest house/pension? ");
define('_JOMRES_COM_ISTHISANMRP_DESC',"Configuration options differ depending on if you are renting out resources in a business, or the business itself. Select MRP if you are offering resources, select SRP if you are offering the entire business. ");
...
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM',"per resource ");
...
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_SUBJECT','Business enquiry from ');
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_THANKS','Thank you for your enquiry, your message has been sent to the business\'s contact email address, and copied to your own address for your records. They will respond to you as soon as possible with their reply.');
...
define('_JOMRES_BOOKINGFORM_LOOKRIGHT','Please select your required accommodation from the list below by clicking on the resource.');
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS','Min resources already selected');
...
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS','Max resources already selected');
...
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYSPERROOM','Per days X resources selected');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_TAB','Business type');
define('_JOMRES_COM_MR_VRCT_PROPERTY_TYPE','Edit your business type');
define('_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_INFO','Select your business type');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMTYPEIMAGE','Booking form resource list show resource type image');
define('_JOMRES_COM_A_LISTLIMIT','Business List limit');
...
define('_JRPORTAL_COUPONS_ROOMONLY',"Resource only");
define('_JRPORTAL_COUPONS_ROOMONLY_DESC',"Discount is only applied to the cost of the resource. If No, then the discount is applied to the entire cost of the booking.");
...
<br/>
");
define('_JOMRES_COM_A_BOOKINGFORM_SHOWDISABLED','Booking form resource list show disabled access');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWMAXPEOPLE','Booking form resource list show max people');
define('_JRPORTAL_HORIZROOMSLIST_ESTIMATEWARNING',"Please note that resource prices listed are estimates and the full price of the booking will not be calculated until you have added a resource or resources to your selection.");
...
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_ROOMSLIMIT',"Resources limit"); // Not currently used, saved for a rainy day
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_PROPERTYLIMIT',"Business limit");
...
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES1',"You need a valid subscription to create new businesses. At this moment in time, you have purchased subscriptions for ");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES2'," <i>published</i> business(s). ");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES3',"You can increase the number of businesses you can create by <a href='".JOMRES_SITEPAGE_URL."&task=list_subscription_packages'>purchasing more subscription packages here.</a>");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES4'," You have used ");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES5'," business slots. ");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES6',"To see a list of your current businesses click <a href='".JOMRES_SITEPAGE_URL."&task=listyourbusinesses'>here</a>. ");
...
define('_JRPORTAL_SUBSCRIPTIONS_PUBLISHERROR',"Unfortunately, you cannot publish this business as you have reached your maximum number of available business slots.");
define('_JRPORTAL_SUBSCRIBERS_SUBSCRIBED',"Thank you for creating a subscription to list your business on our server. Once your invoice is marked as paid (there may be a delay depending on Paypal) please <a href='".JOMRES_SITEPAGE_URL."&task=registerProp_step1'>click here to continue creating your business(s).</a>");
...
define('_JOMRES_CLICKTOREGISTER','Click here to register your business');
...
define('_JOMRES_LATLONG_DESC',"Jomres will pass your address to Google to generate the map position in the business details. If for whatever reason Google cannot find your address based on the information found above, you can enter latitude and longitude in the lat/long fields instead. If you choose to enter the latitude and longitude, please note that we have found the Google earth lat and long information to be inaccurate so you are advised instead to visit <a href=\"http://itouchmap.com/latlong.html\" target=\"_blank\">the itouchmap site</a> and use their information to determine your latitude and longitude. When entering your lat and long, the format should be something like '51.754564622' and '-4.997314810'.");
...
define('_JOMRES_USER_LISTMYPROPERTY','Add my business to this site');
...
define('_JOMRES_FRONT_BLACKBOOKING_SRP_CANNOTBLACKBOOK','Sorry, you cannot black book this business for those dates.');
define('_JOMRES_FRONT_BLACKBOOKING_SRP_CANBLACKBOOK','You can blackbook this business for those dates.');
define('_JOMRES_WARNINGS_PERPERSONPERNIGHT_NOGUESTTYPES','Your business is configured to charge per person per night but you do not have any guest types created or published, please create and publish one or more guest types. ');
define('_JOMRES_WARNINGS_TARIFFS_NOTARIFFS','You don\'t have any tariffs configured yet, you will not be able take any bookings for your business.');
...
define('_JOMRES_REALESTATE_YESNO','Is this business a for sale listing?');
define('_JOMRES_REALESTATE_YESNO_DESC','Select Yes if you are selling the business, select No if it is a listing where you will be offering short term rentals and will be using this system for taking bookings.');
...
define('_JOMRES_SINGLEPROPERTYINSTALLATION_TITLE','Is this a single business installation?');
...
define('_JOMRES_PROPERTYNOTOUBLISHED','We are sorry, but that business is not currently available.');
define('_JOMRES_REVIEWS','Reviews');
define('_JOMRES_REVIEWS_TITLE','Review title');
define('_JOMRES_REVIEWS_DATE','posted on ');
define('_JOMRES_REVIEWS_NOREVIEWS','There are no reviews for this business yet.');
define('_JOMRES_REVIEWS_NOREVIEWS_BETHEFIRST','Would you like to be the first to review this business?');
...
define('_JOMRES_REVIEWS_REVIEWBODY','Tell us what you think about this business : ');
...
define('_JOMRES_REVIEWS_ALREADYREVIEWED','You have already reviewed this business, you can\'t post another review about it.');
...
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_PROS','Please enter the good parts of your experience of being a guest at this business');
...
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_2','Please rate your opinion of the business\s locale');
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_3','Please provide your opinion of the cleanliness of the business');
...
define('_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS','Show Booking form in business details page?');
...
define('_JOMRES_ROOMALLOCATIONS_ROOM','Resource ');
define('_JOMRES_ROOMALLOCATIONS_GUESTS','guest(s). ');
define('_JOMRES_ROOMALLOCATIONS_INFORMATION','This how we have assigned your guest numbers to their resources. If you would like to change this allocation, you will need to contact the hotel after making the booking. Extra charges may apply if you change your assignments.');
define('_JOMRES_SANITY_CHECK_NOT_PUBLISHED',"Note that your business is not yet published, only you can see the business, site visitors will not see it");
...
define('_JOMRES_ROOMMSLIST_STYLE','Resources list style');
define('_JOMRES_ROOMMSLIST_STYLE_DESC','In the booking form, using the "classic" resources list style you offer individual resources to guests. With the resource type view, guests choose the number of resources of type X (eg. 2 x doubles) instead');
define('_JOMRES_ROOMMSLIST_STYLE_CLASSIC','Classic');
define('_JOMRES_ROOMMSLIST_STYLE_ROOMTYPES','Resource types');
define('_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_START','(Re)checking availability');
define('_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_REBUILDING_AVAILABLEROOMS','Rebuilding available resources list');
...
define('_JOMRES_REVIEWS_ADMIN_GUESTSONLY','Only business guests can review?');
define('_JOMRES_REVIEWS_ADMIN_GUESTSONLY_DESC','Set this to Yes if you want to restrict reviews to only those users who have been a guest already in this business.');
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERROOMPERBOOKING','Per resource');

define('_JOMRES_MAX_GUESTS_PER_ROOM','Guests per resource : ');
define('_JOMRES_MAX_GUESTS_PER_BOOKING','Guests per booking : ');
define('_JOMRES_NUMBER_OF_ROOMS','Number of resources');
...
define('_JOMRES_PROPERTYMANAGEMENTPROCESS',"Business management process");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_DESC',"There are different management processes depending on the way you want to list your business/business.");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL',"Rental");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL_DESC',"Choose the rental option if you are booking out resources in a business (eg. Hotel/B&B/Villa/Apartment)");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE',"Realestate/simple listing");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE_DESC',"Choose the real estate option if you are not offering any booking functionality at all, (eg. A business/item for sale)");
...
define('_JOMRES_COM_MANAGEMENTVIEW_MANAGMENT',"Business management view");
...
define('_JOMRES_SUSPENSIONS_MANAGER_SUSPENDED_EMAIL',"Please note that your business manager account has been suspended. You will not be able to perform any business management functions until the account has been restored.");
define('_JOMRES_SUSPENSIONS_MANAGER_UNSUSPENDED_EMAIL',"Please note that your business manager account is now active. You may continue to perform any business management functions. Please log into your account and ensure that the approprite propert(ies) have been published. Thank you.");
...
define('_JOMRES_CHOOSEMANAGER_NUMBEROFPROPERTIES_ASSIGNED',"Number of businesses");
