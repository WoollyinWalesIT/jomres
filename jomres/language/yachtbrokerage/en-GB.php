...
jr_define( '_JOMRES_COM_MR_NEWPROPERTY', 'New boat' );
...
jr_define( '_JOMRES_COM_MR_EDITBOOKING_TAB_ROOM', 'Yacht' );
...
jr_define( '_JOMRES_COM_MR_EB_ROOM_NAME', 'Yacht name' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_NUMBER', 'Yacht' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_FLOOR', 'Berth' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_DISABLED', 'Disabled access available?' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MAXPEOPLE', 'Max people' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV', 'Yacht type' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_CLASS_DESC', 'Yacht type description' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_FEATURES_LIST', 'Yacht features list' );
...
// Edit Language
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_TITLE', 'Our yachts' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_PROPERTYNAME', 'Business' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_ROOMTYPE', 'Yacht type' );
// Display guest form
...
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP4_NUMBEROFGUESTS', 'Number of clients' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP4_TOTALINVOICE', 'Total' );
// Yachts tab
jr_define( '_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE', 'View yachts & business config' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOM', 'Yachts' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOMFEATURES', 'Yt features' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOMTYPES', 'Yacht types' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_PROPERTYS', 'Business' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_PROPERTYFEATURES', 'Prop feats' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_HEADER_LINK', 'Yacht' );
...
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_HEADER_FLOOR', 'Berth' );
...
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_SAVE_INSERT', 'Yacht added' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_LINKTEXT', 'Edit item' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMFEATURES_HEADER_LINK', 'Yt features' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMFEATURES_HEADER_INPUT', 'Feature description' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_INSERT', 'Yacht feature added' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_UPDATE', 'Yacht feature updated' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK', 'Yacht type' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV', 'Yacht type abbreviation' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC', 'Yacht type description' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT', 'Yacht type added' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE', 'Yacht type updated' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_LINKTEXT', 'Edit item' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_NAME', 'Boat/yacht Name' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_STREET', 'Type (Sail or Motor)' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_POSTCODE', 'Engine' );
...
jr_define( '_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS', 'Yacht type' );
...
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_GUESTADMIN', 'Client admin' );
...
jr_define( '_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE', 'There are no yachts available able to satisfy the parameters specified' );
...
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM', 'Booking made for yacht: ' );
...
jr_define( '_JOMRES_FRONT_MR_BOOKIN_GUESTBOOKEDIN', 'Client booked in ' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_NOGUESTSDUEIN', 'No clients are due to arrive today' );
jr_define( '_JOMRES_FRONT_MR_BOOKOUT_TITLE', 'Book out guest ' );
jr_define( '_JOMRES_FRONT_MR_BOOKOUT_NOGUESTSDUEOUT', 'No clients are due to depart today' );
// Config panel
...
jr_define( '_JOMRES_COM_A_TARIFFS_PER_DESC', 'Select Yes if you want to charge per-person-per-night. If no, then costs will be calculated on a per-yacht-per-night basis' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RATE_RULES', 'Cost per night - per yacht ' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN', 'Your yacht will be held until your arrival, and check in is after 2pm.' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE', 'No allowance can be made for meals not taken or for yachts not occupied for the full period of the boking. With this in mind we strongly recommend that you use a holiday insurance facility.' );
...
jr_define( '_JOMRES_COM_MR_ROOM_UNABLETODELETE', 'Unable to remove this yacht, there are bookings against it. Cancel those bookings then retry.' );
jr_define( '_JOMRES_COM_MR_ROOM_DELETED', 'Yacht deleted' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_DELETE', 'Delete yacht feature' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE', 'Unable to remove this yacht feature, it is assigned to some yachts. Remove the feature from those yachts and retry.' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_DELETED', 'Yacht feature deleted' );
...
jr_define( '_JOMRES_COM_MR_ROOMCLASS_DELETE', 'Delete yacht type' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS', 'Unable to remove this yacht type, it is assigned to a yacht. Try re-assigning the yacht to another yacht type then try again.' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS', 'Unable to remove this yacht type, it is assigned to a tariff. Try re-assigning the tariff to another yacht type then try again.' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_DELETED', 'Yacht type deleted' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_MAPPINGLINK', 'Offsite link (eg to manufacturer\'s information page)' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION', 'Boat/yacht description' );
...
jr_define( '_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC', 'Set this to Yes to ensure that visitors can book yachts online.' );
...
jr_define( '_JOMRES_COM_A_BOOKING', 'Booking yachts' );
...
jr_define( '_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC', 'EG you are renting out a business, rather than yachts in that business. If this is the case, then you must make sure that you only have the one yacht registered against each business.' );
...
jr_define( '_JOMRES_COM_AVLCAL_INBGCOLOUR', 'Cell bgcolour for days when business/yacht is available' );
...
jr_define( '_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR', 'Cell bgcolour for provisionally booked yachts (bookings for which a deposit has not been taken)' );
...
jr_define( '_JOMRES_FRONT_DELETEGUEST_GUESTDELETED', 'Client deleted' );
jr_define( '_JOMRES_FRONT_DELETEGUEST_UNABLETODELETEGUEST', 'Unable to delete this guest as they have bookings open against them. Cancel the bookings & try again.' );
jr_define( '_JOMRES_COM_INVOICE_ACTUALROOMCOST', 'Actual yacht cost: ' );
...
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM', 'Created yacht' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM', 'Updated yacht' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM', 'Deleted yacht' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE', 'Created yacht feature' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE', 'Updated yacht feature' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE', 'Deleted yacht feature' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE', 'Inserted yacht type' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE', 'Updated yacht type' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE', 'Deleted yacht type' );
...
jr_define( '_JOMRES_MR_AUDIT_BOOKED_ROOM', 'Booked a yacht' );
...
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR', 'There was an error attempting to book these yachts, one or more of the yachts you selected is not free.' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT', 'Yachts included in black booking' );
...
jr_define( '_JOMRES_COM_A_ROOMTAX', 'Yacht tax' );
jr_define( '_JOMRES_COM_A_ROOMTAX_DESC', 'Designed for the American market. These are the yacht tax amounts that will be charged to the guest. You can charge a combination and/or of fixed and percentage figures. Note that these taxes are only applied to the cost of the yacht.' );
...
jr_define( '_JOMRES_FRONT_TARIFFS_ROOMTYPE', 'Yacht type' );
...
jr_define( '_JOMRES_COM_PTYPES_UNABLETO_DELETE', 'Unable to delete business type. Business type is assigned to one or more properties, please re-assign them before trying to delete' );
...
jr_define( '_JOMRES_COM_MONTHSTOSHOW_DESC', 'In the yacht availability, How many months of the calendar should be shown?' );
...
jr_define( '_JOMRES_FRONT_BLACKBOOKING_DESC', 'Please choose the yacht(s) you wish to take out of service, and the relevant dates. <br>If a yacht does not have a check mark against it, it cannot be included in the black booking until any outstanding bookings have been completed/cancelled.<br/> When you have selected the appropriate dates, click the blue "apply" button to re-check yacht availability. ' );
...
jr_define( '_JOMRES_FRONT_GALLERYLINK', 'View this brokerage\'s website' );
...
jr_define( '_JOMRES_A_GLOBALPFEATURES_DESC', 'Set this to Yes if you want to force all properties to use only the business features defined by the webmaster.' );
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS', 'Click for Yachts and availability' );
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE', 'Show yachts and availability below this link' );
...
jr_define( '_JOMRES_A_GLOBALROOMTYPES', 'Use global yacht types' );
jr_define( '_JOMRES_A_GLOBALROOMTYPES_DESC', 'Set this to Yes if you want to force all properties to use only the yacht types defined by the webmaster. You need to set this to Yes if you intend to allow searching via yacht types.' );
jr_define( '_JOMRES_A_GLOBALROOMTYPES_INFO', 'To assign an image to this yacht type you first need to upload your yacht type images to the /images/stories/jomres/rmtypes/ folder. ' );
...
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_1', 'Please complete your boat\'s details.' );
...
jr_define( '_JOMRES_REGISTRATION_NOTALLOWED', "Sorry, you can't create a boat on this system. You must be a logged in, registered user, and you must not have already created a business." );
jr_define( '_JOMRES_REGISTRATION_CREATEDPROPERTY', 'Created boat: ' );
...
jr_define( '_JOMRES_NUMBEROFROOMSAVAILABLE', 'Number of yachts available' );
jr_define( '_JOMRES_BACKTOPROPERTYDETAILSLINK', 'Back to business details' );
jr_define( '_JOMRES_FRONT_ROOMTYPES', 'Yacht types' );
...
jr_define( '_JOMRES_AJAXFORM_AVAILABLE_DESC', 'Select the yachts that you require' );
...
jr_define( '_JOMRES_AJAXFORM_AVAILABLEROOMS', 'Available yachts' );
jr_define( '_JOMRES_AJAXFORM_SELECTEDROOMS', 'Selected yachts' );
...
jr_define( '_JOMRES_AJAXFORM_CLICKHERECAPTION', 'Click now to add this yacht to your selection' );
jr_define( '_JOMRES_AJAXFORM_CLICKHERECAPTION_REMOVE', 'Click now to remove this yacht from your selection' );
jr_define( '_JOMRES_CONFIG_VARIANCES_CUSTOMERTYPES', 'Client types' );
...
jr_define( '_JOMRES_VARIANCES_ISPERCENTAGE_TT', 'The figure calculated is a percentage of the Base figure calculated for the yacht. If this is set to no then the figure you specify is simply added or subtracted from the base yacht value.' );
jr_define( '_JOMRES_VARIANCES_POSNEG', 'Add variance?' );
jr_define( '_JOMRES_VARIANCES_POSNEG_TT', 'The figure calculated is added to or removed from the Base figure calculated for the yacht. Set this to No if you want this to be a discount from the base figure. ' );
...
jr_define( '_JOMRES_COM_A_SHOWROOMSLISTLINK', 'Show link to yachts list in business details page?' );
jr_define( '_JOMRES_COM_A_SHOWONLYAVLCAL', 'Show <b>only</b> Availability calendar/Yachts list?' );
jr_define( '_JOMRES_COM_A_SHOWONLYAVLCAL_DESC', 'Switch this to Yes to disable display of the business header and details, so that only the yachts list/availability calendar is viewable in the business details section. Only really intended for users renting out single yacht properties (eg apartments, cottages etc).' );
...
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO', 'Booking form yacht list show yacht number' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME', 'Booking form yacht list show yacht name' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE', 'Booking form yacht list show tariff title' );
...
jr_define( '_JOMRES_COM_A_DEFAULTNUMBEROFFIRSTGUESTTYPE', 'Client type default' );
jr_define( '_JOMRES_COM_A_DEFAULTNUMBEROFFIRSTGUESTTYPEDESC', 'Default number of first the first Client type. If you use guest types, then this is the default number that the first guest type in the booking form will be set to.' );
...
jr_define( '_JOMRES_COM_AVLCAL_BOOKING_KEY', 'Yacht is booked' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_GUEST_TYPE_INCORRECT', 'Clienttype variant incorrect' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS', 'You have chosen more yachts than you have clients, click on a yacht name to remove it from your selection' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS', 'Too many clients for the available beds' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS', 'You need to choose more yachts' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM', 'Select a yacht' );
...
jr_define( '_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET', 'No yachts selected yet' );
...
//v2rc2
jr_define( '_JOMRES_COM_LIMITROOMSLIST', 'Available yachts/tariff limit' );
jr_define( '_JOMRES_COM_LIMITROOMSLIST_DESC', 'Use this input to limit the number of available yachts & tariffs that are listed in the booking form. Set it to zero if you do not want limiting enabled. ' );
...
jr_define( '_JOMRES_COM_USERIS_SUPERPROPERTYMANAGER', 'Super Brokerage Manager' );
jr_define( '_JOMRES_COM_WEEKENDONLY', 'Weekends only' );
jr_define( '_JOMRES_COM_WEEKENDDAYS', 'Weekend days' );
jr_define( '_JOMRES_COM_WEEKENDDAYS_DESC', 'Set your weekend days. Tariffs that allow or disallow weekends will take this setting into account when generating the yachts list.' );
jr_define( '_JOMRES_EDITPROPERTY_SELECTCOUNTRY', 'Select your country before adding any brokerage information' );
jr_define( '_JOMRES_EDITPROPERTY_SAVEBEFOREUPLOAD', 'Save your brokerage changes before uploading a brokerage image' );
...
jr_define( '_JOMRES_SEARCH_PTYPES', 'List all properties by brokerage type.' );
jr_define( '_JOMRES_SEARCH_RTYPES', 'List all properties by yacht type.' );
jr_define( '_JOMRES_SORTORDER_DEFAULT', 'Default' );
jr_define( '_JOMRES_SORTORDER_PROPERTYNAME', 'Brokerage Name' );
jr_define( '_JOMRES_SORTORDER_PROPERTYREGION', 'Brokerage Region' );
jr_define( '_JOMRES_SORTORDER_PROPERTYTOWN', 'Brokerage Town' );
jr_define( '_JOMRES_SORTORDER_STARS', 'Stars' );
jr_define( '_JOMRES_PATHWAY_PROPERTYLIST', 'Boat list' );
jr_define( '_JOMRES_PATHWAY_PROPERTYDETAILS', 'Boat details' );
...
jr_define( '_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_RECHECKINGROOMAVIALABILITY', 'Re-checking yacht availability<br/>(Yacht selection will be reset)' );
...
jr_define( '_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_CHANGINGROOMSELECTION', 'Changing your yacht selection' );
...
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMIMAGE', 'Boat image' );
...
jr_define( '_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS', 'Show yachts list in brokerage details page?' );
jr_define( 'JOMRES_PROPERTYTYPE', 'Brokerage type' );
jr_define( 'JOMRES_COM_A_SRPONLY', 'SRP only' );
jr_define( 'JOMRES_MAXPEOPLEINROOM', 'Max people per yacht' );
...
jr_define( '_JOMCOMP_MYUSER_PROPERTYTYPE', 'Brokerage type' );
jr_define( '_JOMCOMP_MYUSER_PUBLISHEDPROPERTIES', 'Brokerages on site' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE', 'Wise price' );
jr_define( '_JOMCOMP_WISEPRICE_ACTIVE', 'Active' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE_DESC', 'This plugin allows you to enable and configure your yacht prices dynamically.' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE_DESC_FULL', 'Most businesses will recalculate yacht prices based on the number of yachts of a required type that are available on a given date. This allows them to offer discounts on a yacht type that isn\'t busy during a given period with the aim of attracting business that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of yachts of a selected type are available in the brokerage on a given day.<br/> The days threashold defines the number of days that the arrival date must be within before yacht prices are adjusted by this feature, then the percentages options allow you to configure the percentage of yachts that can be available before a given discount is applied.' );
jr_define( '_JOMCOMP_WISEPRICE_THREASHOLD', 'Threashold (number of days between arrival date and today)' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE10', 'Percentage yachts occupied 10%' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE25', 'Percentage yachts occupied 25%' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE50', 'Percentage yachts occupied 50%' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE75', 'Percentage yachts occupied 75%' );
...
jr_define( '_JOMCOMP_WISEPRICE_NOTDISCOUNTED', ' Yacht price not discounted ' );
jr_define( 'JOMRES_COM_A_MAPSKEY', 'Google maps API key' );
jr_define( 'JOMRES_COM_A_MAPSKEY_DESC', 'Get can get a google maps API key from <a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google maps</a>. Once you have input your map key here, Jomres will show the map in your Brokerage Details page.' );
...
jr_define( '_JOMCOMP_LASTMINUTE_PROPERTYLIST_PRE', 'This brokerage offers a last minute discount of  ' );
...
jr_define( 'JOMRES_COM_A_VERBOSETARIFFINTO_DESC', 'Set this to Yes to show more detailed tariff information in the brokerage details/tariff popup' );
jr_define( 'JOMRES_COM_A_MINIMALCONFIG', 'Minimise configuration options' );
jr_define( '_JOMCOMP_AMEND', 'Amend Booking - Brokerage Selection' );
jr_define( '_JOMCOMP_AMEND_SELECTPROPERTY', 'Select New Brokerage' );
...
jr_define( '_JRPORTAL_CONFIG_DEFAULT_CRATE_DESC', 'Choose the default commission rate that will be applied to a brokerage in the event that another commission rate is not otherwise set.' );
...
jr_define( '_JRPORTAL_CPANEL_LISTPROPERTIES', 'List Brokerages' );
jr_define( '_JRPORTAL_PROPERTIES_PROPERTYNAME', 'Brokerage name' );
jr_define( '_JRPORTAL_PROPERTIES_PROPERTYADDRESS', 'Brokerage address' );
jr_define( '_JRPORTAL_PROPERTIES_LEGEND', 'Brokerages who\'s background colour is red have not yet had a commission rate applied to them.' );
jr_define( '_JRPORTAL_STATS_PATETITLE', 'Statistics' );
jr_define( '_JRPORTAL_STATS_STATTYPE', 'Statistics for: ' );
jr_define( '_JRPORTAL_STATS_STATTYPE_PROPERTIES', 'Brokerages - Clicks' );
jr_define( '_JRPORTAL_PROPERTIES_VIEWPROPERTY', 'Brokerage view' );
...
jr_define( '_JRPORTAL_LISTBOOKINGS_HEADER_PROPERTY_ID', 'Brokerage id' );
...
jr_define( '_JRPORTAL_ADD_ADHOC_ITEM_CHOOSEPROPERTY', 'Associated brokerage (if applicable)' );
...
jr_define( '_JOMRES_COM_PTYPES_PTYPE_DESC_FURTHER', 'You can have brokerage type specific language files by setting the description to the name of a sub folder, e.g. "yachtbrokerage" and copying a language file to that subfolder. You can then modify that language file for this brokerage type so yachts become, for example, DVDs, etc.' );
jr_define( '_JOMRES_EDITPROPERTY_CONNOTDELETE1', 'You cannot delete this brokerage as it is the only brokerage that you have access to. If you want to disable it, please use the un-publish feature in your toolbar. ' );
jr_define( '_JOMRES_EDITPROPERTY_CONNOTDELETE2', 'If this is a demo installation and you intend to upgrade to Jomres Solo (one brokerage only limit) then you should create a new brokerage first, then delete this one before changing your license key to the Solo license key that you will be assigned on purchase. ' );
...
jr_define( '_JOMRES_COM_ISTHISANMRP', "Are you renting out places on this boat? " );
jr_define( '_JOMRES_COM_ISTHISANMRP_DESC', "Configuration options differ depending on if you are renting out boats from a brokerage, or the brokerage itself. Select MRP if you are offering boats, select SRP if you are offering the entire brokerage. " );
// Jomres v3.0.6
...
jr_define( '_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM', "per yacht " );
...
jr_define( '_JOMRES_COM_MR_EB_ROOM_MINROOMS', 'Min yachts already selected' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC', 'Minimum number of yachts already selected in booking before tariff/yacht type combo can be offered. Allows you to have discounted tariffs when more than N yachts are already selected. ' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MAXROOMS', 'Max yachts already selected' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC', 'Maximum number of yachts already selected in booking before tariff/yacht combo is no longer offered. Allows you to stop offering this yacht type/tariff combination once N yachts have been selected in the booking form. ' );
...
jr_define( '_JOMRES_COM_SEF_TASK_ALIAS_VIEWPROPERTY', 'View brokerage task alias' );
...
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PTYPE', 'Add brokerage type to url' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PTYPE_DESC', '' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME', 'Add brokerage name to url' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME_DESC', '' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID', 'Append brokerage id to brokerage name' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID_DESC', 'if brokerage name is set to No then the id will not be used. If set to yes then the url will look like fawlty_towers-1' );
...
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_PTYPE', 'Search URL Structure - Brokerage type' );
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_PTYPE_DESC', '' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_PTYPE', 'Search URL Structure - Default brokerage type' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_PTYPE_DESC', 'Used in url if search is for all brokerage types' );
...
jr_define( '_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYSPERROOM', 'Per days X yachts selected' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_TAB', 'Brokerage type' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_TYPE', 'Edit your brokerage type' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_INFO', 'Select your brokerage type' );
...
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMTYPEIMAGE', 'Booking form yacht list show yacht type image' );
jr_define( '_JOMRES_COM_A_LISTLIMIT', 'Brokerage List limit' );
jr_define( '_JOMRES_COM_A_LISTLIMIT_DESC', 'The number of brokerages to show on a page after a search' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE', 'Integrated search feature' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE_DESC', 'The Jomres integrated search feature allows your users to search through Jomres brokerages according to a set of functions. If you have already used the search features of Jomres in Joomla you will be familiar with these settings.<br/>This feature allows us to offer search handling within Jomres for those users who don\'t want to use Joomla search modules, or for other CMS users who\'s CMS doesn\'t have it\'s own Jomres search modules.<br/>Just remember that if you choose to search for something via a link (ie not a dropdown) then other search options will not be implemented, only the element that corresponds with the link that you clicked.<br/>Note that by default the layout of this integrated search isn\'t very pretty. That\'s because the template file that performs the layout has to include all possible options, some of which are incompatible. To improve the layout and achieve the look you desire, you will need to edit <b>srch.html</b> in the folder <b>' . JOMRES_TEMPLATEPATH_FRONTEND . '</b> ' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE', 'Activate this feature?' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE_DESC', 'If this feature is enabled, then any call to Jomres that shows the brokerage list will mean that the search options are also shown.' );
...
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME', "Search by brokerage name" );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME_DESC', "Show the search by brokerage name input." );
...
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE', "Search by brokerage type" );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE_DESC', "Show the search by brokerage type input" );
...
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE', "Search by yacht type" );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE_DESC', "Show the search by yacht type input" );
...
jr_define( '_JOMRES_A_GLOBAL_SEARCHOPTION_RANDOMLIMIT_DESC', 'By default, if a brokerage is not selected in Jomres it will perform a search. If this search was not triggered by a search module then that search will produce random results (deliberately). This option allows you to limit the number of returns in that random search.' );
...
jr_define( '_JRPORTAL_COUPONS_ROOMONLY', "Yacht only" );
jr_define( '_JRPORTAL_COUPONS_ROOMONLY_DESC', "Discount is only applied to the cost of the yacht. If No, then the discount is applied to the entire cost of the booking." );
...
<br/>
" );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWDISABLED', 'Booking form yacht list show disabled access' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWMAXPEOPLE', 'Booking form yacht list show max people' );
jr_define( '_JRPORTAL_HORIZROOMSLIST_ESTIMATEWARNING', "Please note that yacht prices listed are estimates and the full price of the booking will not be calculated until you have added a yacht or yachts to your selection." );
...
jr_define( '_JRPORTAL_SUBSCRIPTIONS_PACKAGES_ROOMSLIMIT', "Yachts limit" ); // Not currently used, saved for a rainy day
jr_define( '_JRPORTAL_SUBSCRIPTIONS_PACKAGES_PROPERTYLIMIT', "Brokerage limit" );
...
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES2', " published brokerage(s). " );
...
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES5', " brokerage slots. " );
...
jr_define( '_JOMRES_CLICKTOREGISTER', 'Click here to register your brokerage' );
...
jr_define( '_JOMRES_USER_LISTMYPROPERTY', 'Add my brokerage to this site' );
...
jr_define( '_JOMRES_FRONT_BLACKBOOKING_SRP_CANNOTBLACKBOOK', 'Sorry, you cannot black book this brokerage for those dates.' );
jr_define( '_JOMRES_FRONT_BLACKBOOKING_SRP_CANBLACKBOOK', 'You can blackbook this brokerage for those dates.' );
jr_define( '_JOMRES_WARNINGS_PERPERSONPERNIGHT_NOGUESTTYPES', 'Your brokerage is configured to charge per person per night but you do not have any guest types created or published, please create and publish one or more guest types. ' );
jr_define( '_JOMRES_WARNINGS_TARIFFS_NOTARIFFS', 'You don\'t have any tariffs configured yet, you will not be able take any bookings for your brokerage.' );
...
jr_define( '_JOMRES_CONTACTOWNER_TO_ADMIN_DESC', 'Set this option to Yes if you want Contact Owner emails to be sent to the below input. Leave it set to No to send the emails to the email address defined in the brokerage configuration area.' );
...
jr_define( '_JOMRES_REALESTATE_YESNO', 'Is this brokerage a boat for sale listing?' );
jr_define( '_JOMRES_REALESTATE_YESNO_DESC', 'Select Yes if you are selling the boat, select No if it is a rental item and will be using this system for taking bookings.' );
...
jr_define( '_JOMRES_SINGLEPROPERTYINSTALLATION_TITLE', 'Is this a single brokerage installation?' );
...
jr_define( '_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO', 'Limit brokerage registration to one country?' );
jr_define( '_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO_DESC', 'You can ensure that brokerage registrations are limited to just one country by setting this option to Yes and setting the country in the following option.' );
jr_define( '_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_COUNTRY', 'Brokerages are located in this country : ' );
jr_define( '_JOMRES_JQUERYTHEME', 'Jquery theme' );
jr_define( '_JOMRES_JQUERYTHEME_DESC', 'Choose a jquery theme to use for the brokerage details tabs.' );
jr_define( '_JOMRES_PROPERTYNOTOUBLISHED', 'We are sorry, but that brokerage is not currently available.' );
jr_define( '_JOMRES_REVIEWS', 'Reviews' );
jr_define( '_JOMRES_REVIEWS_TITLE', 'Review title' );
jr_define( '_JOMRES_REVIEWS_DATE', 'posted on ' );
jr_define( '_JOMRES_REVIEWS_NOREVIEWS', 'There are no reviews for this brokerage yet.' );
jr_define( '_JOMRES_REVIEWS_NOREVIEWS_BETHEFIRST', 'Would you like to be the first to review this brokerage?' );
...
jr_define( '_JOMRES_REVIEWS_REVIEWBODY', 'Tell us what you think about this brokerage : ' );
...
jr_define( '_JOMRES_REVIEWS_ALREADYREVIEWED', 'You have already reviewed this brokerage, you can\'t post another review about it.' );
...
jr_define( '_JOMRES_REVIEWS_ADDREVIEW_ERROR_PROS', 'Please enter the good parts of your experience of being a guest at this brokerage' );
...
jr_define( '_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_2', 'Please rate your opinion of the brokerage\s locale' );
jr_define( '_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_3', 'Please provide your opinion of the cleanliness of the brokerage' );
...
jr_define( '_JOMRES_REVIEWS_ADMIN_TESTMODE_DESC', 'Normally brokerage managers cannot review brokerages. With test mode enabled, they can. Naturally this is not ideal in a production environment.' );
jr_define( '_JOMRES_REVIEWS_ADMIN_PROPERTYLISTINFO', 'This is a list of all properties. To see a brokerage\'s reviews, click on that brokerage. From there you will be able to publish or delete a review.' );
...
jr_define( '_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS', 'Show Booking form in brokerage details page?' );
jr_define( '_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS_DESC', 'Set this to Yes to show the booking form in the brokerage details page. If you set it to No, then a link will appear in the brokerage details page instead pointing to the booking form.' );
...
jr_define( '_JOMRES_ROOMALLOCATIONS_ROOM', 'Yacht ' );
jr_define( '_JOMRES_ROOMALLOCATIONS_GUESTS', 'guest(s). ' );
jr_define( '_JOMRES_ROOMALLOCATIONS_INFORMATION', 'This how we have assigned your guest numbers to their yachts. If you would like to change this allocation, you will need to contact the hotel after making the booking. Extra charges may apply if you change your assignments.' );
jr_define( '_JOMRES_SANITY_CHECK_NOT_PUBLISHED', "Note that your brokerage is not yet published, only you can see the brokerage, site visitors will not see it" );
// 4.5.5
...
jr_define( '_JOMRES_ROOMMSLIST_STYLE', 'Yachts list style' );
jr_define( '_JOMRES_ROOMMSLIST_STYLE_DESC', 'In the booking form, using the "classic" yachts list style you offer individual yachts to guests. With the yacht type view, guests choose the number of yachts of type X (eg. 2 x doubles) instead' );
jr_define( '_JOMRES_ROOMMSLIST_STYLE_CLASSIC', 'Classic' );
jr_define( '_JOMRES_ROOMMSLIST_STYLE_ROOMTYPES', 'Yacht types' );
jr_define( '_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_START', '(Re)checking availability' );
jr_define( '_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_REBUILDING_AVAILABLEROOMS', 'Rebuilding available yachts list' );
...
jr_define( '_JOMRES_REVIEWS_ADMIN_GUESTSONLY', 'Only brokerage guests can review?' );
jr_define( '_JOMRES_REVIEWS_ADMIN_GUESTSONLY_DESC', 'Set this to Yes if you want to restrict reviews to only those users who have been a guest already in this brokerage.' );
jr_define( '_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERROOMPERBOOKING', 'Per yacht' );
jr_define( '_JOMRES_MAX_GUESTS_PER_ROOM', 'Guests per yacht : ' );
jr_define( '_JOMRES_MAX_GUESTS_PER_BOOKING', 'Guests per booking : ' );
jr_define( '_JOMRES_NUMBER_OF_ROOMS', 'Number of yachts' );
...
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS', "Brokerage management process" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_DESC', "There are different management processes depending on the way you want to list your brokerage/business." );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL', "Rental" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL_DESC', "Choose the rental option if you are booking out yachts in a brokerage (eg. Hotel/B&B/Villa/Apartment)" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE', "Realestate/simple listing" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE_DESC', "Choose the real estate option if you are not offering any booking functionality at all, (eg. A brokerage/item for sale)" );

jr_define( 'JOMRES_COM_A_MINIMALCONFIG_DESC', 'Set this to Yes to reduce the number of options available to brokerage managers in the General Configuration section. This is useful if you do not want brokerage managers to play around with too many settings, instead you can edit jomres_config.php to define default brokerage options.' );

jr_define( '_JOMRES_AJAXFORM_EXTRAS_SELECT', 'Please select an option for your booking' );
jr_define( '_JOMRES_COM_ALLOWHTMLEDITOR_DESC', 'Switches on html editors in brokerage details editing page. Additionally, if this is set to No, then all html except p and br is stripped from all entered and displayed text.' );
jr_define( '_JOMRES_COM_MANAGEMENTVIEW_MANAGMENT', "Brokerage management view" );
jr_define( '_JOMRES_COM_MANAGEMENTVIEW_SITEPREVIEW', "Normal view" );
jr_define( '_JOMRES_COM_TIMEZONE_SWITCHER', "Show the timezone switcher in the brokerage manager's toolbar?" );
...
jr_define( '_JOMRES_PARTNER_SHOW_SEARCHTITLE', "Search for a brokerage" );
jr_define( '_JOMRES_PARTNER_SHOW_SEARCHINSTRUCTIONS', "Enter a few characters from the brokerage name and select a brokerage.<br/> When you select the brokerage you will add it to the partner's portfolio, however they will not yet enjoy any discounts, you will need to set those youself." );
jr_define( '_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES', "Current properties" );
jr_define( '_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES_INSTRUCTIONS', "Click on a brokerage to edit the partner's discount settings for that brokerage." );
...
jr_define( '_JOMRES_SUSPENSIONS_MANAGERLIST_INFO', "Click on the Suspend Icon (the icon with the man and the green tick) to suspend a manager. This means that the manager will not be able to perform brokerage management functions and all of their properties will be unpublished. Super brokerage managers cannot be suspended." );
...
jr_define( '_JOMRES_SUSPENSIONS_MANAGER_SUSPENDED_EMAIL', "Please note that your brokerage manager account has been suspended. You will not be able to perform any brokerage management functions until the account has been restored." );
jr_define( '_JOMRES_SUSPENSIONS_MANAGER_UNSUSPENDED_EMAIL', "Please note that your brokerage manager account is now active. You may continue to perform any brokerage management functions. Please log into your account and ensure that the approprite propert(ies) have been published. Thank you." );
...
jr_define( '_JOMRES_COM_THUMBNAIL_SMALL_WIDTH_DESC', 'Small thumbnails are used in the brokerage list whereas medium sized thumbnails are used in the brokerage header.' );
