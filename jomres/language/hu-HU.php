...
define('_JOMRES_COM_MR_LISTTARIFF_TITLE','Árak');
...
define('_JOMRES_FRONT_MR_SUBMITBUTTON_CHECKAVAILABILITY','Foglalhatóság ');
...
define('_JOMRES_COM_A_TARIFFS','Díjszabás és árfolyam');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION','Leírás');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_AIRPORTS','Árak');
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_OTHERTRANSPORT','Tömegközlekedés');
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_POLICIESDISCLAIMERS','Működési és lemondási nyilatkozat');
...
define('_JOMRES_FRONT_MR_REVIEWBOOKING','Szállásfoglalás végrehajtása');
...
define('_JOMRES_FRONT_BLACKBOOKING','Hamis foglalások');
define('_JOMRES_FRONT_BLACKBOOKING_NEW','Új hamis foglalás');
...
define('_JOMRES_COM_A_GALLERYLINK_DESC','Szállás weboldalára mutató link');
...
define('_JOMRES_COM_A_SLIDESHOWS_SHOWSLIDESHOWLINK','Galéria linkjének megjelenítése?');
...
define('_JOMRES_FRONT_SLIDESHOW','Galéria');
...
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1','Kérjük adja meg a megyét, ahol a szálláshelye található.');
...
define('_JOMRES_REGISTRATION_NOTALLOWED',"Csak regisztrált felhasználók állíthatnak be szálláshelyet! Regisztrálja magát és jelentkezzen be!");
...
define('_JOMRES_COM_A_REGISTEREDUSERSONLYBOOK','Csak regisztrált felhasználók foglalhatnak on-line?');
...
define('_JOMRES_BOOKINGFORM_MONITORING_REQUIRED_REGION','Megye megadása kötelező');
...
define('_JOMRES_COM_WEEKENDDAYS','Hétvége napjai');
define('_JOMRES_COM_WEEKENDDAYS_DESC','Állítsa be a hétvége napjait. A hétvégét magába foglaló/kizáró tarifák e szerint jelenítik meg a szobalistát.');
define('_JOMRES_EDITPROPERTY_SELECTCOUNTRY','Válassza ki az országot, mielőtt bármely más mezőt kitöltene');
define('_JOMRES_EDITPROPERTY_SAVEBEFOREUPLOAD','Save your property changes before uploading a property image');
define('_JOMRES_TARIFFSFROM','Legkedvezőbb ár - ');
define('_JOMRES_SEARCH_ALL','Összes');
define('_JOMRES_SEARCH_GEO_COUNTRYSEARCH','<label>Keresés ország szerint</label>');
define('_JOMRES_SEARCH_GEO_REGIONSEARCH','<label>Keresés megye szerint</label>');
define('_JOMRES_SEARCH_GEO_TOWNSEARCH','<label>Keresés város szerint</label>');
define('_JOMRES_SEARCH_FEATURE_INFO','<label>Keresés tulajdonság szerint</label>');
define('_JOMRES_SEARCH_BUTTON','Keresés');
define('_JOMRES_SEARCH_DESCRIPTION_INFO','Enter a search word into the box and press the button.');
define('_JOMRES_SEARCH_DESCRIPTION_LABEL','Szavak keresése: ');
define('_JOMRES_SEARCH_AVL_INFO','Kérjük adja meg a tervezett érkezési és indulási idejét és nyomja meg a keresés gombot, hogy ezen időtartamon elérhető szálláshelyeket találjon.');
define('_JOMRES_SEARCH_PTYPES','Összes szállás listázása  szállástípus szerint');
define('_JOMRES_SEARCH_RTYPES','Összes szállás listázása szoba típus szerint');
define('_JOMRES_SORTORDER_DEFAULT','Alapértelmezett');
define('_JOMRES_SORTORDER_PROPERTYNAME','Szállás neve');
define('_JOMRES_SORTORDER_PROPERTYREGION','Megye');
define('_JOMRES_SORTORDER_PROPERTYTOWN','Város');
define('_JOMRES_SORTORDER_STARS','Csillagok');
define('_JOMRES_PATHWAY_PROPERTYLIST','Szállás lista');
define('_JOMRES_PATHWAY_PROPERTYDETAILS','Szállás részletek');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMIMAGE','Szoba kép');
define('_JOMRES_CURRENCYFORMAT','Valuta formátum');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// Jomres 2.6.3
define('JOMRES_COM_A_TARIFFMODE_NORMAL','Normál');
define('JOMRES_COM_A_TARIFFMODE_ADVANCED','Fejlett');
define('JOMRES_COM_A_TARIFFMODE_TARIFFTYPES','Micromanage');
define('JOMRES_COM_A_TARIFFMODE','Díjszabás beállítás');
...
define('_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS','Szobalista megjelenítése a szállás részletei oldalon?');
define('JOMRES_PROPERTYTYPE','Property type');
define('JOMRES_COM_A_SRPONLY','SRP only');
define('JOMRES_MAXPEOPLEINROOM','Max fő/szoba');
define('JOMRES_MAXPEOPLEINBOOKING','Max fő/foglalás');
define('_JOMCOMP_BOOKINGNOTES_ADD','Megjegyzés írása');
define('_JOMCOMP_BOOKINGNOTES_EDIT','Megjegyzés szerkesztése');
define('_JOMCOMP_BOOKINGNOTES_DELETE','Megjegyzés törlése');
define('_JOMCOMP_BOOKINGNOTES_VIEW','Megjegyzések megtekintése');
define('_JOMCOMP_BOOKINGNOTES_AUDITMESSAGE','Megjegyzés hozzáadva');
define('_JOMCOMP_BOOKINGNOTES_AUDITMESSAGE_EDIT','Megjegyzés mentve');
define('_JOMCOMP_BOOKINGNOTES_AUDITMESSAGE_DELETE','Megjegyzés törölve');
define('_JOMCOMP_MYUSER_MENUTITLE','Vezérlőpult');
define('_JOMCOMP_MYUSER_LISTBOOKINGS','Foglalások listázása');
define('_JOMCOMP_MYUSER_MYBOOKINGS','Foglalásaim');
define('_JOMCOMP_MYUSER_VIEWBOOKING','Foglalás megtekintése');
...
define('_JOMCOMP_MYUSER_PUBLISHEDPROPERTIES','Regisztrált szálláshelyek száma');
define('_JOMCOMP_WISEPRICE_TITLE','Wise price');
define('_JOMCOMP_WISEPRICE_ACTIVE','Aktív');
...
define('_JOMCOMP_LASTMINUTE_ACTIVE','Aktív?');
...
define('JOMRES_COM_A_VERBOSETARIFFINTO','Részletes díjszabás információk');
define('JOMRES_COM_A_VERBOSETARIFFINTO_DESC','Állítsa igenre részletesebb díjszabás információk megjelenítéséhez a szállás részletei/díjszabás felugró ablakban.');
...
define('_JOMCOMP_AMEND_OVERRIDE_DEPOSIT','Foglaló felülírása');
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// Jomres 2.7.5
...
define('_JRPORTAL_CRATE_CURRENCYCODE','Valuta kódja');
define('_JRPORTAL_CPANEL_LISTPROPERTIES','Szálláshelyek listája');
define('_JRPORTAL_PROPERTIES_PROPERTYNAME','Szálláshely neve');
define('_JRPORTAL_PROPERTIES_PROPERTYADDRESS','címe');
...
define('_JRPORTAL_ADD_ADHOC_ITEM_DESCRIPTION','Leírás');
...
define('_JOMRES_COM_ISTHISANMRP',"Szálláshely alaptípusa");
define('_JOMRES_COM_ISTHISANMRP_DESC',"A további beállítási lehetőségek ettől függnek. Válassza az \"MRP\"-t ha szobákat ad ki egy ingatlanon belül, az \"SRP\"-t ha egyben adja ki az egész ingatlant.");
// Jomres v3.0.6
...
// Jomres v3.1
define('_JOMRES_AJAXFORM_ACCOMMODATION_TOTAL',"Szállás végösszege");
define('_JOMRES_AJAXFORM_ACCOMMODATION_NIGHTS',"éjszakák a");
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM',"szobánként ");
define('_JOMRES_AJAXFORM_EXTRAS_TOTAL',"Extrák összege ");
define('_JOMRES_AJAXFORM_PRICE_SUMMARY',"Árak összefoglalása ");
define('_JOMRES_CONFIRMATION_ALERT',"Please read and agree to ");
define('_JOMRES_CONFIRMATION_HEADER',"Alább látható a foglalásának az összefoglalása.<br /> Hogy bármilyen módosítást végezzen, kattintson a foglalás módosítása gombra. ");
define('_JOMRES_CONFIRMATION_AMENDTEXT',"Ha módosítani szeretné a foglalását, kattintson ide");
define('_JOMRES_CONFIRMATION_AMEND',"Foglalás módosítása");
define('_JOMRES_CONFIRMATION_SPECIALS',"Kérjük írja ide a különleges kéréseit, kérdéseit amit a szállásadóhoz szeretne intézni.");
define('_JOMRES_CONFIRMATION_TERMS_PRETEXT',"Megerősítem, hogy egyetértek a következőkben foglaltakkal: ");
...
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL','Kapcsolat');
...
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERWEEK','Hetenként');
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYS','Naponként');
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERBOOKING','Foglalásonként');
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERPERSONPERBOOKING','Személyenként és foglalásonként');
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERPERSONPERDAY','Személyenként és napontként');
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERPERSONPERWEEK','Személyenként és hetenként');
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYSMINDAYS','Naponként (min nap)');
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYSPERROOM','Naponként X szobánként');
...
define('_JOMRES_SEARCH_PRICERANGES','Keresés ár szerint');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMTYPEIMAGE','Foglalási űrlap megjeleníti a szoba típus képét');
define('_JOMRES_COM_A_LISTLIMIT','Szállás lista limit');
...
define('_JOMRES_COM_A_INTEGRATEDSEARCH_BYPRICERANGES',"Keresés ár szerint");
...
define('_JOMRES_COM_CUSTOMFIELDS_DESCRIPTION','Leírás');
define('_JOMRES_COM_CUSTOMFIELDS_REQUIRED','Kötelező');
define('_JOMRES_COM_MR_EXTRA_QUANTITY','Maximumális mennyiség');
define('_JOMRES_COM_MR_EXTRA_QUANTITY_DESC','Ha a maximális mennyiség nagyobb mint 1, akkor a vendégek egy legördülő menüt fognak látni, ahol kiválaszthatják az extrák kívánt mennyiségét.');
...
define('_JRPORTAL_INVOICES_TITLE',"Számlák");
define('_JRPORTAL_INVOICES_STATUS_UNPAID',"Nincs fizetve");
define('_JRPORTAL_INVOICES_STATUS_PAID',"Fizetve");
define('_JRPORTAL_INVOICES_STATUS_CANCELLED',"Törölve");
define('_JRPORTAL_INVOICES_STATUS_PENDING',"Függőben");
define('_JRPORTAL_INVOICES_USER',"Felhasználó");
define('_JRPORTAL_INVOICES_STATUS',"Állapot");
define('_JRPORTAL_INVOICES_RAISED',"Kiállítva");
define('_JRPORTAL_INVOICES_DUE',"Esedékes");
define('_JRPORTAL_INVOICES_SUBSCRIPTION',"Előfizetés");
define('_JRPORTAL_INVOICES_INITTOTAL',"Egyszeri végösszeg");
define('_JRPORTAL_INVOICES_RECUR_TOTAL',"Ismétlődő végösszeg");
define('_JRPORTAL_INVOICES_RECUR_FREQUENCY',"Ismétlődés ideje");
define('_JRPORTAL_INVOICES_RECUR_DOMONTH',"Recurring day of month");
define('_JRPORTAL_INVOICES_CURRENCYCODE',"Valuta kódja");
define('_JRPORTAL_INVOICES_LINEITEMS',"Tételek felsorolása");
define('_JRPORTAL_INVOICES_LINEITEMS_NAME',"Név");
define('_JRPORTAL_INVOICES_LINEITEMS_DESCRIPTION',"Leírás");
define('_JRPORTAL_INVOICES_LINEITEMS_INIT_PRICE',"Egyszeri ár");
define('_JRPORTAL_INVOICES_LINEITEMS_INIT_QTY',"Egyszeri mennyiség");
define('_JRPORTAL_INVOICES_LINEITEMS_INIT_DISCOUNT',"Egyszeri kedvezmény");
define('_JRPORTAL_INVOICES_LINEITEMS_INIT_TOTAL',"Egyszeri végösszeg");
define('_JRPORTAL_INVOICES_LINEITEMS_RECUR_PRICE',"Ismétlődő ár");
define('_JRPORTAL_INVOICES_LINEITEMS_RECUR_QTY',"Ismétlődő mennyiség");
define('_JRPORTAL_INVOICES_LINEITEMS_RECUR_DISCOUNT',"Ismétlődő dikedvezményscount");
define('_JRPORTAL_INVOICES_LINEITEMS_RECUR_TOTAL',"Ismétlődő végösszeg");
define('_JRPORTAL_INVOICES_LINEITEMS_TAX_CODE',"Ádó kód");
define('_JRPORTAL_INVOICES_LINEITEMS_TAX_DESCRIPTION',"Ádó leírás");
define('_JRPORTAL_INVOICES_LINEITEMS_TAX_RATE',"Adó");
define('_JRPORTAL_INVOICES_PAYPAL_SETTINGS_TITLE',"Paypal beállítások");
define('_JRPORTAL_INVOICES_PAYPAL_SETTINGS_CURRENCYCODE',"Valuta kódja(pl EUR)");
define('_JRPORTAL_INVOICES_PAYPAL_SETTINGS_USESANDBOX',"Sandbox használata?");
define('_JRPORTAL_INVOICES_PAYPAL_SETTINGS_PAYPALEMAIL',"Paypal email-cím (azonosító)");
...
define('_JRPORTAL_INVOICES_SHOWINVOICES',"Számláim megjelenítése");
define('_JRPORTAL_COUPONS_TITLE',"Kedvezmény kuponok");
...
define('_JOMRES_COM_MR_EDITBOOKING_ADMIN_HISTORICBOOKINGS','Kijelentkezett és törölt foglalások');
/*
* @ignore
*/
...
<br/>
");
define('_JOMRES_COM_A_BOOKINGFORM_SHOWDISABLED','Foglalási űrlap szobalistája megjeleníti a mozgássérült hozzáférést');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWMAXPEOPLE','Foglalási űrlap szobalistája megjeleníti a vendégek maximális számát');
...
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_TITLE',"Előfizetési csomagok");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_NAME',"Név");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_DESCRIPTION',"Leírás");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_PUBLISHED',"Published");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_FREQUENCY',"Számlázási ciklus");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_TRIALPERIOD',"Próbaidő");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_TRIALAMOUNT',"Próbaidő ára");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_FULLAMOUNT',"Teljes ár");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_ROOMSLIMIT',"Rooms limit"); // Not currently used, saved for a rainy day
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_PROPERTYLIMIT',"Engedélyezett szálláshelyek/előfizetés");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_FREQUENCY_DESC',"Számlázási ciklus: H/N/F/É Havi/Negyedéves/Féléves/Éves");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_TRIALPERIOD_DESC',"Próbaidő hossza: Egész szám, 0 (nulla) - nincs, 1 - 1 hónap, 2 - 2 hónap, stb..");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_SUBSCRIBE',"Előfizetés");
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_SUBSCRIBE_DESC',"Kérjük adja meg/frissítse az előfizetői adatait. Megjegyzés: minden adat megadása kötelező.");
define('_JRPORTAL_SUBSCRIBERS_FIRSTNAME',"Keresztnév");
define('_JRPORTAL_SUBSCRIBERS_SURNAME',"Vezetéknév");
define('_JRPORTAL_SUBSCRIBERS_ADDRESS',"Cím");
define('_JRPORTAL_SUBSCRIBERS_COUNTRY',"Ország");
define('_JRPORTAL_SUBSCRIBERS_POSTCODE',"Irányítószám");
...
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES6',"A jelenlegi szálláshelyeinek a megtekintéséhez kérjük kattintson <a href='".JOMRES_SITEPAGE_URL."&task=listyourproperties'>ide</a>. ");
...
define('_JOMRES_LATLONG_DESC',"Használja az egeret a térkép mozgatásához, és húzza oda a mutatót a szállás helyére.");
...
// Jomres v4.2
define('_JOMRES_MANAGER_SHOWINVOICE','Számla');
define('_JOMRES_MANAGER_SHOWINVOICES','Számlák');
define('_JOMRES_USER_LISTMYPROPERTY','Szálláshelyem regisztrációja');
define('_JOMRES_WARNINGS_DANGERWILLROBINSON','Figyelem: ');
...
define('_JOMRES_COM_YOURBUSINESS_NAME','Cégnév');
define('_JOMRES_COM_YOURBUSINESS_VATNO','Adószám');
...
define('_JOMRES_INVOICE_NUMBER','Számla száma ');
...
define('_JOMRES_INVOICE_MARKASPAID','Számla megjelölése fizetettként');
define('_JOMRES_INVOICE_MARKEDASPAID','Számla megjelölve fizetettként');
...
define('_JOMRES_AJAXFORM_BILLING_BALANCE_PAYMENT','Fizetési mérleg');
define('_JOMRES_AJAXFORM_BILLING_INVOICE_BALANCE','Egyenleg');
...
define('_JOMRES_REVIEWS','Vélemények');
define('_JOMRES_REVIEWS_TITLE','Vélemény címe');
define('_JOMRES_REVIEWS_DATE','dátuma ');
define('_JOMRES_REVIEWS_NOREVIEWS','Még nincsenek vélemények erről a szálláshelyről.');
define('_JOMRES_REVIEWS_NOREVIEWS_BETHEFIRST','Szeretne őn lenni az első, aki véleményehzeti ezt a szálláshelyet?');
define('_JOMRES_REVIEWS_IAGREE','Egyetértek ezzel a véleménnyel');
define('_JOMRES_REVIEWS_IDISAGREE','Nem értek egyet ezzel a véleménnyelw');
define('_JOMRES_REVIEWS_AVERAGE_RATING','Átlagos vélemény: ');
define('_JOMRES_REVIEWS_TOTAL_VOTES','Összes velemény:');
define('_JOMRES_REVIEWS_ADD_REVIEW','Új vélemény hozzáadása');
define('_JOMRES_REVIEWS_ADD_REVIEW_NOTLOGGEDIN','Véleményezéshez be kell jelentkeznie.');
define('_JOMRES_REVIEWS_REVIEWBODY','Tell us what you think about this property : ');
define('_JOMRES_REVIEWS_REVIEWBODY_SAID','Ez a véleményező ezt írta: ');
define('_JOMRES_REVIEWS_PROS','Előnyök: ');
define('_JOMRES_REVIEWS_CONS','Hátrányok: ');
...
define('_JOMRES_REVIEWS_CLICKTOSHOW','Vélemények megjelenítése');
...
define('_JOMRES_REVIEWS_SUBMIT','Mentés');
...
define('_JOMRES_COM_A_TAXINCLUSIVE','Az árak tartalmazzák az adót?');
define('_JOMRES_COM_A_TAXINCLUSIVE_DESC','Ha az ön árai tartalmazzák az adót, állítsa igenre, ha nem nemre.');
define('_JOMRES_AJAXFORM_BILLING_TAX_EXTRAS','Extraák adója:');
...
define('_JOMRES_PARTNERS_TITLE','Partnerek');
define('_JOMRES_CALENDAR_TODAY','Ma');
define('_JOMRES_CALENDAR_PREV','Előző');
define('_JOMRES_CALENDAR_NEXT','Következő');
define('_JOMRES_CALENDAR_RTL','false');
define('_JOMRES_ROOMALLOCATIONS_ROOM','Szoba ');
define('_JOMRES_ROOMALLOCATIONS_GUESTS','vendég(ek). ');
...
define('_JOMRES_SANITY_CHECK_NOT_PUBLISHED',"Még nem publikálta a szállást, így a vendégek nem, csak ön láthatja azt.");
// 4.5.5
...
define('_JOMRES_ROOMMSLIST_STYLE','Szobalista stílusa');
define('_JOMRES_ROOMMSLIST_STYLE_DESC','A foglalási űrlapon a klasszikus szobalistán egyedi szobákat ajánlhat a vendégeknek. A Szoba típus szerinti szobalistán viszont a vendég választhat, milyen típusú szobából hányra tart igényt (pl 2 x dupla ágyas).');
define('_JOMRES_ROOMMSLIST_STYLE_CLASSIC','Klasszikus');
define('_JOMRES_ROOMMSLIST_STYLE_ROOMTYPES','Szoba típusok');
...
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERROOMPERBOOKING','Szobánként');
define('_JOMRES_MAX_GUESTS_PER_ROOM','Max. személy/szoba');
define('_JOMRES_MAX_GUESTS_PER_BOOKING','Max személy/foglalás');
define('_JOMRES_NUMBER_OF_ROOMS','Szobák száma');
...
define('_JRPORTAL_MONTHS_LONG_0','Január');
define('_JRPORTAL_MONTHS_LONG_1','Február');
define('_JRPORTAL_MONTHS_LONG_2','Március');
define('_JRPORTAL_MONTHS_LONG_3','Április');
define('_JRPORTAL_MONTHS_LONG_4','Május');
define('_JRPORTAL_MONTHS_LONG_5','Június');
define('_JRPORTAL_MONTHS_LONG_6','Július');
define('_JRPORTAL_MONTHS_LONG_7','Agusztus');
define('_JRPORTAL_MONTHS_LONG_8','Szeptember');
define('_JRPORTAL_MONTHS_LONG_9','Október');
define('_JRPORTAL_MONTHS_LONG_10','November');
define('_JRPORTAL_MONTHS_LONG_11','December');

define('_JOMRES_PROPERTYMANAGEMENTPROCESS',"Szálláshely kezelési mód");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_DESC',"A rendszer különböző képpen kezeli a szálláshelyeket/cégeket a szerint, hogy milyen típusként adjuk hozzá.");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL',"Kiadás (foglalások kezelése)");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL_DESC',"Válassza a kiadás lehetőséget, ha szbákat szeretne kiadni egy ingatlanon belül (pl. Szálloda/B&B/Villa/Apartmanok)");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE',"Megjelenítés (foglalások kezelése nélkül)");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE_DESC',"Válassza a megjelenítés funkciót, ha nem szeretné, hogy a rendszer kezelje a foglalásokat, egyszerűen csak meg szeretne jelenni a rendszerben (pl. rendelkezik saját foglalási rendszerrel, vagy eladó ingatlan hirdetése)");
...
define('_JOMRES_MY_ACCOUNT_EDIT','Személyes adatok szerkesztése');
...
define('_JOMRES_BOOKINGFORM_PRICINGOUTPUT','Az ár összefoglalás és becslés éjszakánként, hetenként vagy hónaponként legyen számolva?');
define('_JOMRES_BOOKINGFORM_PRICINGOUTPUT_DAILY','Éjszakánként');
define('_JOMRES_BOOKINGFORM_PRICINGOUTPUT_WEEKLY','Hetenként');
define('_JOMRES_BOOKINGFORM_PRICINGOUTPUT_MONTHLY','Hónaponként');
define('_JOMRES_BOOKINGFORM_PERPERSON','Vendégenként');
...
define('_JOMRES_PAYPAL_REDIRECTMESSAGE','Kérem várjon, a rendelése feldolgozás alatt van. Nemsokára át lesz irányítva a PayPal fizetéskezelő oldalra.');
define('_JOMRES_PAYPAL_REDIRECTMESSAGE_IFNOTREDIRECTED','Ha nem kerül automatikusan átirányításra 5 másodpercen benül...');
define('_JOMRES_PAYPAL_REDIRECTMESSAGE_CLICKHERE','Kattintson ide');
// 4.7.8
...
//v5.1 
define('_JOMRES_LINEITEM_TOTAL_INCLUDINGTAX',"Végösszeg adóval");
...
// 5.2.1
define('_JOMRES_HISTORIC_GUESTS_SHOW',"Volt és jelenlegi vendégek megjelenítése");
define('_JOMRES_HISTORIC_GUESTS_NOSHOW',"Csak jelenlegi vendégek");
...
define('_JOMRES_AJAXFORM_BUTTON_OPEN_BOOKINGFORM','Szállásfoglalás');

define('_JOMRES_AJAXFORM_BUTTON_BACK_TO_PROPERTY_DETAILS','Vissza a szálláshely leírásához');
define('_JOMRES_COM_MR_EXTRA_AUTO_SELECT','Automatikusan kiválasztva?');
define('_JOMRES_BOOKINGORM_ROOMTOTAL_BALANCE','Egyenleg (előleg befizetése után)');
...
define('_JOMCOMP_AMEND_OVERRIDE_ACCOMMODATION_TOTAL','Foglalás végösszegének felülírása');
define('_JOMCOMP_AMEND_OVERRIDE_SAVE','Felülírás elmentése');
