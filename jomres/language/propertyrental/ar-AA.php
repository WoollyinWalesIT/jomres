...
jr_define( '_JOMRES_A_GLOBALPFEATURES_INFO', 'لتعيين صورة لهذه الميزة تحتاج أولا إلى تحميل الصور الخاصة بك ميزة الفندق إلى /jomres/uploadedimages/pfeatures/ folder. ' );
