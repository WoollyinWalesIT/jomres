...
jr_define( '_JOMRES_COM_MR_EB_GUEST_JOMRES_TOWN_EXPL', 'City' );
jr_define( '_JOMRES_COM_MR_EB_GUEST_JOMRES_POSTCODE_EXPL', 'Zip' );
jr_define( '_JOMRES_COM_MR_EB_GUEST_JOMRES_LANDLINE_EXPL', 'Landline number' );
jr_define( '_JOMRES_COM_MR_EB_GUEST_JOMRES_MOBILE_EXPL', 'Cell number' );
...
jr_define( '_JOMRES_COM_MR_DISPGUEST_TOWN', 'City' );
jr_define( '_JOMRES_COM_MR_DISPGUEST_POSTCODE', 'Zip' );
jr_define( '_JOMRES_COM_MR_DISPGUEST_LANDLINE', 'Landline' );
jr_define( '_JOMRES_COM_MR_DISPGUEST_MOBILE', 'Cell' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_TOWN', 'City' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_REGION', 'State' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_COUNTRY', 'Country' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_POSTCODE', 'Zip' );
...
jr_define( '_JOMRES_COM_MR_LISTTARIFF_TITLE', 'Rates' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_RATETITLE', 'Rate title' );
...
jr_define( '_JOMRES_COM_MR_LISTTARIFF_SAVE_INSERT', 'Rate added' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_SAVE_UPDATE', 'Rate updated' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_LINKTEXT', 'Edit item' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_LINKTEXTCLONE', 'Clone item' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_DELETED', 'Rate deleted' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_TITLE_EDIT', 'Edit rate' );
...
jr_define( '_JOMRES_FRONT_MR_EB_GUEST_JOMRES_TOWN_EXPL', 'City' );
jr_define( '_JOMRES_FRONT_MR_EB_GUEST_JOMRES_POSTCODE_EXPL', 'Zip' );
jr_define( '_JOMRES_FRONT_MR_EB_GUEST_JOMRES_LANDLINE_EXPL', 'Landline number' );
jr_define( '_JOMRES_FRONT_MR_EB_GUEST_JOMRES_MOBILE_EXPL', 'Cell number' );
...
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_MOBILE', 'Cell: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_TOTAL', 'The value of the booking is: ' );
...
jr_define( '_JOMRES_COM_A_TARIFFS', 'Rates & Currency' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_BINDINGCONTRACT', 'You are reminded that a booking is a legally binding booking, so if for any reason you have to cancel or shorten your booking then you are still liable to pay the full amount.' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_50PERCENT', ' 50% of total booking.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_ARRIVALDATETO14DAYS', 'Arrival date to 14 days' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_100_PERCENT', ' 100% of total booking.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_VAT', 'VAT@ 17.5% is included in all rates. Any increase or alterations will be charged.' );
...
jr_define( '_JOMRES_COM_INVOICE_CONTRACTAGREED', 'Booking initially agreed: ' );
...
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE', 'Unable to remove this room feature, it is assigned to some rooms. Remove the feature from those rooms and retry.' );
...
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS', 'Unable to remove this room/property type, it is assigned to a rate. Try re-assigning the rate to another room/property type then try again.' );
...
jr_define( '_JOMRES_COM_AVLCAL_TODAYCOLOUR', 'Font color for the current date' );
jr_define( '_JOMRES_COM_AVLCAL_INMONTHFACE', 'Font color for days in the display month ' );
jr_define( '_JOMRES_COM_AVLCAL_OUTMONTHFACE', 'Font color for days not in the display month' );
...
jr_define( '_JOMRES_MR_AUDIT_INSERT_TARIFF', 'Created rate' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_TARIFF', 'Updated rate' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_TARIFF', 'Deleted rate' );
...
jr_define( '_JOMRES_FRONT_TARIFFS', 'Our Rates' );
jr_define( '_JOMRES_FRONT_TARIFFS_TITLE', 'Rate name' );
jr_define( '_JOMRES_FRONT_TARIFFS_DESC', 'Rate description' );
...
jr_define( '_JOMRES_COM_A_TARIFFS_SHOWTARIFFSLINK', 'Show link to rates?' );
...
//v1.4c
jr_define( '_JOMRES_COM_A_TARIFFS_SHOWTARIFFSINLINE', 'Show rates inline?' );
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWTARIFFS', 'Show rates information' );
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWTARIFFS_TITLE', 'Show rate information below this link' );
jr_define( '_JOMRES_COM_A_TARIFFS_MODEL_SINGLETARIFF', 'Flat rate rates' );
jr_define( '_JOMRES_COM_A_TARIFFS_MODEL_AVERAGES', 'Averages' );
jr_define( '_JOMRES_COM_A_TARIFFS_MODEL', 'Select the rates model you want to use' );
jr_define( '_JOMRES_COM_A_TARIFFS_MODEL_DESC', "You have two choices of rate calculation methods. The first, the 'flat rate' method allows you to offer a number of different rates to the guest and the rate for the stay is the same for the entire time. This is useful if you want to offer several different rates for the same date, eg Bed and Breakfast rate and B&B and Evening meal rate. Choose the 'averages' rate if you want to adjust your prices dependant on the date in question. Jomres will find all of the rates for each day in the booking, add them together then return the average rate across the period" );
// v1.4e
...
jr_define( '_JOMRES_COM_INPUTERROR_BACKGROUND', 'Input error background color' );
...
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1', 'Please provide the country and state of your property.' );
...
jr_define( '_JOMRES_SHOWGOOGLECURRENCYLINKS', 'Show currency conversion links in rate listing?' );
...
jr_define( '_JOMRES_AJAXFORM_ADDRESS_DESC', 'Please enter your details. Note that all fields are required except your cell number' );
...
jr_define( '_JOMRES_COM_A_SHOWROOMSLISTLINK', 'Show link to availability calendar in property details page?' );
...
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE', 'Booking form room list show rate title' );
...
jr_define( '_JOMRES_COM_AVLCAL_CURRENTBOOKINGFONT', 'Font color for links to current bookings' );
...
jr_define( '_JOMRES_COM_A_TARIFFPRICESAREWEEKLY', 'Rate charges stored as weekly figures?' );
jr_define( '_JOMRES_COM_A_TARIFFPRICESAREWEEKLY_DESC', 'You have the option of storing rate charges in either daily or weekly values. If storing them as weekly, you MUST set this option to Yes.' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_IN_PARTY_FOR_TARIFFS', 'You have too many in the party for the available rates' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_REQUIRED_TOWN', 'City is required' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_REQUIRED_REGION', 'State is required' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_REQUIRED_POSTCODE', 'Zip is required' );
...
//v2rc2
jr_define( '_JOMRES_COM_LIMITROOMSLIST', 'Available rooms/rate limit' );
jr_define( '_JOMRES_COM_LIMITROOMSLIST_DESC', 'Use this input to limit the number of available rooms & rates that are listed in the booking form. Set it to zero if you do not want limiting enabled. ' );
...
jr_define( '_JOMRES_COM_WEEKENDDAYS_DESC', 'Set your weekend days. Rates that allow or disallow weekends will take this setting into account when generating the rooms list.' );
...
jr_define( '_JOMRES_SEARCH_GEO_REGIONSEARCH', 'Search by state' );
jr_define( '_JOMRES_SEARCH_GEO_TOWNSEARCH', 'Search by city' );
...
jr_define( '_JOMRES_SORTORDER_PROPERTYREGION', 'Property State' );
jr_define( '_JOMRES_SORTORDER_PROPERTYTOWN', 'Property City' );
...
jr_define( 'JOMRES_COM_A_TARIFFMODE', 'Rate Configuration Mode' );
jr_define( 'JOMRES_COM_A_TARIFFMODE_DESC', "<b>Warning: Switching between different rate types may result in loss of data. See the note below regarding this</b>.
<br/><br/>
You have three options as to how you configure your rates.<br/>
Normal mode: You will have one rate for each room type that is valid for the next 10 years.<br/>
...
Normal mode is the most simplistic but it's the easiest to understand because it will cross reference rooms and rates to room/property types and allows you to configure rooms and prices on the same page.<br/>
...
Advanced mode lets you create a room and associate it with a room type. You then create a rate and associate THAT with a room type. Using this method it is possible to \"layer\" rates over each other, for example a room type \"Double bed\" can have one rate for bed and breakfast, and another for bed, breakfast and evening meal. The advanced method requires a little more attention to detail because it is possible to dis-associate a room or rate from a room/property type, or to incorrectly set valid from and to dates, but it does give you configuration options that the other modes do not offer. <br/>
<br/>
Because Normal and Micromanage modes require a specific set up of rooms and rates for the rate mode to work the system may need to reset some data to make the current rate configurations compatible with the current rate editing mode.<br/>
<br/>
...
jr_define( '_JOMCOMP_MYUSER_VIEWFAVOURITES_NONE', 'You haven\'t added any favorites yet!' );
jr_define( '_JOMCOMP_MYUSER_ADDTOFAVOURITES', 'Add to Favorites' );
...
jr_define( 'JOMRES_COM_A_VERBOSETARIFFINTO', 'Verbose rate info' );
jr_define( 'JOMRES_COM_A_VERBOSETARIFFINTO_DESC', 'Set this to Yes to show more detailed rate information in the property details/rate popup' );
...
jr_define( '_JOMCOMP_AMEND_HEADER', 'Original Booking:' );
...
jr_define( '_JRPORTAL_PROPERTIES_LEGEND', 'Properties who\'s background color is red have not yet had a commission rate applied to them.' );
...
jr_define( '_JRPORTAL_LISTBOOKINGS_HEADER_CONTRACT_ID', 'Booking id' );
jr_define( '_JRPORTAL_LISTBOOKINGS_HEADER_CONTRACT_NUMBER', 'Booking number' );
...
jr_define( '_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC', 'Minimum number of rooms already selected in booking before rate/room type combo can be offered. Allows you to have discounted rates when more than N rooms are already selected. ' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MAXROOMS', 'Max rooms already selected' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC', 'Maximum number of rooms already selected in booking before rate/room combo is no longer offered. Allows you to stop offering this room type/rate combination once N rooms have been selected in the booking form. ' );
...
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_REGION', 'Add state to url' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_REGION_DESC', '' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_TOWN', 'Add city to url' );
...
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_REGION', 'Search URL Structure - Add state to url' );
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_REGION_DESC', '' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_REGION', 'Search URL Structure - Default state' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_REGION_DESC', 'If all your properties are in one state then you will not have state in the search - enter a default state here if you want to display a state' );
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_TOWN', 'Search URL Structure - Add city to url' );
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_TOWN_DESC', '' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_TOWN', 'Search URL Structure - Default city' );
