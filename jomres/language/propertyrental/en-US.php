...
define('_JOMRES_COM_MR_EB_GUEST_JOMRES_TOWN_EXPL','City');
define('_JOMRES_COM_MR_EB_GUEST_JOMRES_POSTCODE_EXPL','Zip');
define('_JOMRES_COM_MR_EB_GUEST_JOMRES_LANDLINE_EXPL','Landline number');
define('_JOMRES_COM_MR_EB_GUEST_JOMRES_MOBILE_EXPL','Cell number');
...
define('_JOMRES_COM_MR_DISPGUEST_TOWN','City');
define('_JOMRES_COM_MR_DISPGUEST_POSTCODE','Zip');
define('_JOMRES_COM_MR_DISPGUEST_LANDLINE','Landline');
define('_JOMRES_COM_MR_DISPGUEST_MOBILE','Cell');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_TOWN','City');
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_REGION','State');
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_COUNTRY','Country');
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_POSTCODE','Zip');
...
define('_JOMRES_FRONT_MR_EB_GUEST_JOMRES_TOWN_EXPL','City');
define('_JOMRES_FRONT_MR_EB_GUEST_JOMRES_POSTCODE_EXPL','Zip');
define('_JOMRES_FRONT_MR_EB_GUEST_JOMRES_LANDLINE_EXPL','Landline number');
define('_JOMRES_FRONT_MR_EB_GUEST_JOMRES_MOBILE_EXPL','Cell number');
...
define('_JOMRES_FRONT_MR_EMAIL_TEXT_MOBILE','Cell: ');
define('_JOMRES_FRONT_MR_EMAIL_TEXT_TOTAL','The value of the booking is: ');
...
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_BINDINGCONTRACT','You are reminded that a booking is a legally binding booking, so if for any reason you have to cancel or shorten your booking then you are still liable to pay the full amount.');
...
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_50PERCENT',' 50% of total booking.');
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_ARRIVALDATETO14DAYS','Arrival date to 14 days');
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_100_PERCENT',' 100% of total booking.');
...
define('_JOMRES_COM_INVOICE_CONTRACTAGREED','Booking initially agreed: ');
...
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS','Unable to remove this room/property type, it is assigned to a rate. Try re-assigning the rate to another room/property type then try again.');
...
define('_JOMRES_COM_AVLCAL_TODAYCOLOUR','Font color for the current date');
define('_JOMRES_COM_AVLCAL_INMONTHFACE','Font color for days in the display month ');
define('_JOMRES_COM_AVLCAL_OUTMONTHFACE','Font color for days not in the display month');
...
define('_JOMRES_COM_INPUTERROR_BACKGROUND','Input error background color');
...
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1','Please provide the country and state of your property.');
...
define('_JOMRES_AJAXFORM_ADDRESS_DESC','Please enter your details. Note that all fields are required except your cell number');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE','Booking form room list show rate title');
...
define('_JOMRES_COM_AVLCAL_CURRENTBOOKINGFONT','Font color for links to current bookings');
...
define('_JOMRES_BOOKINGFORM_MONITORING_REQUIRED_TOWN','City is required');
define('_JOMRES_BOOKINGFORM_MONITORING_REQUIRED_REGION','State is required');
define('_JOMRES_BOOKINGFORM_MONITORING_REQUIRED_POSTCODE','Zip is required');
...
//v2rc2
define('_JOMRES_COM_LIMITROOMSLIST','Available rooms/rate limit');
define('_JOMRES_COM_LIMITROOMSLIST_DESC','Use this input to limit the number of available rooms & rates that are listed in the booking form. Set it to zero if you do not want limiting enabled. ');
...
define('_JOMRES_COM_WEEKENDDAYS_DESC','Set your weekend days. Rates that allow or disallow weekends will take this setting into account when generating the rooms list.');
...
define('_JOMRES_SEARCH_GEO_REGIONSEARCH','Search by state');
define('_JOMRES_SEARCH_GEO_TOWNSEARCH','Search by city');
...
define('_JOMRES_SORTORDER_PROPERTYREGION','Property State');
define('_JOMRES_SORTORDER_PROPERTYTOWN','Property City');
...
define('_JOMCOMP_MYUSER_VIEWFAVOURITES','View Favorites');
define('_JOMCOMP_MYUSER_VIEWFAVOURITES_NONE','You haven\'t added any favorites yet!');
define('_JOMCOMP_MYUSER_ADDTOFAVOURITES','Add to Favorites');
...
define('JOMRES_COM_A_VERBOSETARIFFINTO_DESC','Set this to Yes to show more detailed rate information in the property details/rate popup');
...
define('_JOMCOMP_AMEND_HEADER','Original Booking:');
...
define('_JRPORTAL_PROPERTIES_LEGEND','Properties who\'s background color is red have not yet had a commission rate applied to them.');
...
define('_JRPORTAL_LISTBOOKINGS_HEADER_CONTRACT_ID','Booking id');
define('_JRPORTAL_LISTBOOKINGS_HEADER_CONTRACT_NUMBER','Booking number');
...
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC','Minimum number of rooms already selected in booking before rate/room type combo can be offered. Allows you to have discounted rates when more than N rooms are already selected. ');
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS','Max rooms already selected');
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC','Maximum number of rooms already selected in booking before rate/room combo is no longer offered. Allows you to stop offering this room type/rate combination once N rooms have been selected in the booking form. ');
...
define('_JOMRES_COM_SEF_PROPERTY_URL_REGION','Add state to url');
define('_JOMRES_COM_SEF_PROPERTY_URL_REGION_DESC','');
define('_JOMRES_COM_SEF_PROPERTY_URL_TOWN','Add city to url');
...
define('_JOMRES_COM_SEF_SEARCH_URL_REGION','Search URL Structure - Add state to url');
define('_JOMRES_COM_SEF_SEARCH_URL_REGION_DESC','');
define('_JOMRES_COM_SEF_DEFAULT_REGION','Search URL Structure - Default state');
define('_JOMRES_COM_SEF_DEFAULT_REGION_DESC','If all your properties are in one state then you will not have state in the search - enter a default state here if you want to display a state');
define('_JOMRES_COM_SEF_SEARCH_URL_TOWN','Search URL Structure - Add city to url');
define('_JOMRES_COM_SEF_SEARCH_URL_TOWN_DESC','');
define('_JOMRES_COM_SEF_DEFAULT_TOWN','Search URL Structure - Default city');
...
define('_JOMRES_COM_CONFIGCOUNTRIES_AUTODETECT',"Auto-detect guest's country?");
define('_JOMRES_COM_CONFIGCOUNTRIES_AUTODETECT_DESC',"The system will try to automatically detect the guest's country, if they haven't booked before. You can set this option to No, and define the country you'd prefer to appear in the booking form, in the next option.");
