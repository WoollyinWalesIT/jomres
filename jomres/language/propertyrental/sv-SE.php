...
jr_define('_JOMRES_COM_MR_EB_ROOM_NAME','Resurs namn');
...
jr_define('_JOMRES_COM_MR_EB_PAYM_DEPOSITREQUIRED','Deposition');
...
jr_define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK','Resource type');
...
jr_define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_WEBSITE','Hemsida');
...
jr_define('_JOMRES_FRONT_MR_EB_GUEST_JOMRES_LANDLINE_EXPL','Fasta nummer');
...
jr_define('_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM','Bokning som gjorts för resurs: ');
jr_define('_JOMRES_FRONT_MR_EMAIL_TEXT_ARRIVAL','Ankomst: ');
jr_define('_JOMRES_FRONT_MR_EMAIL_TEXT_DEPARTURE','Avgång : ');
jr_define('_JOMRES_FRONT_MR_EMAIL_TEXT_NAME','Namn: ');
jr_define('_JOMRES_FRONT_MR_EMAIL_TEXT_LANDLINE','Fasta: ');
...
jr_define('_JOMRES_FRONT_MR_BOOKED','Resurser bokas');
...
jr_define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_AREAACTIVITIES','Aktiviteter i området');
jr_define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_DRIVINGDIRECTIONS','Vägbeskrivningar');
jr_define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_AIRPORTS','Flygplatser');
jr_define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_OTHERTRANSPORT','Övriga transporter');
jr_define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_POLICIESDISCLAIMERS','Policy & friskrivningar');
...
jr_define('_JOMRES_COM_MR_WEEKDAYS_FRIDAY','F​​redag');
...
jr_define('_JOMRES_COM_AVLCAL_OCCUPIEDCOLOUR_KEY','Ockuperade / Ej tillgänglig');
jr_define('_JOMRES_COM_AVLCAL_INMONTHFACE_KEY','Finns för bokningar');
...
jr_define('_JOMRES_FRONT_TARIFFS_TITLE','Taxa namn');
jr_define('_JOMRES_FRONT_TARIFFS_DESC','Beskrivning i tulltaxan');
jr_define('_JOMRES_FRONT_TARIFFS_ROOMTYPE','Resurs / verksamhetstyp');
jr_define('_JOMRES_FRONT_TARIFFS_STARTS','Gäller från');
jr_define('_JOMRES_FRONT_TARIFFS_ENDS','Gäller til');
...
jr_define('_JOMRES_AJAXFORM_PARTICULARS','Bokning uppgifter');
jr_define('_JOMRES_AJAXFORM_PARTICULARS_DESC','Välj detaljerna i din bokning behov');
...
jr_define('_JOMRES_AJAXFORM_ADDRESS_DESC','Ange dina uppgifter. Observera att alla fält med en röd stjärna är obligatoriska.');
...
jr_define('_JOMRES_AJAXFORM_BILLING_TAX','Skatt:');
...
jr_define('_JOMRES_SEARCH_AVL_INFO','LÄGENHET SÖK:<br /><br />Ankomster och avgångar på lördagar möjligt.<br />');
...
jr_define('_JOMRES_CONFIRMATION_HEADER',"En sammanfattning av din bokning visas nedan.<br /> Göra några ändringar, klicka på Ändra bokning knappen. ");
...
jr_define('_JOMRES_CONFIRMATION_TERMS_PRETEXT',"Jag intygar att ovanstående uppgifter är korrekta och godkänner ");
...
jr_define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_TITLE','Ange det meddelande som du vill skicka till ');
...
jr_define('_JOMRES_REVIEWS_TITLE','Recensionstitel');
...
jr_define('_JOMRES_CALENDAR_TODAY','I dag');
...
jr_define('_JOMRES_AJAXFORM_BILLING_TAX_ACCOM','Resurs skatt:');
...
jr_define('_JOMRES_CLEARDATES','flexibla datum');
...
jr_define('_JOMRES_PROPERTYLIST_LAYOUT_TILE',"Foto utsikt");

jr_define('_JOMRES_COMPARE',"Jämför");
jr_define('_JOMRES_REMOVE',"Ta bort");
jr_define('_JOMRES_RETURN_TO_RESULTS',"Återgå till sökresultat");

jr_define('_JOMRES_ADDTOSHORTLIST',"Lägg till som favorit");
jr_define('_JOMRES_REMOVEFROMSHORTLIST',"Ta bort från slutlistan");
jr_define('_JOMRES_VIEWSHORTLIST',"Visa din kortlista");
