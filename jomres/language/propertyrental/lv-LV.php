...
jr_define( '_JOMRES_FRONT_IMAGEUPLOADS_INFO', 'Lietojiet šo formu, lai augšupielādētu vairākus attēlus.<br/><b>Piezīme:</b> Attēliem nevar būt vienādi nosaukumi. Šeit var ielādēt tikai naktsmītnes galerijas attēlus. Galveno attēlu un numuru attēlus var ielādēt no Naktsmītnes administrācijas sekcijas.' );
...
jr_define( '_JRPORTAL_SUBSCRIBERS_CANNOT_PUBLISH', "Jūs esat pārsnieguši naktsmītņu limitu, ko paredz Jūsu abonements. Jūs variet palielināt savu naktsmītņu skaitu, <a href='" . JOMRES_SITEPAGE_URL . "&task=list_subscription_packages&Itemid=" . $Itemid . "'>nopērkot papildus abonēšanas paketes šeit.</a> " );
