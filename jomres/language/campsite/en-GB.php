...
define('_JOMRES_COM_MR_QUICKRES_STEP2_TITLE','Our pitches');
...
define('_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE','View pitches & campsite config');
define('_JOMRES_COM_MR_VRCT_TAB_ROOM','Pitches');
...
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK','Pitch type');
...
define('_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE','There are no pitches available able to satisfy the parameters specified');
...
define('_JOMRES_FRONT_MR_BOOKED','Pitches booked');
...
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE','No allowance can be made for meals not taken or for pitches not occupied for the full period of the booking. With this in mind we strongly recommend that you use a holiday insurance facility.');
...
define('_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE','Unable to remove this pitch feature, it is assigned to a pitch or pitches. Remove the feature from those pitches and retry.');
...
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS','Unable to remove this pitch/campsite type, it is assigned to a tariff. Try re-assigning the tariff to another pitch/campsite type then try again.');
...
define('_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC','Set this to Yes to ensure that visitors can book pitches online.');
...
define('_JOMRES_COM_A_BOOKING','Booking pitches');
...
define('_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC','EG you are renting out a campsite, rather than pitches in that campsite. If this is the case, then you must make sure that you only have the one pitch registered against each campsite.');
...
define('_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR','Cell bgcolour for provisionally booked pitches (bookings for which a deposit has not been taken)');
...
define('_JOMRES_FRONT_DELETEGUEST_UNABLETODELETEGUEST','Unable to delete this guest as they have bookings open against them with another campsite.');
...
define('_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE','Created pitchfeature');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE','Updated pitchfeature');
define('_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE','Deleted pitchfeature');
define('_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE','Inserted pitchtype');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE','Updated pitchtype');
define('_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE','Deleted pitchtype');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR','There was an error attempting to book these pitches, one or more of the pitches you selected is not free.');
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT','Pitches included in black booking');
...
define('_JOMRES_COM_A_ROOMTAX_DESC','Designed for the American market. These are the pitch tax amounts that will be charged to the guest. You can charge a combination and/or of fixed and percentage figures. Note that these taxes are only applied to the cost of the pitch.');
...
define('_JOMRES_A_GLOBALPFEATURES_INFO','To assign an image to this feature you first need to upload your campsite feature images to the /jomres/uploadedimages/pfeatures/ folder. ');
...
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS','Click for Pitches and availability');
...
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE','Show pitches and availability below this link');
...
define('_JOMRES_NUMBEROFROOMSAVAILABLE','Number of pitches available');
...
define('_JOMRES_AJAXFORM_AVAILABLE_DESC','Select the pitches that you require');
...
define('_JOMRES_AJAXFORM_AVAILABLEROOMS','Available pitches');
define('_JOMRES_AJAXFORM_SELECTEDROOMS','Selected pitches');
...
define('_JOMRES_COM_A_SHOWROOMSLISTLINK','Show link to pitches list page in campsite details page?');
define('_JOMRES_COM_A_SHOWONLYAVLCAL','Show <b>only</b> Availability calendar?');
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Switch this to Yes to disable display of the campsite header and details, so that only the availability calendar is viewable in the campsite details section. Only really intended for users renting out single pitch campsites (eg apartments, cottages etc).');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE','Booking form pitch list show tariff title');
...
define('_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS','You have chosen more pitches than you have guests, click on a pitch name to remove it from your selection');
define('_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS','Too many guests for the available beds');
define('_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS','You need to choose more pitches');
...
define('_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET','No pitches selected yet');
...
define('_JOMRES_COM_LIMITROOMSLIST','Available pitches/tariff limit');
define('_JOMRES_COM_LIMITROOMSLIST_DESC','Use this input to limit the number of available pitches & tariffs that are listed in the booking form. Set it to zero if you do not want limiting enabled. ');
...
define('_JOMRES_COM_WEEKENDDAYS_DESC','Set your weekend days. Tariffs that allow or disallow weekends will take this setting into account when generating the pitches list.');
...
define('_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS','Show pitches list in campsite details page?');
...
define('_JOMCOMP_MYUSER_PUBLISHEDPROPERTIES','Campsites on site');
...
define('JOMRES_COM_A_VERBOSETARIFFINTO_DESC','Set this to Yes to show more detailed tariff information in the campsite details/tariff popup');
...
define('_JOMRES_COM_ISTHISANMRP',"Is this campsite a hotel/bed and breakfast/guest house/pension? ");
define('_JOMRES_COM_ISTHISANMRP_DESC',"Configuration options differ depending on if you are renting out pitches in a campsite, or the campsite itself. Select MRP if you are offering pitches, select SRP if you are offering the entire campsite. ");
...
define('_JOMRES_BOOKINGFORM_LOOKRIGHT','Please select your required accommodation from the list below by clicking on the pitch.');
...
define('_JRPORTAL_COUPONS_ROOMONLY',"Pitch only");
...
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES2'," <i>published</i> campsite(s). ");
...
define('_JOMRES_COM_YOURBUSINESS','Your campsite details');
define('_JOMRES_COM_YOURBUSINESS_NAME','campsite name');
...
define('_JOMRES_REALESTATE_YESNO','Is this campsite a for sale listing?');
define('_JOMRES_REALESTATE_YESNO_DESC','Select Yes if you are selling the campsite, select No if it is a listing where you will be offering short term rentals and will be using this system for taking bookings.');
...
define('_JOMRES_ROOMALLOCATIONS_ROOM','Pitch ');
...
define('_JOMRES_ROOMMSLIST_STYLE_ROOMTYPES','Pitch types');
...
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_DESC',"There are different management processes depending on the way you want to list your campsite/campsite.");
...
define('_JOMRES_AJAXFORM_BILLING_TAX_ACCOM','Pitch tax:');
...
define('_JOMRES_BOOKINGORM_ROOMFEATURE_FILTER','Filter pitches based on their features.');
...
define('_JOMRES_COM_A_TARIFFS_PER_DESC_WHOLEDAY','Select Yes if you want to charge per-person-per-day. If no, then costs will be calculated on a per-pitch-per-day basis');
...
define('_JOMRES_FEATURE_PROPERTY_TYPE_ASSIGNMENT','Campsite types that can show this feature');
define('_JOMRES_CRATES_CLICKINITIAL','Click on a letter to show all campsites with that first character. Once you have a list of properties you can assign commission rates to those properties, or click on their "edit" icon to view the campsite\'s statistics.');
...
define('_JOMRES_MYPROPERTIES','My campsites');
