...
jr_define("JOMRES_COM_A_MAPSKEY_DESC","Опримайте google maps API key від Google і Jomres буде показувати карту у деталях об'єкта.");
...
jr_define("_JOMRES_COM_A_CRON_METHOD_DESC","If you do not have access to cron jobs, set this to Minicomponent, otherwise create a cron job and tell it to run<br /> curl -s http://welcomer.com.ua/index.php?option=com_jomres&no_html=1&jrajax=1&Itemid=490&lang=en&task=cronjobs&tmpl=jomres&no_html=1&secret=PJjp95Nx2NLMhjuG> /dev/null");
...
jr_define("_JRPORTAL_SUBSCRIBERS_CANNOT_PUBLISH","Нажаль настав той момент, коли ви вже досягнули максимума опублікованих об'єктів. Ви можете додавати ще об'єкти. Для цього придбайте додатковий пакет підписки.");
...
jr_define("_JOMRES_PRODUCT_INFORMATION","Welcome to Jomres, we hope you enjoy using Joomla's favourite booking system. If you would like to purchase a Jomres Solo, Silver or Jomres Gold license,  please visit our site for information on how you can upgrade.");
