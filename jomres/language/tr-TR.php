...
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALCURRENCYYESNO_DESC', 'Aynı para birimini kullanmak için tüm işletmeleri zorlamak için eveti ayarla (e.g. & # 8 3 6 4 ;)' );
...
if ( !defined( '_PN_START' ) ) jr_define( '_PN_START', 'Başlat' );
if ( !defined( '_PN_PREVIOUS' ) ) jr_define( '_PN_PREVIOUS', 'Önceki' );
if ( !defined( '_PN_NEXT' ) ) jr_define( '_PN_NEXT', 'Sonraki' );
if ( !defined( '_PN_END' ) ) jr_define( '_PN_END', 'Son' );
if ( !defined( '_PN_RESULTS' ) ) jr_define( '_PN_RESULTS', 'Sonuçlar' );
...
jr_define('TOUR_ID_TOUR_TARGET_MEDIACENTRE_INTRODUCTION_TITLE' , "Medya Merkezi." );
