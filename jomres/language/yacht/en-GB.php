...
jr_define( '_JOMRES_COM_MR_GENERALCONFIGDESC', 'Yacht Configuration' );
...
jr_define( '_JOMRES_COM_MR_NEWPROPERTY', 'New yacht' );
jr_define( '_JOMRES_COM_MR_NEWPROPERTYFEATURE', 'New yacht feature' );
...
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL', 'Default yacht' );
...
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_LEVEL_ADMIN', 'Yacht manager' );
jr_define( '_JOMRES_COM_MR_EDITBOOKING_ADMIN_TITLE', 'All rentals' );
jr_define( '_JOMRES_COM_MR_EDITBOOKING_ADMIN_NEWBOOKINGS', 'New rentals' );
jr_define( '_JOMRES_COM_MR_EDITBOOKINGTITLE', 'Edit Rental' );
jr_define( '_JOMRES_COM_MR_EDITBOOKING_TAB_ARRIVAL', 'Arr/Dep' );
jr_define( '_JOMRES_COM_MR_EDITBOOKING_TAB_GUEST', 'Guest' );
jr_define( '_JOMRES_COM_MR_EDITBOOKING_TAB_ROOM', 'Berth' );
...
jr_define( '_JOMRES_COM_MR_EB_GUEST_JOMRES_CANCELBOOKING', 'Cancel rental' );
...
jr_define( '_JOMRES_COM_MR_EB_GUEST_CANCELLATION_ALREADYBOOKEDIN', 'Cannot cancel this rental as the guest is already rented in' );
...
jr_define( '_JOMRES_COM_MR_EB_GUEST_CANCELLED', 'Rental cancelled' );
jr_define( '_JOMRES_COM_MR_EB_GUEST_DAYSTOARRIVAL', 'Days to arrival' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_BOOKINGTYPE_EXPL', 'Rental type' );
...
jr_define( '_JOMRES_COM_MR_EB_ROOM_NAME', 'Berth name' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_NUMBER', 'Berth' );
...
jr_define( '_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV', 'Berth/Yacht type' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_CLASS_DESC', 'Berth/yacht type description' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_FEATURES_LIST', 'Berth features list' );
...
jr_define( '_JOMRES_COM_MR_EB_PAYM_BOOKINGNUMBER', 'Rental' );
...
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_TITLE', 'Our berths' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_PROPERTYNAME', 'Yacht' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_ROOMTYPE', 'Berth/yacht type' );
...
jr_define( '_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE', 'View berths & yacht config' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOM', 'Berths' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOMFEATURES', 'Berth features' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOMTYPES', 'Berth types' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_PROPERTYS', 'Yacht' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_PROPERTYFEATURES', 'Prop feats' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_HEADER_LINK', 'Berth' );
...
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_SAVE_INSERT', 'Berth added' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_LINKTEXT', 'Edit item' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMFEATURES_HEADER_LINK', 'Berth features' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMFEATURES_HEADER_INPUT', 'Feature description' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_INSERT', 'Berth feature added' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_UPDATE', 'Berth feature updated' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK', 'Berth type' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV', 'Berth/yacht type abbreviation' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC', 'Berth/yacht type description' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT', 'Berth/yacht type added' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE', 'Berth/yacht type updated' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT', 'Yacht added' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_UPDATE', 'Yacht updated' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_LINK', 'Yacht Features' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_ABBV', 'Yacht feature abbv.' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_DESC', 'Yacht feature full description' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_INSERT', 'Yacht feature added' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_UPDATE', 'Yacht feature updated' );
...
jr_define( '_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS', 'Berth/yacht type' );
...
jr_define( '_JOMRES_COM_MR_BOOKINGSAVEDMESSAGE', 'Rental saved' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAGUESTIN', 'Rent a guest in' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAGUESTOUT', 'Rent guest out' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_LISTBOOKINGS', 'List rentals' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_LISTNEWBOOKINGS', 'NEW rentals' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_HOME', 'Dashboard' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_GUESTADMIN', 'Guest admin' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_PROPERTYADMIN', 'Yacht admin' );
...
jr_define( '_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE', 'There are no berths available able to satisfy the parameters specified' );
jr_define( '_JOMRES_FRONT_MR_BOOKINGMADE', '<center>Thank you for making your rental with us and we hope that you enjoy your stay.<br><br> <b>Please note that this is only a preliminary rental, and will not be confirmed until you receive your confirmation letter from us.</center>' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE', 'Rental made for yacht: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM', 'Rental made for berth: ' );
...
jr_define( '_JOMRES_FRONT_MR_BOOKIN_TITLE', 'Rent in guest ' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_SELECTBUTTON', 'Select guest ' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_GUESTBOOKEDIN', 'Guest rented in ' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_NOGUESTSDUEIN', 'No guests are due to arrive today' );
jr_define( '_JOMRES_FRONT_MR_BOOKOUT_TITLE', 'Rent out guest ' );
...
jr_define( '_JOMRES_COM_A_DEPOSIT_ISPERCENTAGE_DESC', 'Is the deposit required to be a percentage of the total rental? If No, then the deposit applied with be a flat value' );
jr_define( '_JOMRES_COM_A_DEPOSIT_VALUE', 'Deposit required value' );
jr_define( '_JOMRES_COM_A_TARIFFS_PER', 'Per person, per night' );
jr_define( '_JOMRES_COM_A_TARIFFS_PER_DESC', 'Select Yes if you want to charge per-person-per-night. If no, then costs will be calculated on a per-berth-per-night basis' );
...
jr_define( '_JOMRES_FRONT_MR_BOOKED', 'Berths rented' );
jr_define( '_JOMRES_COM_CONFIRMATION_TITLE', 'Confirmation letter' );
jr_define( '_JOMRES_COM_CONFIRMATION_DEAR', 'Dear ' );
jr_define( '_JOMRES_COM_CONFIRMATION_RATE_RULES', 'Cost per night - per berth ' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_DETAILS', 'Reservation details' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_INTRO1', 'Thank you for rental at the' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN', 'Your berth will be held until your arrival, and check in is after 2pm.' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_BINDINGCONTRACT', 'You are reminded that a rental is a legally binding contract, so if for any reason you have to cancel or shorten your rental then you are still liable to pay the full amount.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE', 'No allowance can be made for meals not taken or for berths not occupied for the full period of the rental. With this in mind we strongly recommend that you use a holiday insurance facility.' );
...
jr_define( '_JOMRES_COM_MR_ROOM_UNABLETODELETE', 'Unable to remove this berth, there are rentals against it. Cancel those rentals then retry.' );
jr_define( '_JOMRES_COM_MR_ROOM_DELETED', 'Berth deleted' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_DELETE', 'Delete berth feature' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE', 'Unable to remove this berth feature, it is assigned to a berth or berths. Remove the feature from those berths and retry.' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_DELETED', 'Berth feature deleted' );
jr_define( '_JOMRES_COM_MR_PROPERTYFEATURE_DELETE', 'Delete yacht feature' );
jr_define( '_JOMRES_COM_MR_PROPERTYFEATURE_UNABLETODELETE', 'Unable to remove this yacht feature, it is assigned to a yacht. Remove the feature from this yacht and retry.' );
jr_define( '_JOMRES_COM_MR_PROPERTYFEATURE_DELETED', 'Yacht feature deleted' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_DELETE', 'Delete berth/yacht type' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS', 'Unable to remove this berth/yacht type, it is assigned to a berth. Try re-assigning the berth to another berth/yacht type then try again.' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS', 'Unable to remove this berth/yacht type, it is assigned to a tariff. Try re-assigning the tariff to another berth/yacht type then try again.' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_DELETED', 'Berth/yacht type deleted' );
jr_define( '_JOMRES_COM_MR_PROPERTY_DELETE', 'Delete yacht' );
jr_define( '_JOMRES_COM_MR_PROPERTY_DELETED', 'Yacht deleted' );
jr_define( '_JOMRES_COM_MR_PROPERTY_DELETE_NORIGHTS', 'You do not have rights to delete this yacht.' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION', 'Yacht description' );
...
jr_define( '_JOMRES_COM_A_VISITORSCANBOOKONLINE', 'Visitors can rent online' );
jr_define( '_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC', 'Set this to Yes to ensure that visitors can rent berths online.' );
jr_define( '_JOMRES_COM_A_FIXEDPERIODBOOKINGS', 'Rentals are for a fixed period' );
jr_define( '_JOMRES_COM_A_FIXEDPERIODBOOKINGS_DESC', 'If you set this to Yes, then rentals will be taken for a fixed period. If this is set to No, then ensure that "defined arrival day" isn\'t set to Yes (unless you specifically want to force people to arrive on a certain day) otherwise you will not get many links in the availability calendar.' );
jr_define( '_JOMRES_COM_A_FIXEDPERIOD', 'Rental period: ' );
jr_define( '_JOMRES_COM_A_BOOKING', 'Rental berths' );
jr_define( '_JOMRES_COM_A_FIXEDPERIOD_NUMBEROFPERIODS', 'Maximum periods, eg 3x 7 rental periods = 21 days' );
jr_define( '_JOMRES_COM_A_SINGLEROOMPROPERTY', 'Is this an apartment/cottage/villa?' );
jr_define( '_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC', 'EG you are rental out a yacht, rather than berths in that yacht. If this is the case, then you must make sure that you only have the one berth registered against each yacht.' );
jr_define( '_JOMRES_FRONT_MR_REVIEWBOOKING', 'Review rental' );
jr_define( '_JOMRES_COM_MR_CONFIRMBOOKING', 'Confirm rental' );
...
jr_define( '_JOMRES_COM_AVLCAL_INBGCOLOUR', 'Cell bgcolour for days when yacht/berth is available' );
...
jr_define( '_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR', 'Cell bgcolour for provisionally rented berths (rentals for which a deposit has not been taken)' );
...
jr_define( '_JOMRES_COM_AVLCAL_INMONTHFACE_KEY', 'Available for rentals' );
jr_define( '_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR_KEY', 'Provisional rentals' );
jr_define( '_JOMRES_COM_MR_FIXEDARRIVALDATE_YESNO', 'Pre-defined arrival day' );
jr_define( '_JOMRES_COM_MR_FIXEDARRIVALDATE_YESNO_DESC', 'Only for sites offering fixed period rentals. Choose the day that arrivals must begin on.' );
...
jr_define( '_JOMRES_FRONT_CALENDAR_CLICKDATES', 'Click on a free date to view the rental form.' );
jr_define( '_JOMRES_FRONT_BLACKBOOKING', 'Black rentals' );
jr_define( '_JOMRES_FRONT_BLACKBOOKING_NEW', 'New Black rental' );
jr_define( '_JOMRES_FRONT_DELETEGUEST', 'Delete guest' );
jr_define( '_JOMRES_FRONT_DELETEGUEST_GUESTDELETED', 'Guest deleted' );
jr_define( '_JOMRES_FRONT_DELETEGUEST_UNABLETODELETEGUEST', 'Unable to delete this guest as they have rentals open against them with another yacht.' );
jr_define( '_JOMRES_COM_INVOICE_ACTUALROOMCOST', 'Actual berth cost: ' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_HELLO', 'Hello' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_THANKS', 'Thank you for making your rental with' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_SUMMARY', 'A summary of the rental follows:' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_ANYQUESTIONS', 'If you have any questions regarding this rental or any other service, then please do not hesitate to contact us.' );
...
jr_define( '_JOMRES_COM_A_FIXEDPERIODBOOKINGSSHORT', 'Fixed period rentals allow short breaks' );
...
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM', 'Created berth' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM', 'Updated berth' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM', 'Deleted berth' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE', 'Created berthfeature' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE', 'Updated berthfeature' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE', 'Deleted berthfeature' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE', 'Inserted berthtype' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE', 'Updated berthtype' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE', 'Deleted berthtype' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_PROPERTY', 'Created yacht' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_PROPERTY', 'Updated yacht' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_PROPERTY', 'Deleted yacht' );
...
jr_define( '_JOMRES_MR_AUDIT_BOOKEDGUESTIN', 'Rented guest in' );
jr_define( '_JOMRES_MR_AUDIT_BOOKEDGUESTOUT', 'Rented guest out' );
...
jr_define( '_JOMRES_MR_AUDIT_BOOKED_ROOM', 'Rented a berth' );
...
jr_define( '_JOMRES_MR_AUDIT_BLACKBOOKING', 'Entered black rental.' );
jr_define( '_JOMRES_MR_AUDIT_BLACKBOOKING_DELETE', 'Deleted black rental.' );
...
jr_define( '_JOMRES_COM_A_EXTRAS', 'Show extras at rental time?' );
...
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_BBSTARTS', 'Black rental start date' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_BBSERVICERESUMES', 'Service resumes date' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS', 'Black rentals' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR', 'There was an error attempting to rent these berths, one or more of the berths you selected is not free.' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT', 'Berths included in black rental' );
jr_define( '_JOMRES_COM_MR_BLACKBOOKINGS_VIEWBLACKBOOKING', 'View blackrental' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_NOBBOOKINGS', 'No black rentals to list' );
...
jr_define( '_JOMRES_COM_A_PAYPAL_CANCELLED', 'Rental cancelled' );
...
jr_define( '_JOMRES_COM_A_CURRENCYCODE_DESC', 'Eg GBP. This is used in the email to the customer confirming their rental.' );
jr_define( '_JOMRES_COM_A_CLICKFORMOREINFORMATION', 'Read more' );
jr_define( '_JOMRES_COM_A_ADVANCEBOOKINGSLIMITYESNO', 'Limit advance rentals?' );
jr_define( '_JOMRES_COM_A_ADVANCEBOOKINGSLIMITYESNO_DESC', 'Set this to yes if you want to limit advance rentals (use the next field to set the limit in terms of days). If you do set this to yes then if the user tries to rent more than n days in advance then their arrival date will be restored to todays date' );
jr_define( '_JOMRES_COM_A_ADVANCEBOOKINGSLIMITDAYS', 'Days advanced rentals limited to:' );
...
jr_define( '_JOMRES_COM_A_ROOMTAX', 'Berth tax' );
jr_define( '_JOMRES_COM_A_ROOMTAX_DESC', 'Designed for the American market. These are the berth tax amounts that will be charged to the guest. You can charge a combination and/or of fixed and percentage figures. Note that these taxes are only applied to the cost of the berth.' );
...
jr_define( '_JOMRES_FRONT_TARIFFS_ROOMTYPE', 'Berth/yacht type' );
...
jr_define( '_JOMRES_FRONT_PTYPE', 'Yacht type' );
jr_define( '_JOMRES_COM_PTYPES_LIST_TITLE', 'List yacht types' );
jr_define( '_JOMRES_COM_PTYPES_LIST_TITLE_EDIT', 'Edit yacht type' );
jr_define( '_JOMRES_COM_PTYPES_PTYPE', 'Yacht type' );
jr_define( '_JOMRES_COM_PTYPES_PTYPE_DESC', 'Yacht type description' );
jr_define( '_JOMRES_COM_PTYPES_SAVED', 'Yacht type saved' );
jr_define( '_JOMRES_COM_PTYPES_UNABLETO_DELETE', 'Unable to delete yacht type. Yacht type is assigned to one or more yachts, please re-assign them before trying to delete' );
jr_define( '_JOMRES_COM_PTYPES_DELETED', 'Yacht type(s) deleted' );
...
jr_define( '_JOMRES_COM_CHARGING_CONFIG', 'Amount charged at rental time' );
jr_define( '_JOMRES_COM_CHARGING_CONFIG_DESC', 'Use this option to decide what should be charged at rental time. Choose deposit if the deposit should be charged, or Full amount if the full amount should be charged.' );
jr_define( '_JOMRES_COM_MONTHSTOSHOW', 'Cal months to show' );
jr_define( '_JOMRES_COM_MONTHSTOSHOW_DESC', 'In the berth availability, How many months of the calendar should be shown?' );
...
jr_define( '_JOMRES_FRONT_BLACKBOOKING_DESC', 'Select the dates that you want to apply the black rentals for. When you have selected the appropriate dates, click the "apply" button to re-check availability. <br/> 
<br/> 
Choose the berth(s) you wish to take out of service. <br>If a berth does not have a check mark against it, it cannot be included in the black rental until any outstanding rentals have been completed/cancelled.<br/> ' );
...
jr_define( '_JOMRES_COM_A_GATEWAY_USEGATEWAYS_DESC', 'Set this to yes if you want to use online payment gateways. <b>Note:</b>This does not switch off the deposit calculation showed during the rental process. To disable this you can edit the templates that show berths and wrap the elements that refer to deposits inside a class whos font and bg colour are the same.' );
...
jr_define( '_JOMRES_FRONT_GALLERYLINK', 'View this yacht\'s website' );
...
jr_define( '_JOMRES_JR_A_IMAGEHANDLING_BATCHUPLOAD', 'Batch yacht image upload' );
...
jr_define( '_JOMRES_COM_A_SLIDESHOWS_NOIMAGES', '<br />Sorry, no images available for this yacht. Please upload some images using the batch upload feature if you wish to use the slideshow feature.' );
...
jr_define( '_JOMRES_FRONT_IMAGEUPLOADS_INFO', 'Use this form to upload multiple images of this yacht.<br/><b>Note</b> that any images with the same name will be overwritten. Also note that this form does not upload berth specific images or the yacht header image, you will need to upload them from the Yacht Admin section.<br/><b>Note</b> Images uploaded here will be written to the /jomres/uploadedimages/*yacht_uid* folder. If this folder does not exist, it will be created, unless of course an alternative directory has been specified in the configuration.' );
jr_define( '_JOMRES_A_TABS_MISC', 'Misc' );
jr_define( '_JOMRES_A', 'Site configuration' );
jr_define( '_JOMRES_A_GLOBALPFEATURES', 'Use global yacht features' );
jr_define( '_JOMRES_A_GLOBALPFEATURES_DESC', 'Set this to Yes if you want to force all yachts to use only the yacht features defined by the webmaster.' );
jr_define( '_JOMRES_A_GLOBALPFEATURES_INFO', 'To assign an image to this feature you first need to upload your yacht feature images to the /jomres/uploadedimages/pfeatures/ folder. ' );
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS', 'Click for Berths and availability' );
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWDETAILS_TITLE', 'Show detailed yacht info below this link' );
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE', 'Show berths and availability below this link' );
...
jr_define( '_JOMRES_A_GLOBALROOMTYPES', 'Use global berth/yacht types' );
jr_define( '_JOMRES_A_GLOBALROOMTYPES_DESC', 'Set this to Yes if you want to force all yachts to use only the berth/yacht types defined by the webmaster. You need to set this to Yes if you intend to allow searching via berth/yacht types.' );
jr_define( '_JOMRES_A_GLOBALROOMTYPES_INFO', 'To assign an image to this berth/yacht type you first need to upload your berth/yacht type images to the /images/stories/jomres/rmtypes/ folder. ' );
jr_define( '_JOMRES_COM_INPUTERROR_BACKGROUND', 'Input error background colour' );
jr_define( '_JOMRES_COM_CONFIGCOUNTRIES', 'Default country in rental form' );
jr_define( '_JOMRES_JAVASCRIPT_', 'Items marked with a red star are required.' );
jr_define( '_JOMRES_COM_SELFREGISTRATION', 'Users can register their yachts?' );
jr_define( '_JOMRES_COM_SELFREGISTRATION_DESC', 'Set this to Yes if you want users to be able to register their own yachts without admin intervention.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1', 'Please provide the country and region of your yacht.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_1', 'Please complete your yacht details.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_2', 'Items highlighted are required.' );
jr_define( '_JOMRES_REGISTRATION_AUDIT_CREATEPROPERTY', 'Created yacht' );
jr_define( '_JOMRES_REGISTRATION_NOTALLOWED', "Sorry, you can't create a yacht on this system. You must be a logged in, registered user before you can proceed." );
jr_define( '_JOMRES_REGISTRATION_CREATEDPROPERTY', 'Created yacht: ' );
...
jr_define( '_JOMRES_NUMBEROFROOMSAVAILABLE', 'Number of berths available' );
jr_define( '_JOMRES_BACKTOPROPERTYDETAILSLINK', 'Back to yacht details' );
jr_define( '_JOMRES_FRONT_ROOMTYPES', 'Berth/yacht types' );
...
jr_define( '_JOMRES_AJAXFORM_INSTRUCTIONS', 'Use this form to place your rental. Modify your rental particulars like arrival and departure dates & guest numbers, then select the berth(s) you require from the list of those available. Click any available berths to add them to your rental. When done, you can add any optional extras you may require and provide your address details. When the form has enough information it will then give you a submit button so that you can confirm your rental.' );
jr_define( '_JOMRES_AJAXFORM_INSTRUCTIONS_SRP', 'Use this form to place your rental. Modify your rental particulars like arrival and departure dates & guest numbers. When done, you can add any optional extras you may require and provide your address details. When the form has enough information it will then give you a submit button so that you can confirm your rental.' );
jr_define( '_JOMRES_AJAXFORM_PARTICULARS', 'Rental particulars' );
jr_define( '_JOMRES_AJAXFORM_PARTICULARS_DESC', 'Select the details of your rental requirements' );
jr_define( '_JOMRES_AJAXFORM_AVAILABLE', 'Availability ' );
jr_define( '_JOMRES_AJAXFORM_AVAILABLE_DESC', 'Select the berths that you require' );
jr_define( '_JOMRES_AJAXFORM_AVAILABLE_DESC_SRP', 'Look here to see if the yacht is available at this time.' );
...
jr_define( '_JOMRES_AJAXFORM_AVAILABLEROOMS', 'Available berths' );
jr_define( '_JOMRES_AJAXFORM_SELECTEDROOMS', 'Selected berths' );
...
jr_define( '_JOMRES_VARIANCES_MAXIMUM_TT', 'The maximum number of this customer type that can be selected in the rental form' );
jr_define( '_JOMRES_VARIANCES_ISPERCENTAGE', 'Is percentage' );
jr_define( '_JOMRES_VARIANCES_ISPERCENTAGE_TT', 'The figure calculated is a percentage of the Base figure calculated for the berth. If this is set to no then the figure you specify is simply added or subtracted from the base berth value.' );
jr_define( '_JOMRES_VARIANCES_POSNEG', 'Add variance?' );
jr_define( '_JOMRES_VARIANCES_POSNEG_TT', 'The figure calculated is added to or removed from the Base figure calculated for the berth. Set this to No if you want this to be a discount from the base figure. ' );
...
jr_define( '_JOMRES_COM_A_SHOWROOMSLISTLINK', 'Show link to berths list page in yacht details page?' );
jr_define( '_JOMRES_COM_A_SHOWONLYAVLCAL', 'Show <b>only</b> Availability calendar?' );
jr_define( '_JOMRES_COM_A_SHOWONLYAVLCAL_DESC', 'Switch this to Yes to disable display of the yacht header and details, so that only the availability calendar is viewable in the yacht details section. Only really intended for users rental out single berth yachts (eg apartments, cottages etc).' );
jr_define( '_JOMRES_COM_A_MINIMUMINTERVAL', 'Arr-Dep minimum interval' );
jr_define( '_JOMRES_COM_A_MINIMUMINTERVAL_DESC', 'The mimimum interval in the rental form between the arrival date and the departure date.' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO', 'Rental form berth list show berth number' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME', 'Rental form berth list show berth name' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE', 'Rental form berth list show tariff title' );
...
jr_define( '_JOMRES_COM_A_DEFAULTNUMBEROFFIRSTGUESTTYPEDESC', 'Default number of  the first Guest type shown in the booking form.. If you use guest types, then this is the default number that the first guest type in the rental form will be set to.' );
jr_define( '_JOMRES_COM_A_REGISTEREDUSERSONLYBOOK', 'Registered users only can rent online?' );
jr_define( '_JOMRES_REGISTEREDUSERSONLYBOOK', 'Sorry, you must be a registered user to rent online. Click here to register on this site. ' );
jr_define( '_JOMRES_COM_AVLCAL_CURRENTBOOKINGFONT', 'Font colour for links to current rentals' );
jr_define( '_JOMRES_COM_AVLCAL_WEEKENDBORDER', 'Weekend borders' );
jr_define( '_JOMRES_COM_AVLCAL_BOOKING_KEY', 'Berth is rented' );
jr_define( '_JOMRES_COM_AVLCAL_BLACK_KEY', 'Black rental' );
...
jr_define( '_JOMRES_COM_MR_FIXEDARRIVALDATE_RECURRING_DESC', 'When fixed arrival dates are selected, the number dates that can be shown in the dates dropdown list. Note that the list of dates will not include any dates if a rental is not possible due to prior rentals, and that the list will actually be twice as long as your selected number because it will have a similar number of historic dates (where available) ' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_BOOKING_TOO_SHORT1', 'The rental is too short. There needs to be at least this many days between arrival and departure dates:' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS', 'You have chosen more berths than you have guests, click on a berth name to remove it from your selection' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS', 'Too many guests for the available beds' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS', 'You need to choose more berths' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM', 'Select a berth' );
...
jr_define( '_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET', 'No berths selected yet' );
jr_define( '_JOMRES_BOOKING_NUMBER', 'Rental no.' );
jr_define( '_JOMRES_COM_INPUTOKTOBOOK_BACKGROUND', 'Ok to rent, message box background' );
...
jr_define( '_JOMRES_COM_LIMITROOMSLIST', 'Available berths/tariff limit' );
jr_define( '_JOMRES_COM_LIMITROOMSLIST_DESC', 'Use this input to limit the number of available berths & tariffs that are listed in the rental form. Set it to zero if you do not want limiting enabled. ' );
...
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALEDITING_DESC', 'Take care with this function. If set to Yes, then the editing mode will affect the custom text for ALL yachts in the system for the constant you are editing.' );
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALCURRENCYYESNO', 'Use global currency?' );
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALCURRENCYYESNO_DESC', 'Set this to yes to force all yachts to use the same currency (e.g. & # 8 3 6 4 ;)' );
...
jr_define( '_JOMRES_COM_USERIS_SUPERPROPERTYMANAGER', 'Super Yacht Manager' );
jr_define( '_JOMRES_COM_WEEKENDONLY', 'Weekends only' );
jr_define( '_JOMRES_COM_WEEKENDDAYS', 'Weekend days' );
jr_define( '_JOMRES_COM_WEEKENDDAYS_DESC', 'Set your weekend days. Tariffs that allow or disallow weekends will take this setting into account when generating the berths list.' );
jr_define( '_JOMRES_EDITPROPERTY_SELECTCOUNTRY', 'Select your country before adding any yacht information' );
jr_define( '_JOMRES_EDITPROPERTY_SAVEBEFOREUPLOAD', 'Save your yacht changes before uploading a yacht image' );
...
jr_define( '_JOMRES_SEARCH_AVL_INFO', 'Please enter your intended arrival and departure dates and press the button to find yachts that have accommodation available on your chosen dates.' );
jr_define( '_JOMRES_SEARCH_PTYPES', 'List all yachts by yacht type.' );
jr_define( '_JOMRES_SEARCH_RTYPES', 'List all yachts by berth/yacht type.' );
jr_define( '_JOMRES_SORTORDER_DEFAULT', 'Default' );
jr_define( '_JOMRES_SORTORDER_PROPERTYNAME', 'Yacht Name' );
jr_define( '_JOMRES_SORTORDER_PROPERTYREGION', 'Yacht Region' );
jr_define( '_JOMRES_SORTORDER_PROPERTYTOWN', 'Yacht Town' );
jr_define( '_JOMRES_SORTORDER_STARS', 'Stars' );
jr_define( '_JOMRES_PATHWAY_PROPERTYLIST', 'Yacht list' );
jr_define( '_JOMRES_PATHWAY_PROPERTYDETAILS', 'Yacht details ' );
jr_define( '_JOMRES_PATHWAY_BOOKINGFORM', 'Rental form' );
jr_define( '_JOMRES_BOOKINGFORM_UPDATEADDRESSBUTTON', 'Update your address details' );
jr_define( '_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_RECHECKINGROOMAVIALABILITY', 'Re-checking berth availability<br/>(Berth selection will be reset)' );
...
jr_define( '_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_CHANGINGROOMSELECTION', 'Changing your berth selection' );
...
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMIMAGE', 'Berth image' );
...
Normal mode: You will have one tariff for each berth type that is valid for the next 10 years.<br/>
Micromanage: You can modify the price for each and every day for each berth/yacht type. <br/>
...
Normal mode is the most simplistic but it's the easiest to understand because it will cross reference berths and tariffs to berth/yacht types and allows you to configure berths and prices on the same page.<br/>
...
Advanced mode lets you create a berth and associate it with a berth type. You then create a tariff and associate THAT with a berth type. Using this method it is possible to \"layer\" tariffs over each other, for example a berth type \"Double bed\" can have one tariff for bed and breakfast, and another for bed, breakfast and evening meal. The advanced method requires a little more attention to detail because it is possible to dis-associate a berth or tariff from a berth/yacht type, or to incorrectly set valid from and to dates, but it does give you configuration options that the other modes do not offer. <br/>
<br/>
Because Normal and Micromanage modes require a specific set up of berths and tariffs for the tariff mode to work the system may need to reset some data to make the current tariff configurations compatible with the current tariff editing mode.<br/>
<br/>
...
jr_define( '_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS', 'Show berths list in yacht details page?' );
jr_define( 'JOMRES_PROPERTYTYPE', 'Yacht type' );
jr_define( 'JOMRES_COM_A_SRPONLY', 'SRP only' );
jr_define( 'JOMRES_MAXPEOPLEINROOM', 'Max people per berth' );
jr_define( 'JOMRES_MAXPEOPLEINBOOKING', 'Max people in rental' );
...
jr_define( '_JOMCOMP_MYUSER_LISTBOOKINGS', 'List my Rentals' );
jr_define( '_JOMCOMP_MYUSER_MYBOOKINGS', 'My Rentals' );
jr_define( '_JOMCOMP_MYUSER_VIEWBOOKING', 'View Rental' );
...
jr_define( '_JOMCOMP_MYUSER_PROPERTYTYPE', 'Yacht type' );
jr_define( '_JOMCOMP_MYUSER_PUBLISHEDPROPERTIES', 'Yachts on site' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE', 'Wise price' );
jr_define( '_JOMCOMP_WISEPRICE_ACTIVE', 'Active' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE_DESC', 'This plugin allows you to enable and configure your berth prices dynamically.' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE_DESC_FULL', 'Most yachts will recalculate berth prices based on the number of berths of a required type that are available on a given date. This allows them to offer discounts on a berth/yacht type that isn\'t busy during a given period with the aim of attracting yacht that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of berths of a selected type are available in the yacht on a given day.<br/> The days threshold defines the number of days that the arrival date must be within before berth prices are adjusted by this feature, then the percentages options allow you to configure the percentage of berths that can be available before a given discount is applied. Note however, if multiple berths are rented then the current level of discount will be applied to all berths and will not reduce as more berths are selected.' );
jr_define( '_JOMCOMP_WISEPRICE_THREASHOLD', 'Threshold (number of days between arrival date and today)' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE10', 'Percentage berths occupied 10% or less' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE25', 'Percentage berths occupied 25% or less' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE50', 'Percentage berths occupied 50% or less' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE75', 'Percentage berths occupied 75% or less' );
...
jr_define( 'JOMRES_COM_A_MAPSKEY_DESC', 'Get can get a google maps API key from <a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google maps</a>. Once you have input your map key here, Jomres will show the map in your Yacht Details page.' );
jr_define( 'JOMRES_COM_A_USE_SSL', 'Use SSL in rental form?' );
...
jr_define( '_JOMCOMP_LASTMINUTE_THREASHOLD_DESC', 'If a rental is made and the arrival date is only N days from the date of rental, then the discount can be applied' );
jr_define( '_JOMCOMP_LASTMINUTE_DISCOUNT', 'Discount' );
jr_define( '_JOMCOMP_LASTMINUTE_DISCOUNT_DESC', 'In percent' );
jr_define( '_JOMCOMP_LASTMINUTE_BOOKINGCONFIRMATION1', 'A discount has been applied to this rental!' );
...
jr_define( '_JOMCOMP_LASTMINUTE_PROPERTYLIST_MID', '% discount if you rent to arrive before ' );
jr_define( '_JOMCOMP_LASTMINUTE_PROPERTYLIST_POST', '. Rent now to make the most of this offer!' );
...
jr_define( 'JOMRES_COM_A_VERBOSETARIFFINTO_DESC', 'Set this to Yes to show more detailed tariff information in the yacht details/tariff popup' );
jr_define( 'JOMRES_COM_A_MINIMALCONFIG', 'Minimise configuration options' );
jr_define( '_JOMCOMP_AMEND', 'Amend Rental - Yacht Selection' );
jr_define( '_JOMCOMP_AMEND_SELECTPROPERTY', 'Select New Yacht' );
...
jr_define( '_JRPORTAL_CPANEL_LISTPROPERTIES', 'List Yachts' );
jr_define( '_JRPORTAL_PROPERTIES_PROPERTYNAME', 'Yacht name' );
jr_define( '_JRPORTAL_PROPERTIES_PROPERTYADDRESS', 'Yacht address' );
jr_define( '_JRPORTAL_PROPERTIES_LEGEND', 'Yachts who\'s background colour is red have not yet had a commission rate applied to them.' );
jr_define( '_JRPORTAL_STATS_PATETITLE', 'Statistics' );
jr_define( '_JRPORTAL_STATS_STATTYPE', 'Statistics for: ' );
jr_define( '_JRPORTAL_STATS_STATTYPE_PROPERTIES', 'Yachts - Clicks' );
jr_define( '_JRPORTAL_PROPERTIES_VIEWPROPERTY', 'Yacht view' );
jr_define( '_JRPORTAL_PROPERTIES_NUMBEROFBOOKINGS', 'Number of rentals' );
jr_define( '_JRPORTAL_PROPERTIES_VALUEOFBOOKINGS', 'Value of rentals' );
...
jr_define( '_JRPORTAL_CPANEL_LISTBOOKINGS', 'List rentals' );
jr_define( '_JRPORTAL_LISTBOOKINGS_HEADER_PROPERTY_ID', 'Yacht id' );
...
jr_define( '_JRPORTAL_LISTBOOKINGS_HEADER_BOOKINGTOTAL', 'Rental total' );
...
jr_define( '_JRPORTAL_ADD_ADHOC_ITEM_CHOOSEPROPERTY', 'Associated yacht (if applicable)' );
...
jr_define( '_JOMRES_COM_PTYPES_PTYPE_DESC_FURTHER', 'You can have yacht type specific language files by setting the description to the name of a sub folder, e.g. "yachtbrokerage" and copying a language file to that subfolder. You can then modify that language file for this yacht type so berths become, for example, DVDs, etc.' );
jr_define( '_JOMRES_EDITPROPERTY_CONNOTDELETE1', 'You cannot delete this yacht as it is the only yacht that you have access to. If you want to disable it, please use the un-publish feature in your toolbar. ' );
jr_define( '_JOMRES_EDITPROPERTY_CONNOTDELETE2', 'If this is a demo installation and you intend to upgrade to Jomres Solo (one yacht only limit) then you should create a new yacht first, then delete this one before changing your license key to the Solo license key that you will be assigned on purchase. ' );
...
jr_define( '_JOMRES_COM_ISTHISANMRP', "Is this yacht a hotel/bed and breakfast/guest house/pension? " );
jr_define( '_JOMRES_COM_ISTHISANMRP_DESC', "Configuration options differ depending on if you are rental out berths in a yacht, or the yacht itself. Select MRP if you are offering berths, select SRP if you are offering the entire yacht. " );
...
jr_define( '_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM', "per berth " );
...
jr_define( '_JOMRES_CONFIRMATION_HEADER', "A summary of your rental is shown below.<br /> To make any changes, please click on the Amend Reservation button. " );
...
jr_define( '_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_SUBJECT', 'Yacht enquiry from ' );
jr_define( '_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_THANKS', 'Thank you for your enquiry, your message has been sent to the yacht\'s contact email address, and copied to your own address for your records. They will respond to you as soon as possible with their reply.' );
...
jr_define( '_JOMRES_BOOKINGFORM_LOOKRIGHT', 'Please select your required accommodation from the list below by clicking on the berth.' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MINROOMS', 'Min berths already selected' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC', 'Minimum number of berths already selected in rental before tariff/berth type combo can be offered. Allows you to have discounted tariffs when more than N berths are already selected. ' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MAXROOMS', 'Max berths already selected' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC', 'Maximum number of berths already selected in rental before tariff/berth combo is no longer offered. Allows you to stop offering this berth type/tariff combination once N berths have been selected in the rental form. ' );
...
jr_define( '_JOMRES_AVLCAL_QUARTER', "Some rentals" );
jr_define( '_JOMRES_AVLCAL_HALF', "Half rented" );
jr_define( '_JOMRES_AVLCAL_THREEQUARTER', "Mostly rented" );
jr_define( '_JOMRES_AVLCAL_FULLYBOOKED', "Fully rented" );
...
jr_define( '_JOMRES_COM_SEF_TASK_ALIAS_VIEWPROPERTY', 'View yacht task alias' );
jr_define( '_JOMRES_COM_SEF_TASK_ALIAS_VIEWPROPERTY_DESC', '' );
jr_define( '_JOMRES_COM_SEF_TASK_ALIAS_DOBOOKING', 'dorental task alias' );
...
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PTYPE', 'Add yacht type to url' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PTYPE_DESC', '' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME', 'Add yacht name to url' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME_DESC', '' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID', 'Append yacht id to yacht name' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID_DESC', 'if yacht name is set to No then the id will not be used. If set to yes then the url will look like fawlty_towers-1' );
...
jr_define( '_JOMRES_COM_SEF_DEFAULT_COUNTRY_DESC', 'If all your yachts are in one country then you will not have country in the search - enter a default country here if you want to display a country' );
...
jr_define( '_JOMRES_COM_SEF_DEFAULT_REGION_DESC', 'If all your yachts are in one region then you will not have region in the search - enter a default region here if you want to display a region' );
...
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_PTYPE', 'Search URL Structure - Yacht type' );
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_PTYPE_DESC', '' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_PTYPE', 'Search URL Structure - Default yacht type' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_PTYPE_DESC', 'Used in url if search is for all yacht types' );
...
jr_define( '_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERBOOKING', 'Per rental' );
jr_define( '_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERPERSONPERBOOKING', 'Per person per rental' );
...
jr_define( '_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYSPERROOM', 'Per days X berths selected' );
...
jr_define( '_JOMRES_COM_COMPOSITE_PROPERTY_DETAILS', 'Use Composite Yacht details?' );
jr_define( '_JOMRES_COM_COMPOSITE_PROPERTY_DETAILS_DESC', 'Jomres 3.3 introduces the composite yacht details where all of the yacht details output is sent to one template file (composite_yacht_details.html). If you do not wish to use this set it to No (only existing users are expected to set this to No, new users will probably want to leave it set to Yes)' );
jr_define( '_JOMRES_PROFILELIST_INSTRUCTIONS', 'This is a list of all users on the system. Non-yacht managers will have a Guest icon, yacht managers will have Reception/Yacht Manager/Super yacht manager icons.<br/>When Jomres is first installed "admin" is automatically added as a yacht manager and is considered an authorised user.<br/>Non-super yacht managers must be assigned to at least one yacht otherwise they will see an error when they try to log on and use Jomres.<br/>Once a user is authorised then you can edit their profiles, assign them to yachts or give them super yacht manager rights.<br/>To authorise a user, click on the red Cross next to their name. To unauthrorise them, click the green Tick.<br/>To assign users to specific yachts only, or give them super yacht manager rights, authorise them then click the edit icon (which is only visible once they\'ve been authorised). Users who\'ve registered their yacht(s) themselves will be automatically assigned to those yachts. Super yacht managers automatically have rights over all yachts, and will see all configuration options even if the minimised configuration option is set in Site Config.' );
jr_define( '_JOMRES_PROFILEEDIT_INSTRUCTIONS', 'Here you can assign a manager to certain yachts. Ensure, if they\'re not going to be a super yacht manager, that they have rights to at least one yacht otherwise they will see an error when they log in. To give a receptionist/yacht manager rights over only certain yachts, ensure that the Super Yacht Manager dropdown is not set to Yes.' );
jr_define( '_JOMCOMP_MYUSER_VIEWBOOKINGS_NONE', 'You haven\'t made any rentals yet!' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_TAB', 'Yacht type' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_TYPE', 'Edit your yacht type' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_INFO', 'Select your yacht type' );
jr_define( '_JOMRES_COM_LOGGING', 'Jomres logging' );
jr_define( '_JOMRES_COM_LOGGING_WARNING', 'These options allow you to enable/disable logging within Jomres. Error logging is always enabled, but other logs such as Rental, Gateway, System and Request logs can be switched on and off. You are advised that <b>the ability to enable this logging is provided purely as a way of making debugging easier but it carries a big security risk</b> as it is easy for outside users to view your logs without being authorised therefore you are advised to leave it switched off most of the time. If you have enabled logging, then when you have disabled it, you should also ensure that the <i>' . JOMRESPATH_BASE . JRDS . 'temp' . JRDS . '</i> folder does not contain any old log files. Note that enabling logging will also significantly slow your sytem down as it collects a lot of information.' );
jr_define( '_JOMRES_COM_LOGGING_BOOKING', 'Rental form logging (Rental engine logs) ' );
...
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMTYPEIMAGE', 'Rental form berth list show berth type image' );
jr_define( '_JOMRES_COM_A_LISTLIMIT', 'Yacht List limit' );
jr_define( '_JOMRES_COM_A_LISTLIMIT_DESC', 'The number of yachts to show on a page after a search' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE', 'Integrated search feature' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE_DESC', 'The Jomres integrated search feature allows your users to search through Jomres yachts according to a set of functions. If you have already used the search features of Jomres in Joomla you will be familiar with these settings.<br/>This feature allows us to offer search handling within Jomres for those users who don\'t want to use Joomla search modules, or for other CMS users who\'s CMS doesn\'t have it\'s own Jomres search modules.<br/>Just remember that if you choose to search for something via a link (ie not a dropdown) then other search options will not be implemented, only the element that corresponds with the link that you clicked.<br/>Note that by default the layout of this integrated search isn\'t very pretty. That\'s because the template file that performs the layout has to include all possible options, some of which are incompatible. To improve the layout and achieve the look you desire, you will need to edit <b>srch.html</b> in the folder <b>' . JOMRES_TEMPLATEPATH_FRONTEND . '</b> ' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE', 'Activate this feature?' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE_DESC', 'If this feature is enabled, then any call to Jomres that shows the yacht list will mean that the search options are also shown.' );
...
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME', "Search by yacht name" );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME_DESC', "Show the search by yacht name input." );
...
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE', "Search by yacht type" );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE_DESC', "Show the search by yacht type input" );
...
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE', "Search by berth type" );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE_DESC', "Show the search by berth type input" );
...
jr_define( '_JOMRES_A_GLOBAL_SEARCHOPTION_RANDOMLIMIT_DESC', 'By default, if a yacht is not selected in Jomres it will perform a search. If this search was not triggered by a search module then that search will produce random results (deliberately). This option allows you to limit the number of returns in that random search.' );
...
jr_define( '_JOMRES_COM_CUSTOMFIELDS_DESC', 'Here you can define simple custom fields that will be shown in the rental form.' );
...
jr_define( '_JRPORTAL_INVOICES_PAYPAL_SETTINGS_OVERRIDE_DESC', "If the paypal settings override option is set to Yes then several things happen: General Configuration no longer shows any gateway settings, and two, when a rental is made the settings used here are used so that payment is sent to the address entered here, not that previously configured in General Configuration." );
jr_define( '_JRPORTAL_INVOICES_SHOWINVOICES', "Show my invoices" );
jr_define( '_JRPORTAL_COUPONS_TITLE', "Discount coupons" );
jr_define( '_JRPORTAL_COUPONS_DESC', "Discount codes can be generated and passed onto guests as an incentive to make rentals. Valid from and to dates refer to the dates that a rental can be made on, not the dates of the rental itself." );
...
jr_define( '_JRPORTAL_COUPONS_ROOMONLY', "Berth only" );
jr_define( '_JRPORTAL_COUPONS_ROOMONLY_DESC', "Discount is only applied to the cost of the berth. If No, then the discount is applied to the entire cost of the rental." );
jr_define( '_JRPORTAL_COUPONS_SQLERROR', "Sql error when trying to delete/insert a coupon" );
jr_define( '_JOMRES_AJAXFORM_COUPON_INSTRUCTIONS', 'If you have a coupon code, please enter it into the box and click the "Save coupon" link to save the coupon details against your rental.' );
jr_define( '_JOMRES_AJAXFORM_COUPON_APPLYBUTTON', 'Save coupon' );
jr_define( '_JOMRES_AJAXFORM_COUPON_COUPONSAVED', 'Coupon saved against rental' );
...
jr_define( '_JOMRES_AJAXFORM_COUPON_BOOKINGNOTE', 'Rental discounted. Coupon code/discount value/coupon settings : ' );
...
jr_define( '_JOMRES_COM_MR_EDITBOOKING_ADMIN_HISTORICBOOKINGS', 'Rented out and Cancelled rentals' );
...
jr_define( '_JRPORTAL_NEWUSER_LOG_IN', "Please log in to view your rentals " );
...
<br/>
" );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWDISABLED', 'Rental form berth list show disabled access' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWMAXPEOPLE', 'Rental form berth list show max people' );
jr_define( '_JRPORTAL_HORIZROOMSLIST_ESTIMATEWARNING', "Please note that berth prices listed are estimates and the full price of the rental will not be calculated until you have added a berth or berths to your selection." );
...
jr_define( '_JRPORTAL_SUBSCRIPTIONS_PACKAGES_ROOMSLIMIT', "Berths limit" ); // Not currently used, saved for a rainy day
jr_define( '_JRPORTAL_SUBSCRIPTIONS_PACKAGES_PROPERTYLIMIT', "Yacht limit" );
...
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES1', "You need a valid subscription to create new yachts. At this moment in time, you have purchased subscriptions for " );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES2', " <i>published</i> yacht(s). " );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES3', "You can increase the number of yachts you can create by <a href='" . JOMRES_SITEPAGE_URL . "&task=list_subscription_packages'>purchasing more subscription packages here.</a>" );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES4', " You have used " );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES5', " yacht slots. " );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES6', "To see a list of your current yachts click <a href='" . JOMRES_SITEPAGE_URL . "&task=listyouryachts'>here</a>. " );
...
jr_define( '_JRPORTAL_SUBSCRIPTIONS_PUBLISHERROR', "Unfortunately, you cannot publish this yacht as you have reached your maximum number of available yacht slots." );
jr_define( '_JRPORTAL_SUBSCRIBERS_SUBSCRIBED', "Thank you for creating a subscription to list your yacht on our server. Once your invoice is marked as paid (there may be a delay depending on Paypal) please <a href='" . JOMRES_SITEPAGE_URL . "&task=registerProp_step1'>click here to continue creating your yacht(s).</a>" );
...
jr_define( '_JRPORTAL_SUBSCRIBERS_CANNOT_PUBLISH', "We are sorry, but you've met the limit of the number of yachts that you can have published on this system at any one time. You can raise the number of yachts that you can publish by <a href='" . JOMRES_SITEPAGE_URL . "&task=list_subscription_packages&Itemid=" . $Itemid . "'>purchasing more subscription packages here.</a> " );
jr_define( '_JRPORTAL_SUBSCRIPTIONS_USE', "Use subscription handling functionality" );
jr_define( '_JOMRES_COM_NEWUSER', 'Create new user on rental' );
jr_define( '_JOMRES_COM_NEWUSER_DESC', 'Create new user account on unregistered user rental. (Joomla only)' );
jr_define( '_JOMRES_CLICKTOREGISTER', 'Click here to register your yacht' );
...
jr_define( '_JRPORTAL_NEWUSER_SUBJECT', "Thank you for your rental - new user details follow" );
...
jr_define( '_JOMRES_USER_LISTMYPROPERTY', 'Add my yacht to this site' );
...
jr_define( '_JOMRES_COM_YOURBUSINESS', 'Your yacht details' );
jr_define( '_JOMRES_COM_YOURBUSINESS_NAME', 'yacht name' );
...
jr_define( '_JOMRES_FRONT_BLACKBOOKING_DESC_SRP', 'Select the dates that you want to apply the black rental for. When you have selected the appropriate dates, click the "apply" button to re-check availability. <br/> 
<br/> 
If the yacht has one or more rentals for the period selected, then you will not be able to rent it out until the other rentals/black rentals, have been cancelled/rented out.' );
jr_define( '_JOMRES_FRONT_BLACKBOOKING_SRP_CANNOTBLACKBOOK', 'Sorry, you cannot black rent this yacht for those dates.' );
jr_define( '_JOMRES_FRONT_BLACKBOOKING_SRP_CANBLACKBOOK', 'You can blackrent this yacht for those dates.' );
jr_define( '_JOMRES_WARNINGS_PERPERSONPERNIGHT_NOGUESTTYPES', 'Your yacht is configured to charge per person per night but you do not have any guest types created or published, please create and publish one or more guest types. ' );
jr_define( '_JOMRES_WARNINGS_TARIFFS_NOTARIFFS', 'You don\'t have any tariffs configured yet, you will not be able take any rentals for your yacht.' );
...
jr_define( '_JOMRES_COM_A_DEPOSIT_CHARGEDEPOSIT_VARIABLE_DESC', 'Variable deposits allow you to define if you\'d like to charge the full amount if the rental\'s arrival date is within N days from "today". Set this option to Yes to enable the feature, and enter the number of days below, so for example if the arrival day is within 60 days, then the deposit amount charged will be the full amount, otherwise the amount will be based on the deposit options configured above.' );
...
jr_define( '_JOMRES_CONTACTOWNER_TO_ADMIN_DESC', 'Set this option to Yes if you want Contact Owner emails to be sent to the below input. Leave it set to No to send the emails to the email address defined in the yacht configuration area.' );
...
jr_define( '_JOMRES_REALESTATE_YESNO', 'Is this yacht a for sale listing?' );
jr_define( '_JOMRES_REALESTATE_YESNO_DESC', 'Select Yes if you are selling the yacht, select No if it is a listing where you will be offering short term rentals and will be using this system for taking rentals.' );
...
jr_define( '_JOMRES_AUTOTRANSLATE_DESC', 'This feature is new and experimental, so use at your own risk. The purpose of the feature is to query Google\'s translation tool to automatically set up translations for a given yacht. Note that this feature sanitizes all input, so if you use a html editor for formatting your yacht details, then this will break that formatting.<br/>' );
jr_define( '_JOMRES_SINGLEPROPERTYINSTALLATION_TITLE', 'Is this a single yacht installation?' );
jr_define( '_JOMRES_SINGLEPROPERTYINSTALLATION_DESC', 'If this option is set to Yes, then the frontend view of Jomres to non-authorised users is greatly simplified. Default calls to Jomres from a menu option, instead of being given a list of yachts, just takes the guest to the rental form for the first yacht in the system. Yacht managers also will not see see the Yacht Details preview button or the Add new yacht button. Ideal if you only want to list one yacht and take rentals for it.<br/>' );
...
jr_define( '_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO', 'Limit yacht registration to one country?' );
jr_define( '_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO_DESC', 'You can ensure that yacht registrations are limited to just one country by setting this option to Yes and setting the country in the following option.' );
jr_define( '_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_COUNTRY', 'Yachts are located in this country : ' );
jr_define( '_JOMRES_JQUERYTHEME', 'Jquery theme' );
jr_define( '_JOMRES_JQUERYTHEME_DESC', 'Choose a jquery theme to use for the yacht details tabs.' );
jr_define( '_JOMRES_PROPERTYNOTOUBLISHED', 'We are sorry, but that yacht is not currently available.' );
jr_define( '_JOMRES_REVIEWS', 'Reviews' );
jr_define( '_JOMRES_REVIEWS_TITLE', 'Review title' );
jr_define( '_JOMRES_REVIEWS_DATE', 'posted on ' );
jr_define( '_JOMRES_REVIEWS_NOREVIEWS', 'There are no reviews for this yacht yet.' );
jr_define( '_JOMRES_REVIEWS_NOREVIEWS_BETHEFIRST', 'Would you like to be the first to review this yacht?' );
...
jr_define( '_JOMRES_REVIEWS_REVIEWBODY', 'Tell us what you think about this yacht : ' );
...
jr_define( '_JOMRES_REVIEWS_ALREADYREVIEWED', 'You have already reviewed this yacht, you can\'t post another review about it.' );
...
jr_define( '_JOMRES_REVIEWS_ADDREVIEW_ERROR_PROS', 'Please enter the good parts of your experience of being a guest at this yacht' );
...
jr_define( '_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_2', 'Please rate your opinion of the yacht\s locale' );
jr_define( '_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_3', 'Please provide your opinion of the cleanliness of the yacht' );
...
jr_define( '_JOMRES_REVIEWS_ADMIN_TESTMODE_DESC', 'Normally yacht managers cannot review yachts. With test mode enabled, they can. Naturally this is not ideal in a production environment.' );
jr_define( '_JOMRES_REVIEWS_ADMIN_PROPERTYLISTINFO', 'This is a list of all yachts. To see a yacht\'s reviews, click on that yacht. From there you will be able to publish or delete a review.' );
...
jr_define( '_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS', 'Show Rental form in yacht details page?' );
jr_define( '_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS_DESC', 'Set this to Yes to show the rental form in the yacht details page. If you set it to No, then a link will appear in the yacht details page instead pointing to the rental form.' );
...
jr_define( '_JOMRES_ROOMALLOCATIONS_ROOM', 'Berth ' );
jr_define( '_JOMRES_ROOMALLOCATIONS_GUESTS', 'guest(s). ' );
jr_define( '_JOMRES_ROOMALLOCATIONS_INFORMATION', 'This how we have assigned your guest numbers to their berths. If you would like to change this allocation, you will need to contact the hotel after making the rental. Extra charges may apply if you change your assignments.' );
jr_define( '_JOMRES_SANITY_CHECK_NOT_PUBLISHED', "Note that your yacht is not yet published, only you can see the yacht, site visitors will not see it" );
...
jr_define( '_JOMRES_ROOMMSLIST_STYLE', 'Berths list style' );
jr_define( '_JOMRES_ROOMMSLIST_STYLE_DESC', 'In the rental form, using the "classic" berths list style you offer individual berths to guests. With the berth type view, guests choose the number of berths of type X (eg. 2 x doubles) instead' );
jr_define( '_JOMRES_ROOMMSLIST_STYLE_CLASSIC', 'Classic' );
jr_define( '_JOMRES_ROOMMSLIST_STYLE_ROOMTYPES', 'Berth types' );
jr_define( '_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_START', '(Re)checking availability' );
jr_define( '_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_REBUILDING_AVAILABLEROOMS', 'Rebuilding available berths list' );
...
jr_define( '_JOMRES_REVIEWS_ADMIN_GUESTSONLY', 'Only yacht guests can review?' );
jr_define( '_JOMRES_REVIEWS_ADMIN_GUESTSONLY_DESC', 'Set this to Yes if you want to restrict reviews to only those users who have been a guest already in this yacht.' );
jr_define( '_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERROOMPERBOOKING', 'Per berth' );

jr_define( '_JOMRES_MAX_GUESTS_PER_ROOM', 'Guests per berth : ' );
jr_define( '_JOMRES_MAX_GUESTS_PER_BOOKING', 'Guests per rental : ' );
jr_define( '_JOMRES_NUMBER_OF_ROOMS', 'Number of berths' );
...
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS', "Yacht management process" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_DESC', "There are different management processes depending on the way you want to list your yacht/yacht." );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL', "Rental" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL_DESC', "Choose the rental option if you are rental out berths in a yacht (eg. Hotel/B&B/Villa/Apartment)" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE', "Realestate/simple listing" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE_DESC', "Choose the real estate option if you are not offering any rental functionality at all, (eg. A yacht/item for sale)" );

jr_define( 'JOMRES_COM_A_MINIMALCONFIG_DESC', 'Set this to Yes to reduce the number of options available to yacht managers in the General Configuration section. This is useful if you do not want yacht managers to play around with too many settings, instead you can edit jomres_config.php to define default yacht options.' );
jr_define( '_JOMRES_AJAXFORM_EXTRAS_SELECT', 'Please select an option for your rental' );
jr_define( '_JOMRES_COM_ALLOWHTMLEDITOR_DESC', 'Switches on html editors in yacht details editing page. Additionally, if this is set to No, then all html except p and br is stripped from all entered and displayed text.' );
...
jr_define( '_JOMRES_COM_TIMEZONE_SWITCHER', "Show the timezone switcher in the yacht manager's toolbar?" );

jr_define( '_JOMRES_PARTNER_DISCOUNT', "Partner discount " );
jr_define( '_JOMRES_PARTNER_CHOOSE_SEARCHTITLE', "Search user" );
jr_define( '_JOMRES_PARTNER_CHOOSE_SEARCH_INSTRUCTIONS', "Enter a few characters to search for a user.<br/> When you select a user you will automatically add them as a Partner and you will be taken to the next page where you can assign yachts and discounts to the user." );
...
jr_define( '_JOMRES_PARTNER_SHOW_SEARCHTITLE', "Search for a yacht" );
jr_define( '_JOMRES_PARTNER_SHOW_SEARCHINSTRUCTIONS', "Enter a few characters from the yacht name and select a yacht.<br/> When you select the yacht you will add it to the partner's portfolio, however they will not yet enjoy any discounts, you will need to set those youself." );
jr_define( '_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES', "Current yachts" );
jr_define( '_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES_INSTRUCTIONS', "Click on a yacht to edit the partner's discount settings for that yacht." );

// 4.6
jr_define( '_JOMRES_SUSPENSIONS_TITLE', "Suspended? <br/>(click to suspend a manager, this will auto-unpublish all of their yachts ) " );
jr_define( '_JOMRES_SUSPENSIONS_MANAGERLIST_INFO', "Click on the Suspend Icon (the icon with the man and the green tick) to suspend a manager. This means that the manager will not be able to perform yacht management functions and all of their yachts will be unpublished. Super yacht managers cannot be suspended." );
...
jr_define( '_JOMRES_SUSPENSIONS_MANAGER_SUSPENDED_EMAIL', "Please note that your yacht manager account has been suspended. You will not be able to perform any yacht management functions until the account has been restored." );
jr_define( '_JOMRES_SUSPENSIONS_MANAGER_UNSUSPENDED_EMAIL', "Please note that your yacht manager account is now active. You may continue to perform any yacht management functions. Please log into your account and ensure that the approprite propert(ies) have been published. Thank you." );
jr_define( '_JOMCOMP_MYUSER_REMOVE', 'Remove favourite' );
jr_define( '_JOMRES_DATA_ARCHIVE_TITLE', 'Rental data archive' );
...
jr_define( '_JOMRES_CHOOSEMANAGER_NUMBEROFPROPERTIES_ASSIGNED', "Number of yachts" );
...
jr_define( '_JOMRES_COM_THUMBNAIL_SMALL_WIDTH_DESC', 'Small thumbnails are used in the yacht list whereas medium sized thumbnails are used in the yacht header.' );
...
jr_define( '_JRPORTAL_INVOICES_COMMISSION_MANAGER_TRIGGERS', "Manager rentals create commission invoices?" );
jr_define( '_JRPORTAL_INVOICES_COMMISSION_MANAGER_TRIGGERS_DESC', "If a manager makes a rental, does that also create a commission invoice line item?" );
...
jr_define( '_JRPORTAL_INVOICES_COMMISSION_AUTOSUSPEND_THREASHOLD_DESC', "This threashold is the number of days that a manager has to pay an invoice before they are suspended and their yachts unpublished." );
...
jr_define( '_JRPORTAL_COUPONS_BOOKING_VALIDFROM', "Rental valid from" );
jr_define( '_JRPORTAL_COUPONS_BOOKING_VALIDTO', "Rental valid to" );
jr_define( '_JRPORTAL_COUPONS_GUESTNAME', "Guest name" );
jr_define( '_JRPORTAL_COUPONS_DESC_478', "Discount codes can be generated and passed onto guests as an incentive to make rentals.<br/>
Valid from and to dates refer to the dates that a rental can be made on, whereas the Rental valid from/to dates refer to the dates that the rental must cover for the coupon to be valid. If a rental falls outside of that period then normal rates will apply to the days outside of that period.<br/>
If you want the rental to be available to one specific guest, choose that guest's name in the dropdown to limit the coupon to that guest only." );
jr_define( '_JRPORTAL_COUPONS_BOOKING_DISCOUNT_FEEDBACK', "With your coupon, this rental has been discounted from " );
...
jr_define( '_JOMRES_BOOKINGORM_MODALPOPUP', 'Show the rental form in a modal popup?' );
jr_define( '_JOMRES_BOOKINGORM_MODALPOPUP_DESC', 'If the option to show the rental form in the property details is set to No, then when the rental form page is opened Jomres can show the rental form in a modal popup. This allows you to include much more information in the rental form without overwhelming the customer by having too many elements on the screen (as they\'re hidden behind the popup)' );
jr_define( '_JOMRES_BOOKINGORM_TOTALSPANEL_LOCATION', 'Totals panel location' );
jr_define( '_JOMRES_BOOKINGORM_TOTALSPANEL_LOCATION_DESC', 'In the rental form the totals panel needs different settings depending on the template. For example, on the Jomres Joomla template a setting of 712 works well, however on Milkyway a setting of circa 1500 is more suitablem, particularly if you do not have the modal popup feature enabled. It\'s likely that you\'ll need to experiment with different settings to find something that works well in your chosen template. ' );
...
jr_define( '_JOMRES_AJAXFORM_BILLING_TAX_ACCOM', 'Berth tax:' );

jr_define( '_JOMRES_AJAXFORM_BUTTON_OPEN_BOOKINGFORM', 'Open the rental form' );
...
jr_define( '_JOMRES_BOOKINGORM_ROOMFEATURE_FILTER', 'Filter berths based on their features.' );

jr_define( '_JOMRES_DATEPERIOD_LATESTBOOKING', 'Latest rental' );
...
jr_define( '_JOMRES_WHOLEDAY_TITLE', 'Rentals are for whole days?' );
jr_define( '_JOMRES_WHOLEDAY_DESC', 'By default the system rentals berths out by the night, so a rental from the first of January ' . date( "Y", strtotime( "next year" ) ) . ' to the 2nd of January ' . date( "Y", strtotime( "next year" ) ) . ' covers just one night. If you set this option to Yes, however, then the rental will cover entire days instead, so a rental on those days would cover both days and the customer would be billed for two days.' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_BOOKING_TOO_SHORT1_WHOLEDAY', 'The rental is too short. There needs to be at least this many days between the pickup and return dates:' );
jr_define( '_JOMRES_COM_A_MINIMUMINTERVAL_WHOLEDAY', 'Pickup/Return minimum interval' );
jr_define( '_JOMRES_COM_A_MINIMUMINTERVAL_DESC_WHOLEDAY', 'The mimimum interval in the rental form between the pickup and the drop off dates. An interval of 1 means that the pickup and return dates can be set to the same day, however this is still dependant on the minimum interval that\'s automatically calculated by the rental engine, as it checks tariffs that are valid for the rental period.' );
...
jr_define( '_JOMRES_COM_A_ADVANCEBOOKINGSLIMITYESNO_DESC_WHOLEDAY', 'Set this to yes if you want to limit advance rentals (use the next field to set the limit in terms of days). If you do set this to yes then if the user tries to rent more than n days in advance then their pickup date will be restored to today\'s date' );
jr_define( '_JOMRES_COM_A_SHOWDEPARTUREINPUT_WHOLEDAY', 'Show return date input?' );
jr_define( '_JOMRES_COM_A_SHOWDEPARTUREINPUT_DESC_WHOLEDAY', "Set this to No if you don't want to show the return date input box. Only use this if you know what you're doing, as the return date in rentals will always be set to the day after the pickup date." );

jr_define( '_JOMRES_COM_A_FIXEDPERIODBOOKINGS_DESC_WHOLEDAY', 'If you set this to Yes, then rentals will be taken for a fixed period. If this is set to No, then ensure that "defined pickup day" isn\'t set to Yes (unless you specifically want to force people to pickup on a certain day of the week) otherwise you will not get many links in the availability calendar.' );
jr_define( '_JOMRES_COM_MR_FIXEDARRIVALDATE_YESNO_WHOLEDAY', 'Pre-defined pickup day' );
jr_define( '_JOMRES_COM_MR_FIXEDARRIVALDATE_YESNO_DESC_WHOLEDAY', 'Only for sites offering fixed period rentals. Choose the day of the week that pickups must be made on.' );
...
jr_define( '_JOMRES_COM_MR_FIXEDARRIVALDATE_RECURRING_DESC_WHOLEDAY', 'When fixed pickup dates are selected, the number of dates that can be shown in the dates dropdown list. Note that the list of dates will not include any dates if a rental is not possible due to prior rentals, and that the list will actually be twice as long as your selected number because it will have a similar number of historic dates (where available).' );
jr_define( '_JOMRES_COM_A_TARIFFS_PER_WHOLEDAY', 'Per person, per day' );
jr_define( '_JOMRES_COM_A_TARIFFS_PER_DESC_WHOLEDAY', 'Select Yes if you want to charge per-person-per-day. If no, then costs will be calculated on a per-berth-per-day basis' );
jr_define( '_JOMRES_COM_A_DEPOSIT_CHARGEDEPOSIT_VARIABLE_DESC_WHOLEDAY', 'Variable deposits allow you to define if you\'d like to charge the full amount if the rental\'s pickup date is within N days from "today". Set this option to Yes to enable the feature, and enter the number of days below, so for example if the pickup day is within 60 days, then the deposit amount charged will be the full amount, otherwise the amount will be based on the deposit options configured above.' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE_DESC_FULL_WHOLEDAY', 'Most yachts will recalculate berth prices based on the number of berths of a required type that are available on a given date. This allows them to offer discounts on a berth/yacht type that isn\'t busy during a given period with the aim of attracting yacht that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of berths of a selected type are available in the yacht on a given day.<br/> The days threshold defines the number of days that the pickup date must be within before berth prices are adjusted by this feature, then the percentages options allow you to configure the percentage of berths that can be available before a given discount is applied. Note however, if multiple berths are rented then the current level of discount will be applied to all berths and will not reduce as more berths are selected.' );
...
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAGUESTIN_WHOLEDAY', 'Mark a rental picked up.' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAGUESTOUT_WHOLEDAY', 'Mark a rental returned.' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_TITLE_WHOLEDAY', 'Mark a rental picked up' );
jr_define( '_JOMRES_FRONT_MR_BOOKOUT_TITLE_WHOLEDAY', 'Mark a rental returned' );
...
jr_define( '_JOMRES_BOOKINGFORMWIDTH', 'Rental form width in px' );
jr_define( '_JOMRES_BOOKINGORM_SLIDERENABLED', 'Allow the totals panel to slide down the rental form?' );
jr_define( '_JOMRES_BOOKINGORM_SLIDERENABLED_DESC', 'The totals panel will slide down the rental form as the user scrolls down. You can enable/disable this feature with this switch. Note, if the user visits via a mobile device\'s browser then sliding is automatically disabled.' );
...
jr_define( '_JOMRES_BOOKINGORM_TAX_OUTPUT', 'Show tax output in the rental form totals summary?' );
jr_define( '_JOMRES_BOOKINGORM_TAX_OUTPUT_DESC', 'Prevent the rental form from showing the tax price fields in the totals summary by setting this option to No.' );
jr_define( '_JOMRES_COM_A_ODDS_CANCELLATION_THREASHOLD', 'Cancellation Threashold' );
jr_define( '_JOMRES_COM_A_ODDS_CANCELLATION_THREASHOLD_DESC', 'Logged in, registered guests can cancel their own rentals. Here you can set the threashold, in days, where the rental cannot be cancelled after a certain number of days before the arrival date.' );
...
jr_define( '_JOMRES_FEATURE_PROPERTY_TYPE_ASSIGNMENT', 'Yacht types that can show this feature' );
jr_define( '_JOMRES_CRATES_CLICKINITIAL', 'Click on a letter to show all yachts with that first character. Once you have a list of properties you can assign commission rates to those properties, or click on their "edit" icon to view the yacht\'s statistics.' );
...
jr_define( '_JOMRES_PRODUCT_INFORMATION', 'Welcome to Jomres, we hope you enjoy using Joomla\'s favourite rental system. If you would like to purchase a Jomres Silver or Jomres Gold license, <a href="http://www.jomres.net/prices" target="_blank"> please visit our site</a> for information on how you can upgrade.' );
jr_define( '_JOMRES_PRODUCT_INFORMATION2', 'This system is ideal for any scenario, be it a simple rental form for a single property, right up to a site that has multiple users, in multiple languages, with multiple properties. Please see the "Help" section to the left, including the "Getting Started" page which will guide you through your first steps.' );
...
jr_define( '_JOMRES_WARNING_SYSTEM_CACHE', "Warning : We have detected that your Joomla System Cache plugin is enabled. We advise you to disable this plugin as it will cache the ajax responses to the rental form, causing your system to behave erratically." );
...
jr_define( '_JOMRES_MYPROPERTIES', 'My yachts' );

jr_define( '_JOMRES_CART_TITLE', 'My proposed rentals' );
jr_define( '_JOMRES_CART_INFO', 'Note, these rentals have not been saved yet. If you log out or your session expires they will be lost. Remember to confirm your rentals!' );
jr_define( '_JOMRES_CART_CONFIRM_BOOKINGS', 'Confirm rental(s)' );
jr_define( '_JOMRES_CART_OR', ' or ' );
jr_define( '_JOMRES_CART_SAVEFORLATER', 'Save for later' );
jr_define( '_JOMRES_CART_NOBOOKINGS_SAVED', 'You don\'t have any rentals saved yet.' );
