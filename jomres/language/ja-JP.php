...
jr_define("JOMRES_COM_A_MAPSKEY_DESC","google mapsのAPIキーをgoogleのデベロップメントHPから得ることができます。ここにキーを入力したら、地図が事業・プロパティ情報ページに表示されます。");
...
jr_define("_JOMRES_COM_ALLOWHTMLEDITOR_DESC","事業・プロパティ情報のhtmlエディターを表示したい場合、「YES」に設定してください。「NO」に設定した場合には、<p> と<br/>意外のタグが全て削除されます。");
