...
class jomres_obsolete_file_handling
	...
	function set_default_obs_files_array()
		...
		if ( _JOMRES_DETECTED_CMS == "joomla30" || _JOMRES_DETECTED_CMS == "joomla31" || _JOMRES_DETECTED_CMS == "joomla32" ) $this->add_obs_file( $this->dir_components_administrator . 'admin.jomres.php' );
