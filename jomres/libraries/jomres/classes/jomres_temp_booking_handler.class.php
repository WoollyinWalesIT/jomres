...
class jomres_temp_booking_handler
	...
	function __construct()
		...
		$this->tmpbooking = array ( "requestedRoom" => "", "rate_pernight" => "", "variancetypes" => "", "varianceuids" => "", "varianceqty" => "", "variancevals" => "", "lastminute_id" => "", "agent_booking" => "", "arrivalDate" => "", "departureDate" => "", "stayDays" => "", "dateRangeString" => "", "guests_uid" => "", "property_uid" => "", "rates_uid" => "", "tag" => "", "resource" => "", "single_person_suppliment" => "", "deposit_required" => "", "contract_total" => "", "smoking" => "", "extrasvalue" => "", "extrasvalues_items" => array (), "extras" => "", "extrasquantities" => array (), "third_party_extras" => array (), "third_party_extras_private_data" => array (), "room_allocations" => array (), "room_allocations_note" => "", "total_discount" => "", "booking_discounted" => false, "depositpaidsuccessfully" => false, "tax" => "", "booker_class" => "", "ok_to_book" => "", "beds_available" => "", "referrer" => "", "error_log" => "", "total_in_party" => "", "room_total" => "", "lang" => "", "timestamp" => "", "wisepricediscount" => "", "lastminutediscount" => "", "confirmationSeen" => false, "mininterval" => "", "discounts" => array (), "coupon_id" => "", "coupon_code" => "", "coupon_details" => array (), "coupon_discount_value" => "", "cfg_showExtras" => false, "booking_notes" => array (), "additional_line_items" => array (), "booking_number" => 0, "room_feature_filter" => array (), "override_room_total" => null, "override_deposit" => null, "property_currencycode" => null, "booked_in" => 0, "sendGuestEmail" => true, "sendHotelEmail" => true , "secret_key_payment" => false );

		$this->tmpguest = array ( "guests_uid" => "", "mos_userid" => "", "existing_id" => "", "firstname" => "", "surname" => "", "house" => "", "street" => "", "town" => "", "region" => "", "country" => "", "postcode" => "", "tel_landline" => "", "tel_mobile" => "", "tel_fax" => "", "ccard_no" => "", "ccard_issued" => "", "ccard_expiry" => "", "ccard_iss_no" => "", "ccard_name" => "", "ccv" => "", "type" => "", "property_uid" => "", "email" => "", "discount" => "0", "tag" => "", "timestamp" => "" );
	...
	function resetCreditCardDetails()
		{
		$this->tmpguest = array ( "ccard_no" => "", "ccard_issued" => "", "ccard_expiry" => "", "ccard_iss_no" => "", "ccard_name" => "", "ccv" => "", "type" => "" );
		$this->saveGuestData();
		}
	...
	function resetTempBookingData()
		...
		$this->tmpbooking = array ( "property_uid" => $pid, "requestedRoom" => "", "rate_pernight" => "", "variancetypes" => "", "varianceuids" => "", "varianceqty" => "", "variancevals" => "", "lastminute_id" => "", "agent_booking" => "", "stayDays" => "", "dateRangeString" => "", "guests_uid" => "", "rates_uid" => "", "tag" => "", "resource" => "", "single_person_suppliment" => "", "deposit_required" => "", "contract_total" => "", "smoking" => "", "extrasvalue" => "", "extrasvalues_items" => array (), "extras" => "", "extrasquantities" => array (), "third_party_extras" => array (), "third_party_extras_private_data" => array (), "room_allocations" => array (), "room_allocations_note" => '', "total_discount" => "", "booking_discounted" => false, "depositpaidsuccessfully" => false, "tax" => "", "booker_class" => "", "ok_to_book" => "", "beds_available" => "", "referrer" => "", "error_log" => "", "total_in_party" => "", "room_total" => "", "lang" => "", "timestamp" => "", "wisepricediscount" => "", "lastminutediscount" => "", "confirmationSeen" => false, "mininterval" => "", "discounts" => array (), "coupon_id" => "", "coupon_code" => "", "coupon_details" => array (), "coupon_discount_value" => "", "cfg_showExtras" => false, "booking_notes" => array (), "additional_line_items" => array (), "booking_number" => 0, "room_feature_filter" => array (), "override_room_total" => null, "override_deposit" => null, "property_currencycode" => null, "booked_in" => 0, "sendGuestEmail" => true, "sendHotelEmail" => true );
		$this->saveBookingData();
		}
