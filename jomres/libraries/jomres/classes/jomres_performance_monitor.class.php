...
class jomres_performance_monitor
	...
	public function output_report()
		{
		if ( isset( $_REQUEST[ 'no_html' ] ) && $_REQUEST[ 'no_html' ] == (int) 1 ) return;
	...
	private function get_normalised_memory_usage( $mem_usage )
		{
		if ( $mem_usage < 1024 ) $result = $mem_usage . " bytes";
		elseif ( $mem_usage < 1048576 ) $result = round( $mem_usage / 1024, 2 ) . " kilobytes";
		else
