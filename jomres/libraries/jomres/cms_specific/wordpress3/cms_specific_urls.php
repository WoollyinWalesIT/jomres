...
define( "JOMRES_SITEPAGE_URL_AJAX",get_showtime( 'live_site' ) . "/wp-admin/admin-ajax.php?action=".JOMRES_ROOT_DIRECTORY."/trigger.php&no_html=1&jrajax=1&jr_wp_source=frontend&option=com_jomres&page_id=" . $page_id . $tmpl . $lang);

define( "JOMRES_SITEPAGE_URL_ADMIN", get_showtime( 'live_site' ) . "/wp-admin/admin.php?page=".JOMRES_ROOT_DIRECTORY."/jomres.php&jr_wp_source=admin&option=com_jomres" . $tmpl . $lang . $lang_param );
define( "JOMRES_SITEPAGE_URL_ADMIN_AJAX", get_showtime( 'live_site' ) . "/wp-admin/admin-ajax.php?action=".JOMRES_ROOT_DIRECTORY."/trigger.php&no_html=1&jrajax=1&jr_wp_source=admin&option=com_jomres" . $tmpl . $lang . $lang_param);
