...
define( "JOMRES_SITEPAGE_URL_NOSEF", get_showtime( 'siteurl' ) . '/' . "index.php?page=jomres/admin.php" . $tmpl . $lang_param. "&jr_wp_source=frontend&option=com_jomres");
define( "JOMRES_SITEPAGE_URL_AJAX",get_showtime( 'siteurl' ) . '/' . "/wp-content/plugins/jomres/ajax.php?action=jomres/admin.php&no_html=1&jrajax=1&" . $tmpl . $lang_param ."&jr_wp_source=frontend&option=com_jomres");
define( "JOMRES_SITEPAGE_URL_ADMIN", get_showtime( 'siteurl' ) . "/wp-admin/admin.php?page=jomres/admin.php" . $tmpl . $lang_param . "&jr_wp_source=admin&option=com_jomres" );
define( "JOMRES_SITEPAGE_URL_ADMIN_AJAX", get_showtime( 'siteurl' ) . "/wp-admin/admin-ajax.php?action=jomres/admin.php&no_html=1&jrajax=1" . $tmpl . $lang_param . "&jr_wp_source=admin&option=com_jomres");

define( "JOMRES_SITEPAGE_URL", get_showtime( 'siteurl' ) . "/" . $index . "?" . $tmpl . $lang_param .'&option=com_jomres');
