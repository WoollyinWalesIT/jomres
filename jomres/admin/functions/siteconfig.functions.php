...
function showSiteConfig()
	...
	foreach ( $cssFiles as $file )
		{
		if ( isset( $file[ 'customPath' ] ) ) $jqueryUIthemes[ ] = jomresHTML::makeOption( $file[ 'subdir' ] . "^" . $file[ 'cssfile' ] . "^" . $file[ 'customPath' ], $file[ 'subdir' ] );
		else
...
function searchCSSThemesDirForCSSFiles()
	...
	if ( is_array( $colourSchemeDataArray ) ) $cssFiles = array_merge( $cssFiles, $colourSchemeDataArray );
