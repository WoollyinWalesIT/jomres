...
class j02240listlivebookings
	...
	function j02240listlivebookings()
		...
		$output[ 'HGUEST_LANDLINE' ] = jr_gettext( '_JOMRES_FRONT_MR_EMAIL_TEXT_LANDLINE', _JOMRES_FRONT_MR_EMAIL_TEXT_LANDLINE, false );
		$output[ 'HGUEST_MOBILE' ] = jr_gettext( '_JOMRES_FRONT_MR_EMAIL_TEXT_MOBILE', _JOMRES_FRONT_MR_EMAIL_TEXT_MOBILE, false );
