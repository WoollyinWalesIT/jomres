...
class j16000list_tax_rules
	...
	function j16000list_tax_rules()
		...
		$output[ 'PAGETITLE' ]    = jr_gettext( '_JOMRES_TAX_RULES_LIST', _JOMRES_TAX_RULES_LIST );
		$output[ '_JRPORTAL_TAXRATES_CODE' ]        = jr_gettext( '_JRPORTAL_TAXRATES_CODE', _JRPORTAL_TAXRATES_CODE );
		$output[ '_JRPORTAL_TAXRATES_DESCRIPTION' ] = jr_gettext( '_JRPORTAL_TAXRATES_DESCRIPTION', _JRPORTAL_TAXRATES_DESCRIPTION );
		...
		$output[ '_JOMRES_TAX_RULE_INFO' ]        = jr_gettext( '_JOMRES_TAX_RULE_INFO', _JOMRES_TAX_RULE_INFO );
