	...
	function j06005list_usersinvoices()
		...
		if ( $thisJRUser->userIsRegistered )
			...
			if ( using_bootstrap() )
				...
				{
				$output[ 'TASK_FILTER_ANY' ]       = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_usersinvoices&id=' . $id . '">' . jr_gettext( '_JOMRES_FRONT_ROOMSMOKING_EITHER', _JOMRES_FRONT_ROOMSMOKING_EITHER,false ) . '</a>';
				$output[ 'TASK_FILTER_UNPAID' ]    = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_usersinvoices&status=unpaid&id=' . $id . '">' . jr_gettext( '_JRPORTAL_INVOICES_STATUS_UNPAID', _JRPORTAL_INVOICES_STATUS_UNPAID,false ) . '</a>';
				$output[ 'TASK_FILTER_PAID' ]      = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_usersinvoices&status=paid&id=' . $id . '">' . jr_gettext( '_JRPORTAL_INVOICES_STATUS_PAID', _JRPORTAL_INVOICES_STATUS_PAID,false ) . '</a>';
				$output[ 'TASK_FILTER_CANCELLED' ] = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_usersinvoices&status=cancelled&id=' . $id . '">' . jr_gettext( '_JRPORTAL_INVOICES_STATUS_CANCELLED', _JRPORTAL_INVOICES_STATUS_CANCELLED,false ) . '</a>';
				$output[ 'TASK_FILTER_PENDING' ]   = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_usersinvoices&status=pending&id=' . $id . '">' . jr_gettext( '_JRPORTAL_INVOICES_STATUS_PENDING', _JRPORTAL_INVOICES_STATUS_PENDING,false ) . '</a>';
				}
