...
class j06000show_property_map
	...
	function j06000show_property_map( $componentArgs )
		...
		if ( isset( $_REQUEST[ 'property_uid' ] ) )
			...
			if ( isset( $_REQUEST[ 'show_now' ] ) ) $show_now = (int) $_REQUEST[ 'show_now' ];
			}
		else
			{
			...
			if ( isset( $componentArgs[ 'show_now' ] ) ) $show_now = (int) $componentArgs[ 'show_now' ];
			}
		...
		if ( $show_now == 0 ) $this->retVals = $MiniComponents->miniComponentData[ '01050' ][ 'x_geocoder' ];
		else
