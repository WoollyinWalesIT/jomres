...
class j06001switch_active_property
	...
	function j06001switch_active_property()
		...
		$output['_JOMRES_PORTALUI_CLICKINITIAL'] = jr_gettext("_JOMRES_ROBBED_PORTALUI_CLICKINITIAL",_JOMRES_ROBBED_PORTALUI_CLICKINITIAL);
		$output['_JOMRES_ROBBED_PORTALUI_SWITCH_PROPERTY'] = jr_gettext("_JOMRES_ROBBED_PORTALUI_SWITCH_PROPERTY",_JOMRES_ROBBED_PORTALUI_SWITCH_PROPERTY);
		$output['_JOMRES_FOUNDPROPERTIES'] = jr_gettext("_JOMRES_FOUNDPROPERTIES",_JOMRES_FOUNDPROPERTIES);
