...
class j16000access_control
	...
	function j16000access_control()
		...
		if ( $jrConfig[ 'full_access_control' ] == "0" )
			{
			$output[ '_JOMRES_ACCESS_CONTROL_TITLE' ]         = jr_gettext( '_JOMRES_ACCESS_CONTROL_TITLE', _JOMRES_ACCESS_CONTROL_TITLE );
			$output[ '_JOMRES_ACCESS_CONTROL_DESC' ]          = jr_gettext( '_JOMRES_ACCESS_CONTROL_DESC', _JOMRES_ACCESS_CONTROL_DESC );
			$output[ '_JOMRES_ACCESS_CONTROL_DESC_ADDENDUM' ] = jr_gettext( '_JOMRES_ACCESS_CONTROL_DESC_ADDENDUM', _JOMRES_ACCESS_CONTROL_DESC_ADDENDUM );
			}
		else
			{
			$output[ '_JOMRES_ACCESS_CONTROL_TITLE' ] = jr_gettext( '_JOMRES_ACCESS_CONTROL_TITLE_FULL', _JOMRES_ACCESS_CONTROL_TITLE_FULL );
			$output[ '_JOMRES_ACCESS_CONTROL_DESC' ]  = jr_gettext( '_JOMRES_ACCESS_CONTROL_DESC_FULL', _JOMRES_ACCESS_CONTROL_DESC_FULL );
