...
class j01004property_list_photos
	{
	function j01004property_list_photos( $componentArgs )
		{
		...
		if ( $layout == $this_plugin ) set_showtime( "number_of_ajax_results_required", 3 ); // This is for the list scrolling feature, we need to know the number of properties that should be returned
