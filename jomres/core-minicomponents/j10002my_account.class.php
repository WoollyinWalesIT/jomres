...
class j10002my_account
    ...
    function j10002my_account()
        ...
        $this->cpanelButton = $htmlFuncs->cpanelButton( JOMRES_SITEPAGE_URL_ADMIN . "&task=my_account", 'Help.png', jr_gettext( "_JOMRES_CUSTOMCODE_MYACCOUNTONLINE", _JOMRES_CUSTOMCODE_MYACCOUNTONLINE, false, false ), "/jomres/images/jomresimages/small/", jr_gettext( "_JOMRES_CUSTOMCODE_MENUCATEGORIES_HELP", _JOMRES_CUSTOMCODE_MENUCATEGORIES_HELP, false, false ), $external = false );
        }
