		...
		if ( $thisJRUser->userIsManager )
			...
			if ( $thisJRUser->userIsManager )
				...
				if ( using_bootstrap() )
					...
					{
					$output[ 'TASK_FILTER_ANY' ]       = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_property_invoices">' . jr_gettext( '_JOMRES_FRONT_ROOMSMOKING_EITHER', _JOMRES_FRONT_ROOMSMOKING_EITHER, false ) . '</a>';
					$output[ 'TASK_FILTER_UNPAID' ]    = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_property_invoices&status=unpaid">' . jr_gettext( '_JRPORTAL_INVOICES_STATUS_UNPAID', _JRPORTAL_INVOICES_STATUS_UNPAID, false ) . '</a>';
					$output[ 'TASK_FILTER_PAID' ]      = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_property_invoices&status=paid">' . jr_gettext( '_JRPORTAL_INVOICES_STATUS_PAID', _JRPORTAL_INVOICES_STATUS_PAID, false ) . '</a>';
					$output[ 'TASK_FILTER_CANCELLED' ] = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_property_invoices&status=cancelled">' . jr_gettext( '_JRPORTAL_INVOICES_STATUS_CANCELLED', _JRPORTAL_INVOICES_STATUS_CANCELLED, false ) . '</a>';
					$output[ 'TASK_FILTER_PENDING' ]   = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_property_invoices&status=pending">' . jr_gettext( '_JRPORTAL_INVOICES_STATUS_PENDING', _JRPORTAL_INVOICES_STATUS_PENDING, false ) . '</a>';
					}
				}
			else
				{
				if ( using_bootstrap() )
					...
					{
					$output[ 'TASK_FILTER_ANY' ]       = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_usersinvoices">' . jr_gettext( '_JOMRES_FRONT_ROOMSMOKING_EITHER', _JOMRES_FRONT_ROOMSMOKING_EITHER, false ) . '</a>';
					$output[ 'TASK_FILTER_UNPAID' ]    = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_usersinvoices&status=unpaid">' . jr_gettext( '_JRPORTAL_INVOICES_STATUS_UNPAID', _JRPORTAL_INVOICES_STATUS_UNPAID, false ) . '</a>';
					$output[ 'TASK_FILTER_PAID' ]      = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_usersinvoices&status=paid">' . jr_gettext( '_JRPORTAL_INVOICES_STATUS_PAID', _JRPORTAL_INVOICES_STATUS_PAID, false ) . '</a>';
					$output[ 'TASK_FILTER_CANCELLED' ] = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_usersinvoices&status=cancelled">' . jr_gettext( '_JRPORTAL_INVOICES_STATUS_CANCELLED', _JRPORTAL_INVOICES_STATUS_CANCELLED, false ) . '</a>';
					$output[ 'TASK_FILTER_PENDING' ]   = '<a href="' . JOMRES_SITEPAGE_URL . '&task=list_usersinvoices&status=pending">' . jr_gettext( '_JRPORTAL_INVOICES_STATUS_PENDING', _JRPORTAL_INVOICES_STATUS_PENDING, false ) . '</a>';
					}
				}
			...
			foreach ( $invoices as $invoice )
				...
				if ( $invoice[ 'is_commission' ] != "1" )
					...
					if ( is_null( $r[ 'USER' ] ) ) $r[ 'USER' ] = $r[ 'GUEST' ];
