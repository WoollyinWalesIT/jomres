...
class j00007subscriptions_property_limit
	...
	function __construct( $componentArgs )
		...
		if ($thisJRUser->userIsManager && $thisJRUser->accesslevel == 2) //this subscription feature is applicable only to manager users. new subscribers that don`t have any properties created yet don`t need this restriction
			{
