...
class j04901email_property_welcome_message 
	...
	function __construct($componentArgs)
		...
		$output['_JOMRES_NEW_PROPERTY_WELCOME_3_LINK']		= jomresURL( JOMRES_SITEPAGE_URL."&task=dashboard&thisProperty=".$property_uid );
		...
		$output['_JOMRES_NEW_PROPERTY_WELCOME_4_LINK']		= jomresURL( JOMRES_SITEPAGE_URL."&task=viewproperty&property_uid=".$property_uid );
		...
		$output['_JOMRES_NEW_PROPERTY_WELCOME_7_LINK']		= jomresURL( JOMRES_SITEPAGE_URL."&task=contactowner&property_uid=0" );
