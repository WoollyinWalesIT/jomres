...
class j06005save_review
	...
	function __construct()
		...
		if ( ( $rating_1 < 1 || $rating_1 > 10 ) || ( $rating_2 < 1 || $rating_2 > 10 ) || ( $rating_3 < 1 || $rating_3 > 10 ) || ( $rating_4 < 1 || $rating_4 > 10 ) || ( $rating_5 < 1 || $rating_5 > 10 ) || ( $rating_6 < 1 || $rating_6 > 10 ) || $review_title == "" || $review_description == "" || $pros == "" || $cons == "" ) jomresRedirect( jomresURL( JOMRES_SITEPAGE_URL . "&task=add_review&property_uid=" . $property_uid ), "" );
