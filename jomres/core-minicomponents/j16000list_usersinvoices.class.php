...
class j16000list_usersinvoices
	...
	function j16000list_usersinvoices()
		...
		if ($id>0)
			...
			if (!using_bootstrap())
				{
				$output['TASK_FILTER_ANY']='<a href="'.JOMRES_SITEPAGE_URL_ADMIN.'&task=list_usersinvoices">'.jr_gettext('_JOMRES_FRONT_ROOMSMOKING_EITHER',_JOMRES_FRONT_ROOMSMOKING_EITHER).'</a>';
				$output['TASK_FILTER_UNPAID']='<a href="'.JOMRES_SITEPAGE_URL_ADMIN.'&task=list_usersinvoices&status=unpaid">'.jr_gettext('_JRPORTAL_INVOICES_STATUS_UNPAID',_JRPORTAL_INVOICES_STATUS_UNPAID).'</a>';
				$output['TASK_FILTER_PAID']='<a href="'.JOMRES_SITEPAGE_URL_ADMIN.'&task=list_usersinvoices&status=paid">'.jr_gettext('_JRPORTAL_INVOICES_STATUS_PAID',_JRPORTAL_INVOICES_STATUS_PAID).'</a>';
				$output['TASK_FILTER_CANCELLED']='<a href="'.JOMRES_SITEPAGE_URL_ADMIN.'&task=list_usersinvoices&status=cancelled">'.jr_gettext('_JRPORTAL_INVOICES_STATUS_CANCELLED',_JRPORTAL_INVOICES_STATUS_CANCELLED).'</a>';
				$output['TASK_FILTER_PENDING']='<a href="'.JOMRES_SITEPAGE_URL_ADMIN.'&task=list_usersinvoices&status=pending">'.jr_gettext('_JRPORTAL_INVOICES_STATUS_PENDING',_JRPORTAL_INVOICES_STATUS_PENDING).'</a>';
				}
			else
				{
				$output['TASK_FILTER_ANY']=JOMRES_SITEPAGE_URL_ADMIN.'&task=list_usersinvoices';
				$output['_JOMRES_FRONT_ROOMSMOKING_EITHER']=jr_gettext('_JOMRES_FRONT_ROOMSMOKING_EITHER',_JOMRES_FRONT_ROOMSMOKING_EITHER);
				$output['TASK_FILTER_UNPAID']=JOMRES_SITEPAGE_URL_ADMIN.'&task=list_usersinvoices&status=unpaid';
				$output['_JRPORTAL_INVOICES_STATUS_UNPAID']=jr_gettext('_JRPORTAL_INVOICES_STATUS_UNPAID',_JRPORTAL_INVOICES_STATUS_UNPAID);
				$output['TASK_FILTER_PAID']=JOMRES_SITEPAGE_URL_ADMIN.'&task=list_usersinvoices&status=paid';
				$output['_JRPORTAL_INVOICES_STATUS_PAID']=jr_gettext('_JRPORTAL_INVOICES_STATUS_PAID',_JRPORTAL_INVOICES_STATUS_PAID);
				$output['TASK_FILTER_CANCELLED']=JOMRES_SITEPAGE_URL_ADMIN.'&task=list_usersinvoices&status=cancelled';
				...
				$output['TASK_FILTER_PENDING']=JOMRES_SITEPAGE_URL_ADMIN.'&task=list_usersinvoices&status=pending';
