...
Calendar.cellClick = function (el, ev) {
	...
	if (typeof el.navtype == "undefined") {
		...
		if (!other_month && !cal.currentDateEl)cal._toggleMultipleDate(new Date(date)); else
			newdate = !el.disabled;
...
Calendar.prototype.create = function (_par) {
	...
	if (this.showsTime) {
		...
		(function () {
			...
			cell.className = "time";
			cell.colSpan = 2;
			if (t12)AP = makeTimePart("ampm", pm ? "pm" : "am", ["am", "pm"]); else
				cell.innerHTML = "&nbsp;";
...
Calendar.prototype.showAtElement = function (el, opts) {
	...
	if (Calendar.is_khtml)setTimeout("Calendar.continuation_for_the_fucking_khtml_browser()", 10); else
