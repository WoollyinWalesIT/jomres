...
Calendar._TT["ABOUT"] =
	"DHTML Date/Time Selector\n" +
		...
		"Ultima vers�o visite: http://www.dynarch.com/projects/calendar/\n" +
		...
		"- Prima o botao do rato em qualquer um dos bot�es para selec��o r�pida.";
Calendar._TT["ABOUT_TIME"] = "\n\n" +
	"Selec��o de hora:\n" +
	"- Clique em qualquer parte da hora para incrementar\n" +
	"- ou Shift-click para decrementar\n" +
	"- ou clique e segure para selec��o r�pida.";
