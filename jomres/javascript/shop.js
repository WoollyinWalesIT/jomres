function addToCart(plugin_name,price) {
	...
	if (!already_exists) {
		addition = '<input type="hidden" id="'+plugin_name+'" type="text" value="'+price+'" /><div id="row'+plugin_name+'" class="ui-widget-content ui-corner-all"><label for="' + plugin_name + '">Plugin : '+plugin_name+' Price : &pound;'+price+'  <a  href="#" onClick=\'removeFromCart(\"' + plugin_name +'\"); return false;\'>Remove</a><br/></div>';
