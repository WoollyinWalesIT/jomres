...
jQuery.fn.bt = function(content, options) {
  ...
  return this.each(function(index) {
    ...
    this.btOn = function () {
      ...
      // ----------------------------------------------
      if (typeof opts.ajaxPath == 'string' && content == false) {
      ...
      if ((typeof opts.ajaxPath == 'string' && opts.ajaxCache == false) || ajaxTimeout) {
...
jQuery.bt.defaults = {
  ...
  ajaxLoading:     '<blink>...</blink>',  // yes folks, it's the blink tag!
