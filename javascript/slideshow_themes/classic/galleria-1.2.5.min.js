...
(function (e) {
	var l = this, n = l.document, H = e(n), t = e(l), A = !0, B = 3E4, C = !1, x = navigator.userAgent.toLowerCase(), I = l.location.hash.replace(/#\//, ""), m = function () {
		...
		if (a && a in this.trunk)b.call(v, a); else if (typeof a === "undefined")for (d in this.trunk)this.trunk.hasOwnProperty(d) && b.call(v, d)
		...
		return{array: function (a) {
			...
			var a = function (a) {
					...
					return!1
				}((n.body || n.documentElement).style), b = {MozTransition: "transitionend", OTransition: "oTransitionEnd", WebkitTransition: "webkitTransitionEnd", transition: "transitionend"}[a], d = {_default: [0.25, 0.1, 0.25, 1], galleria: [0.645, 0.045, 0.355, 1],
					galleriaIn: [0.55, 0.085, 0.68, 0.53], galleriaOut: [0.25, 0.46, 0.45, 0.94], ease: [0.25, 0, 0.25, 1], linear: [0.25, 0.25, 0.75, 0.75], "ease-in": [0.42, 0, 1, 1], "ease-out": [0, 0, 0.58, 1], "ease-in-out": [0.42, 0, 0.58, 1]}, c = function (a, b, c) {
			...
			return function (o, q, r) {
				r = e.extend({duration: 400, complete: function () {
				}, stop: !1}, r);
				o = e(o);
			...
			return a instanceof
				e ? {$: a, dom: a[0]} : {$: e(a), dom: a}
		}, hide: function (a, b, d) {
			var d = d || function () {
			}, c = f.elem(a), e = c.$, a = c.dom;
			e.data("opacity") || e.data("opacity", e.css("opacity"));
			c = {opacity: 0};
			b ? f.animate(a, c, {duration: b, complete: m < 9 && a ? function () {
				f.removeAlpha(a);
				a.style.visibility = "hidden";
				d.call(a)
			} : d, stop: !0}) : m < 9 && a ? (f.removeAlpha(a), a.style.visibility = "hidden") : e.css(c)
		}, show: function (a, b, d) {
			var d = d || function () {
			}, c = f.elem(a), e = c.$, a = c.dom, j = {opacity: parseFloat(e.data("opacity")) || 1};
			if (b) {
				if (m < 9)e.css("opacity", 0),
					a.style.visibility = "visible";
				f.animate(a, j, {duration: b, complete: m < 9 && a ? function () {
			...
			var a = e.extend({until: function () {
				return!1
			}, success: function () {
			}, error: function () {
				Galleria.raise("Could not complete wait function.")
			},
				timeout: 3E3}, a), b = f.timestamp(), d, c, i = function () {
				c = f.timestamp();
				d = c - b;
			...
			var d = !1, c = e("<script>").attr({src: a, async: !0}).get(0);
			...
			loadCSS: function (a, b, d) {
				...
				A && (a += "?" + f.timestamp());
				e("#" + b).length ? (e("#" + b).attr("href", a), j--, i = !0) : (c = e("<link>").attr({rel: "stylesheet", href: a, id: b}).get(0), l.setTimeout(function () {
					...
					} : /file:\/\//i.test(a) ? i = !0 : e.ajax({url: a, success: function () {
						i = !0
					}, error: function (a) {
						a.isRejected() && Galleria.WEBKIT && (i = !0)
					}})
				}, 10));
				typeof d === "function" && f.wait({until: function () {
		...
		var a = function (a, d, c, i) {
			var j = this.getOptions("easing"), h = this.getStageWidth(), g = {left: h * (a.rewind ? -1 : 1)}, k = {left: 0};
			if (c)g.opacity = 0, k.opacity = 1;
			e(a.next).css(g);
			f.animate(a.next, k, {duration: a.speed, complete: function (a) {
				return function () {
					d();
					a.css({left: 0})
				}
			}(e(a.next).add(a.prev)), queue: !1, easing: j});
			...
			if (a.prev) {
				...
				e(a.prev).css(g);
				f.animate(a.prev, k, {duration: a.speed,
					queue: !1, easing: j, complete: function () {
						e(this).css("opacity", 0)
					}})
			}
		};
		return{fade: function (a, d) {
			...
			a.prev ? f.animate(a.prev, {opacity: 0}, {duration: a.speed / 2, complete: function () {
				f.animate(a.next, {opacity: 1}, {duration: a.speed, complete: d})
			}}) : f.animate(a.next, {opacity: 1}, {duration: a.speed,
				complete: d})
		}, pulse: function (a, d) {
	...
	Galleria = function () {
		...
		var b = this._keyboard = {keys: {UP: 38, DOWN: 40, LEFT: 37, RIGHT: 39, RETURN: 13, ESCAPE: 27, BACKSPACE: 8, SPACE: 32}, map: {}, bound: !1, press: function (c) {
			...
			H.unbind("keydown",
				b.press)
		}}, d = this._controls = {0: void 0, 1: void 0, active: 0, swap: function () {
			d.active = d.active ? 0 : 1
		}, getActive: function () {
			return d[d.active]
		}, getNext: function () {
			return d[1 - d.active]
		}}, c = this._carousel = {next: a.$("thumb-nav-right"), prev: a.$("thumb-nav-left"), width: 0, current: 0, max: 0, hooks: [], update: function () {
			var b = 0, d = 0, f = [0];
			...
			if (a === 0 || a === c.hooks.length - 2)c.set(a); else {
		...
		}}, i = this._tooltip = {initialized: !1, open: !1, init: function () {
			i.initialized = !0;
			...
			i.show(b)
		}}, j = this._fullscreen = {scrolled: 0, crop: a._options.imageCrop, active: !1, keymap: a._keyboard.map,
			enter: function (b) {
				j.active = !0;
				...
				var c = {height: "100%", overflow: "hidden", margin: 0, padding: 0}, d = a.getData();
				...
				if (d && d.big && d.image !== d.big) {
					...
					c.load(d.big, function (b) {
						a._scaleImage(b, {complete: function (b) {
			...
			}}, h = this._idle = {trunk: [], bound: !1, add: function (a, b) {
			if (a) {
				h.bound || h.addEvent();
				var a = e(a), c = {}, d;
			...
			var c = b.data("idle");
			if (!c.busy && !c.complete)c.busy = !0, a.trigger(Galleria.IDLE_EXIT), f.clearTimer("idle"), f.animate(b, c.from, {duration: a._options.idleSpeed / 2, complete: function () {
		...
		{width: 0, height: 0, initialized: !1, active: null, image: null, elems: {}, keymap: !1, init: function () {
			...
			if (!g.initialized) {
				g.initialized = !0;
				var b = {}, c = a._options, d = "", c = {overlay: "position:fixed;display:none;opacity:" + c.overlayOpacity + ";filter:alpha(opacity=" + c.overlayOpacity * 100 + ");top:0;left:0;width:100%;height:100%;background:" + c.overlayBackground + ";z-index:99990", box: "position:fixed;display:none;width:400px;height:400px;top:50%;left:50%;margin-top:-200px;margin-left:-200px;z-index:99991",
					...
					title: "float:left", counter: "float:right;margin-left:8px;"}, i = {};
				...
				e.each({box: "shadow content close prevholder nextholder",
					info: "title counter", content: "info image", prevholder: "prev", nextholder: "next"}, function (a, b) {
					var c = [];
			...
			var c = Math.min(t.width() - 40, g.width), d = Math.min(t.height() - 60, g.height), d = Math.min(c / g.width, d / g.height), c = Math.round(g.width * d) + 40, d = Math.round(g.height * d) + 60, c = {width: c, height: d, "margin-top": Math.ceil(d /
				2) * -1, "margin-left": Math.ceil(c / 2) * -1};
			b ? e(g.elems.box).css(c) : e(g.elems.box).animate(c, {duration: a._options.lightboxTransitionSpeed, easing: a._options.easing, complete: function () {
	...
	Galleria.prototype = {constructor: Galleria, init: function (a, b) {
		b = K(b);
		...
		y.push(this);
		if (this._target) {
			this._options = {autoplay: !1, carousel: !0, carouselFollow: !0, carouselSpeed: 400, carouselSteps: "auto", clicknext: !1, dataConfig: function () {
				return{}
			}, dataSelector: "img", dataSource: this._target, debug: void 0, dummy: void 0, easing: "galleria", extend: function () {
			}, fullscreenCrop: void 0, fullscreenDoubleTap: !0, fullscreenTransition: void 0, height: "auto", idleMode: !0, idleTime: 3E3, idleSpeed: 200, imageCrop: !1, imageMargin: 0, imagePan: !1, imagePanSmoothness: 12, imagePosition: "50%",
				...
				transitionSpeed: 400, useCanvas: !1, width: "auto"};
		...
		this.bind(Galleria.DATA, function () {
			...
			var b = this.$("container"), d = {width: 0, height: 0}, j = function () {
				return a.$("stage").height()
			};
			f.wait({until: function () {
		...
		e.each(Array(2), function (b) {
			...
			e(d.container).css({position: "absolute", top: 0, left: 0}).prepend(a._layers[b] = e(f.create("galleria-layer")).css({position: "absolute", top: 0, left: 0, right: 0, bottom: 0, zIndex: 2})[0]);
		...
		this._options.swipe && (function (b) {
			var d = [0, 0], e = [0, 0], h = !1, g = 0, k, p = {start: "touchstart", move: "touchmove", stop: "touchend"}, l = function (a) {
		...
		var a, b, d, c, i, j = this, h = this._options, g = function () {
			...
			return function () {
				e(c).append(a);
				j.trigger({type: Galleria.THUMBNAIL,
					thumbTarget: a, index: b})
			}
		}, m = function (a) {
			...
			a.scale({width: a.data.width, height: a.data.height, crop: h.thumbCrop, margin: h.thumbMargin, canvas: h.useCanvas, complete: function (a) {
				var b = ["left", "top"], c, d;
		...
		for (a = 0; this._data[a]; a++)c = this._data[a], h.thumbnails === !0 ? (d = new Galleria.Picture(a), b = c.thumb || c.image, this.$("thumbnails").append(d.container), i = e(d.container), d.data = {width: f.parseValue(p("width")), height: f.parseValue(p("height")),
		...
		f.wait({until: function () {
			...
			a._firstrun ? typeof a._options.show === "number" && a.show(a._options.show) : (a._firstrun = !0, a._options.clicknext && !Galleria.TOUCH && (e.each(a._data, function (a, d) {
				delete d.link
			}), a.$("stage").css({cursor: "pointer"}).bind("click", function () {
				a._options.pauseOnInteraction && a.pause();
				a.next()
		...
		e(a).find(b).each(function (a, b) {
			...
			if (g)f.big = g;
			c._data.push(e.extend({title: b.attr("title") ||
				"", thumb: b.attr("src"), image: b.attr("src"), big: b.attr("src"), description: b.attr("alt") || "", link: b.attr("longdesc"), original: b.get(0)}, f, d(b)))
		});
		...
		push: function () {
			...
			if (this._options.imageCrop !== !1) {
				...
				m === 8 && (a.parent().scrollTop(g * -1).scrollLeft(h * -1), a.css({top: 0, left: 0}));
			...
			for (b in a)if (a.hasOwnProperty(b))if (a[b].constructor ===
				Array)for (d = 0; a[b][d]; d++)this.appendChild(b, a[b][d]); else this.appendChild(b, a[b]);
			return this
		}, _scaleImage: function (a, b) {
			var a = a || this._controls.getActive(), d, c = function (a) {
				e(a.container).children(":first").css({top: Math.max(0, f.parseValue(a.image.style.top)), left: Math.max(0, f.parseValue(a.image.style.left)), width: f.parseValue(a.image.width), height: f.parseValue(a.image.height)})
			}, b = e.extend({width: this._stageWidth, height: this._stageHeight, crop: this._options.imageCrop, max: this._options.maxScaleRatio,
				min: this._options.minScaleRatio, margin: this._options.imageMargin, position: this._options.imagePosition}, b);
			this._options.layerFollow && this._options.imageCrop !== !0 ? typeof b.complete == "function" ? (d = b.complete, b.complete = function () {
				d.call(a, a);
				c(a)
			}) : b.complete = c : e(a.container).children(":first").css({top: 0, left: 0});
			a.scale(b);
			return this
			...
			if (!(a === !1 || !this._options.queue && this._queue.stalled))if (a = Math.max(0, Math.min(parseInt(a, 10), this.getDataLength() - 1)), b = typeof b !==
				"undefined" ? !!b : a < this.getIndex(), !d && Galleria.History)Galleria.History.set(a.toString()); else return this._active = a, Array.prototype.push.call(this._queue, {index: a, rewind: b}), this._queue.stalled || this._show(), this
		}, _show: function () {
			...
			if (d) {
				var c = this.isFullscreen() && "big"in d ? d.big : d.image, i = this._controls.getActive(), j = this._controls.getNext(), h = j.isCached(c), g = this._thumbnails[b.index], k = function (b, c, d, g, h) {
					return function () {
						...
						(b.link || a._options.lightbox) && e(c.image).css({cursor: "pointer"}).bind("mouseup", function () {
				...
				j.load(c, function (c) {
					...
					a._scaleImage(c, {complete: function (c) {
						...
						a.trigger({type: Galleria.LOADFINISH, cached: h, index: b.index, rewind: b.rewind,
							imageTarget: c.image, thumbTarget: a._thumbnails[b.index].image});
			...
			if (this._playing) {
				...
				var e = function () {
					b = f.timestamp() - d;
					b >= a._playtime && a._playing ? (f.clearTimer(c), a.next()) : a._playing && (a.trigger({type: Galleria.PROGRESS, percent: Math.ceil(b / a._playtime * 100), seconds: Math.floor(b / 1E3), milliseconds: b}), f.addTimer(c, e, 20))
				};
				f.addTimer(c, e, 20)
			}
	...
	e.extend(Galleria,
		{IE9: m === 9, IE8: m === 8, IE7: m === 7, IE6: m === 6, IE: m, WEBKIT: /webkit/.test(x), SAFARI: /safari/.test(x), CHROME: /chrome/.test(x), QUIRK: m && n.compatMode && n.compatMode === "BackCompat", MAC: /mac/.test(navigator.platform.toLowerCase()), OPERA: !!l.opera, IPHONE: /iphone/.test(x), IPAD: /ipad/.test(x), ANDROID: /android/.test(x), TOUCH: "ontouchstart"in n});
	...
	Galleria.get = function (a) {
		if (y[a])return y[a]; else if (typeof a !== "number")return y; else Galleria.raise("Gallery index " + a + " not found")
	};
	...
	Galleria.log =
		function () {
			return"console"in l && "log"in l.console ? l.console.log : function () {
	...
	Galleria.Picture.prototype = {cache: {}, show: function () {
		...
		scale: function (a) {
			a = e.extend({width: 0, height: 0, min: void 0, max: void 0, margin: 0, complete: function () {
			}, position: "center", crop: !1, canvas: !1}, a);
			...
			f.wait({until: function () {
				...
				var h = (b - a.margin * 2) / c.original.width, g = (d - a.margin * 2) / c.original.height, i = {"true": Math.max(h, g), width: h, height: g, "false": Math.min(h,
					g)}[a.crop.toString()], h = "";
				...
				e(c.image).css({position: "absolute", top: h(l.top,
	...
	e.extend(e.easing, {galleria: function (a, b, d, c, e) {
