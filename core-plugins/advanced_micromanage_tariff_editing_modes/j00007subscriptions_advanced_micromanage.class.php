	...
	function __construct( $componentArgs )
		...
		$subscribable_features [ $feature_name ] = array (
			"minicomponents" => array (
				"00007subscriptions_advanced_micromanage",
				"00501xtariffsenhanced",
				"06002delete_tariff_micromanage",
				"06002edit_tariff_micromanage",
				"06002list_tariffs_micromanage",
				"06002save_tariff_micromanage",
				"06002delete_tariff_advanced",
				"06002edit_tariff_advanced",
				"06002list_tariffs_advanced",
				"06002save_tariff_advanced"
				),
			"name" => $feature_name,
