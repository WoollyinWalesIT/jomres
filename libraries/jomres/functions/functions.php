...
if (!function_exists('jomres_parse_modules')) {
...
/*
	 ...
	 *
	 */
if (!function_exists('run_jomres_shortcode')) {
 ...
 *
 */
if (!function_exists('jomres_badge')) {
 ...
 */
if (!function_exists('jomres_login_user')) {
 ...
 */
if (!function_exists('jomres_async_request')) {
 ...
 *
 */
if (!function_exists('jomres_implode')) {
 ...
 *
 */
if (!function_exists('jomres_hide_email')) {
 ...
 */
if (!function_exists('jomres_get_client_ip')) {
 ...
 */
if (!function_exists('jomres_bootstrap_version')) {
 ...
 */
if (!function_exists('jomres_formatBytes')) {
 ...
 */
if (!function_exists('jomres_make_qr_code')) {
 ...
 */
if (!function_exists('jomres_makeTooltip')) {
...
if (!function_exists('add_gmaps_source')) {
    function add_gmaps_source()
    {
        ...
        if (!defined('GMAPS_SOURCE_ADDED') && !AJAXCALL) {
            ...
            jomres_cmsspecific_addheaddata('javascript', 'https://maps.googleapis.com/maps/api/js?v=beta&libraries=marker&language='.$shortcode.$apikey, '&v=weekly&channel=2&callback=Function.prototype', $includeVersion = false, $async = true);
        }
    }
}
 ...
 */
if (!function_exists('jomres_nicetime')) {
 ...
 */
if (!function_exists('jomres_validate_gateway_plugin')) {
 ...
 *
 */
if (!function_exists('jomres_generate_tab_anchor')) {
 ...
 */
if (!function_exists('jomresValidateUrl')) {
 ...
 *  Audit log.
 */
if (!function_exists('jomres_audit')) {
 ...
 */
if (!function_exists('jomresRedirect')) {
 ...
 */
if (!function_exists('publishProperty')) {
 ...
 */
if (!function_exists('jomresGetDomain')) {
 ...
 */
if (!function_exists('generateJomresRandomString')) {
 ...
 */
if (!function_exists('get_jomres_current_version')) {
 ...
 */
if (!function_exists('check_jomres_version')) {
