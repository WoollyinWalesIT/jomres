...
function generateDateInput($fieldName, $dateValue = '', $myID = false, $siteConfig = false, $historic = false)
{
	...
	<div class="input-group">
		<input type="text" readonly="readonly" style="cursor:pointer; background-color: #FFFFFF; position: relative; z-index: 100000;" ' .$size.' name="'.$fieldName.'" id="'.$uniqueID.'" value="'.$dateValue.'" placeholder="'.$placeholder.'" class="'.$input_class.' form-control" />'.$bs3_icon.'
	</div>';
