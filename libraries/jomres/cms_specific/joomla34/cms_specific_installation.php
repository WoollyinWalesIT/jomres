...
if ( $folderChecksPassed )
	...
	if ( !copy( _JOMRES_DETECTED_CMS_SPECIFIC_FILES . "installfiles" . JRDS . "en-GB.com_jomres.sys.ini", JOMRESCONFIG_ABSOLUTE_PATH . JRDS . "administrator" . JRDS . "language" . JRDS . "en-GB" . JRDS . "en-GB.com_jomres.sys.ini" ) ) echo "<h1>Error, unable to copy " . _JOMRES_DETECTED_CMS_SPECIFIC_FILES . "installfiles" . JRDS . "en-GB.com_jomres.sys.ini to " . JOMRESCONFIG_ABSOLUTE_PATH . JRDS . "administrator" . JRDS . "language" . JRDS . "en-GB" . JRDS . "en-GB.com_jomres.sys.ini automatically, please do this manually through FTP</h1><br/>";
	...
	if ( !copy( _JOMRES_DETECTED_CMS_SPECIFIC_FILES . "installfiles" . JRDS . "jomres_view.xml", JOMRESCONFIG_ABSOLUTE_PATH . JRDS . "components" . JRDS . "com_jomres" . JRDS . "views" . JRDS . "default" . JRDS . "tmpl" . JRDS . "default.xml" ) ) echo "<h1>Error, unable to copy " . _JOMRES_DETECTED_CMS_SPECIFIC_FILES . "installfiles" . JRDS . "jomres_view.xml to " . JOMRESCONFIG_ABSOLUTE_PATH . JRDS . "components" . JRDS . "com_jomres" . JRDS . "views" . JRDS . "default" . JRDS . "tmpl" . JRDS . "jomres.xml
			automatically, please do this manually through FTP</h1><br/>";
