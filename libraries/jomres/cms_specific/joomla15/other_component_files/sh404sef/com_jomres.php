...
if ( !empty( $limitstart ) ) shRemoveFromGETVarsList( 'limitstart' );
if ( !empty( $popup ) ) shRemoveFromGETVarsList( 'popup' );
...
if ( $jrConfig[ 'sef_task_alias_dobooking' ] == "" ) $jrConfig[ 'sef_task_alias_dobooking' ] = "book";
if ( $jrConfig[ 'sef_task_alias_search' ] == "" ) $jrConfig[ 'sef_task_alias_search' ] = "/";
