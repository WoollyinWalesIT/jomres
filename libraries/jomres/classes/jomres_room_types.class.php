...
class jomres_room_types
	...
	public static function getInstance()
		...
		if ( !self::$configInstance )
			{
			self::$configInstance = new jomres_room_types();
			}
	...
	function get_room_type( $room_classes_uid = 0 )
		{
	...
	function update_roomtype_propertytype_xref_table( $roomtype_id = 0, $ptype_xref = array() )
		{
		if ( $roomtype_id == 0 )
			{
	...
	function delete_room_type( $ids = array() )
		{
		$success = true;
