...
class jrportal_user_functions
{
    ...
    public function getJoomlaUserDetailsForJoomlaId($id)
    {
        $userArray = array();
    ...
    public function getManagerIdForJosId($id)
    {
    ...
    public function getManagerIdsForProperty($property_uid, $notIncludingSuperManagers = false)
    {
        $usersArray = array();
    ...
    public function makeManagersDropdown($id = null)
    {
