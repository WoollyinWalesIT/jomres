...
class jomresHTML
	...
	static function selectList( $arr, $name, $attribs, $key, $text, $default = null, $use_bootstrap_radios = true )
		{
		$not_for_these_dropdowns = array ( "jomreslang", "jomres_editing_mode", "user_timezone", "existingCustomers", "management_process", "all_guests", "force[]", "guestnumber", "country", "region", "town", "include_rooms" );
