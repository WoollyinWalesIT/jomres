...
// ################################################################
	...
	class jomSearch
	{
		...
		public function jomSearch_sleeps_adults()
		{
			...
			if (!empty($filter) && $property_ors) {
				$result_array = array();
				$query = "SELECT property_uid ,value FROM #__jomres_settings WHERE akey = 'accommodates_adults' AND value ".$comparison." ".(int)$filter." ".$property_ors;
		...
		public function jomSearch_sleeps_children()
		{
			...
			if (!empty($filter) && $property_ors) {
				...
				$result_array = array();
				$query = "SELECT property_uid ,value FROM #__jomres_settings WHERE akey = 'accommodates_children' AND value ".$comparison." ".(int)$filter." ".$property_ors;
				$result = doSelectSql($query);
