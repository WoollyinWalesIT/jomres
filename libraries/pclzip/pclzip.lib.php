	...
	function privExtractFile( &$p_entry, $p_path, $p_remove_path, $p_remove_all_path, &$p_options )
		...
		if ( $p_entry[ 'status' ] == 'ok' )
			...
			// ----- Check the directory availability and create it if necessary
				...
				{
				if ( ( ( $p_entry[ 'external' ] & 0x00000010 ) == 0x00000010 ) || ( substr( $p_entry[ 'filename' ], -1 ) == '/' ) ) $v_dir_to_check = $p_entry[ 'filename' ];
				else if ( !strstr( $p_entry[ 'filename' ], "/" ) ) $v_dir_to_check = "";
				else
...
//      if ($p_entry['compressed_size'] == $p_entry['size'])
	...
	function privReadCentralFileHeader( &$p_header )
		...
		if ( $p_header[ 'filename_len' ] != 0 ) $p_header[ 'filename' ] = fread( $this->zip_fd, $p_header[ 'filename_len' ] );
		else
		$p_header[ 'filename' ] = '';
		...
		if ( $p_header[ 'extra_len' ] != 0 ) $p_header[ 'extra' ] = fread( $this->zip_fd, $p_header[ 'extra_len' ] );
		else
		$p_header[ 'extra' ] = '';
		...
		if ( $p_header[ 'comment_len' ] != 0 ) $p_header[ 'comment' ] = fread( $this->zip_fd, $p_header[ 'comment_len' ] );
		else
		$p_header[ 'comment' ] = '';
