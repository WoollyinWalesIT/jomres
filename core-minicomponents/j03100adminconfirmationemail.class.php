...
class j03100adminconfirmationemail
	...
	function j03100adminconfirmationemail( $componentArgs )
		...
		$result = false;
		if ( !jomresMailer( $useremail, $propertyName, $adminemail, $subject, $text, $mode = 1 ) ) error_logging( 'Failure in sending confirmation email to hotel. Target address: ' . $hotelemail . ' Subject' . $subject );
		}
