...
class j16000save_custom_field
	...
	function j16000save_custom_field()
		...
		if ( array_key_exists( $uid, $allCustomFields ) ) $query = "UPDATE #__jomres_custom_fields SET fieldname='" . $fieldname . "',default_value='" . $default_value . "',`description`='" . $description . "',required=" . $required . " WHERE uid = " . $uid;
		else
