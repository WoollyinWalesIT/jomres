	...
	function j16000listTemplates()
		...
		if ( $d )
			...
			if ( count( $docs ) > 0 )
				...
				if ( _JOMRES_DETECTED_CMS == "joomla30" || _JOMRES_DETECTED_CMS == "joomla31" || _JOMRES_DETECTED_CMS == "joomla32" || _JOMRES_DETECTED_CMS == "joomla33") $css_file = 'jomrescss_bootstrap.css';
				else
					{
