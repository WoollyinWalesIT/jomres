...
//			$output['IMAGE']=$jomresConfig_live_site.$fileLocation;
		...
		$output['LINKTOPROPERTY']="<a href=\"".$jomresConfig_live_site. "/index.php?option=com_jomres&task=viewproperty&Itemid=$Itemid&property_uid=".$property_uid."\">".jr_gettext('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_WEBSITE',_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_WEBSITE,FALSE,FALSE)."</a>";
		if ($mrConfig['singleRoomProperty'] != "1")
			{
