	...
	function j16000new_manager_api_key()
		...
		if ($userid > 0)
			...
			if (doInsertSql($query,'') )
				jomresRedirect( JOMRES_SITEPAGE_URL_ADMIN."&task=editProfile&id=".(int)$userid,jr_gettext('_JOMRES_COM_MR_ASSIGNUSER_USERMODIFIEDMESAGE',_JOMRES_COM_MR_ASSIGNUSER_USERMODIFIEDMESAGE) );
			else
