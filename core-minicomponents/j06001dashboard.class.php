...
class j06001dashboard
{
    public function __construct($componentArgs)
    {
        ...
        jomres_cmsspecific_addheaddata('javascript', JOMRES_ROOT_DIRECTORY.'/node_modules/moment/min/', 'moment.min.js');
        jomres_cmsspecific_addheaddata('javascript', JOMRES_ROOT_DIRECTORY.'/node_modules/fullcalendar/dist/', 'fullcalendar.min.js');
        jomres_cmsspecific_addheaddata('javascript', JOMRES_ROOT_DIRECTORY.'/node_modules/fullcalendar/dist/', 'lang-all.js');
        jomres_cmsspecific_addheaddata('javascript', JOMRES_ROOT_DIRECTORY.'/node_modules/fullcalendar-scheduler/dist/', 'scheduler.min.js');
        jomres_cmsspecific_addheaddata('javascript', JOMRES_ROOT_DIRECTORY.'/node_modules/blockui-npm/', 'jquery.blockUI.js');
        jomres_cmsspecific_addheaddata('css', JOMRES_ROOT_DIRECTORY.'/node_modules/fullcalendar/dist/', 'fullcalendar.min.css');
        jomres_cmsspecific_addheaddata('css', JOMRES_ROOT_DIRECTORY.'/node_modules/fullcalendar-scheduler/dist/', 'scheduler.min.css');
        //jomres_cmsspecific_addheaddata("css",JOMRES_ROOT_DIRECTORY.'/node_modules/fullcalendar/','fullcalendar.print.css');
