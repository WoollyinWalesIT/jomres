    ...
    function j06002reportbug( $componentArgs )
        ...
        if ( $thisJRUser->superPropertyManager )
            ...
            if ( _JOMRES_DETECTED_CMS == "joomla15" || _JOMRES_DETECTED_CMS == "joomla16" || _JOMRES_DETECTED_CMS == "joomla16" )
                ...
                if ( get_showtime( 'sef' ) == "1" ) $joomla_sef = 'Joomla SEF functionality is switched on';
                else
                $joomla_sef = 'Joomla SEF functionality is switched off';


                if ( is_dir( JOMRESCONFIG_ABSOLUTE_PATH . JRDS . 'components' . JRDS . 'com_sh404sef' ) ) $sh404sef = 'The sh404sef component directory exists. Is this component enabled? Yes/No';

                if ( is_dir( JOMRESCONFIG_ABSOLUTE_PATH . JRDS . 'components' . JRDS . 'com_sef' ) ) $sef = 'The sef component directory exists. Is this component enabled? Yes/No';
                }
            ...
            $output[ '_JOMRES_DEBUGGING_SUBJECT' ]   = jr_gettext( '_JOMRES_DEBUGGING_SUBJECT', _JOMRES_DEBUGGING_SUBJECT, false );
            $output[ '_JOMRES_DEBUGGING_FULLNAME' ]  = jr_gettext( '_JOMRES_DEBUGGING_FULLNAME', _JOMRES_DEBUGGING_FULLNAME, false );
            $output[ '_JOMRES_DEBUGGING_YOUREMAIL' ] = jr_gettext( '_JOMRES_DEBUGGING_YOUREMAIL', _JOMRES_DEBUGGING_YOUREMAIL, false );
            $output[ '_JOMRES_DEBUGGING_ISSUE' ]     = jr_gettext( '_JOMRES_DEBUGGING_ISSUE', _JOMRES_DEBUGGING_ISSUE, false );
