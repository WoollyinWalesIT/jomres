...
class j06002reportbug {
	...
	function j06002reportbug($componentArgs)
		...
		if ($thisJRUser->superPropertyManager)
			...
			$output['_JOMRES_DEBUGGING_SUBJECT']=jr_gettext('_JOMRES_DEBUGGING_SUBJECT',_JOMRES_DEBUGGING_SUBJECT);
			$output['_JOMRES_DEBUGGING_FULLNAME']=jr_gettext('_JOMRES_DEBUGGING_FULLNAME',_JOMRES_DEBUGGING_FULLNAME);
			$output['_JOMRES_DEBUGGING_YOUREMAIL']=jr_gettext('_JOMRES_DEBUGGING_YOUREMAIL',_JOMRES_DEBUGGING_YOUREMAIL);
			$output['_JOMRES_DEBUGGING_ISSUE']=jr_gettext('_JOMRES_DEBUGGING_ISSUE',_JOMRES_DEBUGGING_ISSUE);
