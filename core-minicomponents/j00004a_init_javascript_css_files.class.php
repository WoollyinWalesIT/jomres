...
class j00004a_init_javascript_css_files
{
    public function __construct($componentArgs)
    {
        ...
        $themePath = JOMRES_ROOT_DIRECTORY.'/node_modules/jquery-ui-themes/themes/'.$jrConfig[ 'jquery_ui_theme' ].'/';
        ...
        if (jomres_cmsspecific_areweinadminarea() || ($jrConfig[ 'load_jquery_ui' ] == '1' && !$management_view)) {
            $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/jquery-ui-dist/', 'jquery-ui.min.js');
        }
        ...
        $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/jquery-ui/ui/i18n/', $datepicker_localisation_file);

        $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/jquery-validation/dist/', 'jquery.validate.min.js');

        $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/jquery-star-rating-plugin/', 'jquery.rating.pack.js');

        $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/jquery.tipsy/src/', 'jquery.tipsy.js');
        ...
        if ($jrConfig[ 'load_font_awesome' ] == '1' || jomres_cmsspecific_areweinadminarea()) {
            $css_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/font-awesome/css/', 'font-awesome.min.css');
        }

        $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/jquery-chained/', 'jquery.chained.js');
        ...
        if (!using_bootstrap()) {
            if ($thisJRUser->userIsManager || jomres_cmsspecific_areweinadminarea()) {
                $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/x-editable/dist/jqueryui-editable/js/', 'jqueryui-editable.min.js');
                $css_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/x-editable/dist/jqueryui-editable/css/', 'jqueryui-editable.css');
            }
            ...
            if ($thisJRUser->userIsManager || jomres_cmsspecific_areweinadminarea()) {
                ...
                $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/x-editable/dist/bootstrap'.$tail.'-editable/js/', 'bootstrap-editable.min.js');
                $css_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/x-editable/dist/bootstrap'.$tail.'-editable/css/', 'bootstrap-editable.css');
            }
        }

        if (get_showtime('task') == 'media_centre' || jomresGetParam($_REQUEST, 'task', '') == 'media_centre') {
			$css_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/blueimp-file-upload/css/',  'jquery.fileupload.css');
            $css_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/blueimp-file-upload/css/',  'jquery.fileupload-ui.css');
            $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/blueimp-load-image/js/', 'load-image.all.min.js');
            $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/blueimp-canvas-to-blob/js/', 'canvas-to-blob.js');
            $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/blueimp-file-upload/js/', 'jquery.iframe-transport.js');
            $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/blueimp-file-upload/js/', 'jquery.fileupload.js');
            $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/blueimp-file-upload/js/', 'jquery.fileupload-process.js');
            $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/blueimp-file-upload/js/', 'jquery.fileupload-image.js');
            $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/blueimp-file-upload/js/', 'jquery.fileupload-validate.js');
			$javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/blueimp-file-upload/js/', 'jquery.fileupload-ui.js');
        }

        //galleria js and css files TODO: find a better solution
        $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/galleria/dist/', 'galleria.min.js');
        $javascript_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/galleria/dist/themes/classic/', 'galleria.classic.min.js');
        $css_files[] = array(JOMRES_ROOT_DIRECTORY.'/node_modules/galleria/dist/themes/classic/', 'galleria.classic.min.css');
