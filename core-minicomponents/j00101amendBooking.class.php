...
class j00101amendBooking
	...
	function __construct()
		...
		if ( $amend )
			...
			if ( isset( $tmpBookingHandler->tmpbooking[ "override_contract_deposit" ] ) ) $tmpBookingHandler->updateBookingField( "override_contract_deposit", "" );

			if ( isset( $tmpBookingHandler->tmpbooking[ "override_contract_total" ] ) ) $tmpBookingHandler->updateBookingField( "override_contract_total", "" );
			...
			if ( isset( $tmpBookingHandler->tmpbooking[ "amend_contract" ] ) ) $tmpBookingHandler->updateBookingField( "amend_contract", false );
