...
class j00011manager_option_14_mycommission_invoices
	...
	function j00011manager_option_14_mycommission_invoices( $componentArgs )
		...
		if ( $jrConfig[ 'use_commission' ] == "1" ) $this->cpanelButton = jomres_mainmenu_option( JOMRES_SITEPAGE_URL . "&task=my_commission_invoices", 'subscriptions.png', jr_gettext( '_JRPORTAL_INVOICES_COMMISSION_TITLE', _JRPORTAL_INVOICES_COMMISSION_TITLE, false, false ), null, jr_gettext( "_JOMRES_CUSTOMCODE_JOMRESMAINMENU_RECEPTION_ACCOUNTING", _JOMRES_CUSTOMCODE_JOMRESMAINMENU_RECEPTION_ACCOUNTING, false, false ) );
		}
