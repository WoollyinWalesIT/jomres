...
class j00011manager_option_08_publish {
	...
	function j00011manager_option_08_publish($componentArgs)
		...
		$this->cpanelButton=jomres_mainmenu_option(jomresURL(JOMRES_SITEPAGE_URL.'&no_html=1&task=publishProperty'.jomresURLToken()), $image.".png", $pubmsg,null,jr_gettext( "_JOMRES_CUSTOMCODE_JOMRESMAINMENU_RECEPTION_SETTINGS" , _JOMRES_CUSTOMCODE_JOMRESMAINMENU_RECEPTION_SETTINGS,false,false) );
		}
