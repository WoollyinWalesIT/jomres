...
jr_define('_JOMRES_FAQ_ADMIN_CATEGORY_INTRODUCTION', 'Einführung');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_WHATISJOMRES', 'Was ist Jomres?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_WHATISJOMRES', "Jomres ist ein Hotel- und Villenbuchungssystem, das mit den Content Management Systemen Joomla und Wordpress arbeitet. Es ist ein vollständiges Buchungssystem, denken Sie an 'booking.com' oder 'airbnb' ohne die Kosten. Es ist ein komplettes Toolkit so können Sie einen einzigartigen Online-Buchungsservice für so viele Unterkünfte aufbauen, wie Sie möchten.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_USERSADD', 'Können sich Benutzer auf meiner Jomres-Site registrieren und ihre eigenen Eigenschaften hinzufügen?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_USERSADD', 'Ja. Standardmäßig erlaubt Jomres registrierten Benutzern, ihre eigenen Eigenschaften zu Ihrer Site hinzuzufügen. Sie können dies bei Bedarf in der Registerkarte Site-Konfiguration > Sonstiges deaktivieren.');
jr_define('_JOMRES_FAQ_ADMIN_CATEGORY_PROPERTIES', 'Eigenschaften');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_ADDPROPERTIES', 'Wie füge ich eine neue Eigenschaft hinzu?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_ADDPROPERTIES', "Wenn Jomres installiert ist, wird der Administratorbenutzer als Super Property Manager erstellt. Melden Sie sich am Frontend Ihres CMS (den öffentlichen Seiten) als Administratorbenutzer an und von dort können Sie neue Eigenschaften hinzufügen. <br/ >Sie können auf der Seite Property Managers neue Manager erstellen, wenn Sie einen neuen Manager hinzufügen möchten, aber standardmäßig (Sie können dies deaktivieren) wird jeder registrierte Benutzer, der eine Immobilie erstellt, automatisch als Property Manager für die von ihnen erstellten Immobilien erstellt Aus Sicherheitsgründen können sie die Eigenschaften anderer Verwalter nicht verwalten. Dies kann geändert werden, indem dieser Benutzer auf der Seite \"Verwalter\" zu einem Super-Property-Manager erhoben wird.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_IMPORTPROPERTIES', 'Kann ich Eigenschaften von einem anderen System importieren?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_IMPORTPROPERTIES', "Es gibt eine Reihe von Möglichkeiten zum Importieren von Eigenschaften. Das Eigenschaftsimport-Plugin ermöglicht Ihnen den Import von Eigenschaften über CSV. Dies ermöglicht Ihnen den gleichzeitigen Import mehrerer Eigenschaften, ist jedoch nur eine Funktion des Administrators. Wenn die Eigenschaft Wenn der Manager ein Beds24-Konto hat, kann er dort alle vorhandenen Unterkünfte aus seinem Konto importieren, sobald er die API-Schlüssel verknüpft hat. Eine andere Möglichkeit besteht darin, die API zu verwenden mit der Verwendung von REST-APIs vertraut, um diese Funktionalität zu verwenden.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_IMPORTBOOKINGS', 'Kann ich Buchungen aus einem anderen System importieren?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_IMPORTBOOKINGS', "Buchungen können von einem Hausverwalter über das iCal-Plugin in eine Unterkunft importiert werden, das eine Funktion zum Importieren von Buchungen in das Menü des Hausverwalters bietet. Auch wenn ein Hausverwalter ein Beds24-Konto hat und seine Unterkunft hat mit Beds24 verknüpft wurden, können sie in Beds24 eine Aktion zum erneuten Senden von Benachrichtigungen durchführen. ");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_EMAILTEMPLATES', 'Kann ich E-Mail-Vorlagen bearbeiten?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_EMAILTEMPLATES', 'Property Manager können E-Mail-Vorlagen über ihre Symbolleiste unter Einstellungen > E-Mail-Vorlagen bearbeiten.');
jr_define('_JOMRES_FAQ_ADMIN_CATEGORY_PAYMENTS', 'Zahlungen');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_TAKEPAYMENTS', 'Wie erlaube ich, dass Unterkünfte Zahlungen entgegennehmen?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_TAKEPAYMENTS', 'Sie müssen ein Zahlungsgateway installieren. Jomres verfügt über zwei Zahlungsgateways, die mit Paypal oder Stripe verbunden sind. Es bietet auch einige Offline-Gateways und Sie können andere Zahlungsgateways von unseren Partnern erwerben.' );
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_WHICHGATEWAY', 'Welches Gateway soll ich verwenden?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_WHICHGATEWAY', "Wenn Sie einen Prozentsatz der Einzahlung eines Managers für Ihre eigenen Kosten übernehmen möchten, verwenden Sie das Stripe-Gateway. Wenn Sie dies nicht tun und stattdessen beabsichtigen, die Abonnement- und/oder Provisionsfunktion zu nutzen, dann 'muss das Paypal-Gateway verwenden.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_PAYMENTACCOUNTS', 'Wenn ein Gast eine Zahlung für eine Buchung vornimmt, wer erhält das Geld?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_PAYMENTACCOUNTS', "Das hängt davon ab, wie Sie Zahlungsgateways auf Ihrer Website eingerichtet haben. Wenn Sie Paypal verwenden, können Sie es so konfigurieren, dass alle Frontend-Einstellungen überschrieben werden, sodass Ihr Konto im Wesentlichen das einzige Konto ist, das Zahlungen empfängt. Wenn Wenn Sie dies nicht tun, muss jede Unterkunft ihr Zahlungs-Gateway-Konto auf der Registerkarte Einstellungen > Gateways einrichten.Wenn Sie Stripe verwenden, dann, sobald der Hausverwalter sein Konto mit Ihrem verbunden hat (siehe die Stripe-Dokumentation in das Handbuch für weitere Informationen ), dann erhalten sie alle Gelder abzüglich einer Provision, die Sie konfigurieren können, wenn Sie dies wünschen.");
jr_define('_JOMRES_FAQ_ADMIN_CATEGORY_TROUBLESHOOTING', 'Fehlerbehebung');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_TROUBLESHOOTING_EMAIL', "Buchungs-E-Mails werden nicht gesendet.");
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_TROUBLESHOOTING_EMAIL', "Wenn Sie Probleme beim Senden von E-Mails vom System haben, überprüfen Sie bitte die E-Mail-Einstellungen Ihres Host-CMS. Jomres verwendet die Wordpress- oder Joomla-Einstellungen zum Senden von E-Mails. Wenn sie falsch sind, kann Jomres nicht entweder E-Mails senden.");
...
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_TROUBLESHOOTING_NOGATEWAY', "Wenn Sie als Property Manager angemeldet sind, sehen Sie das Zahlungsgateway nicht, weil Sie nicht selbst bezahlen, Dummkopf. Nur Nicht-Manager-Benutzer sehen das Gateway bei Buchungen.") ;
jr_define('_JOMRES_FAQ_ADMIN_CATEGORY_PURCHASINGJOMRES', 'Jomres-Lizenz');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_FORCEDTOSUBSCRIBE', 'Muss ich nach dem Kauf einer X-Lizenz nach Ablauf der Lizenz Verlängerungen kaufen?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_FORCEDTOSUBSCRIBE', "Nein, wenn Sie eine Starter-, Business- oder Enterprise-Lizenz erworben haben, können Sie die Software auf unbestimmte Zeit weiter verwenden, sie wird nicht wie von Zauberhand gekappt. Die Ausnahme von dieser Regel ist der Kauf eines Abonnements. Sobald ein Abonnement gekündigt wurde, können Sie die Plugins nicht mehr verwenden und müssen sie deinstallieren.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_EXPIRED', 'Meine Lizenz ist abgelaufen, kann ich Jomres trotzdem upgraden?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_EXPIRED', "Obwohl dies physisch möglich ist, wird dies nicht empfohlen. Sobald eine Lizenz abgelaufen ist, können Sie keinen Support mehr nutzen oder Updates für Plugins für Ihre Jomres-Installation herunterladen. Dies bedeutet, dass Sie < i>nicht</i> aktualisieren Sie Ihre Jomres-Installation, nachdem die Lizenz abgelaufen ist. Dies liegt daran, dass Plugins regelmäßig aktualisiert werden müssen, um mit aktuellen Versionen des Systems zu funktionieren, sodass Ihre älteren Plugins oft nicht auf einer neueren Version des Systems funktionieren . Wenn Sie dennoch ein Upgrade durchführen möchten, um die neuen Funktionen zu nutzen, sollten Sie eine Verlängerungslizenz erwerben, bei der es sich praktisch um eine normale Lizenz mit einem Rabatt von 50 % handelt.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_SOFTWARELICENSE', 'Unter welcher Softwarelizenz wird Jomres veröffentlicht?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_SOFTWARELICENSE', "Jomres ist sowohl unter MIT- als auch unter GPL-Lizenzen lizenziert. Von Starter-, Business- und Enterprise-Lizenzen heruntergeladene Plugins werden unter derselben Lizenz veröffentlicht und sind völlig kostenlos und Open Source nicht unter den GPL- oder MIT-Lizenzen veröffentlicht und sind Ioncube-kodiert. Dieser Ansatz ermöglicht es uns, Ihnen eine Vielzahl von verschiedenen Lizenzen anzubieten, die für jeden Geldbeutel geeignet sind.");
...
jr_define('_JOMRES_FAQ_MANAGER_ANSWER_DISCOUNTS', "Rabatte können gewährt werden, es gibt verschiedene Möglichkeiten dies zu tun. Wenn Sie eine Buchung im Namen eines Kunden vornehmen, können Sie Ihre eigenen Anzahlungs- und Buchungssummen im Buchungsformular festlegen , indem Sie die Felder \"Unterkunftssumme überschreiben\" und \"Anzahlung überschreiben\" verwenden (Gäste können diese Funktion nicht verwenden). Eine andere Möglichkeit, einem Gast einen Rabatt zu gewähren, besteht darin, Rabattgutscheine zu erstellen, die so konfiguriert werden können, dass sie nur zwischen bestimmten Daten ( Gültig von/bis ) oder nur gültig, wenn die Buchung zwischen bestimmten Daten fällt ( Buchung gültig von/bis ) Diese Rabattcoupons können nur einem Gast zugeordnet werden, oder wenn Sie möchten, können Sie die Der Ausdruck enthält einen QR-Code, den die Gäste in ihr Telefon einscannen können und der sie zu Ihrem Buchungsformular mit dem bereits gültigen Rabattcode führt.");
...
jr_define('_JOMRES_FAQ_MANAGER_ANSWER_MEDIACENTRE_INTRO', "Um Bilder hochzuladen, müssen Sie die Seite Einstellungen > Media Center aufrufen. Auf dieser Seite sehen Sie mehrere Bereiche. Oben sehen Sie möglicherweise einige Notizen und darunter ein Dropdown-Menü. In dieser Dropdown-Liste können Sie auswählen, für welche Ressource Sie Bilder hochladen. <br/> Auf der rechten Seite befindet sich eine Spalte mit Bildern hinzufügen, Liste löschen und Alle hochladen. Klicken Sie auf Bilder hinzufügen und wählen Sie einige Bilder von Ihrem Desktop oder Mobilgerät aus Wenn Sie das getan haben, ändert sich die Spalte in eine Liste mit Miniaturansichten. Von hier aus können Sie ein oder mehrere Bilder für Ihre Ressourcen hochladen.");
...
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_CURRENCIES_SETUP', 'Wie richte ich Währungssymbole ein?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_CURRENCIES_SETUP', "Tun Sie nicht. Alle Währungssymbole sind bereits im System gespeichert und es liegt an den Hausverwaltern, die für sie passende Währung auf der Seite \"Eigenschaftenkonfiguration\" auszuwählen.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_CURRENCIES', 'Wie aktiviere ich mehrere Währungen?');
jr_define ( '_JOMRES_FAQ_ADMIN_ANSWER_CURRENCIES' , "hat Jomres Funktionalität zu konvertieren Preise von einer Währung in eine andere automatisch. Zuerst Sie die Website-Konfiguration> Währungsumrechnung Registerkarte besuchen müssen. Dort können Links zu zwei Online-Dienste finden. Der erste Dienst, sobald die Die API wurde gespeichert, ermöglicht es Jomres, einmal täglich Währungsumrechnungsdaten herunterzuladen. Die zweite ermöglicht die IP-basierte Geolokalisierung für Benutzer. Fordern Sie einen kostenlosen API-Schlüssel von jedem Dienst an. Durch die Kombination dieser beiden Dienste kann Jomres die lokale Währung des Benutzers erkennen und anzeigen Preise von Unterkünften sowohl in der Landeswährung des Gastes als auch in der eigenen Währung des Hotels. Wenn Sie diese API-Schlüssel nicht einrichten, verwendet Jomres standardmäßig das Euro-Währungssymbol. Wenn Sie möchten, können Sie einen globalen Währungscode festlegen. Dies bedeutet, dass die Unterkunft Manager können keine anderen Währungen auswählen, potenzielle Gäste sehen jedoch weiterhin die Preise in ihrer eigenen Landeswährung, es sei denn, sie haben die Währungsumschalterfunktion zum Ändern verwendet die Währung, in der die Preise angezeigt werden. ");
...
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_PROPERTIES_NUMBER', 'Wie viele Eigenschaften kann ich auflisten?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_PROPERTIES_NUMBER', "Es gibt keine codierte Begrenzung für die Anzahl der Eigenschaften, die Sie auflisten können, die einzige Einschränkung liegt in der physischen Begrenzung des Servers selbst. Wenn es sich um einen Server mit vielen anderen Konten handelt, sind die Ressourcen begrenzt, wenn , andererseits ist es ein dedizierter oder virtueller dedizierter Server, dann können Sie viele weitere Eigenschaften auflisten.");
...
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_PROFILES', 'Kann ich einen Benutzer zum Hausverwalter machen?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_PROFILES', "Ja, über die Seite Property Managers unter User Management. Wenn der Benutzer bereits registriert ist, geben Sie in die Eingabe oben auf der Property Managers-Seite die ersten Zeichen seines Benutzernamens ein und sein Benutzername wird unten angezeigt. Klicken Sie auf ihren Benutzernamen und Sie werden zu einer Seite weitergeleitet, auf der Sie konfigurieren können, auf welche Eigenschaften sie Zugriff haben. Wenn sie noch nicht registriert sind, müssen Sie zuerst die Benutzerverwaltungsseiten Ihres Host-CMS verwenden, um sie hinzuzufügen. als Benutzer des CMS.<br/><br/> Ein Hinweis: Wenn Sie Immobilienverwalter für die Auflistung ihrer Immobilien auf Ihrer Website in Rechnung stellen möchten, entweder durch die Annahme von Provisionen über das Stripe-Gateway oder durch die Abonnement-/Provisionsfunktionalität, Es wird nicht empfohlen, Benutzer auf diese Weise hinzuzufügen. In diesem Fall sollten nur Super-Property-Manager mit diesem Verfahren hinzugefügt werden, und wenn sie hinzugefügt werden, sollten Sie keine Eigenschaften in der Liste darunter auswählen Die Benutzer sollten ermutigt werden, im Frontend selbst Eigenschaften zu erstellen. Dadurch werden sie automatisch als Hausverwalter hinzugefügt und sichergestellt, dass der richtige Benutzer in Rechnung gestellt wird.");
jr_define('_JOMRES_FAQ_ADMIN_CATEGORY_PLUGINS', 'Plugins');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_GENERAL_PLUGINS', 'Wozu dient der Plugin-Manager?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_GENERAL_PLUGINS', 'Der Plugin-Manager ist ein wichtiges Tool in Jomres. Er ermöglicht es uns, Ihnen die aktuellste Version der Jomres-Plugins durch eine automatische Download- und Installationsfunktion zu verteilen.');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_GENERAL_PLUGINS_IONCUBE', 'Warum erhalte ich eine Warnung über Ioncube Loader, wenn ich auf die Plugin Manager Seite klicke?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_GENERAL_PLUGINS_IONCUBE', "Sie haben einen Testlizenzschlüssel in der Site-Konfiguration gespeichert, aber Ihr Webserver bietet nicht die neuesten Ioncube-Loader. Bitten Sie Ihre Hosts, die Loader zu installieren, die Sie <a href='http ://www.ioncube.com/loaders.php' target='_blank'>auf dieser Seite.</a> Wenn Sie eine Volllizenz ohne Abonnement erworben haben und glauben, dies irrtümlich zu sehen, haben Sie möglicherweise vergessen, Ihren vollständigen Lizenzschlüssel auf der Site-Konfigurationsseite einzugeben.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_GENERAL_PLUGINS_INSTALLATION', 'Wie installiere ich ein Plugin?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_GENERAL_PLUGINS_INSTALLATION', "Angenommen, Sie haben eine gültige Lizenzschlüsselnummer in der Site-Konfiguration gespeichert, müssen Sie nur auf die Schaltfläche Installieren neben dem Plugin-Namen im Plugin-Manager klicken. Jomres installiert das Plugin für Sie und bringt Sie kehren danach zur Plugin-Seite zurück. Gelegentlich werden Sie stattdessen möglicherweise zu einer Discovery-Seite weitergeleitet, wenn Sie Jomres in Joomla ausführen. Klicken Sie einfach auf die Schaltfläche Discover, um das Plugin zu installieren.<br/><br/>HINWEIS Don' Wenn Sie nicht alle Plugins installieren, funktionieren sie nicht alle zusammen (durch Design). Sie könnten leere Seiten im Buchungsformular haben. Suchen Sie stattdessen nach den Plugins, die Sie benötigen, und experimentieren Sie mit jedem einzelnen.");
jr_define('_JOMRES_FAQ_ADMIN_CATEGORY_SITESTRUCTURE', 'Site-Struktur');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_INTRO', 'Was bedeutet Site-Struktur?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_INTRO', "Site-Struktur in Jomres bezieht sich auf die verschiedenen Elemente Ihrer Site, die sie einzigartig machen. Sie definiert die Immobilientypen, die Sie auflisten (zB Villen oder Hotels) und die Zimmer-/Untertypen für diese Immobilientypen. So , wenn Sie Selbstversorger-Ferien verkaufen, verkaufen Sie Vermietungen von so etwas wie einem Chalet oder einer Villa Verschiedene Chalets können eine unterschiedliche Anzahl von Zimmern, Balkonen usw. haben. Im Falle von Hotels oder B&Bs verkaufen Sie Zimmer <em>in</em> der Immobilie, und dies wären Doppelzimmer, Einzelzimmer usw. Um dies zu verdeutlichen, wurden in einer Standardinstallation bereits mehrere Zimmer und Immobilientypen erstellt, damit Sie sie besser verstehen können. Wenn Sie verkaufen möchten Tours, versuchen Sie nicht, einen neuen Eigenschaftstyp zu erstellen, ohne zuerst den Abschnitt zu Tours gelesen zu haben.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_PROPERTYTYPES', 'Was sind Eigenschaftstypen?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_PROPERTYTYPES', 'In diesem System bezieht sich ein Immobilientyp buchstäblich auf den Immobilientyp. Dies kann ein Hotel, eine Villa oder eine Wohnung sein von Gästen durchsucht werden Um sicherzustellen, dass Ihre Suchfunktion sauber und ordentlich bleibt, können nur Site-Administratoren Immobilientypen erstellen.');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_PROPERTYFEATURES', 'Was sind Eigenschaftsmerkmale?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_PROPERTYFEATURES', "Eigenschaften von Immobilien sind Dinge, die eine Immobilie einzigartig machen. Eine Eigenschaft könnte zum Beispiel sein, dass sie in Strandnähe liegt, während ein anderes Hotel die Eigenschaft haben könnte, dass es sich in einem Nationalpark befindet, Reitwege bietet, so ähnlich. Wie bei Property-Typen können Manager keine neuen Features erstellen, sie können nur aus den von Ihnen erstellten auswählen. Property-Features können Bilder zugewiesen werden. Zuerst müssen Sie Feature-Bilder über Site Structure > Media Center > Property-Feature hochladen Dropdown-Liste \"Symbole. Laden Sie so viele Feature-Symbole hoch, wie Sie möchten. Wenn Sie dann ein Property-Feature erstellen, können Sie dessen Bild auswählen.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_PROPERTYFEATURECATEGORIES', 'Was sind Eigenschaftskategorien?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_PROPERTYFEATURECATEGORIES', "Eigenschaftsmerkmale werden unter anderem auf der Seite \"Eigenschaftendetails\" angezeigt. Auf der Seite \"Eigenschaftendetails\" können Merkmale nach Kategorien gruppiert angezeigt werden, zum Beispiel \"Wohnbereich\", \"Zugänglichkeit\" usw.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_ROOMFEATURES', 'Was sind Raumfunktionen?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_ROOMFEATURES', "Property Manager, die den Micromanage- oder Advanced-Tarifbearbeitungsmodus verwenden, können ihre Zimmer direkt bearbeiten. Sie können auch Dinge namens Room Features erstellen, die auf der Zimmerverfügbarkeitsseite für jede Unterkunft angezeigt werden. Wenn sie Verwenden Sie die klassische Zimmerlistenanzeige im Buchungsformular, dann können Gäste die Zimmerfunktionen verwenden, um Zimmer herauszufiltern, bevor sie einen oder mehrere auswählen.Auf der Seite Site-Struktur > Zimmerfunktionen können Site-Manager auch Zimmerfunktionen erstellen, und diese Funktionen kann in allen Buchungsformularen für Unterkünfte angezeigt werden, in denen die Unterkunft die Liste der Classic-Zimmer verwendet. Grundsätzlich handelt es sich um eine globale Zimmerfunktion. Diese Zimmerfunktionen können so konfiguriert werden, dass sie nur bestimmten Objekttypen angezeigt werden, und Bilder für diese Zimmerfunktionen können über hochgeladen werden die Seite Site-Struktur > Media Center.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_COUNTRIES', 'Warum gibt es eine Seite zum Bearbeiten von Ländern/Regionen?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_COUNTRIES', "Man könnte meinen, dass eine Liste von Ländern ziemlich unveränderlich ist, aber Sie würden sich irren. Im Laufe der Jahre haben wir bei der Pflege einer Länderliste viele Änderungen festgestellt. Als Ergebnis haben wir erfuhr, dass es am einfachsten ist, Site-Managern zu erlauben, die Länder zu definieren, die sie auf der Site anzeigen möchten. Dies ermöglicht es dem eingefleischten Katalanen, ihre Provinz als einzigartiges Land darzustellen, wenn dies die Aussage ist, die sie machen möchten. Das gleiche gilt für andere Regionen der Welt.");
jr_define('_JOMRES_FAQ_ADMIN_CATEGORY_LOCALISATION', 'Lokalisierung/Übersetzung');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_LOCALISATION_INTRO', 'Wie übersetze ich Dinge?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_LOCALISATION_INTRO', "Die Übersetzung von Labels/Strings erfolgt über die Menüoptionen \"Sprache\", hauptsächlich die Seiten \"Sprachdatei übersetzen/Gebietsschema übersetzen\". laden. <br/><br/>Schauen wir uns ein Beispiel an. Nehmen wir an, Sie möchten von Deutschland nach Deutschland übersetzen. Klicken Sie zuerst auf Ländereinstellungen übersetzen. Als nächstes überprüfen Sie das Sprachen-Dropdown oben rechts von Englisch nach Deutsch. Scrollen Sie dann die Seite nach unten, bis Sie nach Deutschland kommen. Sie sehen, dass es unterstrichen ist. Das bedeutet, dass Sie es übersetzen können. Klicken Sie auf das Wort, Sie sehen ein Popup mit dem Wort 'Deutschland'. Ändern Sie dies in 'Deutschland' und klicken Sie auf das grüne Häkchen. Wenn Ihr Host-CMS so konfiguriert ist, dass Besuchern der Website deutschsprachige Seiten angeboten werden, wird das Wort \"Deutschland\" jetzt als \"Deutschland\" angezeigt. Dieses Konzept gilt in ganz Jomres. <br/><br/> Auf den Property-Manager-Seiten können Property-Manager auch sehen Sie oben auf ihren Seiten ein Dropdown-Menü für den Etikettenbearbeitungsmodus. Wenn dies auf Ein gesetzt ist, können sie auch Änderungen im Frontend vornehmen, diese Änderungen wirken sich jedoch nur auf ihre derzeit aktive Unterkunft aus, sodass sie beispielsweise das Wort Tarife einfach in Preise für nur eine Unterkunft ändern können, wenn dies der Fall ist erforderlich.");
jr_define('_JOMRES_FAQ_ADMIN_CATEGORY_TOURS', 'Touren');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_INTRO', 'Was sind Touren?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_INTRO', "Dies mag wie eine dumme Frage klingen, ist es aber nicht. Im Laufe der Jahre haben wir gelernt, dass verschiedene Kulturen unterschiedliche Vorstellungen davon haben, was eine \"Tour\" ist. Als Ergebnis werden Erwartungen an den Verkauf von Touren gestellt variieren stark, daher werden wir, bevor wir über Touren sprechen, zuerst definieren, was wir unter Touren verstehen.<br/> Eine Tour ist eine einfache Reise oder ein Besuch, um eine Sehenswürdigkeit oder ein Denkmal zu sehen. Ein Aufenthalt in einem Hotel ist jedoch keine Tour. Touren können während eines Hotelaufenthalts besucht werden.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_HOWTOSELL', 'Wie verkaufe ich mit Jomres Touren?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_HOWTOSELL', 'Um die Frage des Tourenverkaufs in Jomres zu beantworten, müssen Sie zuerst das Jintour-Plugin installieren. Dieses Plugin ermöglicht es Ihnen, Touren zu erstellen, die als Teil von Ferienwohnungen verkauft werden. Es ermöglicht Ihnen auch, Immobilien zu erstellen die ausschließlich für den Verkauf von Touren gedacht sind. Sobald dieses Plugin installiert wurde, können Hausverwalter Touren und Tour-Eigenschaften im Frontend erstellen.');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_WHATISJINTOUR', 'Was ist das Jintour-Plugin?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_WHATISJINTOUR', 'Jintour steht für Jomres INtegrated TOURs. Es ermöglicht Ihnen, einfache, begrenzte Ressourcen zu erstellen, die ausgebucht werden können, die keine Zimmer in einer Unterkunft sind können nicht nur für Touren genutzt werden, sondern können beispielsweise von einer Skihütte genutzt werden, die Ski und Ausrüstung ausleihen möchte. Da diese Ausrüstung nur begrenzt verfügbar ist, können Sie das Jintour-Plugin verwenden, um den Gästen die Möglichkeit zu geben, reservieren und bezahlen Sie diese Ausrüstung zum Zeitpunkt der Buchung.');
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_SAMEBOOKING', 'Wie verkaufe ich Touren und Ferienwohnungen in derselben Buchung?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_SAMEBOOKING', "In diesem Szenario haben Sie ein Hotel und möchten Touren an eine lokale Sehenswürdigkeit verkaufen. Melden Sie sich am Frontend an und gehen Sie zu dem von Ihnen erstellten Hotel. Klicken Sie anschließend auf Einstellungen > Tour /Aktivitätsverwaltung. Befolgen Sie auf dieser Seite die Anweisungen auf dem Bildschirm, um zuerst ein Tourprofil zu erstellen und dann Touren zu generieren. Danach können Sie sowohl Touren als auch Zimmerbuchungen und optionale Extras nebeneinander im selben Buchungsformular verkaufen .");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_STANDALONETOURS', 'Was ist, wenn ich nur Touren verkaufen möchte?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_STANDALONETOURS', "Zuerst müssen Sie eine neue Eigenschaft im Frontend erstellen. Stellen Sie dabei sicher, dass Sie den 'Eigenschaftstyp' auf Tour setzen. Wenn Sie diese neue Eigenschaft erstellt haben, können Sie um wieder Touren über die Seite Einstellungen > Touren-/Aktivitätenverwaltung zu erstellen. Außerdem können Sie wie in normalen Unterkünften optionale Extras anbieten, lediglich Zimmer, Zimmerausstattung oder Tarife können Sie nicht nach Ihren Wünschen konfigurieren. Wir verkaufen keine Zimmer in diesem Objekt.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_GLOBALTOURS', 'Wie kann ich eine Tour/buchbare Ressource erstellen, die in allen Buchungsformularen für Unterkünfte angezeigt wird?');
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_GLOBALTOURS', "Besuchen Sie im Administratorbereich Ihrer Site die Seite Portal > Funktionalitätstour/Aktivitätsverwaltung. Der Tourprofil-/Erstellungsprozess ist der gleiche wie im Frontend, jedoch werden alle hier generierten Touren in der Frontend. Ein typisches Szenario, in dem dies verwendet werden kann, ist, wenn der Site-Administrator Veranstaltungen im ganzen Land organisiert und Hotelbuchungen verkaufen möchte. Sie würden die teilnehmenden Hotels wie gewohnt im Frontend erstellen, Zimmerpreise festlegen usw. Tours' wäre in diesem Fall eigentlich die Teilnahmegebühr für die Veranstaltung selbst.");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_FIRSTTHINGSFIRST', "Ok, ich habe Jomres installiert, was nun?");
jr_define('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_FIRSTTHINGSFIRST', "Das allererste, was Sie tun sollten, nachdem Sie Jomres jetzt installiert haben, klicken Sie im Menü links auf Hilfe und dann auf Erste Schritte. Im Ernst, gehen Sie weg und tun Sie das jetzt.") ;
