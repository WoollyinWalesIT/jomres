...
jr_define('_JOMRES_TUTORIAL_LOGFILES_DESC', 'Dieses Video zeigt Ihnen, wie Sie Protokolldateien anzeigen. Umfangreiche Protokollierung erfolgt, wenn das System ausgeführt wird. Im Produktionsmodus (Site Config > Debugging) werden weniger Protokolle generiert, wenn Sie also eine neue Funktion testen Sie sollten Ihre Site auf "Entwicklung" setzen. Wenn Sie Ihren Jomres-Skripten Ihre eigene Protokollierung hinzufügen möchten, werfen Sie einen Blick auf <a href="https://www.jomres.net/manual/developers-guide/56-other-discussions/339-logging-in-jomres" target ="_blank">unsere Handbuchseite zur Vorgehensweise.</a> Hier werden wir einen gefälschten Fehler ausgeben und dann die Protokolldatei anzeigen. Da die Site dort auf Entwicklung eingestellt ist sind viele Informationen, normalerweise sehen Sie nur eine Meldung, dass ein Fehler aufgetreten ist und dieser gemeldet wurde.');
