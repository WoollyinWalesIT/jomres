...
Puoi lasciare la lingua di destinazione impostata sulla tua lingua corrente e utilizzare questa pagina per rinominare gli elementi qui, invece di visitare le loro singole pagine.');
	...
	jr_define('_JOMRES_COM_A_GATEWAYLIST_INFO', 'In questa pagina puoi configurare i gateway di pagamento attraverso i quali desideri ricevere i pagamenti di deposito. Avrai bisogno di un account sul gateway di pagamento. La pagina delle impostazioni ti fornirà le istruzioni su come configurare il gateway.' );

	jr_define('_JOMRES_COM_A_GATEWAYLIST_TESTINGINFO', "Sei loggato come Super Property Manager. Normalmente i gestori di proprietà non possono utilizzare i gateway di pagamento, tuttavia se imposti il sito in modalità Sviluppo in Amministrazione > Jomres > Impostazioni > scheda Debug, sarai in grado di elaborare tramite una prenotazione e accedere ai gateway di pagamento come fa un ospite.Se non si desidera impostare il sito in modalità Sviluppo, sarà necessario essere disconnessi o aver effettuato l'accesso come normale utente registrato per testare le prenotazioni come ospite. Le impostazioni della modalità di test nei singoli gateway di pagamento non sono influenzate dall'impostazione di produzione o sviluppo del sito. ");