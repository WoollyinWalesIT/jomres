...
jr_define('_JOMRES_FRONT_MR_BOOKINGMADE', 'Tתודה שהזמנת אצלנו. מקווים שתהנה משהייתך<br><br> <b>אנא שים לב , זוהי רק קדם הזמנה. ההזמנה תאושר עם קבלת דואל על ידך ואישורו ');
...
jr_define('_JOMRES_JR_NOTLOGGEDIN', 'נראה שהתנתקת מהמערכת, אנא התחסר שנית');
...
jr_define('_JOMRES_PRODUCT_INFORMATION', 'ברוכים הבאים לג ומרס. מערכת הליבה היא בחינם, אך ניתן לשפר אותה באמצעות התקנת תוספים. כדי לגשת לאותם תוספים תצטרך רישיון הורדה ותמיכה. אם תרצה לרכוש Jomres Starter , רישיון לעסקים או לארגונים, <a href="https://www.jomres.net/prices" target="_blank"> בקר באתר שלנו </a> למידע על האופן שבו תוכל לשדרג. ');
...
jr_define('_JOMRES_EMAIL_TEMPLATES_INSTRUCTIONS', 'אנא עיין בדף זה לעזרה בהתאמה אישית של הודעות הדוא"ל ורשימת הפלט הזמין: <a href = "https://www.jomres.net/manual/property-managers-guide/48-your -toolbar/settings/254-email-templates" target ="_blank"> עזרה בתבניות דוא"ל </a> ');
...
אתה יכול להשאיר את שפת היעד מוגדרת לשפה הנוכחית שלך ולהשתמש בדף זה כדי לשנות שם פריטים כאן, במקום לבקר בדפים האישיים שלהם.');
	...
	jr_define('_JOMRES_COM_TRANSLATE_LANGUAGEFILES_INFO', "טקסט המוצג בדפים מאוחסן בקובצי שפה. מערכת Jomres של הצגת מחרוזות שפה בדף פירושה שאינך צריך לערוך ישירות את קובצי השפה הללו. במקום זאת, אתה יכול לערוך מחרוזות אלה בדף זה. דף על ידי לחיצה על הטקסט המודגש והכנסת הטקסט החדש שברצונך להציג בטופס הקלט שנפתח. כאשר אתה לוחץ על הסימון, אז השינוי הזה נשמר במסד הנתונים. המשמעות היא שכל השינויים שלך מאוחסנים אינם מוחלפים בעת עדכון Jomres. אם ברצונך לשנות טקסט עבור שפות שונות, השתמש בתפריט הנפתח לבחירת שפה בפינה השמאלית העליונה, כדי לשנות את השפה הנוכחית. מחרוזות טקסט חוזרות על עצמן במקומות שונים בקובצי שפה מכיוון שהן משמשות בשונות הקשרים אז אל תשכח להשתמש בתכונת החיפוש של הדפדפן כדי לוודא שערכת את המחרוזת הנכונה. ");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN', "כל ניהול הנכסים מתבצע בחזית האתר שלך. אינך מחובר כעת כמנהל נכס, אז אנא התחבר תחילה ואז תוכל לנהל את הנכסים שלך.");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN_EXPOSITION_FOR_NEW_USERS_JOOMLA', "כאשר Jomres מותקן לראשונה, הוא יצור מנהל נכסים על למשתמש המנהל, ויוסיף אפשרות חדשה לתפריט הראשי. התחבר מחק באמצעות התפריט ואל תמחק באמצעות הפריט הזה דף ההזמנות כדי להתחיל בניהול נכסים. ");

	jr_define('_JOMRES_COM_A_GATEWAYLIST_INFO', 'בדף זה תוכל להגדיר באמצעות אילו שערי תשלום תרצה לקבל תשלומי הפקדה. תצטרך חשבון בשער התשלום. דף ההגדרות יספק לך הנחיות כיצד להגדיר את השער.' );

	jr_define('_JOMRES_COM_A_GATEWAYLIST_TESTINGINFO', "אתה מחובר כמנהל נכסים על. בדרך כלל מנהלי נכסים אינם יכולים להשתמש בשערי תשלום, אולם אם תגדיר את האתר למצב פיתוח ב-Admin > Jomres > הגדרות > הכרטיסייה ניפוי באגים, תוכל לעבד דרך הזמנה וגישה לשערי תשלום כפי שעושה אורח. אם אינך רוצה להגדיר את האתר למצב פיתוח, תצטרך להיות מנותק, או להיכנס כמשתמש רשום רגיל כדי לבדוק הזמנות כאורח. כל הגדרות מצב בדיקה בשערי תשלום בודדים אינן מושפעות מהגדרת הייצור או הפיתוח של האתר. ");
