...
אתה יכול להשאיר את שפת היעד מוגדרת לשפה הנוכחית שלך ולהשתמש בדף זה כדי לשנות שם פריטים כאן, במקום לבקר בדפים האישיים שלהם.');
	...
	jr_define('_JOMRES_COM_A_GATEWAYLIST_INFO', 'בדף זה תוכל להגדיר באמצעות אילו שערי תשלום תרצה לקבל תשלומי הפקדה. תצטרך חשבון בשער התשלום. דף ההגדרות יספק לך הנחיות כיצד להגדיר את השער. אם לשער יש מצב בדיקה ואם מצב בדיקה מופעל, אתה כמנהל נכס תוכל להשתמש בשער התשלום כדי לבדוק את התצורה שלך. כאשר מצב בדיקה מושבת רק משתמשים שאינם מנהלים יראו את שערי התשלום במהלך תהליך ההזמנה .');
