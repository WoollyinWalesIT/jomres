...
jr_define('_JOMRES_PRODUCT_INFORMATION', 'Vítejte v Jomres. Základní systém je zdarma, ale lze jej vylepšit instalací pluginů. K přístupu k těmto pluginům budete potřebovat licenci ke stažení a podpoře. Pokud si chcete zakoupit Jomres Starter "Obchodní nebo podniková licence, <a href="https://www.jomres.net/prices" target="_blank"> navštivte naše stránky </a>, kde najdete informace o tom, jak můžete upgradovat. ');
...
jr_define('_JOMRES_ERROR_MESSAGE', 'Omlouváme se! Při pokusu o zpracování této funkce došlo k chybě. Bylo to pro vás nahlášeno a my se tím budeme zabývat.');
jr_define('_JOMRES_ERROR_DEBUGGING_MESSAGE', 'Zpráva');
...
jr_define('_JOMRES_EMAIL_TEMPLATES_INSTRUCTIONS', 'Na této stránce naleznete pomoc s přizpůsobením e-mailů a seznamem dostupného výstupu: <a href = "https://www.jomres.net/manual/property-managers-guide/48-your-toolbar/settings/254-email-templates" target ="_blank"> Nápověda pro šablony e-mailů </a> ');
...
Můžete ponechat cílový jazyk nastavený na váš aktuální jazyk a použít tuto stránku k přejmenování položek zde, místo abyste navštěvovali jejich jednotlivé stránky.');
	...
	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN', "Veškerá správa nemovitostí se provádí na frontendu vašeho webu. Momentálně nejste přihlášeni jako správce nemovitosti, takže se nejprve přihlaste a poté budete moci spravovat své vlastnosti.");
