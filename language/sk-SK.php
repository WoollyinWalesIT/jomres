...
jr_define('_JOMRES_FRONT_MR_BOOKINGMADE', 'Ďakujeme za prejavený záujem a dúfame, že sa Vám Vaša cesta bude páčiť.<br><br> <b>Berte prosím na vedomie, že Vaša objednávka je zatiaľ predbežná až do doby, pokiaľ Vám ju nepotvrdíme záväzne e-mailom.');
...
jr_define('_JOMRES_JR_NOTLOGGEDIN', '<b>Zrejme ste boli pre dlhú nečinnosť odhlásení zo systému.</b> Znovu sa prihláste.');
...
jr_define('_JOMRES_IP_DETECTION_API_KEY_DESC', 'Na automatické nastavenie rozbaľovacieho kódu meny môže Jomres používať na zisťovanie krajiny návštevníka bezplatnú službu s názvom IPinfoDB, avšak pre kľúč API sa musíte zaregistrovať na <a href = "https://www.ipinfodb.com/login" target="_blank"> IPinfoDB </a> ako prvý. ');
...
jr_define('_JOMRES_EMAIL_TEMPLATES_INSTRUCTIONS', 'Na tejto stránke nájdete pomoc s prispôsobením e-mailov a zoznamom dostupného výstupu: <a href = "https://www.jomres.net/manual/property-managers-guide/48-your -toolbar/settings/254-email-templates" target="_blank"> Pomocník pre e-mailové šablóny </a> ');
...
jr_define('_JOMRES_CONFIG_IPINFODB_KEY_WARNING', "Nemáte nastavený kľúč API pre zisťovanie IP. Toto je potrebné, aby systém mohol automaticky detekovať polohu používateľa a automaticky nastaviť jeho menu a krajinu. <a href = 'https://www.jomres.net/manual/site-manager-guide/35-control-panel/main/site-configuration/128-site-configuration-currency-conversion-currency-codes-tab' target='_blank'> see our manual stránka o tom, ako vytvoriť kľúč API zisťovania IP </a> a uložiť ho v Jomres> Konfigurácia webu> Prevody meny / kódy mien. ");
jr_define('_JOMRES_CONFIG_OPENEXCHANGERATES_KEY_WARNING', "Nemáte sadu kľúčov API pre otvorené výmenné kurzy. Je to potrebné, aby systém mohol automaticky sťahovať a používať výmenné kurzy mien. <a href = 'https://www.jomres.net /manual/site-manager-guide/35-control-panel/main/site-configuration/128-site-configuration-currency-conversion-currency-codes-tab' target ='_blank'> pozrite sa na našu manuálovú stránku o tom, ako vytvorte kľúč API pre zisťovanie IP </a> a uložte ho v Jomres> Konfigurácia webu> Prevody meny / kódy mien. ");
...
Môžete ponechať cieľový jazyk nastavený na váš aktuálny jazyk a použiť túto stránku na premenovanie položiek tu, namiesto toho, aby ste navštevovali ich jednotlivé stránky.');
	...
	jr_define( 'JOMRES_BS5_TOP_PANEL_CHOOSE_CURRENCY', "Vyberte si menu" );
	jr_define( 'JOMRES_BS5_TOP_PANEL_CHOOSE_LANGUAGE', "Vyberte si jazyk" );
	jr_define( 'JOMRES_BS5_TOP_PANEL_REGISTER',"Registrovať" );
	jr_define( 'JOMRES_BS5_TOP_PANEL_SIGN_IN', "Prihlásiť sa");
	jr_define( 'JOMRES_BS5_TOP_PANEL_LIST_YOUR_PROPERTY', "Uveďte svoj majetok");
	jr_define( 'JOMRES_BS5_TOP_PANEL_REGISTER_FIRST', "Najprv sa musíte zaregistrovať a prihlásiť");
	...
	jr_define('_JOMRES_COM_TRANSLATE_LANGUAGEFILES_INFO', "Text zobrazený na stránkach je uložený v jazykových súboroch. Systém Jomres zobrazujúci jazykové reťazce na stránke znamená, že nemusíte priamo upravovať tieto jazykové súbory. Namiesto toho môžete tieto reťazce upravovať na tomto kliknutím na zvýraznený text a vložením nového textu, ktorý chcete zobraziť, do vstupného formulára, ktorý sa otvorí. Keď kliknete na značku začiarknutia, zmena sa uloží do databázy. To znamená, že všetky vaše zmeny sa uložia a sa pri aktualizácii Jomres neprepíšu. Ak chcete zmeniť text pre rôzne jazyky, použite rozbaľovaciu ponuku výberu jazyka vpravo hore a zmeňte aktuálny jazyk. Textové reťazce sa niekedy opakujú na rôznych miestach v jazykových súboroch, pretože sa používajú v rôznych kontextoch, takže nezabudnite použiť funkciu vyhľadávania prehliadača, aby ste sa uistili, že ste upravili správny reťazec. ");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN', "Všetka správa nehnuteľností sa vykonáva na frontende vašej stránky. Momentálne nie ste prihlásený ako správca nehnuteľnosti, takže sa najskôr prihláste a potom budete môcť spravovať svoje nehnuteľnosti.");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN_EXPOSITION_FOR_NEW_USERS_JOOMLA', "Keď je Jomres prvýkrát nainštalovaný, vytvorí Super Property Manager pre administrátora a pridá novú možnosť do Hlavnej ponuky s názvom Rezervácie. Neodstraňujte túto položku ponuky a nenavštevujte ju. stránku Rezervácie, aby ste mohli začať spravovať vlastnosti. ");

	jr_define('_JOMRES_COM_A_GATEWAYLIST_INFO', 'Na tejto stránke môžete nakonfigurovať, cez ktoré platobné brány chcete prijímať zálohové platby. Budete potrebovať účet na platobnej bráne. Stránka s nastaveniami vám poskytne pokyny, ako nakonfigurovať bránu.' );

	jr_define('_JOMRES_COM_A_GATEWAYLIST_TESTINGINFO', "Ste prihlásený ako Super Property Manager. Správcovia nehnuteľností zvyčajne nemôžu používať platobné brány, ak však nastavíte stránku do režimu vývoja v Správca > Jomres > Nastavenia > karta Ladenie, budete môcť spracovať cez rezerváciu a pristupovať k platobným bránam ako hosť. Ak nechcete stránku nastaviť do režimu vývoja, budete musieť byť buď odhlásený, alebo prihlásený ako bežný registrovaný používateľ, aby ste mohli testovať rezervácie ako hosť. Nastavenia testovacieho režimu v jednotlivých platobných bránach nie sú ovplyvnené nastavením produkcie alebo vývoja na stránke. ");
