...
jr_define('_JOMRES_JR_NOTLOGGEDIN', '<b>Úgy néz ki, hogy a portálrendszer az inaktivitás miatt kiléptette Önt.</b> Kérjük jelentkezzen be a rendszerbe és próbálja újra.');
...
jr_define('_JOMRES_EMAIL_TEMPLATES_INSTRUCTIONS', 'Ezen az oldalon talál segítséget az e-mailek személyre szabásához és a rendelkezésre álló kimenet listájához: <a href = "https://www.jomres.net/manual/property-managers-guide/48-your -toolbar/settings/254-email-templates" target="_blank"> E-mail sablonok súgója </a> ');
...
jr_define('_JOMRES_CONFIG_GMAP_KEY_WARNING', "Nem rendelkezik Google Térkép kulcskészlettel. A Google Térkép legutóbbi változásai miatt minden új webhelynek szüksége lesz egy API kulcsra a Google térkép funkcióinak használatához. Kérjük, <a href = 'https://www.jomres.net/manual/site-managers-guide/14-getting-started/338-google-maps-api-key' target ='_blank'> tekintse meg kézikönyvünket az API-kulcs létrehozásáról < /a> és mentse a kulcsot a Jomres -ban.</a> ");
...
jr_define('_JOMRES_SURCHARGE_TITLE', 'Felár');
...
Meghagyhatja a célnyelvet az aktuális nyelven, és ezen az oldalon átnevezheti az itt található elemeket, ahelyett, hogy meglátogatná az egyes oldalakat.');
	...
	jr_define('_JOMRES_COM_TRANSLATE_LANGUAGEFILES_INFO', "Az oldalakon megjelenő szövegek nyelvi fájlokban vannak tárolva. A Jomres rendszer, amely megjeleníti a nyelvi karakterláncokat az oldalon, azt jelenti, hogy nem kell közvetlenül szerkesztenie ezeket a nyelvi fájlokat. Ehelyett szerkesztheti ezeket a karakterláncokat ezen oldalra kattintva a kiemelt szövegre, és a megnyíló beviteli űrlapba beírja a megjeleníteni kívánt új szöveget. Ha a pipára kattint, akkor a módosítás mentésre kerül az adatbázisba. Ez azt jelenti, hogy az összes módosítást eltároljuk és nem íródnak felül a Jomres frissítésekor. Ha különböző nyelvekhez szeretne szöveget módosítani, használja a jobb felső sarokban található nyelvválasztó legördülő menüt az aktuális nyelv megváltoztatásához. A szöveges karakterláncok néha a nyelvi fájlok különböző helyein ismétlődnek, mert különböző nyelvekben használatosak kontextusban, ezért ne felejtse el használni a böngésző keresési funkcióját, hogy megbizonyosodjon arról, hogy a megfelelő karakterláncot szerkesztette. ");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN', "Minden ingatlankezelés a webhely frontendjén történik. Jelenleg nincs bejelentkezve ingatlankezelőként, ezért kérjük, először jelentkezzen be, és csak ezután tudja kezelni ingatlanait.");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN_EXPOSITION_FOR_NEW_USERS_JOOMLA', "A Jomres első telepítésekor létrehoz egy Super Property Managert az adminisztrátor felhasználó számára, és hozzáad egy új opciót a főmenühöz, és ne törölje ezt a menüt a Bookings gombbal. a Foglalások oldalon az ingatlanok kezelésének megkezdéséhez. ");
