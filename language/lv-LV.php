...
jr_define('_JOMRES_EMAIL_TEMPLATES_INSTRUCTIONS', 'Lūdzu, skatiet šo lapu, lai saņemtu palīdzību e-pastu pielāgošanā un pieejamās izejas sarakstu: <a href = "https://www.jomres.net/manual/property-managers-guide/48-your -toolbar/settings/254-email-templates" target="_blank"> E-pasta veidņu palīdzība </a> ');
...
jr_define('_JOMRES_CONFIG_IPINFODB_KEY_WARNING', "Jums nav iestatīta IP noteikšanas API atslēga. Tas ir nepieciešams, lai sistēma varētu automātiski noteikt lietotāja atrašanās vietu un automātiski iestatīt valūtu un valsti. Lūdzu, <a href = 'https://www.jomres.net/manual/site-manager-guide/35-control-panel/main/site-configuration/128-site-configuration-currency-conversion-currency-kodus-tab' target='_blank'> skatiet mūsu rokasgrāmatu lapu par to, kā izveidot IP noteikšanas API atslēgu </a> un saglabāt atslēgu sadaļā Jomres> Vietnes konfigurācija> Valūtas konvertēšana / Valūtas kodi. ");
jr_define('_JOMRES_CONFIG_OPENEXCHANGERATES_KEY_WARNING', "Jums nav Open Exchange Rates API atslēgu komplekta. Tas ir nepieciešams, lai sistēma varētu automātiski lejupielādēt un izmantot valūtas maiņas kursus. Lūdzu, <a href = 'http: //www.jomres.net /manual/site-manager-guide/35-control-panel/main/site-configuration/128-site-configuration-currency-conversion-currency-kodus-tab' target='_blank'> skatiet mūsu rokasgrāmatas lapu, kā izveidojiet IP noteikšanas API atslēgu </a> un saglabājiet atslēgu sadaļā Jomres> Vietnes konfigurācija> Valūtas konvertēšana / Valūtas kodi. ");
...
Varat atstāt mērķa valodu iestatītu uz savu pašreizējo valodu un izmantot šo lapu, lai šeit pārdēvētu vienumus, tā vietā, lai apmeklētu to atsevišķas lapas.');
	...
	jr_define('_JOMRES_COM_TRANSLATE_LANGUAGEFILES_INFO', "Lapās redzamais teksts tiek glabāts valodu failos. Jomres sistēma, kurā tiek rādītas valodas virknes lapā nozīmē, ka jums nav tieši jārediģē šie valodu faili. Tā vietā jūs varat rediģēt šīs virknes šajā lapā lapu, noklikšķinot uz iezīmētā teksta un atveramajā ievades formā ievietojot jauno tekstu, kuru vēlaties rādīt. Noklikšķinot uz atzīmes, šīs izmaiņas tiek saglabātas datu bāzē. Tas nozīmē, ka visas jūsu izmaiņas tiek saglabātas un netiek pārrakstīti, atjauninot Jomres. Ja vēlaties mainīt tekstu dažādām valodām, izmantojiet valodas atlases nolaižamo izvēlni augšējā labajā stūrī, lai mainītu pašreizējo valodu. Teksta virknes dažkārt tiek atkārtotas dažādās valodu failu vietās, jo tās tiek izmantotas dažādās valodās kontekstā, tāpēc neaizmirstiet izmantot pārlūkprogrammas meklēšanas funkciju, lai pārliecinātos, ka esat rediģējis pareizo virkni. ");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN', "Visa īpašuma pārvaldība tiek veikta jūsu vietnes priekšgalā. Jūs pašlaik neesat pieteicies kā īpašuma pārvaldnieks, tāpēc, lūdzu, vispirms piesakieties un tad varēsiet administrēt savus īpašumus.");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN_EXPOSITION_FOR_NEW_USERS_JOOMLA', "Kad Jomres pirmo reizi tiek instalēts, tas izveidos Super Property Manager administratora lietotājam un pievienos jaunu opciju galvenajai izvēlnei, izmantojot norādīto izvēlni un neapmeklējiet šo izvēlni ar nosaukumu Rezervācijas. lapu Rezervācijas, lai sāktu īpašumu administrēšanu. ");
