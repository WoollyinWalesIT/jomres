...
jr_define ('_JOMRES_DEFAULT_SHORTCODE_ALERT', 'Βεβαιωθείτε ότι έχετε δημιουργήσει μια σελίδα WordPress που περιέχει τον σύντομο κωδικό [jomres: xx-XX] (όπου xx-XX είναι ο κωδικός γλώσσας του ιστότοπού σας, για παράδειγμα [jomres: en-GB] ή [ jomres: el-US]) διαφορετικά δεν θα μπορείτε να έχετε πρόσβαση στο Jomres από το προσκήνιο για να διαχειριστείτε τις ιδιοκτησίες και τις κρατήσεις σας. <br> Το Jomres είναι χτισμένο στο πλαίσιο Bootstrap, οπότε πρέπει να το χρησιμοποιήσετε σε ένα θέμα που βασίζεται στο Bootstrap. Εμείς προτείνετε ένα βασισμένο στο Bootstrap 3. Εάν δεν έχετε πρόσβαση σε ένα θέμα, τότε σας συνιστούμε να χρησιμοποιήσετε το θέμα Jomres Leohtian για το Wordpress το οποίο μπορείτε να <a href ="https://www.jomres.net/download/free-downloads/download/5-miscelleneous-downloads/11-leohtian-for-wordpress" target ="_blank"> λήψη από εδώ. </a> ');
...
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_INTRODUCTION', 'Εισαγωγή');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_WHATISJOMRES', 'Τι είναι Jomres;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_WHATISJOMRES', "Jomres είναι ένα σύστημα κρατήσεων ξενοδοχείων και βιλών που λειτουργεί με τα συστήματα διαχείρισης περιεχομένου Joomla και Wordpress. Είναι ένα πλήρες σύστημα κρατήσεων, σκεφτείτε το \" booking.com \"ή το\" airbnb \"χωρίς τα έξοδα. που σας επιτρέπει να δημιουργήσετε μια μοναδική υπηρεσία online κρατήσεων για όσα ακίνητα θέλετε. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_USERSADD', 'Μπορούν οι χρήστες να εγγραφούν στον ιστότοπό μου στο Jomres και να προσθέσουν τις δικές τους ιδιότητες;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_USERSADD', 'Ναι. Από προεπιλογή, το Jomres επιτρέπει στους εγγεγραμμένους χρήστες να προσθέτουν τις δικές τους ιδιότητες στον ιστότοπό σας. Μπορείτε να το απενεργοποιήσετε στην Διαμόρφωση τοποθεσίας> Διάφορα αν χρειαστεί.');
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PROPERTIES', 'Ιδιότητες');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_ADDPROPERTIES', 'Πώς μπορώ να προσθέσω μια νέα ιδιότητα;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_ADDPROPERTIES', "Όταν εγκαθίσταται το Jomres, ο χρήστης διαχειριστή δημιουργείται ως Super Property Manager. Συνδεθείτε στο προσώπο του CMS σας (οι δημόσιες σελίδες) ως χρήστης διαχειριστή και από εκεί μπορείτε να προσθέσετε νέες ιδιότητες. <br/ > Μπορείτε να δημιουργήσετε νέους διαχειριστές στη σελίδα Διαχειριστές ιδιοκτησίας εάν θέλετε να προσθέσετε έναν νέο διαχειριστή, ωστόσο από προεπιλογή (μπορείτε να το απενεργοποιήσετε) κάθε εγγεγραμμένος χρήστης που δημιουργεί μια ιδιότητα δημιουργείται αυτόματα ως διαχειριστής ιδιοτήτων για τις ιδιότητες που δημιουργούν. Για για λόγους ασφαλείας, δεν μπορούν να διαχειριστούν ιδιότητες άλλου διαχειριστή. Αυτό μπορεί να αλλάξει αν μεταφερθεί αυτός ο χρήστης σε Super Property Manager στη σελίδα Διαχειριστές ιδιοκτησίας. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_IMPORTPROPERTIES', 'Μπορώ να εισαγάγω ιδιότητες από άλλο σύστημα;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_IMPORTPROPERTIES', "Υπάρχουν διάφοροι τρόποι με τους οποίους μπορείτε να εισαγάγετε ιδιότητες. Το πρόσθετο \" Εισαγωγή ιδιοκτησίας \" σάς επιτρέπει να εισάγετε ιδιότητες μέσω CSV. Αυτό σας επιτρέπει να εισαγάγετε ταυτόχρονα πολλαπλές ιδιότητες, αλλά είναι μόνο διαχειριστής. Εάν η ιδιότητα ο διαχειριστής έχει λογαριασμό Beds24, στη συνέχεια μπορεί να εισαγάγει τυχόν υπάρχουσες ιδιότητες από τον λογαριασμό του εκεί αφού συνδέσει τα κλειδιά API. Ένας άλλος τρόπος είναι να χρησιμοποιήσετε το API, υπάρχει μια δυνατότητα προσθήκης και αφαίρεσης ιδιοτήτων, ωστόσο αυτό θα απαιτούσε να είστε προγραμματιστής εξοικειωμένοι με τη χρήση REST API για τη χρήση αυτής της λειτουργικότητας. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_IMPORTBOOKINGS', 'Μπορώ να εισαγάγω κρατήσεις από άλλο σύστημα;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_IMPORTBOOKINGS', "Οι κρατήσεις μπορούν να εισαχθούν σε ένα ακίνητο από έναν διαχειριστή ιδιοκτησίας μέσω του πρόσθετου iCal, το οποίο προσφέρει μια δυνατότητα εισαγωγής κρατήσεων στο μενού του διαχειριστή ιδιοκτησίας. Επίσης, εάν ένας διαχειριστής ακινήτου διαθέτει λογαριασμό Beds24 και η ιδιοκτησία του έχει έχει συνδεθεί με το Beds24, τότε μπορούν να εκτελέσουν μια Επανάληψη Αποστολής ειδοποίησης στο Beds24. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_EMAILTEMPLATES', 'Μπορώ να επεξεργαστώ πρότυπα email;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_EMAILTEMPLATES', 'Οι διαχειριστές ιδιοκτησίας μπορούν να επεξεργάζονται πρότυπα email μέσω της γραμμής εργαλείων τους στις Ρυθμίσεις> Πρότυπα ηλεκτρονικού ταχυδρομείου.');
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PAYMENTS', 'Πληρωμές');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TAKEPAYMENTS', 'Πώς επιτρέπω στα ακίνητα να λαμβάνουν πληρωμές;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TAKEPAYMENTS', 'Θα χρειαστεί να εγκαταστήσετε μια πύλη πληρωμής. Το Jomres διαθέτει δύο πύλες πληρωμών, οι οποίες συνδέονται με Paypal ή Stripe. Προσφέρει επίσης δύο πύλες εκτός σύνδεσης και μπορείτε να αγοράσετε άλλες πύλες πληρωμής από τους συνεργάτες μας.' );
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_WHICHGATEWAY', 'Ποια πύλη πρέπει να χρησιμοποιήσω;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_WHICHGATEWAY', "Εάν θέλετε να λάβετε ένα ποσοστό από την κατάθεση ενός διαχειριστή για τα δικά σας έξοδα, τότε χρησιμοποιήστε την πύλη Stripe. Εάν δεν το κάνετε και αντίθετα σκοπεύετε να χρησιμοποιήσετε τη συνδρομή ή/και τη λειτουργία προμήθειας, τότε Θα χρειαστεί να χρησιμοποιήσετε την πύλη Paypal. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PAYMENTACCOUNTS', 'Όταν ένας επισκέπτης πληρώνει για μια κράτηση, ποιος παίρνει τα χρήματα;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PAYMENTACCOUNTS', "Αυτό εξαρτάται από τον τρόπο που έχετε ρυθμίσει τις πύλες πληρωμών στον ιστότοπό σας. Εάν χρησιμοποιείτε το Paypal, μπορείτε να το διαμορφώσετε ώστε να παρακάμπτει όλες τις ρυθμίσεις προσόψεων, καθιστώντας ουσιαστικά τον λογαριασμό σας τον μοναδικό λογαριασμό που λαμβάνει πληρωμές. Εάν δεν επιλέξετε να το κάνετε αυτό, τότε κάθε ιδιοκτησία θα πρέπει να ρυθμίσει τον λογαριασμό πύλης πληρωμής στην καρτέλα Ρυθμίσεις> Πύλες. Εάν χρησιμοποιείτε το Stripe, τότε μόλις ο διαχειριστής ιδιοκτησίας συνδέσει τον λογαριασμό του με τον δικό σας (δείτε την τεκμηρίωση Stripe στο το εγχειρίδιο για περισσότερες πληροφορίες) τότε θα λάβουν όλα τα χρήματα, μείον μια προμήθεια που μπορείτε να διαμορφώσετε εάν το επιλέξετε. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_TROUBLESHOOTING', 'Troubleshooting');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TROUBLESHOOTING_EMAIL', "Η αποστολή μηνυμάτων ηλεκτρονικού ταχυδρομείου δεν αποστέλλεται.");
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TROUBLESHOOTING_EMAIL', "Εάν αντιμετωπίζετε προβλήματα με την αποστολή μηνυμάτων ηλεκτρονικού ταχυδρομείου από το σύστημα, ελέγξτε τις ρυθμίσεις ηλεκτρονικού ταχυδρομείου του κεντρικού υπολογιστή CMS. Ο Jomres χρησιμοποιεί τις ρυθμίσεις Wordpress ή Joomla για αποστολή μηνυμάτων ηλεκτρονικού ταχυδρομείου. Εάν κάνουν λάθος, ο Jomres δεν θα μπορεί στείλτε μηνύματα ηλεκτρονικού ταχυδρομείου. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TROUBLESHOOTING_NOGATEWAY', "Δεν μπορείτε να δείτε την πύλη πληρωμής μετά την πραγματοποίηση κράτησης.");
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TROUBLESHOOTING_NOGATEWAY', "Εάν είστε συνδεδεμένοι ως Διαχειριστής ιδιοκτησίας, δεν θα δείτε την πύλη πληρωμής, επειδή δεν πληρώνετε εσείς, ανόητα. Μόνο οι χρήστες που δεν είναι διαχειριστές θα δουν την πύλη όταν κάνουν κρατήσεις.") ;
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PURCHASINGJOMRES', 'Jomres License');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_FORCEDTOSUBSCRIBE', 'Μετά την αγορά της άδειας Χ, αναγκάζομαι να αγοράσω ανανεώσεις μόλις λήξει η άδεια;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_FORCEDTOSUBSCRIBE', "Όχι, αν έχετε αγοράσει μια άδεια εκκίνησης, επιχείρησης ή επιχείρησης, τότε μπορείτε να συνεχίσετε να χρησιμοποιείτε το λογισμικό επ 'αόριστον, δεν θα διαρρηχτεί μαγικά. Η εξαίρεση αυτού του κανόνα είναι αν αγοράζετε. Μόλις ακυρωθεί μια συνδρομή, δεν θα μπορείτε πλέον να χρησιμοποιείτε τις προσθήκες και θα πρέπει να τις απεγκαταστήσετε. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_EXPIRED', 'Η άδειά μου έληξε, μπορώ να αναβαθμίσω το Jomres έτσι κι αλλιώς;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_EXPIRED', "Ενώ μπορείτε φυσικά, δεν συνιστάται να το κάνετε. Μόλις λήξει η άδεια, δεν θα μπορείτε πλέον να επωφεληθείτε από την υποστήριξη ή τη λήψη ενημερώσεων για πρόσθετα για την εγκατάσταση του Jomres. Αυτό σημαίνει ότι πρέπει να < i> δεν </i> αναβαθμίσετε την εγκατάσταση του Jomres μετά τη λήξη της άδειας. Αυτό συμβαίνει επειδή τα plugins πρέπει να ενημερώνονται τακτικά για να λειτουργούν με τις τρέχουσες εκδόσεις του συστήματος, επομένως συχνά τα παλαιότερα plugins σας δεν θα λειτουργούν σε νεότερη έκδοση του συστήματος . Εάν εξακολουθείτε να θέλετε να αναβαθμίσετε για να επωφεληθείτε από τη νέα λειτουργικότητα, θα πρέπει να αγοράσετε μια άδεια ανανέωσης, η οποία είναι ουσιαστικά μια κανονική άδεια με έκπτωση 50%. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_SOFTWARELICENSE', 'Με ποια άδεια λογισμικού εκδίδεται το Jomres;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_SOFTWARELICENSE', "Το Jomres έχει άδεια τόσο από τις άδειες MIT όσο και από τις GPL. Τα πρόσθετα που κατεβάζονται από τις άδειες Starter, Business and Enterprise εκδίδονται με την ίδια άδεια και είναι εντελώς δωρεάν και κατεβάστηκαν για άδεια χρήσης. δεν εκδίδονται βάσει αδειών GPL ή MIT και έχουν κωδικοποίηση Ioncube. Αυτή η προσέγγιση μας επιτρέπει να σας προσφέρουμε μια ποικιλία διαφορετικών αδειών που ταιριάζουν στις τσέπες όλων. ");
...
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_DISCOUNTS', "Εκπτώσεις μπορούν να γίνουν, υπάρχουν διάφοροι τρόποι για να γίνει αυτό. Εάν κάνετε κράτηση για λογαριασμό πελάτη, τότε μπορείτε να ορίσετε τα δικά σας σύνολα κατάθεσης και κράτησης στη φόρμα κράτησης , χρησιμοποιώντας τα πεδία \"Override Accommodation Total \" και \"Override Deposit \" (οι επισκέπτες δεν μπορούν να χρησιμοποιήσουν αυτήν τη δυνατότητα). Ένας άλλος τρόπος για να δώσετε έκπτωση σε έναν επισκέπτη είναι η δημιουργία κουπονιών έκπτωσης, τα οποία μπορούν να διαμορφωθούν έτσι ώστε να μπορούν να χρησιμοποιείται μόνο μεταξύ συγκεκριμένων ημερομηνιών (Ισχύει από/έως) ή να εφαρμόζεται μόνο όταν η κράτηση πέφτει μεταξύ συγκεκριμένων ημερομηνιών (Η κράτηση ισχύει από/έως). Αυτά τα κουπόνια έκπτωσης μπορούν να ανατεθούν σε έναν μόνο επισκέπτη ή εάν θέλετε μπορείτε να εκτυπώσετε κουπόνια. Η εκτύπωση περιλαμβάνει έναν κωδικό QR τον οποίο οι επισκέπτες μπορούν να σαρώσουν στα τηλέφωνά τους, ο οποίος τους μεταφέρει στη φόρμα κράτησης με τον κωδικό έκπτωσης που ισχύει ήδη. ");
...
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_CURRENCIES_SETUP', 'Πώς ρυθμίζω τα σύμβολα νομίσματος;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_CURRENCIES_SETUP', "Δεν το κάνετε. Όλα τα σύμβολα νομισμάτων είναι ήδη αποθηκευμένα στο σύστημα και εναπόκειται στους διαχειριστές ιδιοκτησίας να επιλέξουν το νόμισμα που τους ταιριάζει στη σελίδα Διαμόρφωση ιδιοτήτων ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_CURRENCIES', 'Πώς ενεργοποιώ πολλά νομίσματα;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_CURRENCIES', "Το Jomres έχει τη δυνατότητα να μετατρέπει αυτόματα τις τιμές από ένα νόμισμα σε άλλο. Πρώτα πρέπει να επισκεφθείτε την καρτέλα Διαμόρφωση ιστότοπου> Μετατροπή νομίσματος. Εκεί θα βρείτε συνδέσμους προς δύο διαδικτυακές υπηρεσίες. Η πρώτη υπηρεσία, Το API έχει αποθηκευτεί, επιτρέπει στον Jomres να κατεβάζει δεδομένα μετατροπής νομίσματος μία φορά την ημέρα. Το δεύτερο δίνει τη δυνατότητα γεωγραφικής τοποθεσίας βάσει IP για τους χρήστες. Ζητήστε δωρεάν κλειδί API από κάθε υπηρεσία. Με αυτές τις δύο υπηρεσίες συνδυασμένες, το Jomres μπορεί να εντοπίσει το τοπικό νόμισμα του χρήστη και να εμφανίσει οι τιμές των ακινήτων τόσο στο τοπικό νόμισμα του επισκέπτη, συν το ίδιο το νόμισμα του ξενοδοχείου. Εάν δεν ρυθμίσετε αυτά τα κλειδιά API, το Jomres θα οριστεί ως προεπιλογή στο σύμβολο του νομίσματος Ευρώ. Εάν θέλετε, μπορείτε να ορίσετε έναν παγκόσμιο κωδικό νομίσματος. Αυτό σημαίνει ότι η ιδιότητα οι διαχειριστές δεν θα μπορούν να επιλέξουν άλλα νομίσματα, ωστόσο οι δυνητικοί επισκέπτες θα εξακολουθούν να βλέπουν τις τιμές στο δικό τους τοπικό νόμισμα, εκτός εάν έχουν χρησιμοποιήσει τη δυνατότητα εναλλαγής νομισμάτων για αλλαγή το νόμισμα στο οποίο εμφανίζονται οι τιμές. ");
jr_define ('_JOMRES_FAQ_MANAGER_QUESTION_LANGUAGES', 'Πώς μπορώ να αποθηκεύσω περιγραφές σε πολλές γλώσσες;');
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_LANGUAGES', "Για να αποθηκεύσετε περιγραφές σε πολλές γλώσσες, επισκεφθείτε πρώτα τη σελίδα Ρυθμίσεις> Λεπτομέρειες ιδιοτήτων. Αποθηκεύστε την περιγραφή για την ιδιοκτησία σας εκεί. Στη συνέχεια, αλλάξτε τη γλώσσα στην οποία προβάλλετε τον ιστότοπο. Τώρα μεταβείτε στις Ρυθμίσεις Στη σελίδα Λεπτομέρειες ιδιοτήτων ξανά και αποθηκεύστε ξανά τις λεπτομέρειες. Επομένως, εάν ο ιστότοπος μπορεί να εμφανίζει αγγλικά και ισπανικά (ή οποιαδήποτε άλλη) γλώσσα, θα επιλέξετε αγγλικά, εισαγάγετε την περιγραφή στα αγγλικά και κάντε κλικ στην επιλογή Αποθήκευση. Στη συνέχεια, αλλάξτε την τρέχουσα γλώσσα στα ισπανικά και, στη συνέχεια, αποθηκεύστε τη νέα ισπανική περιγραφή. Αυτό λειτουργεί για όλες τις εισόδους σε αυτήν τη σελίδα. ");
jr_define('_JOMRES_FAQ_ADMIN_QUESTION_PROPERTIES_NUMBER', 'How many properties can I list?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PROPERTIES_NUMBER', "Δεν υπάρχει κωδικοποιημένο όριο στον αριθμό των ιδιοτήτων που μπορείτε να παραθέσετε, ο μόνος περιορισμός είναι ο φυσικός περιορισμός του ίδιου του διακομιστή. Εάν πρόκειται για διακομιστή με πολλούς άλλους λογαριασμούς, τότε οι πόροι θα είναι περιορισμένοι, αν , από την άλλη πλευρά, είναι ένας αποκλειστικός ή εικονικός αποκλειστικός διακομιστής, τότε θα μπορείτε να αναφέρετε πολλές περισσότερες ιδιότητες. ");
jr_define ('_JOMRES_FAQ_MANAGER_QUESTION_OTHERPROPERTIES', 'Μπορώ να τροποποιήσω άλλες ιδιότητες σε αυτόν τον ιστότοπο;');
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_OTHERPROPERTIES', 'Όχι, δεν μπορείτε. Μπορείτε να διαχειρίζεστε μόνο ιδιότητες στις οποίες έχετε δημιουργήσει ή έχετε εκχωρηθεί ως διαχειριστής ιδιοκτησίας.');
jr_define ('_JOMRES_FAQ_MANAGER_QUESTION_OTHERPROPERTIES_SUPER', 'Μπορώ να τροποποιήσω άλλες ιδιότητες σε αυτόν τον ιστότοπο;');
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_OTHERPROPERTIES_SUPER', "Ναι, μπορείτε, είστε Super Property Manager και μπορείτε να τροποποιήσετε τυχόν ιδιότητες που εμφανίζονται στη σελίδα Ιδιότητες λίστας.");
jr_define ('_JOMRES_FAQ_MANAGER_QUESTION_GUESTTYPES', 'Ποιοι είναι οι τύποι επισκεπτών/Πώς αλλάζω ανά άτομο ανά διανυκτέρευση;');
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_GUESTTYPES', "Στην καρτέλα Ρυθμίσεις> Διαμόρφωση ιδιοκτησίας> Τιμές και νομίσματα, μπορείτε να αποφασίσετε αν θέλετε να χρεώνετε ανά άτομο ανά διανυκτέρευση. Εάν χρεώνετε ανά άτομο ανά διανυκτέρευση, θα χρειαστεί να δημιουργήσετε έναν ή περισσότερους τύπους επισκεπτών. Μπορείτε να δημιουργήσετε έναν απλό τύπο επισκέπτη, όπου τους δίνετε απλώς μια περιγραφή (π.χ. «Άτομα») ή μπορείτε να δημιουργήσετε διάφορους τύπους επισκεπτών, για παράδειγμα «Ενήλικες» και «Παιδιά κάτω των 10 ετών». Για τα παιδιά, αν θέλετε για να προσφέρετε έκπτωση 50%, τότε θα ορίζατε το «Είναι ποσοστό» σε Ναι και η τιμή Διακύμανσης σε 50. Τα δωμάτια έχουν βασικές τιμές, αυτή η ρύθμιση σάς επιτρέπει να προσαρμόσετε την τιμή του δωματίου με βάση τον τύπο του επισκέπτη. ") ;
jr_define ('_JOMRES_FAQ_MANAGER_QUESTION_ROOMFEATURES', 'Τι είναι τα χαρακτηριστικά του δωματίου;');
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_ROOMFEATURES', "Τα χαρακτηριστικά του δωματίου είναι πράγματα που κάνουν το δωμάτιο να ξεχωρίζει. Μπορεί να είναι κάτι απλό όπως οι παροχές για τσάι και καφέ ή μπορεί να είναι πράγματα που πραγματικά κάνουν το δωμάτιο να ξεπερνάει τα άλλα, όπως Θέα πάνω από Μόλις δημιουργήσετε μια λειτουργία δωματίου, μπορείτε να ανεβάσετε εικόνες για αυτήν τη λειτουργία στο Media Center. Αυτές οι δυνατότητες του δωματίου μπορούν να προβληθούν στη σελίδα διαθεσιμότητας του δωματίου και εάν έχετε διαμορφώσει την ιδιοκτησία σας ώστε να εμφανίζει το στυλ λίστας των κλασικών δωματίων (όπου οι επισκέπτες μπορούν να επιλέξουν ακριβώς το δωμάτιο που θέλουν να κάνουν κράτηση), τότε μπορούν να χρησιμοποιήσουν τις δυνατότητες του δωματίου για να φιλτράρουν τα στοιχεία που εμφανίζονται στη φόρμα κράτησης. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_PROFILES', 'Μπορώ να κάνω έναν χρήστη διαχειριστή ιδιοκτησίας;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_PROFILES', "Ναι μπορείτε, μέσω της σελίδας Διαχειριστές ιδιοκτησίας στη Διαχείριση χρηστών. Εάν ο χρήστης είναι ήδη εγγεγραμμένος, στην είσοδο στο επάνω μέρος της σελίδας Διαχειριστές ιδιοτήτων πληκτρολογήστε τους πρώτους χαρακτήρες του ονόματος χρήστη και το όνομα χρήστη τους εμφανίζεται από κάτω. Κάντε κλικ στο όνομα χρήστη και θα μεταφερθείτε σε μια σελίδα όπου μπορείτε να διαμορφώσετε σε ποιες ιδιότητες έχουν πρόσβαση. Εάν δεν είναι ήδη εγγεγραμμένοι, θα πρέπει πρώτα να χρησιμοποιήσετε τις σελίδες διαχείρισης χρηστών του κεντρικού υπολογιστή CMS για να τις προσθέσετε ως χρήστης του CMS. <br/> <br/> Μια συμβουλή: Εάν σκοπεύετε να χρεώσετε τους διαχειριστές ακινήτων για την καταχώριση των ιδιοτήτων τους στον ιστότοπό σας, είτε μέσω ανάληψης προμήθειας μέσω της πύλης Stripe είτε μέσω συνδρομών/προμήθειας, Δεν συνιστούμε να προσθέτετε χρήστες με αυτόν τον τρόπο. Σε αυτήν την περίπτωση, μόνο οι υπερ -διαχειριστές ιδιοτήτων πρέπει να προστεθούν χρησιμοποιώντας αυτήν τη διαδικασία και όταν προστίθενται δεν πρέπει να επιλέξετε καμία ιδιότητα στη λίστα από κάτω. Όλα Οι χρήστες θα πρέπει να ενθαρρύνονται να δημιουργούν οι ίδιοι ιδιότητες στο προσκήνιο. Αυτό θα τους προσθέσει ως διαχειριστές ιδιοκτησίας αυτόματα και θα διασφαλίσει ότι θα χρεωθεί ο σωστός χρήστης. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PLUGINS', 'Plugins');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_GENERAL_PLUGINS', 'Σε τι χρησιμεύει ο Διαχειριστής προσθηκών;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_GENERAL_PLUGINS', 'Το Plugin Manager είναι ένα βασικό εργαλείο στο Jomres. Μας επιτρέπει να διανείμουμε την πιο ενημερωμένη έκδοση των πρόσθετων Jomres σε εσάς μέσω αυτόματης λειτουργίας λήψης και εγκατάστασης.');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_GENERAL_PLUGINS_IONCUBE', 'Γιατί βλέπω μια προειδοποίηση σχετικά με τους Ioncube Loaders όταν κάνω κλικ στη σελίδα Διαχείριση προσθηκών;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_GENERAL_PLUGINS_IONCUBE', "Έχετε αποθηκεύσει ένα δοκιμαστικό κλειδί άδειας χρήσης στη Διαμόρφωση ιστότοπου, αλλά ο διακομιστής ιστού σας δεν προσφέρει τα πιο πρόσφατα φορτωτές Ioncube. Ζητήστε από τους οικοδεσπότες σας να εγκαταστήσουν τους φορτωτές, οι οποίοι μπορούν να βρεθούν <a href = 'http://www.ioncube.com/loaders.php' target ='_blank'> σε αυτήν τη σελίδα. </a> Εάν έχετε αγοράσει μια πλήρη άδεια χωρίς συνδρομή και νομίζετε ότι το βλέπετε κατά λάθος, ενδέχεται να έχετε ξεχάσει να εισαγάγετε το πλήρες κλειδί άδειας χρήσης στη σελίδα Διαμόρφωση ιστότοπου. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_GENERAL_PLUGINS_INSTALLATION', 'Πώς μπορώ να εγκαταστήσω μια προσθήκη;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_GENERAL_PLUGINS_INSTALLATION', "Υποθέτοντας ότι έχετε έναν έγκυρο αριθμό κλειδιού άδειας που έχει αποθηκευτεί στη Διαμόρφωση ιστότοπου, το μόνο που χρειάζεται να κάνετε είναι να κάνετε κλικ στο κουμπί Εγκατάσταση δίπλα στο όνομα της προσθήκης στο διαχειριστή προσθηκών. Ο Τζόμρες θα εγκαταστήσει το πρόσθετο για εσάς και θα σας φέρει επιστρέφετε στη συνέχεια στη σελίδα των προσθηκών. Περιστασιακά, αντίθετα, ενδέχεται να μεταφερθείτε σε μια σελίδα Discovery εάν ​​εκτελείτε το Jomres στο Joomla. Απλώς κάντε κλικ στο κουμπί Discover για να εγκαταστήσετε την προσθήκη. <br/> <br/> ΣΗΜΕΙΩΣΗ Don ' t εγκαταστήσετε όλα τα πρόσθετα, δεν λειτουργούν όλα μαζί (κατά σχεδίαση). Θα μπορούσατε να καταλήξετε με κενές σελίδες στη φόρμα κράτησης. Αντ 'αυτού, προσδιορίστε τα πρόσθετα που χρειάζεστε και πειραματιστείτε με το καθένα. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_SITESTRUCTURE', 'Δομή ιστότοπου');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_INTRO', 'Τι σημαίνει Δομή ιστότοπου;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_INTRO', "Δομή ιστότοπου στο Jomres αναφέρεται στα διάφορα στοιχεία του ιστότοπού σας που τον καθιστούν μοναδικό. Ορίζει τους τύπους ιδιοτήτων που παραθέτετε (π.χ. βίλες ή ξενοδοχεία) και τους τύπους δωματίων/υποθηκών για αυτούς τους τύπους ιδιοκτησίας. Έτσι , εάν πουλάτε διακοπές με δυνατότητα προετοιμασίας γευμάτων, τότε θα πουλούσατε ενοικιάσεις για κάτι σαν σαλέ ή βίλα. Διαφορετικά σαλέ θα μπορούσαν να έχουν διαφορετικό αριθμό δωματίων, μπαλκονιών κ.λπ. Στην περίπτωση των ξενοδοχείων ή των B&B, πουλάτε δωμάτια <em> στο </em> το ακίνητο, και θα ήταν δίκλινα υπνοδωμάτια, μονόκλινα κ.λπ. Για να διευκρινιστεί αυτό, μια προεπιλεγμένη εγκατάσταση έχει ήδη δημιουργήσει αρκετά δωμάτια και τύπους ιδιοκτησίας για να σας βοηθήσει να καταλάβετε. Αν θέλετε να πουλήσετε Περιηγήσεις, μην προσπαθήσετε να δημιουργήσετε έναν νέο τύπο ιδιοκτησίας χωρίς να διαβάσετε πρώτα την ενότητα Περιηγήσεις. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_PROPERTYTYPES', 'Τι είναι οι τύποι ιδιοκτησίας;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_PROPERTYTYPES', 'Σε αυτό το σύστημα, ένας τύπος ιδιοκτησίας αναφέρεται, κυριολεκτικά, στον τύπο του ακινήτου. Αυτό μπορεί να είναι ξενοδοχείο, βίλα, διαμέρισμα. Οι διαχειριστές ακινήτων δεν μπορούν να δημιουργήσουν τύπους ιδιοκτησίας επειδή οι τύποι ιδιοκτησίας είναι ένα στοιχείο που μπορεί για αναζήτηση από επισκέπτες. Για να διασφαλίσετε ότι η λειτουργικότητά σας αναζήτησης παραμένει ωραία και τακτοποιημένη, τακτοποιημένα, μόνο οι διαχειριστές ιστότοπου μπορούν να δημιουργήσουν τύπους ιδιοκτησίας. ');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_PROPERTYFEATURES', 'Τι είναι τα χαρακτηριστικά ιδιοκτησίας;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_PROPERTYFEATURES', "Χαρακτηριστικά ιδιοκτησίας είναι τα πράγματα που κάνουν ένα ακίνητο μοναδικό. Για παράδειγμα, ένα χαρακτηριστικό ιδιοκτησίας μπορεί να είναι το Κοντά στην παραλία ενώ ένα άλλο ξενοδοχείο θα μπορούσε να έχει τη δυνατότητα να βρίσκεται μέσα σε ένα εθνικό πάρκο, προσφέρει brid κάτι τέτοιο. Όπως και οι τύποι ιδιοκτησίας, οι διαχειριστές δεν μπορούν να δημιουργήσουν νέες δυνατότητες, μπορούν να επιλέξουν μόνο από αυτές που δημιουργείτε. Οι δυνατότητες ιδιοκτησίας μπορούν να έχουν εκχωρημένες εικόνες. Πρώτα πρέπει να ανεβάσετε εικόνες χαρακτηριστικών μέσω του Strucutre ιστότοπου> Media Center> Property Feature Ανεβάστε τα αναπτυσσόμενα εικονίδια. Ανεβάστε όσα εικονίδια χαρακτηριστικών θέλετε, στη συνέχεια, όταν δημιουργείτε μια ιδιότητα ιδιοτήτων, μπορείτε να επιλέξετε την εικόνα της. ");

jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_ROOMFEATURES', 'Τι είναι τα χαρακτηριστικά του δωματίου;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_ROOMFEATURES', "Οι διαχειριστές ακινήτων που χρησιμοποιούν τη λειτουργία μικροδιαχείρισης ή προηγμένης τιμολογιακής επεξεργασίας είναι σε θέση να επεξεργάζονται άμεσα τα δωμάτιά τους. Είναι επίσης σε θέση να δημιουργήσουν πράγματα που ονομάζονται Δυνατότητες δωματίου που εμφανίζονται στη σελίδα Διαθεσιμότητα δωματίου για κάθε ιδιοκτησία. Αν χρησιμοποιήστε την εμφάνιση της λίστας Classic δωματίων στη φόρμα κράτησης και, στη συνέχεια, οι επισκέπτες μπορούν να χρησιμοποιήσουν τις λειτουργίες του δωματίου για να φιλτράρουν τα δωμάτια πριν επιλέξουν ένα ή περισσότερα. Στη σελίδα Δομή ιστότοπου> Δυνατότητες δωματίου Οι διαχειριστές ιστότοπου μπορούν επίσης να δημιουργήσουν χαρακτηριστικά δωματίου και αυτές τις δυνατότητες μπορεί να εμφανιστεί σε όλες τις φόρμες κράτησης ακινήτων όπου η ιδιοκτησία χρησιμοποιεί τη λίστα Classic Rooms. Βασικά, είναι μια λειτουργία Global Room. Αυτές οι δυνατότητες δωματίου μπορούν να διαμορφωθούν ώστε να εμφανίζονται μόνο σε συγκεκριμένους τύπους ιδιοκτησίας και οι εικόνες για αυτές τις δυνατότητες δωματίου μπορούν να μεταφορτωθούν μέσω τη σελίδα Δομή ιστότοπου> Κέντρο μέσων. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_COUNTRIES', 'Γιατί υπάρχει σελίδα για επεξεργασία χωρών/περιοχών;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_COUNTRIES', "Νομίζατε ότι μια λίστα χωρών ήταν αρκετά αμετάβλητη, αλλά κάνατε λάθος. Με τα χρόνια, όταν διατηρούσαμε μια λίστα χωρών, είδαμε πολλές αλλαγές. Ως αποτέλεσμα, έμαθε ότι ήταν ευκολότερο να επιτρέπεται στους Διαχειριστές τοποθεσιών να ορίζουν τις χώρες που θα ήθελαν να εμφανίζονται στον ιστότοπο. Αυτό επιτρέπει στους σκληροπυρηνικούς Καταλανούς να εμφανίζουν την επαρχία τους ως μια μοναδική χώρα, αν αυτή είναι η δήλωση που θα ήθελαν να κάνουν. Το ίδιο ισχύει και για άλλες περιοχές του κόσμου. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_LOCALISATION', 'Localization/Translation');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_LOCALISATION_INTRO', 'Πώς μεταφράζω πράγματα;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_LOCALISATION_INTRO', "Η μετάφραση ετικετών/συμβολοσειρών γίνεται μέσω των επιλογών του μενού Γλώσσες, κυρίως των σελίδων Μετάφραση γλώσσας/Μετάφραση τοπικών περιοχών. Επειδή τα αρχεία γλώσσας είναι πολύ μεγάλα, όταν κάνετε κλικ σε αυτήν τη σελίδα μπορεί να χρειαστεί λίγος χρόνος για να φόρτωση. <br/> <br/> Ας δούμε ένα παράδειγμα. Ας πούμε ότι θέλετε να μεταφράσετε τη Γερμανία στα Deutschland. Πρώτα κάντε κλικ στο Translate Locales. Στη συνέχεια, ελέγξτε το αναπτυσσόμενο μενού γλώσσας επάνω δεξιά από τα Αγγλικά στα Γερμανικά. Στη συνέχεια, μετακινηθείτε κάτω από τη σελίδα μέχρι να φτάσετε στη Γερμανία. Μπορείτε να δείτε ότι έχει διακεκομμένη υπογράμμιση. Αυτό σημαίνει ότι μπορείτε να τη μεταφράσετε. Κάντε κλικ στη λέξη, θα δείτε ένα αναδυόμενο παράθυρο που περιέχει τη λέξη \"Γερμανία\". Αλλάξτε αυτό σε \"Deutschland\" και κάντε κλικ το πράσινο τικ. Εάν το κεντρικό CMS του κεντρικού υπολογιστή σας έχει διαμορφωθεί για να προσφέρει σελίδες στα γερμανικά, στους επισκέπτες του ιστότοπου, τότε η λέξη \"Γερμανία\" θα εμφανίζεται πλέον ως \"Deutschland\". Αυτή η έννοια ισχύει για όλους τους Jomres. <br/> <br/> Στις σελίδες του Διαχειριστή ιδιοκτησίας, οι Διαχειριστές ιδιοκτησίας μπορεί επίσης δείτε ένα αναπτυσσόμενο μενού Λειτουργία επεξεργασίας ετικέτας στο επάνω μέρος των σελίδων τους. Όταν αυτό έχει οριστεί σε Ενεργό, τότε θα μπορούν επίσης να κάνουν αλλαγές στο προσκήνιο, ωστόσο αυτές οι αλλαγές θα επηρεάσουν μόνο την τρέχουσα ιδιοκτησία τους, έτσι για παράδειγμα μπορούν εύκολα να αλλάξουν τη λέξη Τιμολόγια σε τιμές μόνο για μια ιδιοκτησία, αν αυτό είναι απαιτείται.");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_TOURS', 'Tours');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_INTRO', 'Τι είναι οι εκδρομές;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_INTRO', "Αυτό μπορεί να ακούγεται σαν ανόητη ερώτηση, αλλά στην πραγματικότητα δεν είναι. Με τα χρόνια μάθαμε ότι διαφορετικοί πολιτισμοί έχουν διαφορετικές αντιλήψεις για το τι είναι μια περιοδεία. Ως αποτέλεσμα, προσδοκίες πώλησης περιηγήσεων ποικίλλουν άγρια, οπότε πριν συζητήσουμε για περιηγήσεις, πρώτα θα ορίσουμε τι πιστεύουμε για τις εκδρομές. <br/> Μια περιήγηση είναι ένα απλό ταξίδι ή επίσκεψη για να δείτε ένα αξιοθέατο ή μνημείο. Ωστόσο, η διαμονή σε ξενοδοχείο δεν είναι περιοδεία μπορούν να συμμετέχουν περιηγήσεις κατά τη διαμονή σας σε ξενοδοχείο. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_HOWTOSELL', 'Πώς μπορώ να χρησιμοποιήσω το Jomres για να πωλήσω εκδρομές;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_HOWTOSELL', 'Για να αντιμετωπίσετε το ζήτημα της πώλησης περιηγήσεων στο Jomres, θα πρέπει πρώτα να εγκαταστήσετε το πρόσθετο Jintour. Αυτό το plugin σας επιτρέπει να δημιουργήσετε εκδρομές που πωλούνται ως μέρος των ενοικιαζόμενων διακοπών. Σας επιτρέπει επίσης να δημιουργήσετε ακίνητα που προορίζονται αποκλειστικά για την πώληση περιηγήσεων. Μόλις εγκατασταθεί αυτό το πρόσθετο, οι διαχειριστές ακινήτων θα μπορούν να δημιουργούν περιηγήσεις και περιηγήσεις στο προσκήνιο. ');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_WHATISJINTOUR', 'Τι είναι η προσθήκη Jintour;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_WHATISJINTOUR', 'Jintour σημαίνει Jomres INtegrated TOURs. Σας επιτρέπει να δημιουργήσετε απλούς, περιορισμένους πόρους που μπορούν να κρατηθούν, που δεν είναι δωμάτια σε μια ιδιοκτησία. Ενώ το plugin έχει σχεδιαστεί κυρίως για να επιτρέπει τις κρατήσεις μπορεί να χρησιμοποιηθεί για πολλά πράγματα, όχι μόνο για περιηγήσεις. Μπορούν να χρησιμοποιηθούν, για παράδειγμα, από ένα χιονοδρομικό κέντρο που θέλει να νοικιάσει σκι και εξοπλισμό. Καθώς αυτός ο εξοπλισμός θα έχει περιορισμένη διαθεσιμότητα, μπορείτε να χρησιμοποιήσετε το πρόσθετο Jintour για να επιτρέψετε στους επισκέπτες να κρατήστε και πληρώστε για αυτό το εργαλείο κατά την κράτηση. ');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_SAMEBOOKING', 'Πώς μπορώ να πουλήσω εκδρομές και ενοικιάσεις διακοπών στην ίδια κράτηση;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_SAMEBOOKING', "Σε αυτό το σενάριο, έχετε ένα ξενοδοχείο και θέλετε να πουλήσετε εκδρομές σε ένα τοπικό αξιοθέατο. Συνδεθείτε στο προσώπο και μεταβείτε στο ξενοδοχείο που έχετε δημιουργήσει. Στη συνέχεια, κάντε κλικ στις Ρυθμίσεις> Περιήγηση /Διαχείριση δραστηριοτήτων. Σε αυτήν τη σελίδα, ακολουθήστε τις οδηγίες στην οθόνη για να δημιουργήσετε πρώτα ένα προφίλ περιοδείας και, στη συνέχεια, να δημιουργήσετε περιηγήσεις. Μόλις ολοκληρωθεί, θα μπορείτε να πουλάτε τόσο περιηγήσεις όσο και κρατήσεις δωματίων και προαιρετικά πρόσθετα το ένα δίπλα στο άλλο στην ίδια φόρμα κράτησης . ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_STANDALONETOURS', 'Τι γίνεται αν θέλω να πωλήσω μόνο εκδρομές;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_STANDALONETOURS', "Πρώτα θα χρειαστεί να δημιουργήσετε μια νέα ιδιότητα στο προσκήνιο. Όταν το κάνετε, βεβαιωθείτε ότι έχετε ορίσει τον Τύπο ιδιοτήτων σε Tour. Όταν δημιουργήσετε αυτήν τη νέα ιδιότητα, τότε θα μπορείτε για να δημιουργήσετε ξανά περιηγήσεις μέσω της σελίδας Ρυθμίσεις> Διαχείριση περιήγησης/δραστηριότητας. Θα μπορείτε επίσης να προσφέρετε προαιρετικά πρόσθετα όπως σε κανονικές ιδιοκτησίες, το μόνο που δεν θα μπορείτε να κάνετε είναι να διαμορφώσετε τα δωμάτια, τις λειτουργίες των δωματίων ή τις τιμές όπως εσείς δεν πουλάω δωμάτια σε αυτό το κατάλυμα. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_GLOBALTOURS', 'Πώς μπορώ να δημιουργήσω έναν πόρο περιήγησης/κράτησης που να εμφανίζεται σε όλες τις φόρμες κράτησης ακινήτων;');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_GLOBALTOURS', "Στην περιοχή διαχειριστή του ιστότοπού σας, επισκεφθείτε τη σελίδα Portal> Functionality Tour/Activity Managerenent. Το προφίλ περιοδείας/η διαδικασία δημιουργίας είναι η ίδια που χρησιμοποιείται στο προσκήνιο, ωστόσο οι περιηγήσεις που δημιουργούνται εδώ φαίνονται στο frontend. Ένα τυπικό σενάριο όπου αυτό μπορεί να χρησιμοποιηθεί είναι εάν ο διαχειριστής του ιστότοπου διοργανώνει εκδηλώσεις σε όλη τη χώρα και θέλουν να πουλήσουν κρατήσεις ξενοδοχείων. Θα δημιουργούσαν τα συμμετέχοντα ξενοδοχεία στο frontend ως συνήθως, καθορίζοντας τιμές δωματίων κ.λπ., στη συνέχεια Σε αυτήν την περίπτωση, οι εκδρομές θα ήταν στην πραγματικότητα το τέλος συμμετοχής για την ίδια την εκδήλωση. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_FIRSTTHINGSFIRST', "Εντάξει, έχω εγκαταστήσει το Jomres, τι ακολουθεί;");
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_FIRSTTHINGSFIRST', "Το πρώτο, πολύ πρώτο πράγμα που πρέπει να κάνετε, τώρα που έχετε εγκαταστήσει το Jomres είναι να κάνετε κλικ στο Help (Βοήθεια) στο μενού στα αριστερά και, στη συνέχεια, στο Getting Started. Σοβαρά, φύγετε και κάντε το τώρα.") ;
jr_define ('_JOMRES_MANAGE_PROPERTIES', 'Διαχείριση ιδιοτήτων');
jr_define ('_JOMRES_CONFIG_IPINFODB_KEY_WARNING', "Δεν διαθέτετε κλειδί API ανίχνευσης IP. Αυτό απαιτείται για να επιτρέπει στο σύστημα να εντοπίζει αυτόματα την τοποθεσία του χρήστη και να ορίζει αυτόματα το νόμισμα και τη χώρα του. <a href = 'http://www.jomres.net/manual/site-manager-guide/35-control-panel/main/site-configuration/128-site-configuration-currency-conversion-currency-codes-tab' target='_blank'> δείτε το εγχειρίδιό μας σελίδα σχετικά με τον τρόπο δημιουργίας ενός κλειδιού API ανίχνευσης IP </a> και αποθήκευσης του κλειδιού στο Jomres> Διαμόρφωση ιστότοπου> Μετατροπές νομισμάτων / Κωδικοί νομίσματος. ");
jr_define ('_JOMRES_CONFIG_OPENEXCHANGERATES_KEY_WARNING', "Δεν έχετε ένα κλειδί API ανοικτής συναλλαγματικής ισοτιμίας. Αυτό απαιτείται για να επιτρέψει στο σύστημα να πραγματοποιεί αυτόματη λήψη και χρήση συναλλαγματικών ισοτιμιών. <a href = 'http://www.jomres.net/manual/site-manager-guide/35-control-panel/main/site-configuration/128-site-configuration-currency-conversion-currency-codes-tab' target='_blank'> δείτε τη σελίδα του εγχειριδίου μας για το πώς δημιουργήστε ένα κλειδί API ανίχνευσης IP </a> και αποθηκεύστε το κλειδί στο Jomres> Site Configuration> Currency Conversions / Currency Codes. ");
