...
jr_define('JOMRES_COM_A_TARIFFMODE_DESC', "<b>Προειδοποίηση: Η εναλλαγή μεταξύ διαφορετικών τρόπων επεξεργασίας τιμολογίων μπορεί να οδηγήσει σε απώλεια δεδομένων. Δείτε την παρακάτω σημείωση σχετικά με αυτό.</b>.
<br/><br/>
...
jr_define('_JOMRES_COM_LANGUAGE_CONTEXT_DESC', 'Χρησιμοποιήστε αυτήν την επιλογή για να αλλάξετε το γλωσσικό περιβάλλον του ιστότοπου. Αυτή η δυνατότητα επιτρέπει στη Jomres να χρησιμοποιεί ετικέτες που είναι κατάλληλες για τον τρόπο που χρησιμοποιείτε το Jomres, επομένως εάν η εστίασή σας είναι ως Μεσιτεία Yacht, τότε η αλλαγή του περιβάλλοντος θα επιτρέψει στη Jomres να παρουσιάσει ετικέτες κατάλληλες για γιοτ. Για παράδειγμα, εάν ορίσετε το περιβάλλον σε "Yacht Brokerage", τότε το Jomres θα βρει πρώτα την τρέχουσα γλώσσα και, στη συνέχεια, θα πραγματοποιήσει αναζήτηση στη βάση δεδομένων προσαρμοσμένου κειμένου για συμβολοσειρές που έχουν αποθηκευτεί με ένα γλωσσικό περιβάλλον "yachtbrokerage". Εάν υπάρχουν προσαρμοσμένες συμβολοσειρές για την τρέχουσα γλώσσα και το περιβάλλον, τότε αυτές θα χρησιμοποιηθούν. Εάν όχι, τότε το Jomres θα επιστρέψει στους ορισμούς γλώσσας που χρησιμοποιούνται από τα αρχεία γλώσσας Core.');
// 4.7.3
...
jr_define('_JOMRES_AJAX_SEARCH_COMPOSITE_HIDEFILTERS' , "Απόκρυψη φίλτρων");
	...
	jr_define('_JOMRES_COM_A_GATEWAYLIST_INFO', 'Σε αυτήν τη σελίδα μπορείτε να διαμορφώσετε τις πύλες πληρωμής μέσω των οποίων θέλετε να λαμβάνετε πληρωμές κατάθεσης. Θα χρειαστείτε έναν λογαριασμό στην πύλη πληρωμών. Η σελίδα ρυθμίσεων θα σας παρέχει οδηγίες για τη διαμόρφωση της πύλης. Εάν η πύλη έχει μια δοκιμαστική λειτουργία και εάν είναι ενεργοποιημένη η λειτουργία δοκιμής, εσείς ως διαχειριστής ιδιοκτησίας θα μπορείτε να χρησιμοποιήσετε την πύλη πληρωμής για να δοκιμάσετε τη διαμόρφωσή σας. Όταν η δοκιμαστική λειτουργία είναι απενεργοποιημένη, μόνο οι χρήστες που δεν είναι διαχειριστές θα βλέπουν τις πύλες πληρωμής κατά τη διαδικασία κράτησης .');

	jr_define('_JOMRES_COM_A_GATEWAYLIST_TEST_MODE_STR', "Λειτουργία δοκιμής");

	jr_define('JOMRES_ADMIN_UPDATE_NIGHTLY_WARNING', "Η λειτουργία ανάπτυξης είναι ενεργοποιημένη, επομένως, εάν χρησιμοποιήσετε αυτήν τη δυνατότητα, θα ενημερώσετε την εγκατάσταση του Jomres στον κλάδο Nightly. Αυτή είναι η πιο πρόσφατη έκδοση του Jomres και μπορεί να είναι ή να μην είναι σταθερή. Εάν το κάνετε δεν θέλετε να κάνετε ενημέρωση σε Nightly, επισκεφτείτε Διαχειριστής > Jomres > Ρυθμίσεις > Διαμόρφωση ιστότοπου > καρτέλα Εντοπισμός σφαλμάτων και ορίστε την επιλογή Παραγωγή/Ανάπτυξη σε Παραγωγή.");

	jr_define('JOMRES_POLICY_OCCUPANCY_LEVELS_INCLUDE_CHILDREN', "Να συμπεριληφθούν παιδιά στους ελέγχους επιπέδου πληρότητας;");
