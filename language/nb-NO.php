...
Du kan la målspråket settes til ditt nåværende språk og bruke denne siden til å endre navn på elementer her, i stedet for å besøke deres individuelle sider.');
	...
	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN', "All eiendomsadministrasjon utføres i frontend av nettstedet ditt. Du er for øyeblikket ikke logget inn som eiendomsforvalter, så vennligst logg inn først og deretter vil du kunne administrere eiendommene dine.");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN_EXPOSITION_FOR_NEW_USERS_JOOMLA', "Når Jomres installeres for første gang vil det opprette en Super Property Manager for administratorbrukeren, og legge til et nytt alternativ til hovedmenyen som heter denne menyen som heter bestillinger. Ikke slett denne knappen siden Bestillinger for å begynne å administrere eiendommer. ");
