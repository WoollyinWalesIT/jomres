...
##################################################################
jr_define( '_JOMRES_COM_MR_QUICKRESDESC', 'Hurtig Reservasjon' );
jr_define( '_JOMRES_COM_MR_SHOWPROFILES', 'Vis Profiler' );
jr_define( '_JOMRES_COM_MR_GENERALCONFIGDESC', 'Generel Konfigurasjon' );
...
jr_define( '_JOMRES_COM_MR_NEWPROPERTY', 'Nye Egenskaper' );
jr_define( '_JOMRES_COM_MR_NEWPROPERTYFEATURE', 'Nye hotell/motell/rom egenskaper' );
...
jr_define( '_JOMRES_COM_MR_VIEWBOOKINGS_ARRIVAL', 'Ankomst Dato' );
jr_define( '_JOMRES_COM_MR_VIEWBOOKINGS_DEPARTURE', 'Avreise Dato' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_TITLE', 'Tildel Brukere for Administrering av Funksjoner' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_ID', 'ID' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_NAME', 'Navn' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_USERNAME', 'Bruker navn' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDHOTELUSER', 'Autorisert' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL', 'Standard egenskaper' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDCHANGETHIS', 'Endre Disse' );
...
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_LEVEL_RECEPTION', 'Resepsjon' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_LEVEL_ADMIN', 'Behandle Egenskaper' );
// Edit bookings
jr_define( '_JOMRES_COM_MR_EDITBOOKING_ADMIN_TITLE', 'Alle Bestillinger' );
jr_define( '_JOMRES_COM_MR_EDITBOOKING_ADMIN_NEWBOOKINGS', 'Nye Bestillinger(deponeringer ubetalt)' );
jr_define( '_JOMRES_COM_MR_EDITBOOKINGTITLE', 'Endre Bestilling' );
jr_define( '_JOMRES_COM_MR_EDITBOOKING_TAB_ARRIVAL', 'Ank/Avg' );
jr_define( '_JOMRES_COM_MR_EDITBOOKING_TAB_GUEST', 'Gjest' );
jr_define( '_JOMRES_COM_MR_EDITBOOKING_TAB_ROOM', 'Rom' );
...
jr_define( '_JOMRES_COM_MR_EB_ROOM_BOOKINGSPECIALREQ_DISCLAIMER', 'Vennligst vær oppmerksom på at enkelte spesielle krav medfører ekstra kostnader.' );
jr_define( '_JOMRES_COM_MR_EB_GUEST_JOMRES_CANCELBOOKING', 'Kanseller din Bestilling' );
jr_define( '_JOMRES_COM_MR_EB_GUEST_JOMRES_HOUSE_EXPL', 'Husnr eller Navn' );
jr_define( '_JOMRES_COM_MR_EB_GUEST_JOMRES_STREET_EXPL', 'Gate' );
...
jr_define( '_JOMRES_COM_MR_EB_ROOM_NAME', 'Rom navn' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_NUMBER', 'Rom nummer' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_FLOOR', 'Etg' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_DISABLED', 'Handikapp tilpasset?' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MAXPEOPLE', 'Maks antall personer' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV', 'Rom - type' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_CLASS_DESC', 'Rommets beskrivelse' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_FEATURES_LIST', 'Rommets egenskaper' );
...
jr_define( '_JOMRES_COM_MR_DISPGUEST_CCARDNO', 'Kredittkort nummer' );
jr_define( '_JOMRES_COM_MR_DISPGUEST_CCARDISS', 'Kort utstedt den' );
jr_define( '_JOMRES_COM_MR_DISPGUEST_CCARDEXPIRE', 'Kortets utløpsdato' );
jr_define( '_JOMRES_COM_MR_DISPGUEST_CCARISSNO', 'Issue number (brukes ikke i norge)' );
jr_define( '_JOMRES_COM_MR_DISPGUEST_CCARDNAME', 'Navn på kortets  innehaver' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP4_TITLE', 'Velg et rom' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP4_STAYDAYS', 'Oppholdets lengde' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP4_NUMBEROFGUESTS', 'Antall gjester' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP4_TOTALINVOICE', 'Totalt' );
// Rooms tab
jr_define( '_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE', 'Se rom & egenskaps konfigurasjon' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOM', 'Rom' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOMFEATURES', 'Rom - egenskaper' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOMTYPES', 'Rom - typer' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_PROPERTYS', 'hotell/motell/rom' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_PROPERTYFEATURES', 'hotell/motell/rom - egenskaper' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_HEADER_LINK', 'Rom' );
...
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_HEADER_DISABLEDACCESS', 'Handikap tilpasset?' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_HEADER_MAXPEOPLE', 'Maks antall folk' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_HEADER_FEATURES', 'Fasiliteter' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_SAVE_INSERT', 'Rom er lagt til' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_LINKTEXT', 'Rediger rommet' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMFEATURES_HEADER_LINK', 'Rommets fasiliteter' );
...
jr_define( '_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_UPDATE', 'Rommets fasiliteter er oppdatert' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK', 'Rom - type' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV', 'Rom - type, forkortelse' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC', 'Rom - type beskrivelse' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT', 'Rom - type er lagt til' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE', 'Rom - type er oppdatert' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_LINKTEXT', 'Rediger enhet' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_NAME', 'Navn' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_STREET', 'Gate' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT', 'hotell/motell/rom lagt til' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_UPDATE', 'hotell/motell/rom er oppdatert' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_LINK', 'hotell/motell/rom -  fasiliteter' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_ABBV', 'hotell/motell/rom fasilitet abbv.' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_DESC', 'Full beskrivelse av rommets fasiliteter' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_INSERT', 'hotell/motell/rom - fasilitet lagt til' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_UPDATE', 'hotell/motell/rom - fasilitet er oppdatert' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_TITLE', 'Pris' );
...
jr_define( '_JOMRES_COM_MR_LISTTARIFF_ROOMRATEPERDAY', 'Pris pr natt' );
...
jr_define( '_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS', 'Rom - type' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_IGNOREPPN', 'Ignorer PPPN' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_ALLOWWE', 'Tillat helger' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_SAVE_INSERT', 'Pris lagt til' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_SAVE_UPDATE', 'Pris er oppdatert' );
...
jr_define( '_JOMRES_COM_MR_PUBLICHOLIDAY_TITLE', 'Offentlige fridager' );
jr_define( '_JOMRES_COM_MR_BOOKINGSAVEDMESSAGE', 'Bestilling lagret' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAGUESTIN', 'Registrer en gjest inn' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAGUESTOUT', 'Registrer en gjest ut' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_LISTBOOKINGS', 'List bestillinger' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_LISTNEWBOOKINGS', 'List NYE bestillinger' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_HOME', 'Admin Panel' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_GUESTADMIN', 'Administrer gjester' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_PROPERTYADMIN', 'Administrer hotell/motell/rom' );
jr_define( '_JOMRES_FRONT_MR_SUBMITBUTTON_CHECKAVAILABILITY', 'Sjekk om ledig' );
jr_define( '_JOMRES_FRONT_MR_SUBMITBUTTON_CONFIRMYOURDETAILS', 'Bekreft dine personalia' );
...
jr_define( '_JOMRES_FRONT_MR_EB_GUEST_JOMRES_STREET_EXPL', 'Gate' );
jr_define( '_JOMRES_FRONT_MR_EB_GUEST_JOMRES_TOWN_EXPL', 'Sted' );
jr_define( '_JOMRES_FRONT_MR_EB_GUEST_JOMRES_POSTCODE_EXPL', 'Postnr' );
jr_define( '_JOMRES_FRONT_MR_EB_GUEST_JOMRES_LANDLINE_EXPL', 'Tlf. nummer' );
jr_define( '_JOMRES_FRONT_MR_EB_GUEST_JOMRES_MOBILE_EXPL', 'Mobil nummer' );
jr_define( '_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE', 'Det finnes ingen rom som tillfredstiller de ønskene du har spesifisert' );
jr_define( '_JOMRES_FRONT_MR_BOOKINGMADE', '<center>Tusen takk for at du bestiller hos oss og vi håper du får glede av oppholdet.<br><br> <b>Vi gjør oppmerksom på at bestillingen ikke er endelig før du har mottatt bekreftelse fra oss.</center>' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE', 'Bestillingen er gjort for hotell/motell/rom: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM', 'Bestillingen er gjort for rom: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_ARRIVAL', 'Annkomst: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_DEPARTURE', 'Avreise: ' );
...
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_TOTAL', 'Kontrakten pålyder: ' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_TITLE', 'Registrer inn gjest ' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_SELECTBUTTON', 'Velg gjest ' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_GUESTBOOKEDIN', 'Gjest er registrert ' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_NOGUESTSDUEIN', 'Ingen gjester er ventet i dag' );
jr_define( '_JOMRES_FRONT_MR_BOOKOUT_TITLE', 'Registrer avreise på en gjest ' );
jr_define( '_JOMRES_FRONT_MR_BOOKOUT_NOGUESTSDUEOUT', 'Ingen gjester skal reise i dag' );
// Config panel
jr_define( '_JOMRES_COM_A_SUPPLIMENTS', 'Supplemanger' );
jr_define( '_JOMRES_COM_A_TARIFFS', 'Pris & Valuta' );
jr_define( '_JOMRES_COM_A_DISCOUNTS', 'Rabattering' );
jr_define( '_JOMRES_COM_A_JOMRES_FILE_UPLOADS', 'Fil opplasting' );
jr_define( '_JOMRES_COM_A_CURRENT_SETTINGS', 'Nåværende Setting' );
jr_define( '_JOMRES_COM_A_EXPLANATION', 'Forklaring' );
jr_define( '_JOMRES_COM_A_SUPPLIMENTS_SINGLEPERSON', 'Enkel person tillegg' );
jr_define( '_JOMRES_COM_A_SUPPLIMENTS_SINGLEPERSON_DESC', 'Pass på at du setter denne til Ja om du ønsker og benytte singel person tillegg' );
jr_define( '_JOMRES_COM_A_SUPPLIMENTS_SINGLEPERSON_COST', 'Enkel person tillegg' );
jr_define( '_JOMRES_COM_A_DEPOSIT_ISPERCENTAGE', 'Forskudd som kreves er prosentvis?' );
jr_define( '_JOMRES_COM_A_DEPOSIT_ISPERCENTAGE_DESC', 'Er forskuddet som kreves er prosentvis av den total ordren? Hvis Nei, hvis nei vil depositumet bli fast pris' );
jr_define( '_JOMRES_COM_A_DEPOSIT_VALUE', 'Ønsket forskuddsbeløp' );
jr_define( '_JOMRES_COM_A_TARIFFS_PER', 'Pr person, pr natt' );
jr_define( '_JOMRES_COM_A_TARIFFS_PER_DESC', 'Velg Ja om du ønsker å belaste pr-person-pr-natt. Om ikke vil prisen bli beregnet på en pr-rom-pr-natt basis' );
jr_define( '_JOMRES_COM_A_UPLOADS_FILESIZE', 'Fil størrelse' );
jr_define( '_JOMRES_COM_A_UPLOADS_FILESIZE_DESC', 'Maks. Bilde filstørrelse i Kilobyte' );
jr_define( '_JOMRES_FRONT_MR_BOOKED', 'Bestilt' );
jr_define( '_JOMRES_COM_CONFIRMATION_TITLE', 'Bekreftelses brev' );
jr_define( '_JOMRES_COM_CONFIRMATION_DEAR', 'Kjære ' );
jr_define( '_JOMRES_COM_CONFIRMATION_RATE_RULES', 'Pris pr natt - pr rom ' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_DETAILS', 'Bestillings detaljer' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_INTRO1', 'Tusen takk for deres bestilling på' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_INTRO2', '. Her er en oppsummering av bestillingen. Vær vennlig å kontroller at alt er korekt, om du finner feil så vennligst kontakt oss omgående.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN', 'Ditt rom er reservert til din annkomst, og du kan sjekke inn etter 12.00.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_LOOKFORWARD', 'Vi ser frem til å ønske deg velkommen på' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_HAVEAPLEASANTSTAY', 'Vi håper at du får et hyggelig opphold.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINTINTRO', 'Nå vil vi henvise deg til det med liten skrift.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_BINDINGCONTRACT', 'Vi minner deg på at en bestilling er en bindende kontrakt, slik at dersom du av en eller annen grunn avbestiller eller forkorter din bestilling så vil du likevel være ansvarlig for å betale hele beløpet.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE', 'Det gis ingen kompensasjon for uspiste måltider eller rom som ikke anvendes hele perioden det er bestilt for. Med tanke på dette anbefaler vi deg på det sterkeste å anskaffe en reiseforsikring.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_CANCELLATIONCHARGES_INTRO', '<i>Avbestillings avgifter</i> Om du avbestiller må du gjøre det skriftlig. Avbestillingsgebyrer er som følger:' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_30DAYSPLUS', '30 dager eller mer' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_DEPOSITONLY', ' Kun forskudd.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_1530DAYS', '15 til 30 dager' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_50PERCENT', ' 50% av den totale kontrakt.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_ARRIVALDATETO14DAYS', 'Ankomst dato til 14 dager før' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_100_PERCENT', ' 100% av total kontrakt.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_VAT', 'VAT@ 17.5% er inkludert i alle priser. Eventuell økning vil bli belastet.' );
...
jr_define( '_JOMRES_COM_INVOICE_CONTRACTAGREED', 'Kontrakt initielt akseptert: ' );
jr_define( '_JOMRES_COM_INVOICE_COSTPERNIGHT', 'Pris pr natt: ' );
jr_define( '_JOMRES_COM_INVOICE_LETTER_GRANDTOTAL', 'Totalsum' );
jr_define( '_JOMRES_COM_INVOICE_LETTER_INTRO1', 'Tusen takk ditt opphold hos' );
jr_define( '_JOMRES_COM_INVOICE_LETTER_HOPEYOUENJOYEDSTAY', 'Vi håper å se deg igjen.' );
...
jr_define( '_JOMRES_COM_ADDSERVICE_TOTALVALUE', 'Andre belastede enheter, total sum: ' );
...
jr_define( '_JOMRES_FILE_ERROR_TYPE', 'Du kan kun laste opp filer av type:\n' );
jr_define( '_JOMRES_FILE_ERROR_EMPTY', 'Vennligst velg en fil før opplasting' );
jr_define( '_JOMRES_FILE_ERROR_NAME', 'Filen må kun inneholde alfanumeriske tegn og ingen mellomrom.' );
jr_define( '_JOMRES_FILE_ERROR_SIZE', 'Filstørrelsen overskrider det maksimum Administrator har satt.' );
jr_define( '_JOMRES_FILE_NOT_UPLOADED', 'Din fil er IKKE lastet.' );
jr_define( '_JOMRES_FILE_UPDATED', 'Din fil er lastet opp.' );
jr_define( '_JOMRES_COM_A_JSCALENDAR', 'JS Kalender' );
jr_define( '_JOMRES_COM_A_CALENDARLANGUAGE', 'JS Kalender språk fil' );
jr_define( '_JOMRES_COM_A_CALENDARLANGUAGE_DESC', 'Velg den språk filen som skal benyttes i Javascript kalenderen. Vennligst legg merke til at noen av kalenderne kan ha feil, Se http://sourceforge.net/  for flere opplysninger' );
jr_define( '_JOMRES_COM_A_CALENDARCSS', 'JS Kalender CSS fil' );
jr_define( '_JOMRES_COM_A_CALENDARCSS_DESC', 'Velg CSS fil som skal brukes i Javascript kalenderen' );
...
jr_define( '_JOMRES_COM_MR_ROOM_UNABLETODELETE', 'Kan ikke slette dette rommet, de er  bestilt av noen. Slett bestillingene og prøv igjen.' );
jr_define( '_JOMRES_COM_MR_ROOM_DELETED', 'Rom er slettet' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_DELETE', 'Slett rom - fasiliteter' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE', 'Kan ikke slette denne rom - fasiliteten, den er tildelt flere rom. Fjern rom - fasiliten fra disse rommene og prøv igjen.' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_DELETED', 'Rom - fasilitet er slettet' );
jr_define( '_JOMRES_COM_MR_PROPERTYFEATURE_DELETE', 'Slett hotell/motell/rom - fasilitet' );
jr_define( '_JOMRES_COM_MR_PROPERTYFEATURE_UNABLETODELETE', 'Kan ikke slette denne hotell/motell/rom - fasiliteten, en er tildelt flere hotell/motell/rom. Fjern fasiliteten fra hotell/motell/rom og prøv igjen.' );
jr_define( '_JOMRES_COM_MR_PROPERTYFEATURE_DELETED', 'hotell/motell/rom - fasilitet er slettet' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_DELETE', 'Slett rom - type' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS', 'Kan ikke slette denne rom - typen, den er knyttet til et rom. Prøv å gi rommet en annen rom - type og prøv på nytt.' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS', 'Kan ikke slette denne rom - typen, den er knyttet til en pris. Prøv å gi pris til en annen rom - type og prøv på nytt.' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_DELETED', 'Rom - type er slettet' );
jr_define( '_JOMRES_COM_MR_PROPERTY_DELETE', 'Slett hotell/motell/rom' );
jr_define( '_JOMRES_COM_MR_PROPERTY_DELETED', 'hotell/motell/rom er slettet' );
jr_define( '_JOMRES_COM_MR_PROPERTY_DELETE_NORIGHTS', 'Du har ikke rettighet til å slette hotell/motell/rom.' );
jr_define( '_JOMRES_COM_A_UPLOADS_IMAGES_WIDTH_LARGE', 'Fullstørrelse bilde bredde' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_MAPPINGLINK', 'Klikk for et kart' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION', 'hotell/motell/rom - beskrivelse' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_CHECKINTIMES', 'Sjekk inn tider' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_AREAACTIVITIES', 'Aktiviteter' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_DRIVINGDIRECTIONS', 'Vei forklaring' );
...
jr_define( '_JOMRES_COM_A_VISITORSCANBOOKONLINE', 'Gjester kan bestille online' );
jr_define( '_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC', 'Sett denne til Ja for å tillate gjester å bestille rom online.' );
jr_define( '_JOMRES_COM_A_FIXEDPERIODBOOKINGS', 'Bestillinger er for en bestemt periode' );
jr_define( '_JOMRES_COM_A_FIXEDPERIODBOOKINGS_DESC', 'Om du setter denne til Ja, så registrerers bestillingen for en avgrenset periode. Om den er satt til Nei, så må du forsikre deg om at "Forhånds
...
jr_define( '_JOMRES_COM_A_BOOKING', 'Bestilt rom' );
jr_define( '_JOMRES_COM_A_FIXEDPERIOD_NUMBEROFPERIODS', 'Maks perioder, eks 3x 7 bestilte perioder = 21 dager' );
jr_define( '_JOMRES_COM_A_SINGLEROOMPROPERTY', 'Er dette en hotell/motell/rom?' );
jr_define( '_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC', 'Eks du leier ut et hotell/motell/rom, ikke et rom i eiendommen. Om så må du passe på at du bare har et rom registret på hver hotell/motell/rom.' );
jr_define( '_JOMRES_FRONT_MR_REVIEWBOOKING', 'Se bestillinger' );
jr_define( '_JOMRES_COM_MR_CONFIRMBOOKING', 'Bekreft bestillinger' );
...
jr_define( '_JOMRES_COM_A_AVLCAL', 'Tilghengelighets kal.' );
jr_define( '_JOMRES_COM_AVLCAL_TODAYCOLOUR', 'Skrift farge for dagens dato' );
jr_define( '_JOMRES_COM_AVLCAL_INMONTHFACE', 'Skrift farge for dager i den viste måneden ' );
jr_define( '_JOMRES_COM_AVLCAL_OUTMONTHFACE', 'Skrift farge for dager som ikke er i den viste måneden' );
jr_define( '_JOMRES_COM_AVLCAL_INBGCOLOUR', 'Boks bakgrunnsfarge for dager når hotell/motell/rom er ledig' );
jr_define( '_JOMRES_COM_AVLCAL_OUTBGCOLOUR', 'Boks bakgrunnsfarge for dager som ikke er i den viste måneden' );
jr_define( '_JOMRES_COM_AVLCAL_OCCUPIEDCOLOUR', 'Boks bakgrunnsfarge for bestillte dager' );
jr_define( '_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR', 'Boks bakgrunnsfarge for midlertidig bestilte rom (bestilling hvor forskudd ikke er betalt)' );
jr_define( '_JOMRES_COM_AVLCAL_PASTCOLOUR', 'Boks bakgrunnsfarge for tidligere datoer' );
...
jr_define( '_JOMRES_COM_MR_FIXEDARRIVALDATE_YESNO', 'Forhåndsbestemt ankomst - Dag' );
jr_define( '_JOMRES_COM_MR_FIXEDARRIVALDATE_YESNO_DESC', 'Kun for nettsteder som tilbyr bestilling av forhånds
definerte perioder. Velg ankomstdato.' );
jr_define( '_JOMRES_COM_MR_FIXEDARRIVALDATE_DAY', 'Fast ankomst dag' );
jr_define( '_JOMRES_FRONT_MR_FIXEDPRIOD1', 'Oppholdets varighet (dager)' );
jr_define( '_JOMRES_COM_A_SHOWAVILABILITY_CALENDAR', 'Vis tilgjengelighets kalenderen?' );
jr_define( '_JOMRES_COM_A_SHOWAVILABILITY_CALENDAR_DESC', 'Sett denne til ja for å vise tilgjengelighets kalenderen' );
...
jr_define( '_JOMRES_FRONT_BLACKBOOKING', 'Overbestilling' );
jr_define( '_JOMRES_FRONT_BLACKBOOKING_NEW', 'Ny overbestilling' );
jr_define( '_JOMRES_FRONT_DELETEGUEST', 'Slett gjest' );
jr_define( '_JOMRES_FRONT_DELETEGUEST_GUESTDELETED', 'Gjest er slettet' );
jr_define( '_JOMRES_FRONT_DELETEGUEST_UNABLETODELETEGUEST', 'Kan ikke slette denne gjesten fordi de har åpne bestillinger. Sltt bestillingene & prøv igjen.' );
jr_define( '_JOMRES_COM_INVOICE_ACTUALROOMCOST', 'Reell rom pris: ' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_HELLO', 'Hei' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_THANKS', 'Tusen takk for at du foretar din bestilling hos oss' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_SUMMARY', 'Her er en oppsummering av din bestilling:' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_ANYQUESTIONS', 'Om du har noen spørsmål i forbindelse med bestillingen eller noen av våre andre tjenester, så må du ikke nøle med å ta kontakt med oss.' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_TELEPHONE', 'Vårt tlf nummer er' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_EMAIL', 'Alternativt kan du kontakte oss med e-post til' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_ROOMSMOKING', 'Røking' );
jr_define( '_JOMRES_FRONT_ROOMSMOKING_EITHER', 'Spiller ingen rolle' );
jr_define( '_JOMRES_COM_CALENDAROUTPUT', 'Kalender format' );
jr_define( '_JOMRES_COM_CALENDAROUTPUT_DESC', 'Dette lar brukeren endre format på datoer inne i systemet' );
jr_define( '_JOMRES_COM_CALENDARINPUT', 'Kalender input format' );
jr_define( '_JOMRES_COM_CALENDARINPUT_DESC', 'Dette lar brukeren endre input format på datoer inne i systemet.' );
jr_define( '_JOMRES_COM_A_FIXEDPERIODBOOKINGSSHORT', 'Fast periode bestilling gir adgang til korte pauser' );
jr_define( '_JOMRES_COM_A_FIXEDPERIOD_SHORTBREAK_DAYS', 'Lengde på kort pauser' );
...
jr_define( '_JOMRES_MR_AUDIT_LISTING_VIEWSQL', 'Se detaljer' );
jr_define( '_JOMRES_MR_AUDIT_LISTING_FILTER_DATE', 'Filter på dato' );
jr_define( '_JOMRES_MR_AUDIT_LISTING_FILTER_USERNAME', 'Filter på brukernavn' );
jr_define( '_JOMRES_MR_AUDIT_LISTING_FILTER_OPERATION', 'Filter på oppgave' );
...
jr_define( '_JOMRES_COM_MR_VIEWBOOKINGS_DEPARTTODAY', 'Avreiser i dag' );
...
jr_define( '_JOMRES_MR_AUDIT_UNKNOWNUSER', 'Ukjent bruker' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM', 'Opprettet rom' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM', 'Oppdatert rom' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM', 'Slettet rom' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE', 'Opprettet rom - fasiliter' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE', 'Oppdatert rom - fasiliter' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE', 'Slettet rom - fasiliter' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE', 'Opprettet rom - type' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE', 'Oppdatert rom - type' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE', 'Slettet rom - type' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_PROPERTY', 'Opprettet hotell/motell/rom' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_PROPERTY', 'Oppdatert hotell/motell/rom' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_PROPERTY', 'Slettet hotell/motell/rom' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_PROPERTY_FEATURE', 'Opprettet hotell/motell/rom - fasiliteter' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_PROPERTY_FEATURE', 'Oppdatert hotell/motell/rom - fasiliteter' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_PROPERTY_FEATURE', 'Slettet hotell/motell/rom - fasiliteter' );
jr_define( '_JOMRES_MR_AUDIT_EDIT_PROPERTY_SETTINGS', 'Redigert hotell/motell/rom - setninger' );
jr_define( '_JOMRES_MR_AUDIT_PUBLISH_PROPERTY', 'Publiser hotell/motell/rom' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_TARIFF', 'Opprettet pris' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_TARIFF', 'Oppdatert pris' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_TARIFF', 'Slettet pris' );
jr_define( '_JOMRES_MR_AUDIT_ADDSERVICE', 'Lagt til service tillegg' );
jr_define( '_JOMRES_MR_AUDIT_BOOKEDGUESTIN', 'Regisrert gjest inn' );
jr_define( '_JOMRES_MR_AUDIT_BOOKEDGUESTOUT', 'Regisrert gjest ut' );
jr_define( '_JOMRES_MR_AUDIT_ENTEREDDEPOSIT', 'Registret forskudd' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_GUEST', 'Opprettet gjest' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_GUEST', 'Oppdatert gjest' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_GUEST', 'Slettet gjest' );
jr_define( '_JOMRES_MR_AUDIT_BOOKED_ROOM', 'Bestilt et rom' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_EXTRA', 'Opprettet en ekstra tjeneste' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_EXTRA', 'Oppdaterte en ekstratjeneste' );
...
jr_define( '_JOMRES_MR_AUDIT_BLACKBOOKING', 'Opprettet overbestilling.' );
jr_define( '_JOMRES_MR_AUDIT_BLACKBOOKING_DELETE', 'Slettet overbestilling.' );
...
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_EXTRAS', 'Administrer tillegg' );
jr_define( '_JOMRES_COM_A_EXTRAS', 'Vis tillegg ved bestilling?' );
jr_define( '_JOMRES_COM_A_EXTRAS_DESC', 'Sett denne til ja for å vise tilleggene som du ønsker å tilby gjesten' );
jr_define( '_JOMRES_FRONT_MR_BOOKING_EXTRAS_HELP', 'Valgfrie tillegg.' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_BBSTARTS', 'Overbestilling start dato' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_BBSERVICERESUMES', 'Service påbegynt dato' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS', 'Administrer Overbooking' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR', 'De oppstod en feil ved bestilling av disse rom, ett eller flere av rommene du har valgt er ikke ledig.' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT', 'Rom inkludert i overbestilling' );
jr_define( '_JOMRES_COM_MR_BLACKBOOKINGS_VIEWBLACKBOOKING', 'Se overbooking' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_NOBBOOKINGS', 'Der er ingen overbooking å vise' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_STARS', 'Antall stjerner' );
jr_define( '_JOMRES_COM_A_SMOKING', 'Vis røyke alternativer?' );
jr_define( '_JOMRES_COM_A_SMOKING_DESC', 'Sett denne til ja for å vise røyke alternativer.' );
...
jr_define( '_JOMRES_COM_A_SMOKING_OPTION', 'Standard røkinger valg' );
jr_define( '_JOMRES_COM_A_CURRENCYSYMBOL', 'Valuta symbol' );
jr_define( '_JOMRES_COM_A_CURRENCYSYMBOL_DESC', 'Eg &amp;pound&#59; Vennligst vær oppmerksom på at du må bruke HTML entities kode for det ønskede symbol. For en list over disse entities vennligst besøk <a href="http://www.w3schools.com/tags/ref_entities.asp">w3schools</a>' );
jr_define( '_JOMRES_COM_A_CURRENCYCODE', 'Valuta kode' );
jr_define( '_JOMRES_COM_A_CURRENCYCODE_DESC', 'For eks. NOK. Dette er brukt i e-posten som er sendt til kunden for å bekrefte deres bestilling.' );
jr_define( '_JOMRES_COM_A_CLICKFORMOREINFORMATION', 'Klikk for mer informasjon' );
jr_define( '_JOMRES_COM_A_ADVANCEBOOKINGSLIMITYESNO', 'Begrens avanserte bestillinger?' );
jr_define( '_JOMRES_COM_A_ADVANCEBOOKINGSLIMITYESNO_DESC', 'Sett denne til ja om du ønsker å begrense avansert bestilling (bruk det neste feltet for å sette begrensninger i antall dager). Om du setter denne til ja så vil, dersom brukeren prøver å bestille mer enn en dag på forhånd, deres annkomst dato bli satt til dagens dato' );
jr_define( '_JOMRES_COM_A_ADVANCEBOOKINGSLIMITDAYS', 'Dager avanserte bestillinger er begrenset til:' );
jr_define( '_JOMRES_COM_A_TAX_WARNING', '<font color=red>NOTE: Det er ikke å anbefale at du setter begge disse valgene til Ja, du bør bruke kun en av de to skattebergningene som er tilgjengelig. </FONT>' );
jr_define( '_JOMRES_COM_FRONT_ROOMTAX', 'Avgift' );
jr_define( '_JOMRES_COM_A_ROOMTAX', 'Rom - Avgift' );
jr_define( '_JOMRES_COM_A_ROOMTAX_DESC', '(Dette valget gjelder ikke Norge) Designet for det Amerikanske markedet. Dette er romavgtiften som vil bli belastet gjesten. Du kan belaste fast eller end prosentvis sum. Vær oppmerksom på at disse avgiftene kun legges til på prisen for rommet.' );
jr_define( '_JOMRES_COM_A_ROOMTAX_FIXED', 'romavgift fast beløp' );
...
jr_define( '_JOMRES_MR_AUDIT_ARCHIVED_MESSAGE', ' Poster arkivert' );
jr_define( '_JOMRES_MR_AUDIT_ARCHIVED_AUDIT', 'Endre arkiverte endrede poster' );
jr_define( '_JOMRES_FRONT_TARIFFS', 'Vår Pris' );
jr_define( '_JOMRES_FRONT_TARIFFS_TITLE', 'Pris navn' );
jr_define( '_JOMRES_FRONT_TARIFFS_DESC', 'Pris beskrivelse' );
jr_define( '_JOMRES_FRONT_TARIFFS_ROOMTYPE', 'Rom - type' );
...
jr_define( '_JOMRES_COM_A_EDITING_CURRENTTEXT', 'Nåværende tekst' );
jr_define( '_JOMRES_COM_A_EDITING_NEWTEXT', 'Ny tekst' );
jr_define( '_JOMRES_MR_AUDIT_UPDATECUSTOMTEXT', 'Oppdatert kunde tekst.' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_LANGUAGE', 'Redigere språk' );
jr_define( '_JOMRES_COM_A_AUDITING_SHOWING', 'Antall uarkiverte poster: ' );
jr_define( '_JOMRES_FRONT_PTYPE', 'hotell/motell/rom - type' );
jr_define( '_JOMRES_COM_PTYPES_LIST_TITLE', 'List hotell/motell/rom - typer' );
jr_define( '_JOMRES_COM_PTYPES_LIST_TITLE_EDIT', 'Rediger hotell/motell/rom - typer' );
jr_define( '_JOMRES_COM_PTYPES_PTYPE', 'hotell/motell/rom - type' );
jr_define( '_JOMRES_COM_PTYPES_PTYPE_DESC', 'Beskrivelse hotell/motell/rom - Typer' );
jr_define( '_JOMRES_COM_PTYPES_SAVED', 'hotell/motell/rom - type lagret' );
jr_define( '_JOMRES_COM_PTYPES_UNABLETO_DELETE', 'Kan ikke slette hotell/motell/rom - type. hotell/motell/rom - type er tilldelt en eller flere eiendommer, vennligst tildel på nytt før du prøver å slette' );
jr_define( '_JOMRES_COM_PTYPES_DELETED', 'hotell/motell/rom - type(r) er slettet' );
jr_define( '_JOMRES_COM_MR_EDITBOOKING_REMAINDERTOPAY', 'Betalings påminnelse' );
...
jr_define( '_JOMRES_COM_MONTHSTOSHOW', 'Kalender måneder for å vise' );
jr_define( '_JOMRES_COM_MONTHSTOSHOW_DESC', 'I rom tilgjengelighet, hvor mange måneder skal vises i kalenderen?' );
jr_define( '_JOMRES_INVOICE_SIGNEDONBEHALFOF', 'Signert på vegne av ' );
// V1.4
jr_define( '_JOMRES_COM_A_GATEWAYLIST', 'Utveier' );
jr_define( '_JOMRES_COM_A_CANCEL', 'Avbryt' );
jr_define( '_JOMRES_FRONT_BLACKBOOKING_DESC', 'Velg rommene du vil markere som ute av service, og de aktuelle datoene. <br>Dersom et rom ikke har en avmerking, kan det ikke inkluderes i overbookinger før eventuelle opphold er avslutett/kasellert.<br/> Etter at du har valgt de aktuelle datoene klikker du den blå "bruk" knappen for å kontrollere rom tilgjengeligheten igjen. ' );
jr_define( '_JOMRES_JR_NOTLOGGEDIN', '<center><b>Det ser ut som om systemet har logget deg ut pga. innaktivitet</b> Logg inn igjen og prøv på nytt.' );
jr_define( '_JOMRES_JR_BLACKBOOKING_REASON', 'Årsak' );
jr_define( '_JOMRES_COM_A_GATEWAY_USEGATEWAYS', 'Bruke betalingstjenester?' );
jr_define( '_JOMRES_COM_A_GATEWAY_USEGATEWAYS_DESC', 'Sett denne til ja om du ønsker å benytte online betalingstjeneste. <b>NB:</b>Dette slår ikke av den automatiske beregningen av forskudd som gjøres i bestillingsprossesen. For å fjerne denne kan du redigere utseende som viser rom og fjerne elementet som viser forskuddet.' );
...
jr_define( '_JOMRES_MR_AUDIT_PLUGINS_UPDATE', 'Modifisert plugin instillinger' );
jr_define( '_JOMRES_MR_AUDIT_PLUGINS_INSERT', 'Lagt til plugin instillinger' );
...
jr_define( '_JOMRES_MR_AUDIT_CREDITCARD_VIEWED', 'Se kreditt kort' );
jr_define( '_JOMRES_MR_AUDIT_CREDITCARD_UPDATED', 'Oppdatert kreditt kort' );
jr_define( '_JOMRES_MR_CREDITCARD_EDIT', 'Rediger kreditt kort' );
jr_define( '_JOMRES_COM_A_EDITICON', 'Rediger icon størrelse' );
jr_define( '_JOMRES_JR_A_IMAGEHANDLING_BATCHUPLOAD', 'Mengde opplasting av hotell/motell/rom - bilder.' );
jr_define( '_JOMRES_JR_A_IMAGEHANDLING_IMAGESALREADYINDIR', 'Bildene er alt i mappen' );
...
jr_define( '_JOMRES_COM_A_SLIDESHOWS_SHOWSLIDESHOWINLINE', 'Vis bilderemvisningen inline?' );
jr_define( '_JOMRES_COM_A_SLIDESHOW_THUMBSIZE', 'bildefremvisning thumbnail  høyde' );
jr_define( '_JOMRES_FRONT_SLIDESHOW', 'Bildefremvisning' );
jr_define( '_JOMRES_COM_A_SLIDESHOWS_NOIMAGES', '<br />Beklager, det finnes ingen bilder for hotell/motell/rom' );
jr_define( '_JOMRES_COM_A_TARIFFS_SHOWTARIFFSLINK', 'Vis link til priser?' );
jr_define( '_JOMRES_COM_A_POPUPSALLOWED', 'Popups tillatt?' );
jr_define( '_JOMRES_COM_A_POPUPSALLOWED_DESC', 'Om satt til nei så vil linker som normalt åpnes i en pop opp vises inline istedet. EKSPERIMENTELL! ' );
jr_define( '_JOMRES_FRONT_IMAGEUPLOADS', 'Batch bilde opplasting' );
jr_define( '_JOMRES_FRONT_IMAGEUPLOADS_INFO', 'Bruk denne formen til å laste opp flere bilder av hotell/motell/rom.<br/><b>NB</b> Bilder med samme navn vil overskrive hverandre. Vær også oppmerksom på at denne formen ikke laster opp rom spesifikke bilder eller hotell/motell/rom header bilde, disse må du laste opp i hotell/motell/rom Admin området.<br/><b>NB</b> Bilder som lastes opp her lagres i /images/stories/jomres/*property_uid* mappen. Om mappen ikke finnes vil den bli opprettet dersom du ikke har spesifisert en annen mappe i konfigurasjonen din.' );
jr_define( '_JOMRES_A_TABS_MISC', 'Diverse' );
jr_define( '_JOMRES_A', 'Konfigurer Side' );
jr_define( '_JOMRES_A_GLOBALPFEATURES', 'Bruk globale hotell/motell/rom - egenskaper' );
jr_define( '_JOMRES_A_GLOBALPFEATURES_DESC', 'Sett denne til Ja om du ønsker å tvinge alle hotell/motell/rom til å bruke hotell/motell/rom - egenskapene 
definert av webmaster.' );
jr_define( '_JOMRES_A_GLOBALPFEATURES_INFO', 'For å vise et bilde til denne fasiliteten må du først laste det opp til  /images/stories/jomres/pfeatures/ mappen. ' );
jr_define( '_JOMRES_A_ICON', 'Ikon' );
jr_define( '_JOMRES_A_GLOBAL_SEARCHOPTION', 'Velg den søke modulen du ønsker å bruke.' );
jr_define( '_JOMRES_FRONT_NORESULTS', '<b>Beklager med det finnes ingen treff for søket ditt. Vennligst forandr søket og prøv igjen.</b>' );
jr_define( '_JOMRES_AREYOUSURE', 'Er du sikker?' );
jr_define( '_JOMRES_FRONT_MR_MENU_BOOKAROOM', 'Bestill et rom' );
jr_define( '_JOMRES_FRONT_MR_MENU_BOOKTHISPROPERTY', 'Bestill dette hotell/motell/rom' );
jr_define( '_JOMRES_COM_MR_DISPGUEST_CCV', 'Referanse nummer' );
//v1.4c
jr_define( '_JOMRES_COM_A_TARIFFS_SHOWTARIFFSINLINE', 'Vis priser inline?' );
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWADDRESS', 'Vis adresse opplysninger' );
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWDETAILS', 'Vis detaljert hotell/motell/rom info' );
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS', 'Vis rom og tilgjengelighet' );
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWTARIFFS', 'Vis priser opplysninger' );
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWADDRESS_TITLE', 'Vis adresse opplysninger under denne linken' );
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWDETAILS_TITLE', 'Vis detaljert eiendoms info under denne linken' );
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE', 'Vis rom og tilgjengelighet under denne linken' );
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWTARIFFS_TITLE', 'Vis pris opplysninger under denne linken' );
// Translate from here
jr_define( '_JOMRES_COM_A_TARIFFS_MODEL_SINGLETARIFF', 'Fast pris' );
jr_define( '_JOMRES_COM_A_TARIFFS_MODEL_AVERAGES', 'Gjennomsnittet' );
jr_define( '_JOMRES_COM_A_TARIFFS_MODEL', 'Velg prismodellen du ønsker og bruke' );
jr_define( '_JOMRES_COM_A_TARIFFS_MODEL_DESC', "Du har to metoder for beregning av pris. Den første er fast pris, denne metoden gir deg mulighet til å gi deg flere prisvalg slik at kunden betaler en fast pris for hele oppholdet.
...
" );
// v1.4e
jr_define( '_JOMRES_COM_A_SHOWDEPARTUREINPUT', 'Vis avreisedato input?' );
jr_define( '_JOMRES_COM_A_SHOWDEPARTUREINPUT_DESC', "Sett denne til NEI hvis du ikke ønsker og vise avreiseboksen. Bruk denne kun hvis du vet hva du driver med, som avreisedatoer i booking alltid settes til dagen etter ankomst dato" );
// v1.4f
jr_define( '_JOMRES_COM_PROPERTYLISTDESC', 'Begrens beskrivelse' );
jr_define( '_JOMRES_COM_PROPERTYLISTDESC_DESC', "Dette valget setter begrensninger for antall tegn I oppføringen når man skriver fra hotell/motell/rom - beskrivelse" );
// v1.4g
jr_define( '_JOMRES_COM_A_bildefremvisning_POPUPWIDTH', 'bildefremvisning popup bredde' );
jr_define( '_JOMRES_COM_A_bildefremvisning_POPUPHEIGHT', 'bildefremvisning popup høyde' );
jr_define( '_JOMRES_COM_A_DATEFORMATSTYLE', 'Brukt dato() format stil?' );
...
jr_define( '_JOMRES_COM_INPUTERROR_BACKGROUND', 'Input feil bakgrunnsfarge' );
...
jr_define( '_JOMRES_COM_SELFREGISTRATION', 'Brukerne kan registrere sine egenskaper?' );
jr_define( '_JOMRES_COM_SELFREGISTRATION_DESC', 'Sett dette til JA hvis du vil at brukerne skal kunne registrere sine egenskaper uten påvirkning fra administrator.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1', 'Vennligst før opp lang og region for dine egenskaper.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_1', 'Vennligst fullfør dine egenskapsdetaljer.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_2', 'Felter merket med rød stjerne er påkrevet.' );
jr_define( '_JOMRES_REGISTRATION_AUDIT_CREATEPROPERTY', 'Egenskaper opprettet' );
jr_define( '_JOMRES_REGISTRATION_NOTALLOWED', "Beklager, du kan ikke opprette en egenskap på dette systemet. Du må være pålogget, registrert bruker og du kan ikke allerede ha en egenskap registrert." );
jr_define( '_JOMRES_REGISTRATION_CREATEDPROPERTY', 'Egenskaper opprettet: ' );
jr_define( '_JOMRES_REGISTRATION_CREATEDPROPERTY_FORUSER', 'For bruker: ' );
// v1.4i
...
jr_define( '_JOMRES_NUMBEROFROOMSAVAILABLE', 'Antall rom ledige' );
jr_define( '_JOMRES_BACKTOPROPERTYDETAILSLINK', 'Tilbake til egenskaprdetaljer' );
jr_define( '_JOMRES_FRONT_ROOMTYPES', 'Rom - typer' );
// v2
...
jr_define( '_JOMRES_AJAXFORM_PARTICULARS', 'Booking spesifikasjoner' );
jr_define( '_JOMRES_AJAXFORM_PARTICULARS_DESC', 'Velg detaljer for dine bookingkrav' );
jr_define( '_JOMRES_AJAXFORM_AVAILABLE', 'Tilgjengelighet ' );
jr_define( '_JOMRES_AJAXFORM_AVAILABLE_DESC', 'Velg rom du ønsker' );
jr_define( '_JOMRES_AJAXFORM_AVAILABLE_DESC_SRP', 'Se her for å se om hotell/motell/rom er ledig.' );
jr_define( '_JOMRES_AJAXFORM_EXTRAS', 'Valgfri ekstrautstyr' );
jr_define( '_JOMRES_AJAXFORM_EXTRAS_DESC', 'Velg ekstrautstyr du vil inkludere i bookingen din' );
jr_define( '_JOMRES_COM_PERDAY', 'Pr natt' );
jr_define( '_JOMRES_AJAXFORM_ADDRESS', 'Din adresse' );
jr_define( '_JOMRES_AJAXFORM_ADDRESS_DESC', 'Fyll inn dine detaljer. Merk. Alle felter er påkrevet med unntak av mobil' );
jr_define( '_JOMRES_AJAXFORM_AVAILABLEROOMS', 'Ledige rom' );
jr_define( '_JOMRES_AJAXFORM_SELECTEDROOMS', 'Valgte rom' );
jr_define( '_JOMRES_AJAXFORM_EARLIESTPOSSIBLEARRIVALDATE', '<br>Tidligst ankomst dato er: ' );
jr_define( '_JOMRES_AJAXFORM_BILLING_ROOM', 'Pr natt:' );
jr_define( '_JOMRES_AJAXFORM_BILLING_ROOM_TOTAL', 'Total:' );
jr_define( '_JOMRES_AJAXFORM_BILLING_EXTRAS', 'Ekstratjenester:' );
...
jr_define( '_JOMRES_AJAXFORM_CLICKHERECAPTION', 'Klikk nå for å legge dette rommet til ditt valg' );
jr_define( '_JOMRES_AJAXFORM_CLICKHERECAPTION_REMOVE', 'Klikk nå for å fjerne dette rommet fra dine valg' );
jr_define( '_JOMRES_CONFIG_VARIANCES_CUSTOMERTYPES', 'Gjest - type' );
jr_define( '_JOMRES_VARIANCES_TYPE', 'Type' );
jr_define( '_JOMRES_VARIANCES_TYPE_TT', 'Type kunder, feks Barn alder 5-10, eller studenter ' );
...
jr_define( '_JOMRES_VARIANCES_MAXIMUM_TT', 'Maksimum av denne kundegruppen kan velges i bookingskjemaet' );
jr_define( '_JOMRES_VARIANCES_ISPERCENTAGE', 'I prosent' );
jr_define( '_JOMRES_VARIANCES_ISPERCENTAGE_TT', 'Den kalkurete prisen er en prosentvis pris av den kalkurerte grunn prisen for rommet. Hvis denne er satt til nei vil figuren du spesifiserer bli lagt til eller trukket fra grunn prisen for rommet.' );
jr_define( '_JOMRES_VARIANCES_POSNEG', 'Legg til variabel?' );
jr_define( '_JOMRES_VARIANCES_POSNEG_TT', 'Den kalkurerte prisen er lagd til eller trukket fra grunn prisen kalkulert for rommet. Set denne til Nei hvis du vil at den kalkulerte prisen er et prisavslag av grunn prisen.' );
...
jr_define( '_JOMRES_MR_AUDIT_PUBLISH_CUSTOMERTYPE', 'Publiser kundegruppe' );
...
jr_define( '_JOMRES_MR_AUDIT_UPDATE_CUSTOMERTYPE', 'Oppdater kundegruppe' );
jr_define( '_JOMRES_COM_MR_CUSTOMERTYPE_UPDATED', 'Oppdatert kundegruppe' );
jr_define( '_JOMRES_COM_A_SHOWROOMSLISTLINK', 'Vis lenker til rom listen i siden for egenskapers detaljer?' );
jr_define( '_JOMRES_COM_A_SHOWONLYAVLCAL', 'Vis <b>kun</b> Tilgjengelige kalender/Rom listen?' );
jr_define( '_JOMRES_COM_A_SHOWONLYAVLCAL_DESC', 'Sett denne til JA for hvis du ikke ønsker å vise Hotell/motel/rom header og detaljer, slik at kun romlisten/tilgjengelighetskalenderen er synlig i Hotell/motel/rom detalj seksjonen. Dette alternativet er for brukere som leier ut enkle Hotell/motel/rom egenskaper.' );
jr_define( '_JOMRES_COM_A_MINIMUMINTERVAL', 'Ankomst/avreise minimum intervall' );
jr_define( '_JOMRES_COM_A_MINIMUMINTERVAL_DESC', 'Minimum intervallen i bookskjemaet mellom ankomst og avreise dato.' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO', 'Bookingskjema liste viser romnummer' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME', 'Bookingskjema liste viser rom - navn' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE', 'Bookingskjema liste viser tarifftittel' );
jr_define( '_JOMRES_ORDER', 'Bestill' );
jr_define( '_JOMRES_REQUIREDFIELDS', 'Påkrevet' );
jr_define( '_JOMRES_COM_A_DAYSBEFOREFIRSTBOOKING', 'Dager før ankomst' );
jr_define( '_JOMRES_COM_A_DAYSBEFOREFIRSTBOOKING_DESC', 'Minimum dager som må ovelappe, fra "idag", til før ankomstdato.' );
jr_define( '_JOMRES_DTV', 'Dato type variasjoner' );
jr_define( '_JOMRES_DTV_DOW', 'Dag i uken' );
jr_define( '_JOMRES_COM_A_DEFAULTNUMBEROFFIRSTGUESTTYPE', 'Gjeste - type standard' );
jr_define( '_JOMRES_COM_A_DEFAULTNUMBEROFFIRSTGUESTTYPEDESC', 'Standard nummer for den første gjeste – typen. Hvis du bruker gjeste – typer, er dette standard nummeret som den første gjeste – typen vil bli satt til i bookingskjemaet.' );
jr_define( '_JOMRES_COM_A_REGISTEREDUSERSONLYBOOK', 'Kun registrerte medlemmer kan bestille online?' );
jr_define( '_JOMRES_REGISTEREDUSERSONLYBOOK', 'Beklager, men du må være registrert for å bestille online. Klikk her for å registrere deg. ' );
jr_define( '_JOMRES_COM_AVLCAL_CURRENTBOOKINGFONT', 'Skrift farge for linker til gjueldende bookinger' );
jr_define( '_JOMRES_COM_AVLCAL_WEEKENDBORDER', 'Weekendtabeller' );
jr_define( '_JOMRES_COM_AVLCAL_BOOKING_KEY', 'Rommet er booket' );
jr_define( '_JOMRES_COM_AVLCAL_BLACK_KEY', 'Svart booking' );
jr_define( '_JOMRES_COM_A_DEPOSIT_DEPOSITROUNDUP', 'Avrund depositum opp til nærmeste hele tall?' );
jr_define( '_JOMRES_COM_A_DEPOSIT_CHARGEDEPOSIT', 'Krev depositum?' );
jr_define( '_JOMRES_COM_A_TARIFFPRICESAREWEEKLY', 'Tariffer lagret som ukentlige tall?' );
jr_define( '_JOMRES_COM_A_TARIFFPRICESAREWEEKLY_DESC', 'Du har valget om du vil lagre tariffer enten dagelig eller ukentlig. Hvis du lagrer de ukenlig MÅ du sette dette alternativet til JA.' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_ROOMRATEPERWEEK', 'Pris pr uke' );
jr_define( '_JOMRES_COM_MR_FIXEDARRIVALDATE_RECURRING', 'Fast ankomst dato: ' );
jr_define( '_JOMRES_COM_MR_FIXEDARRIVALDATE_RECURRING_DESC', 'Når du velger fast ankomst kan datoen vises I en nedtrekksliste' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_SMOKING_INVALID', 'Røker valg ugyldig' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_BOOKING_TOO_SHORT1', 'Bookingen er for kort. Det må minimum ære så mange dager mellom ankomst og avreisedatoen:' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_BOOKING_TOO_SHORT2', 'Dine intervaller er' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_GUEST_TYPE_INCORRECT', 'GGjeste - type variant er ukorrekt' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_SELECT_GUEST_NUMBERS', 'Velg ditt gjeste nummer/type' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_IN_PARTY_FOR_TARIFFS', 'Det er for mange inkludert for dagens tariff' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS', 'Du har valgt flere rom enn du har gjester' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS', 'For mange gjester, ikke nok sengeplasser' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS', 'Du må velge flere rom' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM', 'Velg et rom' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_REQUIRED_EMAIL', 'E-post adresse er påkrevd' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_EMAIL_INVALID', 'E-post adressen er ikke gyldig' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_CANNOT_VALIDATE_EMAIL', 'Kunne ikke finne gyldig e-post domene' );
jr_define( '_JOMRES_SRP_WEHAVEVACANCIES', 'Vi har ledig rom!' );
jr_define( '_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET', 'Ingen rom valgt' );
jr_define( '_JOMRES_BOOKING_NUMBER', 'Booking nr.' );
jr_define( '_JOMRES_COM_INPUTOKTOBOOK_BACKGROUND', 'Klar for booking, melding boks bakgrunn.' );
jr_define( '_JOMRES_COM_DUMPTEMPLATEDATA', 'Tom mal variabler?' );
jr_define( '_JOMRES_COM_DUMPTEMPLATEDATA_DESC', 'Set denne for å muliggjør DHTML tømming av mal variabler for hver FRONTEND mal fil mens siden vises. Hjelpsom hvis du vil se om et bestemt element er tilgjengelig for bruk i en bestemt mal.' );
jr_define( '_JOMRES_COM_A_SUPPLIMENTS_SINGLEPERSON_ISPERCENTAGE', 'Tallet er prosentvis' );
jr_define( '_JOMRES_COM_A_SUPPLIMENTS_SINGLEPERSON_ISPERCENTAGE_DESC', 'Set denne til Ja hvis en persons kalkulerings figur er prosentvis. Hvis Nei vil en flat sum bli satt.' );
//v2rc2
jr_define( '_JOMRES_COM_LIMITROOMSLIST', 'Ledig rom/rompris begrensning' );
jr_define( '_JOMRES_COM_LIMITROOMSLIST_DESC', 'Bruk dette feltet til å begrense antall rom og romprisene ledige som er i listen for booking skjema. Set den til 0 hvis begrensning ikke ønskes. ' );
jr_define( '_JOMRES_SRP_WEHAVENOVACANCIES', 'Ingen ledige rom på dette tidspunktet.' );
// Introduced in v2.5
// v2.6
jr_define( '_JOMRES_BOOKITNOW', 'Book nå: ' );
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALEDITING', 'Global redigerings modus?' );
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALEDITING_DESC', 'Vær forsiktig med denne funksjonen. Hvis ja, vil redigerings moduse påvirke alle tilpassede tekster for alle egenskaper i systemet for konstanten du redigerer.' );
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALCURRENCY', 'Global valuta symbol' );
jr_define( '_JOMRES_COM_JRCONFIG_ISWRAPPED', 'Komponent innpakket' );
jr_define( '_JOMRES_COM_JRCONFIG_ISWRAPPED_DESC', 'Set denne til Ja hvis komponenten skal være innpakket for at modulen og header område ikke skal vises.' );
