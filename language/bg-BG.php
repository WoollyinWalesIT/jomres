...
Можете да оставите целевия език настроен на текущия ви език и да използвате тази страница, за да преименувате елементи тук, вместо да посещавате отделните им страници.');
	...
	jr_define('_JOMRES_COM_A_GATEWAYLIST_INFO', 'На тази страница можете да конфигурирате през кои шлюзове за плащане искате да получавате депозитни плащания. Ще ви трябва акаунт в шлюза за плащания. Страницата с настройки ще ви предостави инструкции как да конфигурирате шлюза.' );

	jr_define('_JOMRES_COM_A_GATEWAYLIST_TESTINGINFO', "Вие сте влезли като Super Property Manager. Обикновено мениджърите на имоти не могат да използват шлюзове за плащане, но ако зададете сайта в режим на разработка в Admin > Jomres > Settings > раздел Debugging, тогава ще можете да обработвате чрез резервация и достъп до шлюзовете за плащане като гост. Ако не искате да настроите сайта в режим на разработка, тогава ще трябва или да излезете, или да влезете като нормален регистриран потребител, за да тествате резервациите като гост. Настройките на тестовия режим в отделните шлюзове за плащане не се влияят от настройката за производство или разработка на сайта. ");
