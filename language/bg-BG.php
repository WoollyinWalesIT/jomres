...
jr_define('JOMRES_COM_A_TARIFFMODE_DESC', '<b>Предупреждение: Превключването между различни режими за редактиране на тарифи може да доведе до загуба на данни. Вижте бележката по-долу относно това.</b>.
<br/><br/>
...
jr_define('_JOMRES_COM_LANGUAGE_CONTEXT_DESC', 'Използвайте тази опция, за да промените езиковия контекст на сайта. Тази функция позволява на Jomres да използва етикети, които са подходящи за начина, по който използвате Jomres, така че ако фокусът ви е като брокер на яхти, тогава промяната на контекста ще позволи на Jomres да представя етикети, подходящи за яхти. Например, ако зададете контекста на „Yacht Brokerage“, тогава Jomres първо ще намери текущия език, след което ще търси в персонализираната текстова база данни за низове, запазени с езиков контекст на „yachtbrokerage“. Ако съществуват потребителски низове за текущия език и контекст, те ще бъдат използвани. Ако не, тогава Jomres ще се върне към езиковите дефиниции, използвани от основните езикови файлове.');
// 4.7.3
...
jr_define('_JOMRES_EMAIL_TEMPLATES_INSTRUCTIONS', 'Моля, вижте тази страница за помощ при персонализирането на имейлите и списък с наличните резултати: <a href = "https://www.jomres.net/manual/property-managers-guide/48-your-toolbar/settings/254-email-templates" target="_blank"> Помощ за шаблони за имейли </a> ');
...
jr_define('_JOMRES_MEDIA_CENTRE_UPLOAD_CONTEXT_PROPERTY_TYPE_IMAGES', "Изображения от тип собственост");
	...
	jr_define('JOMRES_WORDPRESS_PERMALINK_EDITING_MODE_INFO', 'Мениджърите на имоти могат да използват режима на редактиране във интерфейса, за да персонализират низове за всяко свойство, но това може да работи само ако настройката ви за постоянна връзка в WordPress е настроена на Обикновена (http://www.domain.com/?p=123). След като направите това, потребителите на интерфейса ще могат да персонализират низове, като имена на стаи и други етикети, които са специфични за уникалните свойства. ');

	jr_define('JOMRES_EDITING_MODE_HELP_TITLE', 'Режим за редактиране на етикети');
	jr_define('JOMRES_EDITING_MODE_HELP_LEAD', 'Тази функция се използва за промяна на етикетите на артикули, обикновено на различни езици.');
	jr_define('JOMRES_EDITING_MODE_HELP_INFO_1', 'Режимът на редактиране ви позволява да преименувате етикети, които са уникални за отделните свойства. Когато използвате режим на редактиране, за да преименувате етикет, промяната ще се появи само в списъка на този имот. Например, на една собственост, която може да искате да използвате думата "Цени" и на друга думата "Цени". Не всички етикети могат да се променят, например имената на типове стаи са етикети за целия сайт, така че не могат да се променят, но обикновено всичко, което е уникално за отделен имот може да се промени.');
	jr_define('JOMRES_EDITING_MODE_HELP_INFO_2', 'Ако сайтът поддържа няколко езика, докато използвате един език, можете да създадете елемент, който е уникален за отделно свойство. Когато след това промените активния си език, можете да използвате режима на редактиране, за да преименувате този етикет, въвеждане на подходящ превод на текущия език. Можете да продължите да променяте активния език, за да въведете подходящ превод за този етикет за всеки език, който сайтът поддържа.');
	jr_define('JOMRES_EDITING_MODE_HELP_STEPS_1_TITLE', 'Превключвател на режим за редактиране на етикети');
	jr_define('JOMRES_EDITING_MODE_HELP_STEPS_1_TEXT', 'На тази екранна снимка виждаме превключвателя за режим на редактиране. Режимът на редактиране е ИЗКЛЮЧЕН и етикетите се появяват както обикновено: ');
	jr_define('JOMRES_EDITING_MODE_HELP_STEPS_2_TITLE', 'Режимът за редактиране на етикети е активиран');
	jr_define('JOMRES_EDITING_MODE_HELP_STEPS_2_TEXT', 'На тази екранна снимка виждаме, че докато сте в режим на редактиране, етикетите, които можете да преименувате, са осветени:');
	jr_define('JOMRES_EDITING_MODE_HELP_STEPS_3_TITLE', 'Изберете елемента за промяна');
	jr_define('JOMRES_EDITING_MODE_HELP_STEPS_3_TEXT', 'Когато е избран етикет, се появява изскачащ прозорец:');
	jr_define('JOMRES_EDITING_MODE_HELP_STEPS_4_TITLE', 'Промяна на етикета');
	jr_define('JOMRES_EDITING_MODE_HELP_STEPS_4_TEXT', 'Използвайте малката форма, за да промените етикета. Щракнете върху Отметка, за да завършите, или щракнете върху X, за да отмените редактирането:');
	jr_define('JOMRES_EDITING_MODE_HELP_STEPS_5_TITLE', 'Етикетът е променен');
	jr_define('JOMRES_EDITING_MODE_HELP_STEPS_5_TEXT', 'След като запазите промяната, етикетът се актуализира на страницата. Можете да деактивирате режима на редактиране сега:');

	jr_define('JOMRES_TRANSLATIONS_TITLE', 'Преводи');
	jr_define('JOMRES_TRANSLATIONS_LEAD', 'На тази страница можете да превеждате етикети от един език на друг. Когато посетите страницата, ще видите низове, които вече сте създали и тяхната стойност на езика, който използвате в момента. В горната част задайте целеви език, след това за етикетите, които искате да преведете, щракнете върху етикета и изскачащ прозорец ще ви позволи да въведете новия си превод. За по-дълги редове текст можете да поставите в текста от друг източник. Не забравяйте, че всеки HTML ще бъде премахнат .<br/>
Можете да оставите целевия език настроен на текущия ви език и да използвате тази страница, за да преименувате елементи тук, вместо да посещавате отделните им страници.');
	jr_define('JOMRES_TARGET_LANGUAGE', 'Целеви език');
	...
	jr_define( 'JOMRES_BS5_TOP_PANEL_CHOOSE_CURRENCY', "Изберете вашата валута" );
	jr_define( 'JOMRES_BS5_TOP_PANEL_CHOOSE_LANGUAGE', "Изберете вашия език" );
	jr_define( 'JOMRES_BS5_TOP_PANEL_REGISTER',"Регистрация");
	jr_define( 'JOMRES_BS5_TOP_PANEL_SIGN_IN', "Вход");
	jr_define( 'JOMRES_BS5_TOP_PANEL_LIST_YOUR_PROPERTY', "Избройте вашия имот");
	jr_define( 'JOMRES_BS5_TOP_PANEL_REGISTER_FIRST', "Първо трябва да се регистрирате и да влезете");

	jr_define('_JOMRES_AJAX_SEARCH_COMPOSITE_SHOWFILTERS',"Показване на филтри");
	jr_define('_JOMRES_AJAX_SEARCH_COMPOSITE_HIDEFILTERS',"Скриване на филтрите");

	jr_define('_JOMRES_COM_TRANSLATE_LANGUAGEFILES_INFO', "Текстът, показан на страниците, се съхранява в езикови файлове. Системата на Jomres за показване на езикови низове на страницата означава, че не е необходимо да редактирате директно тези езикови файлове. Вместо това можете да редактирате тези низове на това страница, като щракнете върху маркирания текст и поставите новия текст, който искате да покажете, във формуляра за въвеждане, който се отваря. Когато щракнете върху отметката, тази промяна се записва в базата данни. Това означава, че всичките ви промени се съхраняват и не се презаписват, когато актуализирате Jomres. Ако искате да промените текст за различни езици, използвайте падащото меню за избор на език горе вдясно, за да промените текущия език. Текстовите низове понякога се повтарят на различни места в езиковите файлове, защото се използват в различни контексти, така че не забравяйте да използвате функцията за търсене на браузъра, за да сте сигурни, че сте редактирали правилния низ. ");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN', "Цялото управление на собственост се извършва в предния край на вашия сайт. В момента не сте влезли като мениджър на собственост, така че, моля, влезте първо и след това ще можете да администрирате своите собствености.");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN_EXPOSITION_FOR_NEW_USERS_JOOMLA', "Когато Jomres се инсталира за първи път, той ще създаде Super Property Manager за администраторския потребител и ще добави нова опция към главното меню, наречено Резервации. Не изтривайте този елемент от менюто. Влезте с предоставения бутон и посетете страницата Резервации, за да започнете да администрирате свойства. ");

	jr_define('_JOMRES_COM_A_GATEWAYLIST_INFO', 'На тази страница можете да конфигурирате през кои шлюзове за плащане искате да получавате депозитни плащания. Ще ви е необходим акаунт в шлюза за плащания. Страницата с настройки ще ви предостави инструкции как да конфигурирате шлюза. Ако шлюзът има тестов режим и ако тестовият режим е активиран, вие като мениджър на собственост ще можете да използвате шлюза за плащане, за да тествате вашата конфигурация. Когато тестовият режим е деактивиран, само потребители, които не са мениджър, ще виждат шлюзовете за плащане по време на процеса на резервация .');

	jr_define('_JOMRES_COM_A_GATEWAYLIST_TEST_MODE_STR', "Тестов режим");

	jr_define('JOMRES_ADMIN_UPDATE_NIGHTLY_WARNING', "Режимът за разработка е активиран, следователно, ако използвате тази функция, вие ще актуализирате вашата инсталация на Jomres до клона Nightly. Това е най-новата версия на Jomres и може или не може да бъде стабилна. Ако го направите не искате да актуализирате до Nightly, моля, посетете Admin > Jomres > Settings > Site Configuration > раздел Debugging и задайте опцията Production/Development на Production.");

	jr_define('JOMRES_POLICY_OCCUPANCY_LEVELS_INCLUDE_CHILDREN', "Включване на деца в проверките за ниво на заетост?");
	jr_define('JOMRES_POLICY_OCCUPANCY_LEVELS_INCLUDE_CHILDREN_DESC_MRP', "Когато гостите правят резервации, стаите имат максимален брой гости, които могат да приемат. Ако общият брой гости надвишава броя гости, които избраните стаи могат да приемат, тогава формулярът за резервация ще им каже, че те трябва да изберат повече стаи.
...
jr_define('_JOMRES_PROPERTYTYPE_FLAG_HIRE', 'Наем на артикул');


jr_define('SHORTCODE_INFO_JOMRES_V_JOMRES_SCRIPT',"Кратките кодове трябва да бъдат опаковани в &#123;&#125; в Joomla или [] в Wordpress (СКОБИ). Има три начина, по които могат да се разглеждат страниците, генерирани от къси кодове. Първият е да добавете кратък код към статия/страница/модул във формат BRACKETjomres аргументи за къс код BRACKET. Вторият е в шаблонните файлове на Jomres, където бихте поставили BRACKETjomres_script аргументи за къс код BRACKET. Последният начин е чрез url, така че например в Joomla бихте поставили www.domain.com/index.php?option=com_jomres&task=SHORTCODE&ARGUMENTS=ARGUMENTS. ");
