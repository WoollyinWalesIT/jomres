...
jr_define('_JRPORTAL_SUBSCRIBERS_SUBSCRIBED', "Благодарим за заявката Ви за абонаментен пакет. Щом платите сумата моля <a href='".JOMRES_SITEPAGE_URL."&task=new_property'>кликнете тук за да продължите със създаването на обекти.</a>");
