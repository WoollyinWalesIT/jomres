...
jr_define ('_OPENEXCHANGE_API_DESC', 'За да конвертирате цените между услугите, ще ви е необходим API ключ за Open Exchange Rates. Трябва да имате ключ за API, за да показвате цените правилно в Jomres, но можете <a href = "https://openexchangerates.org /signup/free "_target =" _blank "> регистрирайте се за безплатен ключ </a> (почасови актуализации, 1000 заявки/месец - без HTTPS, поддръжка по имейл или разширени функции). Jomres изтегля обменни курсове веднъж дневно, стига използвате ключа само на шепа сайтове, едва ли ще надхвърлите тези граници. Преди Jomres 8.3 използвахме по -стара, недокументирана функция на Yahoo, но открихме, че използването на тази функция е в противоречие с Условията на Yahoo и Условия. В резултат на това трябва да приемем, че функцията може да изчезне в даден момент в бъдеще, оттук и промяната в използването на Open Exchange Rates. ');
...
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_INTRODUCTION', 'Въведение');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_WHATISJOMRES', 'Какво е Джомрес?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_WHATISJOMRES', "Jomres е система за резервации на хотели и вили, която работи със системите за управление на съдържанието Joomla и Wordpress. Това е пълна система за резервации, помислете за \"booking.com\" или \" airbnb\" без разходи. Това е пълен набор от инструменти което ви позволява да изградите уникална онлайн услуга за резервация за колкото искате имоти. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_USERSADD', 'Могат ли потребителите да се регистрират на моя сайт на Jomres и да добавят свои собствени имоти?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_USERSADD', 'Да. По подразбиране Jomres позволява на регистрираните потребители да добавят свои собствени свойства към вашия сайт. Можете да го деактивирате в Конфигурация на сайта> Различни, ако е необходимо.');
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PROPERTIES', 'Свойства');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_ADDPROPERTIES', 'Как да добавя нов имот?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_ADDPROPERTIES', "Когато Jomres е инсталиран, администраторският потребител се създава като Super Property Manager. Влезте във фронтенда на вашата CMS (публичните страници) като администраторски потребител и оттам можете да добавяте нови свойства. <br/ > Можете да създадете нови мениджъри на страницата „Мениджъри на имоти\", ако искате да добавите нов мениджър, но по подразбиране (можете да деактивирате това) всеки регистриран потребител, който създава свойство, се създава автоматично като мениджър на собствености за създадените от тях свойства. За от съображения за сигурност те не могат да администрират свойствата на друг мениджър. Това може да бъде променено чрез издигане на този потребител до Super Property Manager на страницата „Мениджъри на имоти.");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_IMPORTPROPERTIES', 'Мога ли да импортирам свойства от друга система?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_IMPORTPROPERTIES', "Има няколко начина, по които можете да импортирате свойства. Приставката за импортиране на имоти ви позволява да импортирате свойства чрез CSV. Това ви позволява да импортирате няколко свойства наведнъж, но е функция само за администратор. Ако собствеността мениджърът има Beds24 акаунт, след което те могат да импортират всички съществуващи свойства от своя акаунт там, след като свържат API ключове. Друг начин е да използвате API, има функция за добавяне и премахване на свойства, но това ще изисква да сте разработчик запознат с използването на REST API за използване на тази функционалност. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_IMPORTBOOKINGS', 'Мога ли да импортирам резервации от друга система?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_IMPORTBOOKINGS', "Резервациите могат да бъдат импортирани в имот от мениджъра на имот чрез приставката iCal, която предлага функция за импортиране на резервации в менюто на мениджъра на имоти. Също така, ако мениджърът на имот има акаунт в Beds24 и тяхната собственост има са свързани с Beds24, след това те могат да изпълнят действие за Изпращане на Известие в Beds24. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_EMAILTEMPLATES', 'Мога ли да редактирам шаблони за имейли?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_EMAILTEMPLATES', 'Мениджърите на имоти могат да редактират шаблони за имейли чрез лентата си с инструменти в Настройки> Шаблони за имейли.');
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PAYMENTS', 'Плащания');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TAKEPAYMENTS', 'Как мога да позволя на имотите да приемат плащания?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TAKEPAYMENTS', 'Ще трябва да инсталирате шлюз за плащане. Jomres има два шлюза за плащане, които се свързват с Paypal или Stripe. Той също така предлага няколко офлайн шлюза и можете да закупите други шлюзове за плащане от нашите партньори.' );
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_WHICHGATEWAY', 'Кой шлюз да използвам?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_WHICHGATEWAY', "Ако искате да вземете процент от депозита на мениджъра за собствените си разходи, използвайте шлюза на Stripe. Ако не го направите и вместо това възнамерявате да използвате функцията за абонамент и/или комисионна, тогава вие ще трябва да използвам шлюза на Paypal. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PAYMENTACCOUNTS', 'Когато гост прави плащане за резервация, кой получава парите?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PAYMENTACCOUNTS', "Това зависи от начина, по който сте настроили шлюзове за плащане на вашия сайт. Ако използвате Paypal, можете да го конфигурирате да отменя всички настройки на интерфейса, като по същество прави акаунта ви единствения акаунт, който получава плащания. Ако ако не решите да направите това, тогава всеки имот ще трябва да настрои своя акаунт за платежен шлюз в Настройки> раздел Шлюзове. Ако използвате Stripe, тогава след като мениджърът на имоти е свързал профила си с вашия (вижте документацията на Stripe в ръководството за повече информация) след това те ще получат всички средства, минус комисионна, която можете да конфигурирате, ако решите да го направите. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_TROUBLESHOOTING', 'Отстраняване на неизправности');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TROUBLESHOOTING_EMAIL', "Имейлите за резервации не се изпращат.");
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TROUBLESHOOTING_EMAIL', "Ако имате проблеми с изпращането на имейли от системата, моля, проверете настройките за електронна поща на вашата хост CMS. Jomres използва настройките на Wordpress или Joomla за изпращане на имейли. Ако грешат, Jomres няма да може изпращайте и имейли. ");
...
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TROUBLESHOOTING_NOGATEWAY', "Ако сте влезли като Property Manager, няма да видите шлюза за плащане, защото не плащате сами, глупако. Само потребители, които не са мениджъри, ще виждат шлюза при извършване на резервации.") ;
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PURCHASINGJOMRES', 'Лиценз на Jomres');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_FORCEDTOSUBSCRIBE', 'След закупуване на X лиценз, принуден ли съм да закупя подновявания, след като лицензът изтече?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_FORCEDTOSUBSCRIBE', "Не, ако сте закупили лиценз за стартиране, бизнес или предприятие, тогава можете да продължите да използвате софтуера за неопределено време, той няма да бъде магически манипулиран. Изключението от това правило е, ако закупите абонамент. След като абонаментът бъде анулиран, вече няма да можете да използвате приставките и ще трябва да ги деинсталирате. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_EXPIRED', 'Лицензът ми е изтекъл, мога ли все пак да надстроя Jomres?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_EXPIRED', "Докато физически можете, не се препоръчва да го правите. След като лицензът изтече, вече няма да можете да се възползвате от поддръжката или да изтегляте актуализации на приставки за вашата инсталация на Jomres. Това означава, че трябва < i> не </i> надграждам вашата инсталация на Jomres след изтичане на лиценза. Това е така, защото приставките редовно трябва да се актуализират, за да работят с текущите версии на системата, така че често по -старите ви приставки няма да работят на по -нова версия на системата . Ако все пак искате да надстроите, за да се възползвате от новата функционалност, трябва да закупите лиценз за подновяване, който всъщност е нормален лиценз с 50% отстъпка. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_SOFTWARELICENSE', 'Под какъв софтуерен лиценз е издаден Jomres?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_SOFTWARELICENSE', "Jomres е лицензиран както по лицензите MIT, така и по GPL. Приставките, изтеглени от Starter, Business и Enterprise лицензи, се издават под един и същ лиценз и са напълно безплатни и с отворен код. не са пуснати под лицензите на GPL или MIT и са кодирани с Ioncube. Този подход ни позволява да ви предложим разнообразие от различни лицензи, които да отговарят на джобовете на всеки. ");
...
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_DISCOUNTS', "Могат да се дават отстъпки, има няколко различни начина, по които това може да стане. Ако правите резервация от името на клиент, тогава можете да зададете свой собствен депозит и суми за резервации във формуляра за резервация , като използвате полетата \"Override Accommodation Total \" и \"Override Deposit \" (гостите не могат да използват тази функция). Друг начин да се даде отстъпка на гост е да се създадат купони за отстъпка, които могат да бъдат конфигурирани така, че да могат може да се използва само между определени дати (валиден от/до) или да се прилага само когато резервацията попада между определени дати (резервация валидна от/до). Тези купони за отстъпка могат да бъдат присвоени само на един гост или ако искате, можете да разпечатате купони. Разпечатката включва QR код, който гостите могат да сканират в телефоните си, който ги отвежда във формуляра ви за резервация с вече приложим код за отстъпка. ");
...
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_BOOKINGS_CONTACTPAGE', 'Преди да можете да правите резервации онлайн, първо трябва да конфигурирате някои цени (тарифи) за всеки тип стая, която имате във вашия имот в реалния свят. След като създадете някои тарифи, ще можете да приемате резервации . ');
...
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_CURRENCIES_SETUP', 'Как да настроя символите на валутата?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_CURRENCIES_SETUP', "Не го правите. Всички символи за валута вече се съхраняват в системата и от мениджърите на имоти зависи да изберат подходящата за тях валута на страницата за конфигуриране на имота.");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_CURRENCIES', 'Как да активирам няколко валути?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_CURRENCIES', "Jomres има функционалност за автоматично преобразуване на цените от една валута в друга. Първо трябва да посетите раздела Конфигурация на сайта> Конвертиране на валута. Там ще намерите връзки към две онлайн услуги. Първата услуга, след като API е запазен, позволява на Jomres да изтегля данни за конвертиране на валута веднъж дневно. Второто позволява геолокация, базирана на IP за потребителите. Изисквайте безплатен API ключ от всяка услуга. С тези две услуги Jomres може да открие местната валута на потребителя и да покаже цени на имоти както в местната валута на госта, така и в собствената валута на хотела. Ако не настроите тези API ключове, Jomres по подразбиране ще използва символа на евро валутата. Ако искате, можете да зададете глобален код на валута. Това означава, че имотът мениджърите няма да могат да избират други валути, но потенциалните гости все пак ще виждат цените в собствената си местна валута, освен ако не са използвали функцията за смяна на валута, за да променят валутата, в която се показват цените. ");
...
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PROPERTIES_NUMBER', 'Колко имота мога да изброя?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PROPERTIES_NUMBER', "Няма кодирано ограничение за броя на свойствата, които можете да изброите, единственото ограничение е във физическото ограничение на самия сървър. Ако това е сървър с много други акаунти, тогава ресурсите ще бъдат ограничени, ако , от друга страна, това е специален или виртуален специален сървър, тогава ще можете да изброите още много свойства. ");
...
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_PROFILES', 'Мога ли да направя потребител управител на имот?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_PROFILES', "Да, можете, чрез страницата Мениджъри на имоти под Управление на потребители. Ако потребителят вече е регистриран, в полето за въвеждане в горната част на страницата Мениджъри на имоти въведете първите няколко знака от потребителското си име и неговото потребителско име ще се показват отдолу. Кликнете върху потребителското им име и ще бъдете отведени на страница, където можете да конфигурирате до кои свойства имат достъп. Ако все още не са регистрирани, първо ще трябва да използвате страниците за управление на потребителите на вашата хост CMS, за да ги добавите като потребител на CMS. <br/> <br/> Един съвет: Ако възнамерявате да таксувате мениджърите на имоти за изброяване на техните имоти на вашия сайт, чрез взимане на комисионна чрез шлюза Stripe или функционалност за абонаменти/комисионни, ние не препоръчвайте да добавяте потребители по този начин. В този случай само супер администраторите на собствености трябва да се добавят с помощта на този процес и когато те се добавят, не трябва да избирате никакви свойства в списъка отдолу. Всичко останало Потребителите трябва да бъдат насърчавани да създават собствени имоти във фронтенда. Това автоматично ще ги добави като мениджъри на имоти и гарантира, че на правилния потребител се таксува. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PLUGINS', 'Приставки');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_GENERAL_PLUGINS', 'За какво е Plugin Manager?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_GENERAL_PLUGINS', 'Мениджърът на приставки е ключов инструмент в Jomres. Позволява ни да ви разпространяваме най-актуалната версия на приставките на Jomres чрез функция за автоматично изтегляне и инсталиране.');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_GENERAL_PLUGINS_IONCUBE', 'Защо виждам предупреждение за Ioncube Loaders, когато щракна върху страницата на Plugin Manager?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_GENERAL_PLUGINS_IONCUBE', "Запазили сте пробен лицензионен ключ в конфигурацията на сайта, но вашият уеб сървър не предлага най -новите Ioncube Loaders. Моля, помолете хостовете си да инсталират товарачите, които можете да намерите <a href = 'http : //www.ioncube.com/loaders.php 'target =' _blank '> на тази страница. </a> Ако сте закупили пълен лиценз без абонамент и смятате, че виждате това по погрешка, вие може да сте забравили да въведете пълния си лицензен ключ в страницата за конфигуриране на сайта. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_GENERAL_PLUGINS_INSTALLATION', 'Как да инсталирам приставка?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_GENERAL_PLUGINS_INSTALLATION', "Ако приемем, че имате валиден номер на лицензен ключ, записан в конфигурацията на сайта, всичко, което трябва да направите, е да кликнете върху бутона Инсталиране до името на приставката в мениджъра на приставки. Jomres ще инсталира приставката вместо вас и ще донесе след това се връщате към страницата с приставки. Понякога вместо това може да бъдете отведени до страница за откриване, ако използвате Jomres в Joomla. Просто щракнете върху бутона „Откриване\", за да инсталирате приставката. <br/> <br/> ЗАБЕЛЕЖКА Не t инсталирайте всички приставки, те не работят заедно (по дизайн). Можете да завършите с празни страници във формуляра за резервация. Вместо това идентифицирайте необходимите приставки и експериментирайте с всяка от тях. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_SITESTRUCTURE', 'Структура на сайта');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_INTRO', 'Какво означава структурата на сайта?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_INTRO', "Структурата на сайта в Jomres се отнася до различните елементи на вашия сайт, които го правят уникален. Той определя типовете имоти, които посочвате за (напр. вили или хотели) и стаите/подтиповете за тези типове имоти. Така че , ако продавате празници на самообслужване, тогава бихте продавали наеми на нещо като хижа или вила. Различните хижи могат да имат различен брой стаи, балкони и др. В случай на хотели или пансиони, вие продавате стаи <em> в </em> имота и те биха били двойни спални, единични и т.н. За да се изясни това, инсталацията по подразбиране вече има няколко стаи и типове имоти, създадени за вас, за да ви помогне да разберете. Ако искате да продадете Обиколки, не се опитвайте да създадете нов тип собственост, без първо да прочетете раздела за Обиколки. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_PROPERTYTYPES', 'Какви са типовете собствености?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_PROPERTYTYPES', 'В тази система тип собственост се отнася буквално до типа на имота. Това може да бъде хотел, вила, апартамент. Мениджърите на имоти не могат да създават типове имоти, тъй като типовете имоти са елемент, който може да бъдат търсени от гостите. За да сте сигурни, че функционалността ви за търсене остава приятна, спретната и подредена, само администраторите на сайтове могат да създават типове имоти. ');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_PROPERTYFEATURES', 'Какви са свойствата на имота?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_PROPERTYFEATURES', "Характеристиките на имота са неща, които правят имота уникален. Например, една характеристика на имота може да бъде, че е\" близо до плажа \", докато друг хотел може да има характеристиката, че е в национален парк, предлага мостови пътеки, нещо подобно. Подобно на типовете собствености, мениджърите не могат да създават нови функции, те могат да избират само от тези, които вие създавате. Функциите на собствеността могат да имат назначени изображения. Първо трябва да качите изображения на функции чрез Site Strucutre> Media Center> Property Feature Падащи менюта с икони. Качете колкото искате икони на функции, след което, когато създадете свойство, можете да изберете неговото изображение. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_PROPERTYFEATURECATEGORIES', 'Какво представляват категориите свойства на имота?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_PROPERTYFEATURECATEGORIES', "Характеристиките на имота се показват на страницата с подробности за имота, наред с други. На страницата с подробности за имота функциите могат да се показват групирани по категории, например\" жилищна площ \",\" достъпност \"и т.н.");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_ROOMFEATURES', 'Какви са функциите на стаята?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_ROOMFEATURES', "Мениджърите на имоти, които използват режим Микроуправление или Разширен режим за редактиране на тарифите, могат да редактират своите стаи директно. Те също така могат да създават неща, наречени Функции на стаята, които се показват на страницата за наличност на стаите за всеки имот. Ако те използвайте класическия списък със стаи, показан във формуляра за резервация, след което гостите могат да използват функциите на стаята, за да филтрират стаите, преди да изберат една или повече. могат да се видят във всички формуляри за резервация на имоти, където имотът използва списъка с класически стаи. По принцип това е функция за глобална стая. Тези функции на стаята могат да бъдат конфигурирани да се показват само на определени типове имоти, а изображенията за тези функции на стаите могат да се качват чрез Структурата на сайта> страницата на Media Center. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_COUNTRIES', 'Защо има страница за редактиране на държави/региони?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_COUNTRIES', "Бихте си помислили, че списък с държави е доста неизменен, но ще сгрешите. През годините, когато поддържаме списък с държави, виждаме много промени. В резултат на това ние научих, че е най-лесно да се позволи на мениджърите на сайтове да определят държавите, които биха искали да покажат на сайта. Това позволява на непоколебимия каталунец да покаже своята провинция като уникална държава, ако това е декларацията, която биха искали да направят. Същото важи и за други региони на света. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_LOCALISATION', 'Локализация/Превод');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_LOCALISATION_INTRO', 'Как да преведа нещата?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_LOCALISATION_INTRO', "Преводът на етикети/низове се извършва чрез опциите на менюто Езици, главно страниците Превод на езиков файл/Превод на локали. Тъй като езиковите файлове са много големи, когато щракнете върху тази страница, може да отнеме известно време, докато зареждане. <br/> <br/> Нека разгледаме един пример. Да предположим, че искате да преведете Германия на Deutschland. Първо щракнете върху Превод на локали. След това проверете падащото меню на езика горе вдясно от английски на немски. След това превъртете надолу по страницата, докато стигнете до Германия. Можете да видите, че има пунктирано подчертаване. Това означава, че можете да я преведете. Кликнете върху думата, ще видите изскачащ прозорец, съдържащ думата „Германия\". Променете това на „Deutschland\" и щракнете върху зелената отметка. Ако вашата хост CMS е конфигурирана да предлага страници на немски език на посетителите на сайта, тогава думата „Германия\" вече ще се показва като „Deutschland\". Тази концепция се прилага през целия Jomres. <br/> <br/> На страниците на Мениджър на имоти, Мениджърите на имоти също могат вижте падащото меню Режим на редактиране на етикети в горната част на страниците им. Когато това е зададено на Включено, те също ще могат да правят промени във външния интерфейс, но тези промени ще засегнат само текущото им свойство, така че например те могат лесно да променят думата Тарифи на Цени само за един имот, ако това е задължително. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_TOURS', 'Обиколки');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_INTRO', 'Какво представляват обиколките?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_INTRO', "Това може да звучи като глупав въпрос, но всъщност не е. През годините научихме, че различните култури имат различно възприятие за това какво е\" турне \". В резултат на това очакванията за продажба на турнета варират силно, така че преди да обсъдим обиколките, първо ще определим какво мислим за обиколките. <br/> Обиколката е просто пътуване или посещение за разглеждане на атракция или паметник. Престоят в хотел обаче не е обиколка могат да се участват в обиколки, докато сте отседнали в хотел. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_HOWTOSELL', 'Как да използвам Jomres за продажба на обиколки?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_HOWTOSELL', 'За да решите въпроса за продажбата на обиколки в Jomres, първо трябва да инсталирате приставката Jintour. Тази приставка ви позволява да създавате обиколки, които се продават като част от ваканционни наеми. Също така ви позволява да създавате имоти които са изключително за продажба на обиколки. След като този плъгин бъде инсталиран, тогава мениджърите на имоти ще могат да създават обиколки и имоти за обиколки във фронтента. ');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_WHATISJINTOUR', 'Какво представлява приставката Jintour?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_WHATISJINTOUR', 'Jintour означава Jomres INtegrated TOURs. Позволява ви да създавате прости, ограничени ресурси, които могат да бъдат резервирани, които не са помещения в имот. Докато плъгинът е предназначен да позволява резервации на обиколки, могат да се използват за много неща, а не само за обиколки. Те могат да се използват например от ски хижа, която иска да отдаде под наем ски и екипировка. Тъй като това оборудване ще има ограничена наличност, можете да използвате приставката Jintour, за да позволите на гостите да резервирайте и заплатете тази екипировка по време на резервацията. ');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_SAMEBOOKING', 'Как да продавам обиколки и ваканционни жилища в една и съща резервация?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_SAMEBOOKING', "При този сценарий имате хотел и искате да продавате обиколки на местна атракция. Влезте във фронтента и отидете до хотела, който сте създали. След това щракнете върху Настройки> Обиколка /Управление на активността. На тази страница следвайте инструкциите на екрана, за да създадете първо профил на обиколка, след което да генерирате обиколки. След като това стане, ще можете да продавате както обиколки, така и резервации за стаи и допълнителни екстри една до друга в една и съща форма за резервация . ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_STANDALONETOURS', 'Ами ако искам да продавам само обиколки?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_STANDALONETOURS', "Първо ще трябва да създадете нова собственост във интерфейса. Когато го направите, уверете се, че сте задали\" Тип собственост \"на Tour. Когато сте създали тази нова собственост, тогава ще можете за да създавате отново обиколки чрез страницата Настройки> Обиколка/Управление на активността. Също така ще можете да предлагате допълнителни опции, както в нормалните имоти, единственото нещо, което няма да можете да направите, е да конфигурирате стаи, функции на стаите или тарифи, както вие ' не продавате стаи в този имот. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_GLOBALTOURS', 'Как мога да създам обиколка/резервируем ресурс, който може да се види във всички формуляри за резервации на имоти?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_GLOBALTOURS', "В администраторската област на вашия сайт посетете страницата Portal> Funkcionalnost Tour/Activity Managenent. Профилът/генерирането на обиколката е същият като този, използван във фронтенда, но всички генерирани тук обиколки се виждат в frontend. Един типичен сценарий, при който това може да се използва, е ако администраторът на сайта организира събития в цялата страна и те искат да продават хотелски резервации. Те биха създали участващите хотели във frontend като нормално, като определят цените на стаите и т.н., след това „ обиколките в този случай всъщност биха били таксата за присъствие на самото събитие. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_FIRSTTHINGSFIRST', "Добре, инсталирах Jomres, какво следва?");
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_FIRSTTHINGSFIRST', "Най -първото нещо, което трябва да направите, след като сте инсталирали Jomres, е да щракнете върху Помощ в менюто вляво, след което щракнете върху Първи стъпки. Сериозно, отидете и направете това сега.") ;
