...
jr_define('JOMRES_COM_A_TARIFFMODE_DESC', '<b>Предупреждение: Переключение между различными режимами редактирования тарифов может привести к потере данных. См. примечание ниже по этому поводу.</b>.
<br/><br/>
...
jr_define('_JOMRES_EMAIL_TEMPLATES_INSTRUCTIONS', 'Пожалуйста, посмотрите эту страницу для помощи Настройка электронной почты и список доступных продукции: <a href="https://www.jomres.net/manual/property-managers-guide/48-your-toolbar/settings/254-email-templates" target="_blank">Email Templates Help</a>');
...
jr_define('_JOMRES_CONFIG_GMAP_KEY_WARNING', "У вас нет набора ключей Карт Google. В связи с недавними изменениями в картах Google, всем новым сайтам потребуется ключ API, чтобы иметь возможность использовать функции карты Google. Пожалуйста, <a href = 'https://www.jomres.net/manual/site-managers-guide/14-getting-started/338-google-maps-api-key' target='_blank'> см. нашу страницу руководства о том, как создать ключ API < / a> и сохраните ключ в Jomres. ");
...
jr_define('_JOMRES_MEDIA_CENTRE_UPLOAD_CONTEXT_PROPERTY_TYPE_IMAGES', "Изображения свойств");
	...
	jr_define('JOMRES_TRANSLATIONS_TITLE', 'Переводы');
	jr_define('JOMRES_TRANSLATIONS_LEAD', 'На этой странице вы можете переводить метки с одного языка на другой. При посещении страницы вы увидите строки, которые вы уже создали, и их значение на любом языке, который вы используете в данный момент. Вверху установите целевом языке, затем для ярлыков, которые вы хотите перевести, нажмите на ярлык, и всплывающее окно позволит вам ввести новый перевод. Для более длинных строк текста вы можете вставить текст из другого источника. Помните, что любой HTML-код будет удален .<br/>
Вы можете оставить в качестве целевого языка ваш текущий язык и использовать эту страницу, чтобы переименовывать элементы здесь, вместо того, чтобы посещать их отдельные страницы.');
	jr_define('JOMRES_TARGET_LANGUAGE', 'Целевой язык');
...
jr_define('_JOMRES_COM_A_GATEWAYLIST_TEST_MODE_STR', "Тестовый режим");
