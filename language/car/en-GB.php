...
jr_define( '_JOMRES_COM_MR_GENERALCONFIGDESC', 'Car Configuration' );
...
jr_define( '_JOMRES_COM_MR_NEWPROPERTY', 'New car' );
jr_define( '_JOMRES_COM_MR_NEWPROPERTYFEATURE', 'New car feature' );
...
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL', 'Default car' );
...
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_LEVEL_ADMIN', 'Car manager' );
...
jr_define( '_JOMRES_COM_MR_EDITBOOKING_TAB_ROOM', 'Car' );
...
jr_define( '_JOMRES_COM_MR_EB_ROOM_NAME', 'Car name' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_NUMBER', 'Car' );
...
jr_define( '_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV', 'Car type' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_CLASS_DESC', 'Car type description' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_FEATURES_LIST', 'Car features list' );
...
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_TITLE', 'Our cars' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_PROPERTYNAME', 'Car' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_ROOMTYPE', 'Car type' );
...
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK', 'Car type' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV', 'Car type abbreviation' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC', 'Car type description' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT', 'Car type added' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE', 'Car type updated' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT', 'Car added' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_UPDATE', 'Car updated' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_LINK', 'Car Features' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_ABBV', 'Car feature abbv.' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_DESC', 'Car feature full description' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_INSERT', 'Car feature added' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_UPDATE', 'Car feature updated' );
...
jr_define( '_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS', 'Car type' );
...
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_PROPERTYADMIN', 'Car admin' );
...
jr_define( '_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE', 'There are no cars available able to satisfy the parameters specified' );
...
jr_define( '_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE', 'Rental made for car: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM', 'Rental made for car: ' );
...
jr_define( '_JOMRES_COM_A_TARIFFS_PER_DESC', 'Select Yes if you want to charge per-person-per-night. If no, then costs will be calculated on a per-car-per-night basis' );
...
jr_define( '_JOMRES_FRONT_MR_BOOKED', 'Cars rented' );
jr_define( '_JOMRES_COM_CONFIRMATION_TITLE', 'Confirmation letter' );
jr_define( '_JOMRES_COM_CONFIRMATION_DEAR', 'Dear ' );
jr_define( '_JOMRES_COM_CONFIRMATION_RATE_RULES', 'Cost per night - per car ' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN', 'Your car will be held until your arrival, and check in is after 2pm.' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE', 'No allowance can be made for meals not taken or for cars not occupied for the full period of the rental. With this in mind we strongly recommend that you use a holiday insurance facility.' );
...
jr_define( '_JOMRES_COM_MR_ROOM_UNABLETODELETE', 'Unable to remove this car, there are rentals against it. Cancel those rentals then retry.' );
jr_define( '_JOMRES_COM_MR_ROOM_DELETED', 'Car deleted' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_DELETE', 'Delete car feature' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE', 'Unable to remove this car feature, it is assigned to a car or cars. Remove the feature from those cars and retry.' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_DELETED', 'Car feature deleted' );
jr_define( '_JOMRES_COM_MR_PROPERTYFEATURE_DELETE', 'Delete car feature' );
jr_define( '_JOMRES_COM_MR_PROPERTYFEATURE_UNABLETODELETE', 'Unable to remove this car feature, it is assigned to a car. Remove the feature from this car and retry.' );
jr_define( '_JOMRES_COM_MR_PROPERTYFEATURE_DELETED', 'Car feature deleted' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_DELETE', 'Delete car type' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS', 'Unable to remove this car type, it is assigned to a car. Try re-assigning the car to another car type then try again.' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS', 'Unable to remove this car type, it is assigned to a tariff. Try re-assigning the tariff to another car type then try again.' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_DELETED', 'Car type deleted' );
jr_define( '_JOMRES_COM_MR_PROPERTY_DELETE', 'Delete car' );
jr_define( '_JOMRES_COM_MR_PROPERTY_DELETED', 'Car deleted' );
jr_define( '_JOMRES_COM_MR_PROPERTY_DELETE_NORIGHTS', 'You do not have rights to delete this car.' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION', 'Car description' );
...
jr_define( '_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC', 'Set this to Yes to ensure that visitors can rent cars online.' );
...
jr_define( '_JOMRES_COM_A_BOOKING', 'Rental cars' );
...
jr_define( '_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC', 'EG you are renting out a car, rather than cars in that car. If this is the case, then you must make sure that you only have the one car registered against each car.' );
...
jr_define( '_JOMRES_COM_AVLCAL_INBGCOLOUR', 'Cell bgcolour for days when car is available' );
...
jr_define( '_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR', 'Cell bgcolour for provisionally rented cars (rentals for which a deposit has not been taken)' );
...
jr_define( '_JOMRES_FRONT_DELETEGUEST_UNABLETODELETEGUEST', 'Unable to delete this guest as they have rentals open against them with another car.' );
jr_define( '_JOMRES_COM_INVOICE_ACTUALROOMCOST', 'Actual car cost: ' );
...
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM', 'Created car' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM', 'Updated car' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM', 'Deleted car' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE', 'Created carfeature' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE', 'Updated carfeature' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE', 'Deleted carfeature' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE', 'Inserted cartype' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE', 'Updated cartype' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE', 'Deleted cartype' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_PROPERTY', 'Created car' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_PROPERTY', 'Updated car' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_PROPERTY', 'Deleted car' );
...
jr_define( '_JOMRES_MR_AUDIT_BOOKED_ROOM', 'Rented a car' );
...
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR', 'There was an error attempting to rent these cars, one or more of the cars you selected is not free.' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT', 'Cars included in black rental' );
...
jr_define( '_JOMRES_COM_A_ROOMTAX', 'Car tax' );
jr_define( '_JOMRES_COM_A_ROOMTAX_DESC', 'Designed for the American market. These are the car tax amounts that will be charged to the guest. You can charge a combination and/or of fixed and percentage figures. Note that these taxes are only applied to the cost of the car.' );
...
jr_define( '_JOMRES_FRONT_TARIFFS_ROOMTYPE', 'Car type' );
...
jr_define( '_JOMRES_FRONT_PTYPE', 'Car type' );
jr_define( '_JOMRES_COM_PTYPES_LIST_TITLE', 'List car types' );
jr_define( '_JOMRES_COM_PTYPES_LIST_TITLE_EDIT', 'Edit car type' );
jr_define( '_JOMRES_COM_PTYPES_PTYPE', 'Car type' );
jr_define( '_JOMRES_COM_PTYPES_PTYPE_DESC', 'Car type description' );
jr_define( '_JOMRES_COM_PTYPES_SAVED', 'Car type saved' );
jr_define( '_JOMRES_COM_PTYPES_UNABLETO_DELETE', 'Unable to delete car type. Car type is assigned to one or more cars, please re-assign them before trying to delete' );
jr_define( '_JOMRES_COM_PTYPES_DELETED', 'Car type(s) deleted' );
...
jr_define( '_JOMRES_COM_MONTHSTOSHOW_DESC', 'In the car availability, How many months of the calendar should be shown?' );
...
<br/> 
Choose the car(s) you wish to take out of service. <br>If a car does not have a check mark against it, it cannot be included in the black rental until any outstanding rentals have been completed/cancelled.<br/> ' );
...
jr_define( '_JOMRES_FRONT_GALLERYLINK', 'View this car\'s website' );
...
jr_define( '_JOMRES_JR_A_IMAGEHANDLING_BATCHUPLOAD', 'Batch car image upload' );
...
jr_define( '_JOMRES_COM_A_SLIDESHOWS_NOIMAGES', '<br />Sorry, no images available for this car. Please upload some images using the batch upload feature if you wish to use the slideshow feature.' );
...
jr_define( '_JOMRES_FRONT_IMAGEUPLOADS_INFO', 'Use this form to upload multiple images of this car.<br/><b>Note</b> that any images with the same name will be overwritten. Also note that this form does not upload car specific images or the car header image, you will need to upload them from the Car Admin section.<br/><b>Note</b> Images uploaded here will be written to the /jomres/uploadedimages/*car_uid* folder. If this folder does not exist, it will be created, unless of course an alternative directory has been specified in the configuration.' );
jr_define( '_JOMRES_A_TABS_MISC', 'Misc' );
jr_define( '_JOMRES_A', 'Site configuration' );
jr_define( '_JOMRES_A_GLOBALPFEATURES', 'Use global car features' );
jr_define( '_JOMRES_A_GLOBALPFEATURES_DESC', 'Set this to Yes if you want to force all cars to use only the car features defined by the webmaster.' );
jr_define( '_JOMRES_A_GLOBALPFEATURES_INFO', 'To assign an image to this feature you first need to upload your car feature images to the /jomres/uploadedimages/pfeatures/ folder. ' );
...
jr_define( '_JOMRES_FRONT_MR_MENU_BOOKAROOM', 'Rent a car' );
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS', 'Click for Cars and availability' );
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWDETAILS_TITLE', 'Show detailed car info below this link' );
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE', 'Show cars and availability below this link' );
...
jr_define( '_JOMRES_COM_PROPERTYLISTDESC_DESC', "This limits the number of characters shown in the car listing when drawing from the car description." );
...
jr_define( '_JOMRES_A_GLOBALROOMTYPES', 'Use global car types' );
jr_define( '_JOMRES_A_GLOBALROOMTYPES_DESC', 'Set this to Yes if you want to force all cars to use only the car types defined by the webmaster. You need to set this to Yes if you intend to allow searching via car types.' );
jr_define( '_JOMRES_A_GLOBALROOMTYPES_INFO', 'To assign an image to this car type you first need to upload your car type images to the /images/stories/jomres/rmtypes/ folder. ' );
...
jr_define( '_JOMRES_COM_SELFREGISTRATION', 'Users can register their cars?' );
jr_define( '_JOMRES_COM_SELFREGISTRATION_DESC', 'Set this to Yes if you want users to be able to register their own cars without admin intervention.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1', 'Please provide the country and region of your car.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_1', 'Please complete your car details.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_2', 'Items highlighted are required.' );
jr_define( '_JOMRES_REGISTRATION_AUDIT_CREATEPROPERTY', 'Created car' );
jr_define( '_JOMRES_REGISTRATION_NOTALLOWED', "Sorry, you can't create a car on this system. You must be a logged in, registered user before you can proceed." );
jr_define( '_JOMRES_REGISTRATION_CREATEDPROPERTY', 'Created car: ' );
...
jr_define( '_JOMRES_NUMBEROFROOMSAVAILABLE', 'Number of cars available' );
jr_define( '_JOMRES_BACKTOPROPERTYDETAILSLINK', 'Back to car details' );
jr_define( '_JOMRES_FRONT_ROOMTYPES', 'Car types' );
...
jr_define( '_JOMRES_AJAXFORM_INSTRUCTIONS', 'Use this form to place your rental. Modify your rental particulars like arrival and departure dates & guest numbers, then select the car(s) you require from the list of those available. Click any available cars to add them to your rental. When done, you can add any optional extras you may require and provide your address details. When the form has enough information it will then give you a submit button so that you can confirm your rental.' );
...
jr_define( '_JOMRES_AJAXFORM_AVAILABLE_DESC', 'Select the cars that you require' );
jr_define( '_JOMRES_AJAXFORM_AVAILABLE_DESC_SRP', 'Look here to see if the car is available at this time.' );
...
jr_define( '_JOMRES_AJAXFORM_AVAILABLEROOMS', 'Available cars' );
jr_define( '_JOMRES_AJAXFORM_SELECTEDROOMS', 'Selected cars' );
...
jr_define( '_JOMRES_VARIANCES_ISPERCENTAGE_TT', 'The figure calculated is a percentage of the Base figure calculated for the car. If this is set to no then the figure you specify is simply added or subtracted from the base car value.' );
jr_define( '_JOMRES_VARIANCES_POSNEG', 'Add variance?' );
jr_define( '_JOMRES_VARIANCES_POSNEG_TT', 'The figure calculated is added to or removed from the Base figure calculated for the car. Set this to No if you want this to be a discount from the base figure. ' );
...
jr_define( '_JOMRES_COM_A_SHOWROOMSLISTLINK', 'Show link to cars list page in car details page?' );
jr_define( '_JOMRES_COM_A_SHOWONLYAVLCAL', 'Show <b>only</b> Availability calendar?' );
jr_define( '_JOMRES_COM_A_SHOWONLYAVLCAL_DESC', 'Switch this to Yes to disable display of the car header and details, so that only the availability calendar is viewable in the car details section. Only really intended for users renting out single car cars (eg apartments, cottages etc).' );
...
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO', 'Rental form car list show car number' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME', 'Rental form car list show car name' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE', 'Rental form car list show tariff title' );
...
jr_define( '_JOMRES_COM_AVLCAL_BOOKING_KEY', 'Car is rented' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS', 'You have chosen more cars than you have guests, click on a car name to remove it from your selection' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS', 'Too many guests for the available beds' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS', 'You need to choose more cars' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM', 'Select a car' );
...
jr_define( '_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET', 'No cars selected yet' );
...
jr_define( '_JOMRES_COM_LIMITROOMSLIST', 'Available cars/tariff limit' );
jr_define( '_JOMRES_COM_LIMITROOMSLIST_DESC', 'Use this input to limit the number of available cars & tariffs that are listed in the rental form. Set it to zero if you do not want limiting enabled. ' );
...
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALEDITING_DESC', 'Take care with this function. If set to Yes, then the editing mode will affect the custom text for ALL cars in the system for the constant you are editing.' );
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALCURRENCYYESNO', 'Use global currency?' );
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALCURRENCYYESNO_DESC', 'Set this to yes to force all cars to use the same currency (e.g. & # 8 3 6 4 ;)' );
...
jr_define( '_JOMRES_COM_USERIS_SUPERPROPERTYMANAGER', 'Super Car Manager' );
jr_define( '_JOMRES_COM_WEEKENDONLY', 'Weekends only' );
jr_define( '_JOMRES_COM_WEEKENDDAYS', 'Weekend days' );
jr_define( '_JOMRES_COM_WEEKENDDAYS_DESC', 'Set your weekend days. Tariffs that allow or disallow weekends will take this setting into account when generating the cars list.' );
jr_define( '_JOMRES_EDITPROPERTY_SELECTCOUNTRY', 'Select your country before adding any car information' );
jr_define( '_JOMRES_EDITPROPERTY_SAVEBEFOREUPLOAD', 'Save your car changes before uploading a car image' );
...
jr_define( '_JOMRES_SEARCH_AVL_INFO', 'Please enter your intended arrival and departure dates and press the button to find cars that have accommodation available on your chosen dates.' );
jr_define( '_JOMRES_SEARCH_PTYPES', 'List all cars by car type.' );
jr_define( '_JOMRES_SEARCH_RTYPES', 'List all cars by car type.' );
jr_define( '_JOMRES_SORTORDER_DEFAULT', 'Default' );
jr_define( '_JOMRES_SORTORDER_PROPERTYNAME', 'Car Name' );
jr_define( '_JOMRES_SORTORDER_PROPERTYREGION', 'Car Region' );
jr_define( '_JOMRES_SORTORDER_PROPERTYTOWN', 'Car Town' );
jr_define( '_JOMRES_SORTORDER_STARS', 'Stars' );
jr_define( '_JOMRES_PATHWAY_PROPERTYLIST', 'Car list' );
jr_define( '_JOMRES_PATHWAY_PROPERTYDETAILS', 'Car details ' );
...
jr_define( '_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_RECHECKINGROOMAVIALABILITY', 'Re-checking car availability<br/>(Car selection will be reset)' );
...
jr_define( '_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_CHANGINGROOMSELECTION', 'Changing your car selection' );
...
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMIMAGE', 'Car image' );
...
Normal mode: You will have one tariff for each car type that is valid for the next 10 years.<br/>
Micromanage: You can modify the price for each and every day for each car type. <br/>
...
Normal mode is the most simplistic but it's the easiest to understand because it will cross reference cars and tariffs to car types and allows you to configure cars and prices on the same page.<br/>
...
Advanced mode lets you create a car and associate it with a car type. You then create a tariff and associate THAT with a car type. Using this method it is possible to \"layer\" tariffs over each other, for example a car type \"Double bed\" can have one tariff for bed and breakfast, and another for bed, breakfast and evening meal. The advanced method requires a little more attention to detail because it is possible to dis-associate a car or tariff from a car type, or to incorrectly set valid from and to dates, but it does give you configuration options that the other modes do not offer. <br/>
<br/>
Because Normal and Micromanage modes require a specific set up of cars and tariffs for the tariff mode to work the system may need to reset some data to make the current tariff configurations compatible with the current tariff editing mode.<br/>
<br/>
...
jr_define( '_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS', 'Show cars list in car details page?' );
jr_define( 'JOMRES_PROPERTYTYPE', 'Car type' );
jr_define( 'JOMRES_COM_A_SRPONLY', 'SRP only' );
jr_define( 'JOMRES_MAXPEOPLEINROOM', 'Max people per car' );
...
jr_define( '_JOMCOMP_MYUSER_PROPERTYTYPE', 'Car type' );
jr_define( '_JOMCOMP_MYUSER_PUBLISHEDPROPERTIES', 'Cars on site' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE', 'Wise price' );
jr_define( '_JOMCOMP_WISEPRICE_ACTIVE', 'Active' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE_DESC', 'This plugin allows you to enable and configure your car prices dynamically.' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE_DESC_FULL', 'Most cars will recalculate car prices based on the number of cars of a required type that are available on a given date. This allows them to offer discounts on a car type that isn\'t busy during a given period with the aim of attracting car that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of cars of a selected type are available in the car on a given day.<br/> The days threshold defines the number of days that the arrival date must be within before car prices are adjusted by this feature, then the percentages options allow you to configure the percentage of cars that can be available before a given discount is applied. Note however, if multiple cars are rented then the current level of discount will be applied to all cars and will not reduce as more cars are selected.' );
jr_define( '_JOMCOMP_WISEPRICE_THREASHOLD', 'Threshold (number of days between arrival date and today)' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE10', 'Percentage cars occupied 10% or less' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE25', 'Percentage cars occupied 25% or less' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE50', 'Percentage cars occupied 50% or less' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE75', 'Percentage cars occupied 75% or less' );
...
jr_define( 'JOMRES_COM_A_MAPSKEY_DESC', 'Get can get a google maps API key from <a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google maps</a>. Once you have input your map key here, Jomres will show the map in your Car Details page.' );
...
jr_define( 'JOMRES_COM_A_VERBOSETARIFFINTO_DESC', 'Set this to Yes to show more detailed tariff information in the car details/tariff popup' );
jr_define( 'JOMRES_COM_A_MINIMALCONFIG', 'Minimise configuration options' );
jr_define( '_JOMCOMP_AMEND', 'Amend Rental - Car Selection' );
jr_define( '_JOMCOMP_AMEND_SELECTPROPERTY', 'Select New Car' );
...
jr_define( '_JRPORTAL_CONFIG_DEFAULT_CRATE_DESC', 'Choose the default commission rate that will be applied to a car in the event that another commission rate is not otherwise set.' );
...
jr_define( '_JRPORTAL_CPANEL_LISTPROPERTIES', 'List Cars' );
jr_define( '_JRPORTAL_PROPERTIES_PROPERTYNAME', 'Car name' );
jr_define( '_JRPORTAL_PROPERTIES_PROPERTYADDRESS', 'Car address' );
jr_define( '_JRPORTAL_PROPERTIES_LEGEND', 'Cars who\'s background colour is red have not yet had a commission rate applied to them.' );
jr_define( '_JRPORTAL_STATS_PATETITLE', 'Statistics' );
jr_define( '_JRPORTAL_STATS_STATTYPE', 'Statistics for: ' );
jr_define( '_JRPORTAL_STATS_STATTYPE_PROPERTIES', 'Cars - Clicks' );
jr_define( '_JRPORTAL_PROPERTIES_VIEWPROPERTY', 'Car view' );
...
jr_define( '_JRPORTAL_LISTBOOKINGS_HEADER_PROPERTY_ID', 'Car id' );
...
jr_define( '_JRPORTAL_ADD_ADHOC_ITEM_CHOOSEPROPERTY', 'Associated car (if applicable)' );
...
jr_define( '_JOMRES_COM_PTYPES_PTYPE_DESC_FURTHER', 'You can have car type specific language files by setting the description to the name of a sub folder, e.g. "yachtbrokerage" and copying a language file to that subfolder. You can then modify that language file for this car type so cars become, for example, DVDs, etc.' );
jr_define( '_JOMRES_EDITPROPERTY_CONNOTDELETE1', 'You cannot delete this car as it is the only car that you have access to. If you want to disable it, please use the un-publish feature in your toolbar. ' );
jr_define( '_JOMRES_EDITPROPERTY_CONNOTDELETE2', 'If this is a demo installation and you intend to upgrade to Jomres Solo (one car only limit) then you should create a new car first, then delete this one before changing your license key to the Solo license key that you will be assigned on purchase. ' );
...
jr_define( '_JOMRES_COM_ISTHISANMRP', "Is this car a hotel/bed and breakfast/guest house/pension? " );
jr_define( '_JOMRES_COM_ISTHISANMRP_DESC', "Configuration options differ depending on if you are renting out cars in a car, or the car itself. Select MRP if you are offering cars, select SRP if you are offering the entire car. " );
...
jr_define( '_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM', "per car " );
...
jr_define( '_JOMRES_FRONT_MR_MENU_CONTACTHOTEL', 'Contact agency' );
jr_define( '_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_SUBJECT', 'Car enquiry from ' );
jr_define( '_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_THANKS', 'Thank you for your enquiry, your message has been sent to the car\'s contact email address, and copied to your own address for your records. They will respond to you as soon as possible with their reply.' );
...
jr_define( '_JOMRES_BOOKINGFORM_LOOKRIGHT', 'Please select your required accommodation from the list below by clicking on the car.' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MINROOMS', 'Min cars already selected' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC', 'Minimum number of cars already selected in rental before tariff/car type combo can be offered. Allows you to have discounted tariffs when more than N cars are already selected. ' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MAXROOMS', 'Max cars already selected' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC', 'Maximum number of cars already selected in rental before tariff/car combo is no longer offered. Allows you to stop offering this car type/tariff combination once N cars have been selected in the rental form. ' );
...
jr_define( '_JOMRES_COM_SEF_TASK_ALIAS_VIEWPROPERTY', 'View car task alias' );
...
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PTYPE', 'Add car type to url' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PTYPE_DESC', '' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME', 'Add car name to url' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME_DESC', '' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID', 'Append car id to car name' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID_DESC', 'if car name is set to No then the id will not be used. If set to yes then the url will look like fawlty_towers-1' );
...
jr_define( '_JOMRES_COM_SEF_DEFAULT_COUNTRY_DESC', 'If all your cars are in one country then you will not have country in the search - enter a default country here if you want to display a country' );
...
jr_define( '_JOMRES_COM_SEF_DEFAULT_REGION_DESC', 'If all your cars are in one region then you will not have region in the search - enter a default region here if you want to display a region' );
...
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_PTYPE', 'Search URL Structure - Car type' );
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_PTYPE_DESC', '' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_PTYPE', 'Search URL Structure - Default car type' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_PTYPE_DESC', 'Used in url if search is for all car types' );
...
jr_define( '_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYSPERROOM', 'Per days X cars selected' );
...
jr_define( '_JOMRES_COM_COMPOSITE_PROPERTY_DETAILS', 'Use Composite Car details?' );
jr_define( '_JOMRES_COM_COMPOSITE_PROPERTY_DETAILS_DESC', 'Jomres 3.3 introduces the composite car details where all of the car details output is sent to one template file (composite_car_details.html). If you do not wish to use this set it to No (only existing users are expected to set this to No, new users will probably want to leave it set to Yes)' );
jr_define( '_JOMRES_PROFILELIST_INSTRUCTIONS', 'This is a list of all users on the system. Non-car managers will have a Guest icon, car managers will have Reception/Car Manager/Super car manager icons.<br/>When Jomres is first installed "admin" is automatically added as a car manager and is considered an authorised user.<br/>Non-super car managers must be assigned to at least one car otherwise they will see an error when they try to log on and use Jomres.<br/>Once a user is authorised then you can edit their profiles, assign them to cars or give them super car manager rights.<br/>To authorise a user, click on the red Cross next to their name. To unauthrorise them, click the green Tick.<br/>To assign users to specific cars only, or give them super car manager rights, authorise them then click the edit icon (which is only visible once they\'ve been authorised). Users who\'ve registered their car(s) themselves will be automatically assigned to those cars. Super car managers automatically have rights over all cars, and will see all configuration options even if the minimised configuration option is set in Site Config.' );
jr_define( '_JOMRES_PROFILEEDIT_INSTRUCTIONS', 'Here you can assign a manager to certain cars. Ensure, if they\'re not going to be a super car manager, that they have rights to at least one car otherwise they will see an error when they log in. To give a receptionist/car manager rights over only certain cars, ensure that the Super Car Manager dropdown is not set to Yes.' );
jr_define( '_JOMCOMP_MYUSER_VIEWBOOKINGS_NONE', 'You haven\'t made any rentals yet!' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_TAB', 'Car type' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_TYPE', 'Edit your car type' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_INFO', 'Select your car type' );
...
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMTYPEIMAGE', 'Rental form car list show car type image' );
jr_define( '_JOMRES_COM_A_LISTLIMIT', 'Car List limit' );
jr_define( '_JOMRES_COM_A_LISTLIMIT_DESC', 'The number of cars to show on a page after a search' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE', 'Integrated search feature' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE_DESC', 'The Jomres integrated search feature allows your users to search through Jomres cars according to a set of functions. If you have already used the search features of Jomres in Joomla you will be familiar with these settings.<br/>This feature allows us to offer search handling within Jomres for those users who don\'t want to use Joomla search modules, or for other CMS users who\'s CMS doesn\'t have it\'s own Jomres search modules.<br/>Just remember that if you choose to search for something via a link (ie not a dropdown) then other search options will not be implemented, only the element that corresponds with the link that you clicked.<br/>Note that by default the layout of this integrated search isn\'t very pretty. That\'s because the template file that performs the layout has to include all possible options, some of which are incompatible. To improve the layout and achieve the look you desire, you will need to edit <b>srch.html</b> in the folder <b>' . JOMRES_TEMPLATEPATH_FRONTEND . '</b> ' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE', 'Activate this feature?' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE_DESC', 'If this feature is enabled, then any call to Jomres that shows the car list will mean that the search options are also shown.' );
...
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME', "Search by car name" );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME_DESC', "Show the search by car name input." );
...
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE', "Search by car type" );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE_DESC', "Show the search by car type input" );
...
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE', "Search by car type" );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE_DESC', "Show the search by car type input" );
...
jr_define( '_JOMRES_A_GLOBAL_SEARCHOPTION_RANDOMLIMIT_DESC', 'By default, if a car is not selected in Jomres it will perform a search. If this search was not triggered by a search module then that search will produce random results (deliberately). This option allows you to limit the number of returns in that random search.' );
...
jr_define( '_JRPORTAL_COUPONS_ROOMONLY', "Car only" );
jr_define( '_JRPORTAL_COUPONS_ROOMONLY_DESC', "Discount is only applied to the cost of the car. If No, then the discount is applied to the entire cost of the rental." );
...
<br/>
" );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWDISABLED', 'Rental form car list show disabled access' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWMAXPEOPLE', 'Rental form car list show max people' );
jr_define( '_JRPORTAL_HORIZROOMSLIST_ESTIMATEWARNING', "Please note that car prices listed are estimates and the full price of the rental will not be calculated until you have added a car or cars to your selection." );
...
jr_define( '_JRPORTAL_SUBSCRIPTIONS_PACKAGES_ROOMSLIMIT', "Cars limit" ); // Not currently used, saved for a rainy day
jr_define( '_JRPORTAL_SUBSCRIPTIONS_PACKAGES_PROPERTYLIMIT', "Car limit" );
...
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES1', "You need a valid subscription to create new cars. At this moment in time, you have purchased subscriptions for " );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES2', " <i>published</i> car(s). " );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES3', "You can increase the number of cars you can create by <a href='" . JOMRES_SITEPAGE_URL . "&task=list_subscription_packages'>purchasing more subscription packages here.</a>" );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES4', " You have used " );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES5', " car slots. " );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES6', "To see a list of your current cars click <a href='" . JOMRES_SITEPAGE_URL . "&task=listyourcars'>here</a>. " );
...
jr_define( '_JRPORTAL_SUBSCRIPTIONS_PUBLISHERROR', "Unfortunately, you cannot publish this car as you have reached your maximum number of available car slots." );
jr_define( '_JRPORTAL_SUBSCRIBERS_SUBSCRIBED', "Thank you for creating a subscription to list your car on our server. Once your invoice is marked as paid (there may be a delay depending on Paypal) please <a href='" . JOMRES_SITEPAGE_URL . "&task=registerProp_step1'>click here to continue creating your car(s).</a>" );
...
jr_define( '_JRPORTAL_SUBSCRIBERS_CANNOT_PUBLISH', "We are sorry, but you've met the limit of the number of cars that you can have published on this system at any one time. You can raise the number of cars that you can publish by <a href='" . JOMRES_SITEPAGE_URL . "&task=list_subscription_packages&Itemid=" . $Itemid . "'>purchasing more subscription packages here.</a> " );
...
jr_define( '_JOMRES_CLICKTOREGISTER', 'Click here to register your car' );
...
jr_define( '_JOMRES_USER_LISTMYPROPERTY', 'Add my car to this site' );
...
jr_define( '_JOMRES_COM_YOURBUSINESS', 'Your car details' );
jr_define( '_JOMRES_COM_YOURBUSINESS_NAME', 'car name' );
...
<br/> 
If the car has one or more rentals for the period selected, then you will not be able to rent it out until the other rentals/black rentals, have been cancelled/rented out.' );
jr_define( '_JOMRES_FRONT_BLACKBOOKING_SRP_CANNOTBLACKBOOK', 'Sorry, you cannot black rent this car for those dates.' );
jr_define( '_JOMRES_FRONT_BLACKBOOKING_SRP_CANBLACKBOOK', 'You can blackrent this car for those dates.' );
jr_define( '_JOMRES_WARNINGS_PERPERSONPERNIGHT_NOGUESTTYPES', 'Your car is configured to charge per person per night but you do not have any guest types created or published, please create and publish one or more guest types. ' );
jr_define( '_JOMRES_WARNINGS_TARIFFS_NOTARIFFS', 'You don\'t have any tariffs configured yet, you will not be able take any rentals for your car.' );
...
jr_define( '_JOMRES_CONTACTOWNER_TO_ADMIN_DESC', 'Set this option to Yes if you want Contact Owner emails to be sent to the below input. Leave it set to No to send the emails to the email address defined in the car configuration area.' );
...
jr_define( '_JOMRES_REALESTATE_YESNO', 'Is this car a for sale listing?' );
jr_define( '_JOMRES_REALESTATE_YESNO_DESC', 'Select Yes if you are selling the car, select No if it is a listing where you will be offering short term rentals and will be using this system for taking rentals.' );
...
jr_define( '_JOMRES_AUTOTRANSLATE_DESC', 'This feature is new and experimental, so use at your own risk. The purpose of the feature is to query Google\'s translation tool to automatically set up translations for a given car. Note that this feature sanitizes all input, so if you use a html editor for formatting your car details, then this will break that formatting.<br/>' );
jr_define( '_JOMRES_SINGLEPROPERTYINSTALLATION_TITLE', 'Is this a single car installation?' );
jr_define( '_JOMRES_SINGLEPROPERTYINSTALLATION_DESC', 'If this option is set to Yes, then the frontend view of Jomres to non-authorised users is greatly simplified. Default calls to Jomres from a menu option, instead of being given a list of cars, just takes the guest to the rental form for the first car in the system. Car managers also will not see see the Car Details preview button or the Add new car button. Ideal if you only want to list one car and take rentals for it.<br/>' );
...
jr_define( '_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO', 'Limit car registration to one country?' );
jr_define( '_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO_DESC', 'You can ensure that car registrations are limited to just one country by setting this option to Yes and setting the country in the following option.' );
jr_define( '_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_COUNTRY', 'Cars are located in this country : ' );
jr_define( '_JOMRES_JQUERYTHEME', 'Jquery theme' );
jr_define( '_JOMRES_JQUERYTHEME_DESC', 'Choose a jquery theme to use for the car details tabs.' );
jr_define( '_JOMRES_PROPERTYNOTOUBLISHED', 'We are sorry, but that car is not currently available.' );
jr_define( '_JOMRES_REVIEWS', 'Reviews' );
jr_define( '_JOMRES_REVIEWS_TITLE', 'Review title' );
jr_define( '_JOMRES_REVIEWS_DATE', 'posted on ' );
jr_define( '_JOMRES_REVIEWS_NOREVIEWS', 'There are no reviews for this car yet.' );
jr_define( '_JOMRES_REVIEWS_NOREVIEWS_BETHEFIRST', 'Would you like to be the first to review this car?' );
...
jr_define( '_JOMRES_REVIEWS_REVIEWBODY', 'Tell us what you think about this car : ' );
...
jr_define( '_JOMRES_REVIEWS_ALREADYREVIEWED', 'You have already reviewed this car, you can\'t post another review about it.' );
...
jr_define( '_JOMRES_REVIEWS_ADDREVIEW_ERROR_PROS', 'Please enter the good parts of your experience of being a guest at this car' );
...
jr_define( '_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_2', 'Please rate your opinion of the car\s locale' );
jr_define( '_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_3', 'Please provide your opinion of the cleanliness of the car' );
...
jr_define( '_JOMRES_REVIEWS_ADMIN_TESTMODE_DESC', 'Normally car managers cannot review cars. With test mode enabled, they can. Naturally this is not ideal in a production environment.' );
jr_define( '_JOMRES_REVIEWS_ADMIN_PROPERTYLISTINFO', 'This is a list of all cars. To see a car\'s reviews, click on that car. From there you will be able to publish or delete a review.' );
...
jr_define( '_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS', 'Show Rental form in car details page?' );
jr_define( '_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS_DESC', 'Set this to Yes to show the rental form in the car details page. If you set it to No, then a link will appear in the car details page instead pointing to the rental form.' );
...
jr_define( '_JOMRES_ROOMALLOCATIONS_ROOM', 'Car ' );
jr_define( '_JOMRES_ROOMALLOCATIONS_GUESTS', 'guest(s). ' );
jr_define( '_JOMRES_ROOMALLOCATIONS_INFORMATION', 'This how we have assigned your guest numbers to their cars. If you would like to change this allocation, you will need to contact the hotel after making the rental. Extra charges may apply if you change your assignments.' );
jr_define( '_JOMRES_SANITY_CHECK_NOT_PUBLISHED', "Note that your car is not yet published, only you can see the car, site visitors will not see it" );
...
jr_define( '_JOMRES_ROOMMSLIST_STYLE', 'Cars list style' );
jr_define( '_JOMRES_ROOMMSLIST_STYLE_DESC', 'In the rental form, using the "classic" cars list style you offer individual cars to guests. With the car type view, guests choose the number of cars of type X (eg. 2 x doubles) instead' );
jr_define( '_JOMRES_ROOMMSLIST_STYLE_CLASSIC', 'Classic' );
jr_define( '_JOMRES_ROOMMSLIST_STYLE_ROOMTYPES', 'Car types' );
jr_define( '_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_START', '(Re)checking availability' );
jr_define( '_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_REBUILDING_AVAILABLEROOMS', 'Rebuilding available cars list' );
...
jr_define( '_JOMRES_REVIEWS_ADMIN_GUESTSONLY', 'Only car guests can review?' );
jr_define( '_JOMRES_REVIEWS_ADMIN_GUESTSONLY_DESC', 'Set this to Yes if you want to restrict reviews to only those users who have been a guest already in this car.' );
jr_define( '_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERROOMPERBOOKING', 'Per car' );

jr_define( '_JOMRES_MAX_GUESTS_PER_ROOM', 'Guests per car : ' );
jr_define( '_JOMRES_MAX_GUESTS_PER_BOOKING', 'Guests per rental : ' );
jr_define( '_JOMRES_NUMBER_OF_ROOMS', 'Number of cars' );
...
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS', "Car management process" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_DESC', "There are different management processes depending on the way you want to list your car." );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL', "Rental" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL_DESC', "Choose the rental option if you are renting out cars in a car hire depot." );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE', "Realestate/simple listing" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE_DESC', "Choose the real estate option if you are not offering any rental functionality at all, (eg. A car/item for sale)" );

jr_define( 'JOMRES_COM_A_MINIMALCONFIG_DESC', 'Set this to Yes to reduce the number of options available to car managers in the General Configuration section. This is useful if you do not want car managers to play around with too many settings, instead you can edit jomres_config.php to define default car options.' );
jr_define( '_JOMRES_AJAXFORM_EXTRAS_SELECT', 'Please select an option for your rental' );
jr_define( '_JOMRES_COM_ALLOWHTMLEDITOR_DESC', 'Switches on html editors in car details editing page. Additionally, if this is set to No, then all html except p and br is stripped from all entered and displayed text.' );
...
jr_define( '_JOMRES_COM_TIMEZONE_SWITCHER', "Show the timezone switcher in the car manager's toolbar?" );

jr_define( '_JOMRES_PARTNER_DISCOUNT', "Partner discount " );
jr_define( '_JOMRES_PARTNER_CHOOSE_SEARCHTITLE', "Search user" );
jr_define( '_JOMRES_PARTNER_CHOOSE_SEARCH_INSTRUCTIONS', "Enter a few characters to search for a user.<br/> When you select a user you will automatically add them as a Partner and you will be taken to the next page where you can assign cars and discounts to the user." );
...
jr_define( '_JOMRES_PARTNER_SHOW_SEARCHTITLE', "Search for a car" );
jr_define( '_JOMRES_PARTNER_SHOW_SEARCHINSTRUCTIONS', "Enter a few characters from the car name and select a car.<br/> When you select the car you will add it to the partner's portfolio, however they will not yet enjoy any discounts, you will need to set those youself." );
jr_define( '_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES', "Current cars" );
jr_define( '_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES_INSTRUCTIONS', "Click on a car to edit the partner's discount settings for that car." );

// 4.6
jr_define( '_JOMRES_SUSPENSIONS_TITLE', "Suspended? <br/>(click to suspend a manager, this will auto-unpublish all of their cars ) " );
jr_define( '_JOMRES_SUSPENSIONS_MANAGERLIST_INFO', "Click on the Suspend Icon (the icon with the man and the green tick) to suspend a manager. This means that the manager will not be able to perform car management functions and all of their cars will be unpublished. Super car managers cannot be suspended." );
...
jr_define( '_JOMRES_SUSPENSIONS_MANAGER_SUSPENDED_EMAIL', "Please note that your car manager account has been suspended. You will not be able to perform any car management functions until the account has been restored." );
jr_define( '_JOMRES_SUSPENSIONS_MANAGER_UNSUSPENDED_EMAIL', "Please note that your car manager account is now active. You may continue to perform any car management functions. Please log into your account and ensure that the approprite propert(ies) have been published. Thank you." );
...
jr_define( '_JOMRES_MANAGER_CHOOSE_SEARCH_INSTRUCTIONS', "Enter a few characters from their username to search for a user.<br/> When you select a user you will automatically add them as a Manager and you will be taken to the next page where you can assign cars and access rights to the user." );
...
jr_define( '_JOMRES_CHOOSEMANAGER_NUMBEROFPROPERTIES_ASSIGNED', "Number of cars" );
...
jr_define( '_JOMRES_COM_THUMBNAIL_SMALL_WIDTH_DESC', 'Small thumbnails are used in the car list whereas medium sized thumbnails are used in the car header.' );
...
jr_define( '_JRPORTAL_INVOICES_COMMISSION_AUTOSUSPEND_THREASHOLD_DESC', "This threashold is the number of days that a manager has to pay an invoice before they are suspended and their cars unpublished." );
...
jr_define( '_JOMRES_AJAXFORM_BILLING_TAX_ACCOM', 'Car tax:' );
...
jr_define( '_JOMRES_BOOKINGORM_ROOMFEATURE_FILTER', 'Filter cars based on their features.' );
...
jr_define( '_JOMRES_COM_A_TARIFFS_PER_DESC_WHOLEDAY', 'Select Yes if you want to charge per-person-per-day. If no, then costs will be calculated on a per-car-per-day basis' );
...
jr_define( '_JOMCOMP_WISEPRICE_TITLE_DESC_FULL_WHOLEDAY', 'Most cars will recalculate car prices based on the number of cars of a required type that are available on a given date. This allows them to offer discounts on a car type that isn\'t busy during a given period with the aim of attracting car that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of cars of a selected type are available in the car on a given day.<br/> The days threshold defines the number of days that the pickup date must be within before car prices are adjusted by this feature, then the percentages options allow you to configure the percentage of cars that can be available before a given discount is applied. Note however, if multiple cars are rented then the current level of discount will be applied to all cars and will not reduce as more cars are selected.' );
...
jr_define( '_JOMRES_FEATURE_PROPERTY_TYPE_ASSIGNMENT', 'Car types that can show this feature' );
jr_define( '_JOMRES_CRATES_CLICKINITIAL', 'Click on a letter to show all cars with that first character. Once you have a list of properties you can assign commission rates to those properties, or click on their "edit" icon to view the car\'s statistics.' );
...
jr_define( '_JOMRES_MYPROPERTIES', 'My cars' );
