...
define('_JOMRES_COM_MR_GENERALCONFIGDESC','Car Configuration');
...
define('_JOMRES_COM_MR_NEWPROPERTY','New car');
define('_JOMRES_COM_MR_NEWPROPERTYFEATURE','New car feature');
...
define('_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL','Default car');
...
define('_JOMRES_COM_MR_ASSIGNUSER_LEVEL_ADMIN','Car manager');
...
define('_JOMRES_COM_MR_EDITBOOKING_TAB_ROOM','Car');
...
define('_JOMRES_COM_MR_EB_ROOM_NAME','Car name');
define('_JOMRES_COM_MR_EB_ROOM_NUMBER','Car');
...
define('_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV','Car type');
define('_JOMRES_COM_MR_EB_ROOM_CLASS_DESC','Car type description');
define('_JOMRES_COM_MR_EB_ROOM_FEATURES_LIST','Car features list');
...
define('_JOMRES_COM_MR_QUICKRES_STEP2_TITLE','Our cars');
define('_JOMRES_COM_MR_QUICKRES_STEP2_PROPERTYNAME','Car');
define('_JOMRES_COM_MR_QUICKRES_STEP2_ROOMTYPE','Car type');
...
define('_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE','View cars & car config');
define('_JOMRES_COM_MR_VRCT_TAB_ROOM','Cars');
define('_JOMRES_COM_MR_VRCT_TAB_ROOMFEATURES','Rm features');
define('_JOMRES_COM_MR_VRCT_TAB_ROOMTYPES','Rm types');
define('_JOMRES_COM_MR_VRCT_TAB_PROPERTYS','Car');
define('_JOMRES_COM_MR_VRCT_TAB_PROPERTYFEATURES','Prop feats');
define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_LINK','Car');
...
define('_JOMRES_COM_MR_VRCT_ROOM_SAVE_INSERT','Car added');
...
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_INSERT','Car feature added');
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_UPDATE','Car feature updated');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK','Car type');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV','Car type abbreviation');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC','Car type description');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT','Car type added');
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE','Car type updated');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT','Car added');
define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_UPDATE','Car updated');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_LINK','Car Features');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_ABBV','Car feature abbv.');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_DESC','Car feature full description');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_INSERT','Car feature added');
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_UPDATE','Car feature updated');
...
define('_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS','Car type');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_PROPERTYADMIN','Car admin');
...
define('_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE','There are no cars available able to satisfy the parameters specified');
...
define('_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE','Rental made for car: ');
define('_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM','Rental made for car: ');
...
define('_JOMRES_COM_A_TARIFFS_PER_DESC','Select Yes if you want to charge per-person-per-night. If no, then costs will be calculated on a per-car-per-night basis');
define('_JOMRES_COM_A_UPLOADS_FILESIZE','File size');
define('_JOMRES_COM_A_UPLOADS_FILESIZE_DESC','Max. Image Filesize in Kilobyte');
define('_JOMRES_FRONT_MR_BOOKED','Cars rented');
define('_JOMRES_COM_CONFIRMATION_TITLE','Confirmation letter');
define('_JOMRES_COM_CONFIRMATION_DEAR','Dear ');
define('_JOMRES_COM_CONFIRMATION_RATE_RULES','Cost per night - per car ');
...
define('_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN','Your car will be held until your arrival, and check in is after 2pm.');
...
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE','No allowance can be made for meals not taken or for cars not occupied for the full period of the rental. With this in mind we strongly recommend that you use a holiday insurance facility.');
...
define('_JOMRES_COM_MR_ROOM_UNABLETODELETE','Unable to remove this car, there are rentals against it. Cancel those rentals then retry.');
define('_JOMRES_COM_MR_ROOM_DELETED','Car deleted');
define('_JOMRES_COM_MR_ROOMFEATURE_DELETE','Delete car feature');
define('_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE','Unable to remove this car feature, it is assigned to a car or cars. Remove the feature from those cars and retry.');
define('_JOMRES_COM_MR_ROOMFEATURE_DELETED','Car feature deleted');
define('_JOMRES_COM_MR_PROPERTYFEATURE_DELETE','Delete car feature');
define('_JOMRES_COM_MR_PROPERTYFEATURE_UNABLETODELETE','Unable to remove this car feature, it is assigned to a car. Remove the feature from this car and retry.');
define('_JOMRES_COM_MR_PROPERTYFEATURE_DELETED','Car feature deleted');
define('_JOMRES_COM_MR_ROOMCLASS_DELETE','Delete car type');
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS','Unable to remove this car type, it is assigned to a car. Try re-assigning the car to another car type then try again.');
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS','Unable to remove this car type, it is assigned to a tariff. Try re-assigning the tariff to another car type then try again.');
define('_JOMRES_COM_MR_ROOMCLASS_DELETED','Car type deleted');
define('_JOMRES_COM_MR_PROPERTY_DELETE','Delete car');
define('_JOMRES_COM_MR_PROPERTY_DELETED','Car deleted');
define('_JOMRES_COM_MR_PROPERTY_DELETE_NORIGHTS','You do not have rights to delete this car.');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION','Car description');
...
define('_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC','Set this to Yes to ensure that visitors can rent cars online.');
...
define('_JOMRES_COM_A_BOOKING','Rental cars');
...
define('_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC','EG you are renting out a car, rather than cars in that car. If this is the case, then you must make sure that you only have the one car registered against each car.');
...
define('_JOMRES_COM_AVLCAL_INBGCOLOUR','Cell bgcolour for days when car is available');
...
define('_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR','Cell bgcolour for provisionally rented cars (rentals for which a deposit has not been taken)');
...
define('_JOMRES_FRONT_DELETEGUEST_UNABLETODELETEGUEST','Unable to delete this guest as they have rentals open against them with another car.');
define('_JOMRES_COM_INVOICE_ACTUALROOMCOST','Actual car cost: ');
...
define('_JOMRES_MR_AUDIT_INSERT_ROOM','Created car');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM','Updated car');
define('_JOMRES_MR_AUDIT_DELETE_ROOM','Deleted car');
define('_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE','Created carfeature');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE','Updated carfeature');
define('_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE','Deleted carfeature');
define('_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE','Inserted cartype');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE','Updated cartype');
define('_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE','Deleted cartype');
define('_JOMRES_MR_AUDIT_INSERT_PROPERTY','Created car');
define('_JOMRES_MR_AUDIT_UPDATE_PROPERTY','Updated car');
define('_JOMRES_MR_AUDIT_DELETE_PROPERTY','Deleted car');
...
define('_JOMRES_MR_AUDIT_BOOKED_ROOM','Rented a car');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR','There was an error attempting to rent these cars, one or more of the cars you selected is not free.');
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT','Cars included in black rental');
...
define('_JOMRES_COM_A_ROOMTAX','Car tax');
define('_JOMRES_COM_A_ROOMTAX_DESC','Designed for the American market. These are the car tax amounts that will be charged to the guest. You can charge a combination and/or of fixed and percentage figures. Note that these taxes are only applied to the cost of the car.');
...
define('_JOMRES_FRONT_TARIFFS_ROOMTYPE','Car type');
...
define('_JOMRES_FRONT_PTYPE','Car type');
define('_JOMRES_COM_PTYPES_LIST_TITLE','List car types');
define('_JOMRES_COM_PTYPES_LIST_TITLE_EDIT','Edit car type');
define('_JOMRES_COM_PTYPES_PTYPE','Car type');
define('_JOMRES_COM_PTYPES_PTYPE_DESC','Car type description');
define('_JOMRES_COM_PTYPES_SAVED','Car type saved');
define('_JOMRES_COM_PTYPES_UNABLETO_DELETE','Unable to delete car type. Car type is assigned to one or more cars, please re-assign them before trying to delete');
define('_JOMRES_COM_PTYPES_DELETED','Car type(s) deleted');
...
define('_JOMRES_COM_MONTHSTOSHOW_DESC','In the car availability, How many months of the calendar should be shown?');
...
define('_JOMRES_FRONT_GALLERYLINK','View this car\'s website');
...
define('_JOMRES_JR_A_IMAGEHANDLING_BATCHUPLOAD','Batch car image upload');
...
define('_JOMRES_COM_A_SLIDESHOWS_NOIMAGES','<br />Sorry, no images available for this car. Please upload some images using the batch upload feature if you wish to use the slideshow feature.');
...
define('_JOMRES_FRONT_IMAGEUPLOADS_INFO','Use this form to upload multiple images of this car.<br/><b>Note</b> that any images with the same name will be overwritten. Also note that this form does not upload car specific images or the car header image, you will need to upload them from the Car Admin section.<br/><b>Note</b> Images uploaded here will be written to the /jomres/uploadedimages/*car_uid* folder. If this folder does not exist, it will be created, unless of course an alternative directory has been specified in the configuration.');
define('_JOMRES_A_TABS_MISC','Misc');
define('_JOMRES_A','Site configuration');
define('_JOMRES_A_GLOBALPFEATURES','Use global car features');
define('_JOMRES_A_GLOBALPFEATURES_DESC','Set this to Yes if you want to force all cars to use only the car features defined by the webmaster.');
define('_JOMRES_A_GLOBALPFEATURES_INFO','To assign an image to this feature you first need to upload your car feature images to the /jomres/uploadedimages/pfeatures/ folder. ');
...
define('_JOMRES_FRONT_MR_MENU_BOOKAROOM','Rent a car');
...
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS','Click for Cars and availability');
...
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWDETAILS_TITLE','Show detailed car info below this link');
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE','Show cars and availability below this link');
...
define('_JOMRES_COM_PROPERTYLISTDESC_DESC',"This limits the number of characters shown in the car listing when drawing from the car description.");
...
define('_JOMRES_A_GLOBALROOMTYPES','Use global car types');
define('_JOMRES_A_GLOBALROOMTYPES_DESC','Set this to Yes if you want to force all cars to use only the car types defined by the webmaster. You need to set this to Yes if you intend to allow searching via car types.');
define('_JOMRES_A_GLOBALROOMTYPES_INFO','To assign an image to this car type you first need to upload your car type images to the /images/stories/jomres/rmtypes/ folder. ');
...
define('_JOMRES_COM_SELFREGISTRATION','Users can register their cars?');
define('_JOMRES_COM_SELFREGISTRATION_DESC','Set this to Yes if you want users to be able to register their own cars without admin intervention.');
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1','Please provide the country and region of your car.');
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_1','Please complete your car details.');
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_2','Items highlighted are required.');
define('_JOMRES_REGISTRATION_AUDIT_CREATEPROPERTY','Created car');
define('_JOMRES_REGISTRATION_NOTALLOWED',"Sorry, you can't create a car on this system. You must be a logged in, registered user before you can proceed.");
define('_JOMRES_REGISTRATION_CREATEDPROPERTY','Created car: ');
...
define('_JOMRES_NUMBEROFROOMSAVAILABLE','Number of cars available');
define('_JOMRES_BACKTOPROPERTYDETAILSLINK','Back to car details');
define('_JOMRES_FRONT_ROOMTYPES','Car types');
...
define('_JOMRES_AJAXFORM_AVAILABLE_DESC','Select the cars that you require');
define('_JOMRES_AJAXFORM_AVAILABLE_DESC_SRP','Look here to see if the car is available at this time.');
...
define('_JOMRES_AJAXFORM_AVAILABLEROOMS','Available cars');
define('_JOMRES_AJAXFORM_SELECTEDROOMS','Selected cars');
...
define('_JOMRES_VARIANCES_ISPERCENTAGE_TT','The figure calculated is a percentage of the Base figure calculated for the car. If this is set to no then the figure you specify is simply added or subtracted from the base car value.');
define('_JOMRES_VARIANCES_POSNEG','Add variance?');
define('_JOMRES_VARIANCES_POSNEG_TT','The figure calculated is added to or removed from the Base figure calculated for the car. Set this to No if you want this to be a discount from the base figure. ');
...
define('_JOMRES_COM_A_SHOWROOMSLISTLINK','Show link to cars list page in car details page?');
define('_JOMRES_COM_A_SHOWONLYAVLCAL','Show <b>only</b> Availability calendar?');
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Switch this to Yes to disable display of the car header and details, so that only the availability calendar is viewable in the car details section. Only really intended for users renting out single car cars (eg apartments, cottages etc).');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO','Rental form car list show car number');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME','Rental form car list show car name');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE','Rental form car list show tariff title');
...
define('_JOMRES_COM_AVLCAL_BOOKING_KEY','Car is rented');
...
define('_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS','You have chosen more cars than you have guests, click on a car name to remove it from your selection');
define('_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS','Too many guests for the available beds');
define('_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS','You need to choose more cars');
define('_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM','Select a car');
...
define('_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET','No cars selected yet');
...
define('_JOMRES_COM_LIMITROOMSLIST','Available cars/tariff limit');
define('_JOMRES_COM_LIMITROOMSLIST_DESC','Use this input to limit the number of available cars & tariffs that are listed in the rental form. Set it to zero if you do not want limiting enabled. ');
...
define('_JOMRES_COM_JRCONFIG_GLOBALEDITING_DESC','Take care with this function. If set to Yes, then the editing mode will affect the custom text for ALL cars in the system for the constant you are editing.');
define('_JOMRES_COM_JRCONFIG_GLOBALCURRENCYYESNO','Use global currency?');
define('_JOMRES_COM_JRCONFIG_GLOBALCURRENCYYESNO_DESC','Set this to yes to force all cars to use the same currency (e.g. & # 8 3 6 4 ;)');
...
define('_JOMRES_COM_USERIS_SUPERPROPERTYMANAGER','Super Car Manager');
define('_JOMRES_COM_WEEKENDONLY','Weekends only');
define('_JOMRES_COM_WEEKENDDAYS','Weekend days');
define('_JOMRES_COM_WEEKENDDAYS_DESC','Set your weekend days. Tariffs that allow or disallow weekends will take this setting into account when generating the cars list.');
define('_JOMRES_EDITPROPERTY_SELECTCOUNTRY','Select your country before adding any car information');
define('_JOMRES_EDITPROPERTY_SAVEBEFOREUPLOAD','Save your car changes before uploading a car image');
...
define('_JOMRES_SEARCH_AVL_INFO','Please enter your intended arrival and departure dates and press the button to find cars that have accommodation available on your chosen dates.');
define('_JOMRES_SEARCH_PTYPES','List all cars by car type.');
define('_JOMRES_SEARCH_RTYPES','List all cars by car type.');
define('_JOMRES_SORTORDER_DEFAULT','Default');
define('_JOMRES_SORTORDER_PROPERTYNAME','Car Name');
define('_JOMRES_SORTORDER_PROPERTYREGION','Car Region');
define('_JOMRES_SORTORDER_PROPERTYTOWN','Car Town');
define('_JOMRES_SORTORDER_STARS','Stars');
define('_JOMRES_PATHWAY_PROPERTYLIST','Car list');
define('_JOMRES_PATHWAY_PROPERTYDETAILS','Car details ');
define('_JOMRES_PATHWAY_BOOKINGFORM','Rental form');
define('_JOMRES_BOOKINGFORM_UPDATEADDRESSBUTTON','Update your address details');
define('_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_RECHECKINGROOMAVIALABILITY','Re-checking car availability<br/>(Car selection will be reset)');
...
define('_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_CHANGINGROOMSELECTION','Changing your car selection');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMIMAGE','Car image');
...
define('_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS','Show cars list in car details page?');
define('JOMRES_PROPERTYTYPE','Car type');
define('JOMRES_COM_A_SRPONLY','SRP only');
define('JOMRES_MAXPEOPLEINROOM','Max people per car');
...
define('JOMRES_COM_A_MAPSKEY_DESC','Get can get a google maps API key from <a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google maps</a>. Once you have input your map key here, Jomres will show the map in your Car Details page.');
...
define('JOMRES_COM_A_VERBOSETARIFFINTO_DESC','Set this to Yes to show more detailed tariff information in the car details/tariff popup');
define('JOMRES_COM_A_MINIMALCONFIG','Minimise configuration options');
define('_JOMCOMP_AMEND','Amend Rental - Car Selection');
define('_JOMCOMP_AMEND_SELECTPROPERTY','Select New Car');
...
define('_JRPORTAL_CONFIG_DEFAULT_CRATE_DESC','Choose the default commission rate that will be applied to a car in the event that another commission rate is not otherwise set.');
...
define('_JRPORTAL_CPANEL_LISTPROPERTIES','List Cars');
define('_JRPORTAL_PROPERTIES_PROPERTYNAME','Car name');
define('_JRPORTAL_PROPERTIES_PROPERTYADDRESS','Car address');
define('_JRPORTAL_PROPERTIES_LEGEND','Cars who\'s background colour is red have not yet had a commission rate applied to them.');
define('_JRPORTAL_STATS_PATETITLE','Statistics');
define('_JRPORTAL_STATS_STATTYPE','Statistics for: ');
define('_JRPORTAL_STATS_STATTYPE_PROPERTIES','Cars - Clicks');
define('_JRPORTAL_PROPERTIES_VIEWPROPERTY','Car view');
...
define('_JRPORTAL_LISTBOOKINGS_HEADER_PROPERTY_ID','Car id');
...
define('_JRPORTAL_ADD_ADHOC_ITEM_CHOOSEPROPERTY','Associated car (if applicable)');
...
define('_JOMRES_COM_PTYPES_PTYPE_DESC_FURTHER','You can have car type specific language files by setting the description to the name of a sub folder, e.g. "yachtbrokerage" and copying a language file to that subfolder. You can then modify that language file for this car type so cars become, for example, DVDs, etc.');
define('_JOMRES_EDITPROPERTY_CONNOTDELETE1','You cannot delete this car as it is the only car that you have access to. If you want to disable it, please use the un-publish feature in your toolbar. ');
define('_JOMRES_EDITPROPERTY_CONNOTDELETE2','If this is a demo installation and you intend to upgrade to Jomres Solo (one car only limit) then you should create a new car first, then delete this one before changing your license key to the Solo license key that you will be assigned on purchase. ');
...
define('_JOMRES_COM_ISTHISANMRP',"Is this car a hotel/bed and breakfast/guest house/pension? ");
define('_JOMRES_COM_ISTHISANMRP_DESC',"Configuration options differ depending on if you are renting out cars in a car, or the car itself. Select MRP if you are offering cars, select SRP if you are offering the entire car. ");
...
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM',"per car ");
...
define('_JOMRES_BOOKINGFORM_LOOKRIGHT','Please select your required accommodation from the list below by clicking on the car.');
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS','Min cars already selected');
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC','Minimum number of cars already selected in rental before tariff/car type combo can be offered. Allows you to have discounted tariffs when more than N cars are already selected. ');
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS','Max cars already selected');
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC','Maximum number of cars already selected in rental before tariff/car combo is no longer offered. Allows you to stop offering this car type/tariff combination once N cars have been selected in the rental form. ');
...
define('_JOMRES_COM_SEF_TASK_ALIAS_VIEWPROPERTY','View car task alias');
...
define('_JOMRES_COM_SEF_PROPERTY_URL_PTYPE','Add car type to url');
define('_JOMRES_COM_SEF_PROPERTY_URL_PTYPE_DESC','');
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME','Add car name to url');
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME_DESC','');
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID','Append car id to car name');
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID_DESC','if car name is set to No then the id will not be used. If set to yes then the url will look like fawlty_towers-1');
...
define('_JOMRES_COM_SEF_DEFAULT_COUNTRY_DESC','If all your cars are in one country then you will not have country in the search - enter a default country here if you want to display a country');
...
define('_JOMRES_COM_SEF_DEFAULT_REGION_DESC','If all your cars are in one region then you will not have region in the search - enter a default region here if you want to display a region');
...
define('_JOMRES_COM_SEF_SEARCH_URL_PTYPE','Search URL Structure - Car type');
define('_JOMRES_COM_SEF_SEARCH_URL_PTYPE_DESC','');
define('_JOMRES_COM_SEF_DEFAULT_PTYPE','Search URL Structure - Default car type');
define('_JOMRES_COM_SEF_DEFAULT_PTYPE_DESC','Used in url if search is for all car types');
...
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYSPERROOM','Per days X cars selected');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_TAB','Car type');
define('_JOMRES_COM_MR_VRCT_PROPERTY_TYPE','Edit your car type');
define('_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_INFO','Select your car type');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMTYPEIMAGE','Rental form car list show car type image');
define('_JOMRES_COM_A_LISTLIMIT','Car List limit');
define('_JOMRES_COM_A_LISTLIMIT_DESC','The number of cars to show on a page after a search');
define('_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE','Integrated search feature');
define('_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE_DESC','The Jomres integrated search feature allows your users to search through Jomres cars according to a set of functions. If you have already used the search features of Jomres in Joomla you will be familiar with these settings.<br/>This feature allows us to offer search handling within Jomres for those users who don\'t want to use Joomla search modules, or for other CMS users who\'s CMS doesn\'t have it\'s own Jomres search modules.<br/>Just remember that if you choose to search for something via a link (ie not a dropdown) then other search options will not be implemented, only the element that corresponds with the link that you clicked.<br/>Note that by default the layout of this integrated search isn\'t very pretty. That\'s because the template file that performs the layout has to include all possible options, some of which are incompatible. To improve the layout and achieve the look you desire, you will need to edit <b>srch.html</b> in the folder <b>'.JOMRES_TEMPLATEPATH_FRONTEND.'</b> ');
define('_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE','Activate this feature?');
define('_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE_DESC','If this feature is enabled, then any call to Jomres that shows the car list will mean that the search options are also shown.');
...
define('_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME',"Search by car name");
define('_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME_DESC',"Show the search by car name input.");
...
define('_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE',"Search by car type");
define('_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE_DESC',"Show the search by car type input");
...
define('_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE',"Search by car type");
define('_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE_DESC',"Show the search by car type input");
...
define('_JOMRES_A_GLOBAL_SEARCHOPTION_RANDOMLIMIT_DESC','By default, if a car is not selected in Jomres it will perform a search. If this search was not triggered by a search module then that search will produce random results (deliberately). This option allows you to limit the number of returns in that random search.');
...
define('_JRPORTAL_COUPONS_ROOMONLY',"Car only");
define('_JRPORTAL_COUPONS_ROOMONLY_DESC',"Discount is only applied to the cost of the car. If No, then the discount is applied to the entire cost of the rental.");
...
<br/>
");
define('_JOMRES_COM_A_BOOKINGFORM_SHOWDISABLED','Rental form car list show disabled access');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWMAXPEOPLE','Rental form car list show max people');
define('_JRPORTAL_HORIZROOMSLIST_ESTIMATEWARNING',"Please note that car prices listed are estimates and the full price of the rental will not be calculated until you have added a car or cars to your selection.");
...
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_ROOMSLIMIT',"Cars limit"); // Not currently used, saved for a rainy day
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_PROPERTYLIMIT',"Car limit");
...
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES1',"You need a valid subscription to create new cars. At this moment in time, you have purchased subscriptions for ");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES2'," <i>published</i> car(s). ");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES3',"You can increase the number of cars you can create by <a href='".JOMRES_SITEPAGE_URL."&task=list_subscription_packages'>purchasing more subscription packages here.</a>");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES4'," You have used ");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES5'," car slots. ");
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES6',"To see a list of your current cars click <a href='".JOMRES_SITEPAGE_URL."&task=listyourcars'>here</a>. ");
...
define('_JRPORTAL_SUBSCRIPTIONS_PUBLISHERROR',"Unfortunately, you cannot publish this car as you have reached your maximum number of available car slots.");
define('_JRPORTAL_SUBSCRIBERS_SUBSCRIBED',"Thank you for creating a subscription to list your car on our server. Once your invoice is marked as paid (there may be a delay depending on Paypal) please <a href='".JOMRES_SITEPAGE_URL."&task=registerProp_step1'>click here to continue creating your car(s).</a>");
...
define('_JOMRES_CLICKTOREGISTER','Click here to register your car');
...
define('_JOMRES_USER_LISTMYPROPERTY','Add my car to this site');
...
define('_JOMRES_COM_YOURBUSINESS','Your car details');
define('_JOMRES_COM_YOURBUSINESS_NAME','car name');
...
define('_JOMRES_FRONT_BLACKBOOKING_SRP_CANNOTBLACKBOOK','Sorry, you cannot black rent this car for those dates.');
define('_JOMRES_FRONT_BLACKBOOKING_SRP_CANBLACKBOOK','You can blackrent this car for those dates.');
define('_JOMRES_WARNINGS_PERPERSONPERNIGHT_NOGUESTTYPES','Your car is configured to charge per person per night but you do not have any guest types created or published, please create and publish one or more guest types. ');
define('_JOMRES_WARNINGS_TARIFFS_NOTARIFFS','You don\'t have any tariffs configured yet, you will not be able take any rentals for your car.');
...
define('_JOMRES_CONTACTOWNER_TO_ADMIN_DESC','Set this option to Yes if you want Contact Owner emails to be sent to the below input. Leave it set to No to send the emails to the email address defined in the car configuration area.');
...
define('_JOMRES_REALESTATE_YESNO','Is this car a for sale listing?');
define('_JOMRES_REALESTATE_YESNO_DESC','Select Yes if you are selling the car, select No if it is a listing where you will be offering short term rentals and will be using this system for taking rentals.');
...
define('_JOMRES_SINGLEPROPERTYINSTALLATION_TITLE','Is this a single car installation?');
...
define('_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO','Limit car registration to one country?');
define('_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO_DESC','You can ensure that car registrations are limited to just one country by setting this option to Yes and setting the country in the following option.');
define('_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_COUNTRY','Cars are located in this country : ');
define('_JOMRES_JQUERYTHEME','Jquery theme');
define('_JOMRES_JQUERYTHEME_DESC','Choose a jquery theme to use for the car details tabs.');
define('_JOMRES_PROPERTYNOTOUBLISHED','We are sorry, but that car is not currently available.');
define('_JOMRES_REVIEWS','Reviews');
define('_JOMRES_REVIEWS_TITLE','Review title');
define('_JOMRES_REVIEWS_DATE','posted on ');
define('_JOMRES_REVIEWS_NOREVIEWS','There are no reviews for this car yet.');
define('_JOMRES_REVIEWS_NOREVIEWS_BETHEFIRST','Would you like to be the first to review this car?');
...
define('_JOMRES_REVIEWS_REVIEWBODY','Tell us what you think about this car : ');
...
define('_JOMRES_REVIEWS_ALREADYREVIEWED','You have already reviewed this car, you can\'t post another review about it.');
...
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_PROS','Please enter the good parts of your experience of being a guest at this car');
...
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_2','Please rate your opinion of the car\s locale');
define('_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_3','Please provide your opinion of the cleanliness of the car');
...
define('_JOMRES_REVIEWS_ADMIN_TESTMODE_DESC','Normally car managers cannot review cars. With test mode enabled, they can. Naturally this is not ideal in a production environment.');
define('_JOMRES_REVIEWS_ADMIN_PROPERTYLISTINFO','This is a list of all cars. To see a car\'s reviews, click on that car. From there you will be able to publish or delete a review.');
...
define('_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS','Show Rental form in car details page?');
define('_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS_DESC','Set this to Yes to show the rental form in the car details page. If you set it to No, then a link will appear in the car details page instead pointing to the rental form.');
...
define('_JOMRES_ROOMALLOCATIONS_ROOM','Car ');
define('_JOMRES_ROOMALLOCATIONS_GUESTS','guest(s). ');
define('_JOMRES_ROOMALLOCATIONS_INFORMATION','This how we have assigned your guest numbers to their cars. If you would like to change this allocation, you will need to contact the hotel after making the rental. Extra charges may apply if you change your assignments.');
define('_JOMRES_SANITY_CHECK_NOT_PUBLISHED',"Note that your car is not yet published, only you can see the car, site visitors will not see it");
...
define('_JOMRES_ROOMMSLIST_STYLE','Cars list style');
define('_JOMRES_ROOMMSLIST_STYLE_DESC','In the rental form, using the "classic" cars list style you offer individual cars to guests. With the car type view, guests choose the number of cars of type X (eg. 2 x doubles) instead');
define('_JOMRES_ROOMMSLIST_STYLE_CLASSIC','Classic');
define('_JOMRES_ROOMMSLIST_STYLE_ROOMTYPES','Car types');
define('_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_START','(Re)checking availability');
define('_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_REBUILDING_AVAILABLEROOMS','Rebuilding available cars list');
...
define('_JOMRES_REVIEWS_ADMIN_GUESTSONLY','Only car guests can review?');
define('_JOMRES_REVIEWS_ADMIN_GUESTSONLY_DESC','Set this to Yes if you want to restrict reviews to only those users who have been a guest already in this car.');
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERROOMPERBOOKING','Per car');

define('_JOMRES_MAX_GUESTS_PER_ROOM','Guests per car : ');
define('_JOMRES_MAX_GUESTS_PER_BOOKING','Guests per rental : ');
define('_JOMRES_NUMBER_OF_ROOMS','Number of cars');
...
define('_JOMRES_PROPERTYMANAGEMENTPROCESS',"Car management process");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_DESC',"There are different management processes depending on the way you want to list your car.");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL',"Rental");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL_DESC',"Choose the rental option if you are rental out cars in a car (eg. Hotel/B&B/Villa/Apartment)");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE',"Realestate/simple listing");
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE_DESC',"Choose the real estate option if you are not offering any rental functionality at all, (eg. A car/item for sale)");

define('JOMRES_COM_A_MINIMALCONFIG_DESC','Set this to Yes to reduce the number of options available to car managers in the General Configuration section. This is useful if you do not want car managers to play around with too many settings, instead you can edit jomres_config.php to define default car options.');
define('_JOMRES_AJAXFORM_EXTRAS_SELECT','Please select an option for your rental');
define('_JOMRES_COM_ALLOWHTMLEDITOR_DESC','Switches on html editors in car details editing page. Additionally, if this is set to No, then all html except p and br is stripped from all entered and displayed text.');
define('_JOMRES_COM_MANAGEMENTVIEW_MANAGMENT',"Fullscreen view");
define('_JOMRES_COM_MANAGEMENTVIEW_SITEPREVIEW',"Normal view");
define('_JOMRES_COM_TIMEZONE_SWITCHER',"Show the timezone switcher in the car manager's toolbar?");

define('_JOMRES_PARTNER_DISCOUNT',"Partner discount ");
define('_JOMRES_PARTNER_CHOOSE_SEARCHTITLE',"Search user");
define('_JOMRES_PARTNER_CHOOSE_SEARCH_INSTRUCTIONS',"Enter a few characters to search for a user.<br/> When you select a user you will automatically add them as a Partner and you will be taken to the next page where you can assign cars and discounts to the user.");
...
define('_JOMRES_PARTNER_SHOW_SEARCHTITLE',"Search for a car");
define('_JOMRES_PARTNER_SHOW_SEARCHINSTRUCTIONS',"Enter a few characters from the car name and select a car.<br/> When you select the car you will add it to the partner's portfolio, however they will not yet enjoy any discounts, you will need to set those youself.");
define('_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES',"Current cars");
define('_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES_INSTRUCTIONS',"Click on a car to edit the partner's discount settings for that car.");

// 4.6
define('_JOMRES_SUSPENSIONS_TITLE',"Suspended? <br/>(click to suspend a manager, this will auto-unpublish all of their cars ) ");
define('_JOMRES_SUSPENSIONS_MANAGERLIST_INFO',"Click on the Suspend Icon (the icon with the man and the green tick) to suspend a manager. This means that the manager will not be able to perform car management functions and all of their cars will be unpublished. Super car managers cannot be suspended.");
...
define('_JOMRES_SUSPENSIONS_MANAGER_SUSPENDED_EMAIL',"Please note that your car manager account has been suspended. You will not be able to perform any car management functions until the account has been restored.");
define('_JOMRES_SUSPENSIONS_MANAGER_UNSUSPENDED_EMAIL',"Please note that your car manager account is now active. You may continue to perform any car management functions. Please log into your account and ensure that the approprite propert(ies) have been published. Thank you.");
...
define('_JOMRES_MANAGER_CHOOSE_SEARCH_INSTRUCTIONS',"Enter a few characters from their username to search for a user.<br/> When you select a user you will automatically add them as a Manager and you will be taken to the next page where you can assign cars and access rights to the user.");
...
define('_JOMRES_CHOOSEMANAGER_NUMBEROFPROPERTIES_ASSIGNED',"Number of cars");
...
define('_JOMRES_COM_THUMBNAIL_SMALL_WIDTH_DESC','Small thumbnails are used in the car list whereas medium sized thumbnails are used in the car header.');
...
define('_JRPORTAL_INVOICES_COMMISSION_AUTOSUSPEND_THREASHOLD_DESC',"This threashold is the number of days that a manager has to pay an invoice before they are suspended and their cars unpublished.");
...
define('_JOMRES_AJAXFORM_BILLING_TAX_ACCOM','Car tax:');
...
define('_JOMRES_BOOKINGORM_ROOMFEATURE_FILTER','Filter cars based on their features.');
...
define('_JOMRES_COM_A_TARIFFS_PER_DESC_WHOLEDAY','Select Yes if you want to charge per-person-per-day. If no, then costs will be calculated on a per-car-per-day basis');
...
define('_JOMRES_FEATURE_PROPERTY_TYPE_ASSIGNMENT','Car types that can show this feature');
define('_JOMRES_CRATES_CLICKINITIAL','Click on a letter to show all cars with that first character. Once you have a list of properties you can assign commission rates to those properties, or click on their "edit" icon to view the car\'s statistics.');
...
define('_JOMRES_MYPROPERTIES','My cars');
