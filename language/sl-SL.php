...
jr_define('_JOMRES_JR_NOTLOGGEDIN', '<b>Vse kaže, da vas je sistem Joomla odjavil zaradi nedejavnosti.</b> Prosimo, prijavite se in poskusite znova.');
...
jr_define('_JOMRES_PRODUCT_INFORMATION', 'Dobrodošli v Jomresu. Osnovni sistem je brezplačen, vendar ga je mogoče izboljšati z namestitvijo vtičnikov. Za dostop do teh vtičnikov potrebujete licenco za prenos in podporo. Če želite kupiti Jomres Starter , Licenco za podjetja ali podjetja, <a href="https://www.jomres.net/prices" target="_blank"> obiščite našo spletno stran </a> za informacije o tem, kako lahko nadgradite. ');
...
jr_define('_JOMRES_EMAIL_TEMPLATES_INSTRUCTIONS', 'Prosimo, poglejte to stran za pomoč pri prilagajanju e-poštnih sporočil in seznam razpoložljivih rezultatov: <a href = "https://www.jomres.net/manual/property-managers-guide/48-your -toolbar/settings/254-email-templates" target="_blank"> Pomoč za predloge e-pošte </a> ');
...
jr_define('_JOMRES_CONFIG_GMAP_KEY_WARNING', "Nimate nastavljenega ključa Google Zemljevidov. Zaradi nedavnih sprememb v Google Zemljevidih ​​bodo vsa nova spletna mesta potrebovala ključ API za uporabo funkcij Google Zemljevida. Prosimo <a href = 'https://www.jomres.net/manual/site-managers-guide/14-getting-started/338-google-maps-api-key' target ='_blank'> si oglejte našo stran z navodili za ustvarjanje ključa API < /a> in ključ shranite v Jomresu. ");
...
jr_define('_JOMRES_CONFIG_IPINFODB_KEY_WARNING', "Nimate nastavljenega ključa API -ja za zaznavanje IP -ja. To je potrebno, da lahko sistem samodejno zazna uporabnikovo lokacijo in samodejno nastavi njihovo valuto in državo. Prosimo <a href = 'http: // www .jomres.net/manual/site-manager-guide/35-control-panel/main/site-configuration/128-site-configuration-currency-conversion-currency-codes-tab' target='_blank'> glejte naš priročnik stran o tem, kako ustvariti ključ API -ja za zaznavanje IP -ja </a> in ga shraniti v Jomres> Konfiguracija spletnega mesta> Pretvorbe valut / kode valut. ");
jr_define('_JOMRES_CONFIG_OPENEXCHANGERATES_KEY_WARNING', "Nimate nastavljenega ključa API -ja za odprte menjalne tečaje. To je potrebno, da lahko sistem samodejno prenese in uporablja menjalne tečaje. Prosim <a href = 'https://www.jomres.net /manual/site-manager-guide/35-control-panel/main/site-configuration/128-site-configuration-currency-conversion-currency-code-tab' target='_blank'> si oglejte našo stran z navodili, kako ustvarite ključ API -ja za zaznavanje IP -ja </a> in ga shranite v Jomres> Konfiguracija spletnega mesta> Pretvorbe valut / kode valut. ");
...
Ciljni jezik lahko pustite nastavljen na vaš trenutni jezik in uporabite to stran za preimenovanje elementov tukaj, namesto da obiščete njihove posamezne strani.');
	...
	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN', "Vso upravljanje lastnine se izvaja v sprednjem delu vašega spletnega mesta. Trenutno niste prijavljeni kot upravitelj nepremičnine, zato se najprej prijavite in nato boste lahko upravljali svoje lastnosti.");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN_EXPOSITION_FOR_NEW_USERS_JOOMLA', "Ko je Jomres prvič nameščen, bo ustvaril Super Property Manager za uporabnika skrbnika in v glavni meni dodal novo možnost, imenovano Rezervacije. Ne izbrišite tega elementa menija. Prijavite se s priloženim gumbom in obiščite stran Rezervacije, da začnete upravljati nepremičnine. ");
