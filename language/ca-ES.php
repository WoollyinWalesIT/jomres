...
jr_define('_JOMRES_WARNINGS_GLOBALEDITINGMODE', "Tingui en compte vostè està utilitzant el mode d'edició amb el mode global d'edició habilitat. Això està bé si vostè sap el que significa el mode d'edició global. Si no està segur si ha d'utilitzar Jomres d'aquesta manera, si us plau, consulti <a href='https://www.jomres.net/manual/developers-guide/53-customising-jomres/editing-labels-languages/268-editing-mode' target='_blank'>el mode d'edició de pàgina del manual</a> per a obtenir més informació sobre aquest tema.");
...
jr_define('_JOMRES_PRODUCT_INFORMATION', 'Benvingut a Jomres, esperem que disfruti utilitzant el sistema de reserves preferit de Joomla. Si desitja comprar llicències de Jomres Plata u Or , <a href="https://www.jomres.net/prices" target="_blank"> Si us plau, visiti la nostra pàgina</a> per a obtenir informació sobre la millora.');
...
Podeu deixar l\'idioma d\'arribada configurat en el vostre idioma actual i utilitzar aquesta pàgina per canviar el nom dels elements aquí, en lloc de visitar les seves pàgines individuals.');
	...
	jr_define('_JOMRES_COM_TRANSLATE_LANGUAGEFILES_INFO', "El text que es mostra a les pàgines s'emmagatzema en fitxers d'idioma. El sistema de Jomres de mostrar cadenes d'idioma a la pàgina significa que no cal que editeu directament aquests fitxers d'idioma. En canvi, podeu editar aquestes cadenes en aquesta pàgina. pàgina fent clic al text ressaltat i posant el text nou que voleu mostrar al formulari d'entrada que s'obre. Quan feu clic a la marca de verificació, el canvi es desa a la base de dades. Això vol dir que tots els vostres canvis s'emmagatzemen i no se sobreescriuen quan actualitzeu Jomres. Si voleu canviar el text per a diferents idiomes, utilitzeu el menú desplegable de selecció d'idiomes a la part superior dreta per canviar l'idioma actual. Les cadenes de text de vegades es repeteixen en diferents llocs dels fitxers d'idiomes perquè s'utilitzen en diferents idiomes. contextos, així que no us oblideu d'utilitzar la funció de cerca del navegador per assegurar-vos que heu editat la cadena correcta.");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN', "Tota la gestió de propietats es realitza a l'interfície del vostre lloc. Actualment no heu iniciat sessió com a administrador de propietats, així que primer inicieu la sessió i després podreu administrar les vostres propietats.");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN_EXPOSITION_FOR_NEW_USERS_JOOMLA', "Quan Jomres s'instal·li per primera vegada, crearà un Super Gestor de propietats per a l'usuari administrador i afegirà una nova opció al menú principal anomenada \"Reserves\". la pàgina Reserves per començar a administrar propietats.");

	jr_define('_JOMRES_COM_A_GATEWAYLIST_INFO', 'En aquesta pàgina podeu configurar les passarel·les de pagament mitjançant les quals voleu rebre els pagaments d\'ingrés. Necessitareu un compte a la passarel·la de pagament. La pàgina de configuració us proporcionarà instruccions sobre com configurar la passarel·la.' );

jr_define('_JOMRES_COM_A_GATEWAYLIST_TESTINGINFO', "Heu iniciat sessió com a Super Gestor de propietats. Normalment els administradors de propietats no poden utilitzar passarel·les de pagament, però si configureu el lloc en mode de desenvolupament a Administració > Jomres > Configuració > Pestanya Depuració, podreu processar mitjançant una reserva i accedir a passarel·les de pagament com ho fa un hoste. Si no voleu configurar el lloc en mode de desenvolupament, haureu de tancar la sessió o iniciar la sessió com a usuari registrat normal per provar les reserves com a convidat. La configuració del mode de prova a les passarel·les de pagament individuals no es veu afectada per la configuració de producció o desenvolupament del lloc.");
