...
jr_define('JOMRES_COM_A_TARIFFMODE_DESC', "هشدار: تعویض بین انواع مختلف تعرفه ممکن است منجر به از دست رفتن داده ها شود. در این باره به یادداشت زیر<b>هشدار: جابه‌جایی بین حالت‌های مختلف ویرایش تعرفه ممکن است منجر به از دست رفتن داده‌ها شود. در این مورد به یادداشت زیر مراجعه کنید.</b>.
<br/><br/>
