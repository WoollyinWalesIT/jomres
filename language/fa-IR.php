...
jr_define ('_OPENEXCHANGE_API_DESC' , 'برای تبدیل قیمت بین خدمات به کلید API نرخهای تبادل ارز نیاز دارید. برای نمایش صحیح قیمتها در Jomres باید یک کلید API داشته باشید , اما می توانید برای یک کلید رایگان در <a href = "https ثبت نام کنید : //openexchangerates.org/signup/free "_target =" _ blank "> ثبت نام برای یک کلید رایگان </a> (به روز رسانی ساعتی , 1000 درخواست در ماه - بدون HTTPS , پشتیبانی ایمیل یا ویژگی های پیشرفته). Jomres یکبار نرخ ارز را بارگیری می کند یک روز تا زمانی که از کلید در تعداد انگشت شماری از سایتها استفاده کنید , بعید است که از این محدوده فراتر بروید. ');
...
jr_define ('_JOMRES_GDPR_MY_RTBF_INTRO' , 'ما معتقدیم که شما باید بتوانید <a href="https://gdpr-info.eu/art-17-gdpr/" target="_blank"> حذف </a> << a href = "https://gdpr-info.eu/art-4-gdpr/" target = "_ blank"> اطلاعات شناسایی شخصی </a> در صورت تمایل و در صورت امکان. ');
