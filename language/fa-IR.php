...
jr_define ('_OPENEXCHANGE_API_DESC' , 'برای تبدیل قیمت بین خدمات به کلید API نرخهای تبادل ارز نیاز دارید. برای نمایش صحیح قیمتها در Jomres باید یک کلید API داشته باشید , اما می توانید برای یک کلید رایگان در <a href = "https ثبت نام کنید : //openexchangerates.org/signup/free "_target="_blank" > ثبت نام برای یک کلید رایگان </a> (به روز رسانی ساعتی , 1000 درخواست در ماه - بدون HTTPS , پشتیبانی ایمیل یا ویژگی های پیشرفته). Jomres یکبار نرخ ارز را بارگیری می کند یک روز تا زمانی که از کلید در تعداد انگشت شماری از سایتها استفاده کنید , بعید است که از این محدوده فراتر بروید. ');
