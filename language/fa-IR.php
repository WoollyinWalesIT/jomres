...
jr_define('_JOMRES_COM_LANGUAGE_CONTEXT_DESC', "از این گزینه برای تغییر بافت زبان سایت استفاده کنید. این ویژگی به Jomres اجازه می دهد تا از برچسب هایی استفاده کند که برای نحوه استفاده شما از Jomres مناسب است، بنابراین اگر تمرکز شما به عنوان یک کارگزاری قایق بادبانی است، تغییر زمینه به Jomres اجازه می دهد تا برچسب های مناسب برای قایق های تفریحی ارائه دهد. به عنوان مثال، اگر زمینه را روی کارگزاری قایق بادبانی تنظیم کنید، Jomres ابتدا زبان فعلی را پیدا می کند، سپس در پایگاه داده متن سفارشی رشته های ذخیره شده با زمینه زبان yachtbrokerage را جستجو می کند. اگر رشته‌های سفارشی برای زبان و زمینه فعلی وجود داشته باشد، از آن‌ها استفاده می‌شود. در غیر این صورت، Jomres به تعاریف زبانی که توسط فایل‌های زبان اصلی آن استفاده می‌شود، بازمی‌گردد. ");
