...
jr_define('JOMRES_UPDATE_MESSAGE_TITLE', 'Jomres updated');
jr_define('JOMRES_UPDATE_MESSAGE_MESSAGE', 'There is a new version of Jomres available. You must update before you can continue to use Jomres as updates improve functionality and ensure that your installation remains secure.');
...
jr_define('_JOMRES_RUN_PLUGIN_INSTALLATION_SCRIPTS', 'Run plugin installation scripts');
jr_define('_JOMRES_RUN_PLUGIN_INSTALLATION_SCRIPTS_INFO', 'This page automatically runs plugin installation scripts. This is useful if you\'re creating plugins and need to run the installer without actually installing the plugin through the plugin installer.' );
