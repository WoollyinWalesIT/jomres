...
Jr_define ('_JOMRES_FAQ_MANAGER_QUESTION_EXTRAS', 'İsteğe bağlı ekstraları nasıl oluşturabilirim?');
Jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_EXTRAS', "Ekstralar rezervasyonlara eklenebilir ve Ayarlar> Ekstralar'da yapılandırılmıştır. Bunlar isteğe bağlı veya zorunlu olabilir, başka bir deyişle konuk rezervasyon sırasında seçimlerini kaldıramaz. İsteğe bağlı ekstralar için ücretlendirme yapılması ve Emlak Ayrıntıları sayfanızda gösterilip gösterilmemesine bağlıdır.Ekstralar yalnızca belirli bir tarihte (örneğin mevsimlik meyvelerde) bir rezervasyon olup olmadığını göstermek için yapılabilir, Geçerli ve Bitiş tarihlerini ayarladınız.Eğer isteğe bağlı ek özellikler oluşturduktan sonra, Media Manager aracılığıyla resimler yükleyebilirsiniz. ");
Jr_define ('_JOMRES_FAQ_MANAGER_QUESTION_PAYMENTS', 'Ödemeleri nasıl çevrimiçi alabilirim?');
Jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_PAYMENTS', "Ödemeleri çevrimiçi yapmak için, bir Ağ Geçidi adı verilen bir çevrimiçi ödeme sağlayıcısına sahip bir hesabınız olmalıdır.Mümkün ağ geçitlerini görmek için Özellik Konfigürasyonu> Ağ geçitleri sekmesine gidin. Alınacak ağ geçidi adını tıklayın. Yapılandırma sayfasına ekleyin. ");
Jr_define ('_JOMRES_FAQ_MANAGER_QUESTION_DISCOUNTS', 'İndirim alabilir miyim?');
Jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_DISCOUNTS', "İndirimler verilebilir, bunun yapılabilmesi için bir dizi farklı yöntem vardır: Bir müşteri adına bir rezervasyon yapıyorsanız, kendi rezervasyon ve rezervasyon toplamlarını rezervasyon formunda ayarlayabilirsiniz. , \"Konaklama Toplamını Geçersiz Kıl\" ve \"Depozitoyu Geçersiz kıl\" alanlarını kullanarak (misafirler bu özelliği kullanamazlar) bir konuk indirimli hale getirmenin başka bir yolu, indirimli kuponlar yaratmaktır. Sadece belirli tarihler arasında (Geçerli / sona kadar) uygulanabilir veya rezervasyon belirli tarihler arasında (Rezervasyon geçerli / tarihine kadar) düştüğünde uygulanabilir. Bu indirim kuponları sadece bir konuk atanabilir veya isterseniz Çıktılar, misafirlerin telefonlarını tarayarak indirimli kodun geçerli olduğu rezervasyon formuna götüren bir QR kodu içermektedir. ");
Jr_define ('_JOMRES_FAQ_MANAGER_CATEGORY_BOOKINGS', 'Rezervasyon');
Jr_define ('_JOMRES_FAQ_MANAGER_QUESTION_BOOKINGS_CONTACTPAGE', 'Yeni rezervasyon\' u tıkladığımda, neden iletişim formuna yönlendiriliyorum? ');
Jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_BOOKINGS_CONTACTPAGE', 'Online rezervasyon yapmadan önce, gerçek dünyadaki mülkünüzde bulunan her oda türü için bazı fiyatları (tarifeler) yapılandırmanız gerekir Bazı tarifeler oluşturduktan sonra rezervasyon yapabilir . ');
Jr_define ('_JOMRES_FAQ_MANAGER_QUESTION_BOOKINGS_BLACK', 'Kapalı oda Nedir?');
Jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_BOOKINGS_BLACK', "Kapalı oda, bir oda veya odalara hizmet vermemek için oluşturulmuş, herhangi bir konukla ilişkili olmayan ve örneğin bir oda yenilenmesi gerekiyorsa kullanışlı rezervasyonlar.") ;
Jr_define ('_JOMRES_FAQ_MANAGER_CATEGORY_IMAGES', 'Resimler');
