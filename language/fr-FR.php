...
##################################################################
define('_JOMRES_COM_MR_QUICKRESDESC','réserve rapide');
...
// Edit bookings
define('_JOMRES_COM_MR_EDITBOOKING_ADMIN_TITLE','Toutes les réserves');
define('_JOMRES_COM_MR_EDITBOOKING_ADMIN_NEWBOOKINGS','Nouvelles réserves (Dépôt impayé)');
define('_JOMRES_COM_MR_EDITBOOKINGTITLE','Editer la réserve : ');
...
define('_JOMRES_COM_MR_EB_GUEST_JOMRES_CANCELBOOKING','Annuler la réserve');
...
define('_JOMRES_COM_MR_EB_GUEST_CANCELLATION_ALREADYBOOKEDIN','Nous ne pouvons pas annuler cette réserve car le client occupe déjà les installations');
define('_JOMRES_COM_MR_EB_GUEST_CANCELLATION_NODEPOSIT','La réserve n\'a pas été réglée');
define('_JOMRES_COM_MR_EB_GUEST_CANCELLATION_BUTTON',"Confirmez l'annulation");
define('_JOMRES_COM_MR_EB_GUEST_CANCELLED','réserve annulée');
define('_JOMRES_COM_MR_EB_GUEST_DAYSTOARRIVAL',"jours avant l'arrivée");
define('_JOMRES_COM_MR_EB_ROOM_BOOKINGTYPE_EXPL','Type de réserve');
...
define('_JOMRES_COM_MR_EB_PAYM_BOOKINGNUMBER','Numéro de réserve');
...
define('_JOMRES_COM_MR_BOOKINGSAVEDMESSAGE','Réserve enregistrée');
define('_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAGUESTOUT','Enlever réserve');
define('_JOMRES_FRONT_MR_MENU_ADMIN_LISTBOOKINGS','Lister les réserves');
define('_JOMRES_FRONT_MR_MENU_ADMIN_LISTNEWBOOKINGS','Lister les NOUVELLES réserves');
...
define('_JOMRES_FRONT_MR_BOOKINGMADE',"<center>Nous vous remercions d'avoir effectué votre réserve en utilisant nos services, nous vous souhaitons un excellent séjour.<br><br> <b>Veuillez cependant noter que vous venez d'effectuer une pré-réserve, et que celle-ci sera confirmée lorsque vous recevrez la lettre de confirmation que nous allons vous faire parvenir dans les plus bref délais.</center>");
define('_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE',"Réserve faite pour l'établissement : ");
define('_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM','réserve réalisée pour la chambre : ');
...
define('_JOMRES_FRONT_MR_BOOKIN_GUESTBOOKEDIN',"Réserve d'hôte effectuée ");
define('_JOMRES_FRONT_MR_BOOKIN_NOGUESTSDUEIN',"Aucune arrivée d'hôte n'est prévue aujourd'hui");
define('_JOMRES_FRONT_MR_BOOKOUT_TITLE',"Retirer la réserve d'un hôte ");
...
define('_JOMRES_COM_CONFIRMATION_RESERVATION_DETAILS','Détails de votre réserve');
define('_JOMRES_COM_CONFIRMATION_RESERVATION_INTRO1','Nous vous remercions pour votre réserve avec');
define('_JOMRES_COM_CONFIRMATION_RESERVATION_INTRO2',". Vous trouverez, à la suite, le résumé de votre réserve. Veuillez vérifier si nous avons enregistré correctement toutes les informations nécessaires à votre réserve, si vous remarquez une erreur, n'hésitez pas à nous contacter.");
...
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_BINDINGCONTRACT','Nous vous rappelons que la réserve fait office de contrat, donc si par aucune raison vous deviez annuler ou raccourcir la durée de votre séjour, vous resterez redevable de la totalité de la somme.');
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE',"Aucun remboursement ne peut être réalisé sur les repas non consommés ou pour les chambres non occupées sur toute la période de la réserve. Compte tenu de cette disposition et afin d'éviter tout désagrément, nous vous recommandons l'utilisation d'une police d'assurance pour vos vacances.");
...
define('_JOMRES_COM_MR_ROOM_UNABLETODELETE',"Il n'est pas possible de supprimer cette chambre, il y a déjà des réserves assignées. Annulez ces réserves et recommencez.");
...
define('_JOMRES_COM_A_VISITORSCANBOOKONLINE','Les visiteurs peuvent réserver en ligne');
define('_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC','Sélectionner OUI si vous voulez que les visiteurs puissent réserver une chambre en ligne.');
define('_JOMRES_COM_A_FIXEDPERIODBOOKINGS','Les réserves sont établies pour une période fixe');
define('_JOMRES_COM_A_FIXEDPERIODBOOKINGS_DESC',"Si vous sélectionnez OUI, la réserve sera activée pour une période fixe. Si vous sélectionnez NON, rassurez vous que la fonction  \"Jour d'arrivée prédéfini\" n'est pas activée à OUI (à moins que vous souhaitiez imposer une date d'arrivée fixe à vos hôtes) Sinon vous n'obtiendrez pas beaucoup de liens de disponibilité sur le calendrier.");
define('_JOMRES_COM_A_FIXEDPERIOD','Période de réserve: ');
define('_JOMRES_COM_A_BOOKING','réserve des chambres');
define('_JOMRES_COM_A_FIXEDPERIOD_NUMBEROFPERIODS','Périodes Maximum, Ex. 3 x 7 périodes de réserve = 21 jours');
...
define('_JOMRES_FRONT_MR_REVIEWBOOKING','Vérifier la réserve');
define('_JOMRES_COM_MR_CONFIRMBOOKING','Confirmer la réserve');
...
define('_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR',"Couleur d'arrière plan de la cellule pour les réserves provisoires (réserves pour lesquelles un acompte n'a pas encore été perçu)");
...
define('_JOMRES_COM_AVLCAL_INMONTHFACE_KEY','Disponible pour réserves');
define('_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR_KEY','réserves provisoires');
define('_JOMRES_COM_MR_FIXEDARRIVALDATE_YESNO',"Date d'arrivée prédéfinie");
define('_JOMRES_COM_MR_FIXEDARRIVALDATE_YESNO_DESC','Uniquement pour les sites offrant des périodes de réserve fixe. Choisissez le jour dans lequel les arrivées doivent démarrer.');
...
define('_JOMRES_FRONT_CALENDAR_CLICKDATES','Cliquer sur une date libre pour accéder au formulaire de réserve.');
...
define('_JOMRES_FRONT_DELETEGUEST_UNABLETODELETEGUEST',"Ce n\'est pas possible de supprimer cet hôte car il y a déjà une réserve en cours. Annulez la réserve et recommencez.");
...
define('_JOMRES_FRONT_GUEST_EMAIL_TEXT_SUMMARY','un email de réserve vient de vous être envoyé de part de: ');
define('_JOMRES_FRONT_GUEST_EMAIL_TEXT_ANYQUESTIONS',"Si vous avez des questions concernant la réserve ou tout autre service, n'hésitez pas à nous contacter.");
...
define('_JOMRES_COM_A_FIXEDPERIODBOOKINGSSHORT','Les réserves à période fixe permettent des courts séjours');
...
define('_JOMRES_MR_AUDIT_BOOKEDGUESTIN','Introduire la réserve');
define('_JOMRES_MR_AUDIT_BOOKEDGUESTOUT','sortir la réserve');
...
define('_JOMRES_COM_A_EXTRAS','Afficher les extras au moment de la réserve?');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR','Il y a eu une erreur lors de votre tentative de réserver ces chambres, une ou plusieurs ne sont pas disponibles.');
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT','Chambres inclues dans la Liste d\'Indisponibilités');
define('_JOMRES_COM_MR_BLACKBOOKINGS_VIEWBLACKBOOKING','Afficher les réserves de la Liste d\'Indisponibilités');
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_NOBBOOKINGS',"Il n'y a pas de réserves sur la Liste d\'Indisponibilités à afficher");
...
define('_JOMRES_COM_A_PAYPAL_CANCELLED','réserve annulée');
...
define('_JOMRES_COM_A_ADVANCEBOOKINGSLIMITYESNO',"Limiter les réserves à l'avance ?");
define('_JOMRES_COM_A_ADVANCEBOOKINGSLIMITYESNO_DESC',"Sélectionner OUI si vous voulez limiter les réserves à l'avance (utilisez le champ suivant pour entrer la limite en nombre de jours). Si vous sélectionnez OUI alors l'utilisateur qui souhaitera réserver avant n jours à l'avance sera enregistré à la date d'aujourd'hui");
define('_JOMRES_COM_A_ADVANCEBOOKINGSLIMITDAYS',"Le nombre de jours pour la réserve à l'avance est limité à: ");
...
define('_JOMRES_COM_CHARGING_CONFIG','Montant enregistré au moment de la réserve');
define('_JOMRES_COM_CHARGING_CONFIG_DESC',"Utilisez cette option pour décider ce qui sera facturé lors de la réserve. Choisisez le Un acompte, si un acompte doit être perçu ou le montant total si c'est celui qui doit être perçu.");
...
define('_JOMRES_FRONT_BLACKBOOKING_DESC',"Veuillez choisir la/les chambre(s) que vous voulez prendre, et les dates appropriées. <br>si une chambre n'a pas de marque \"vérifiée\", celle-ci ne pourra pas être insérée dans la Liste d'Indisponibles avant la fin ou l'annulation de la réserve.<br/> Lorsque vous avez choisi les dates appropriées, cliquez sur le bouton bleu \"appliqué\" pour revérifier la disponibilité de la chambre. ");
...
define('_JOMRES_COM_A_GATEWAY_USEGATEWAYS_DESC',"Sélectionner OUI si vous voulez utiliser les services de gateways de paiement. <b>Remarque:</b>Ceci n'annule pas le calcul d'un acompte nécessaire à la réserve. Pour le désactiver vous devez modifier le thème utilisé pour afficher les chambre et supprimer dans le code les éléments se référant à Un acompte.");
...
define('_JOMRES_FRONT_MR_MENU_BOOKAROOM','Réserver une chambre');
...
define('_JOMRES_COM_A_TARIFFS_MODEL_DESC',"Vous avez 2 choix de calcul du tarif. Au premier, 'tarif unique', permet d'offrir une variété de tarifs différents à l'hôte à la même taxe pendant tout le séjour. Ceci est utile si vous voulez divers tarifs différents pour la même date, par exemple tarif lit et petit déjeuner, et tarif lit petit déjeuner et dîner. Choisissez le tarif 'moyennes' si vous voulez ajuster vos prix en fonction de la date en question. Jomres trouvera tous les tarifs pour chaque jour de la réserve, les groupe ensemble et retourne la taxe moyenne pour la période de séjour");
// v1.4e
define('_JOMRES_COM_A_SHOWDEPARTUREINPUT','Voir les dates de départ?');
define('_JOMRES_COM_A_SHOWDEPARTUREINPUT_DESC',"Sélectionnez non si vous ne voulez pas voir apparaitre la date de départ dans une boite de sélection. Conseillable seulement si vous savez ce que vous faîtes, car la date de départ dans les réserves sera toujours ajustée au jour suivant l'arrivée.");
// v1.4f
...
// v2
define('_JOMRES_AJAXFORM_INSTRUCTIONS',"Utilisez ce formulaire pour effectuer votre réserve. Déplacez votre souris sur l'image du \"i\" pour plus d'information sur la colonne. Modifiez les particularités des réserves comme les dates d'arrivée ou de départ et les numéros des hôtes, puis sélectionnez la ou les chambres voulues depuis la liste. Cliquez sur n'importe quelle chambre disponible pour l'ajouter à la liste des réserves possibles. Quand vous aurez terminé, vous pouvez ajouter des services supplémentaires (option) et remplir le nom, adresse etc. Quand le formulaire soit prêt, confirmez votre réserve en cliquant soumettre (submit).");
define('_JOMRES_AJAXFORM_INSTRUCTIONS_SRP',"Utilisez ce formulaire pour votre réserve. Le \"i\" vous fournit d'avantage d'information sur la colonne. Vous pouvez modifier vos souhaits (arrivée, départ, nombre de personnes) à tout moment. Quand vous aurez terminé, vous pouvez ajouter s'il y a lieu des options ou services supplémentaires et confirmer avec le bouton soumettre (submit).");
define('_JOMRES_AJAXFORM_PARTICULARS','Options de réserve');
define('_JOMRES_AJAXFORM_PARTICULARS_DESC','Sélection de vos détails de demande de réserve');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAGUESTIN','Faire une réserve');
...
define('_JOMRES_COM_A_MINIMUMINTERVAL_DESC',"intervalle minimum de réserve entre la date d'arrivée et la date de départ.");
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO','Le formulaire de réserve montre le numéro de la chambre');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME','Le formulaire de réserve montre le nom de la chambre');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE','Le formulaire de réserve montre le titre du tarif');
...
define('_JOMRES_COM_A_DEFAULTNUMBEROFFIRSTGUESTTYPEDESC','Nombre de personnes par défaut pour le premier type de client montré. Si vous utilisez les types de client, ce chiffre est le nombre de personnes sélectionné par défaut pour le premier type de client dans le formulaire de réserve.');
define('_JOMRES_COM_A_REGISTEREDUSERSONLYBOOK','Seulement les utilisateurs enregistrés peuvent effectuer des réserves en ligne?');
define('_JOMRES_REGISTEREDUSERSONLYBOOK','Désolé, vous devez être un utilisateur enregistré pour pourvoir réserver en ligne. Cliquez ici pour vous logger sur le site !');
define('_JOMRES_COM_AVLCAL_CURRENTBOOKINGFONT','Couleur des caractères pour les liens aux réserves en cours');
define('_JOMRES_COM_AVLCAL_WEEKENDBORDER','Limites du weekend');
define('_JOMRES_COM_AVLCAL_BOOKING_KEY','réserve validée');
define('_JOMRES_COM_AVLCAL_BLACK_KEY','réserve en liste d\'indisponibilités');
...
define('_JOMRES_COM_MR_FIXEDARRIVALDATE_RECURRING_DESC',"Quand l'option DATE D'ARRIVEE FIXE est activée, le nombre de dates qui peut être affiché dans la liste déroulante. Remarquez que la liste de dates ne fait pas inclusion d'aucune date si une réserve n'est pas possible à cause de réserves précédentes, et que cette liste sera deux fois plus longue que votre chiffre sélectionné, car elle aura un nombre similaire de dates dans son historique (où applicable)");
...
define('_JOMRES_BOOKINGFORM_MONITORING_BOOKING_TOO_SHORT1','Votre réserve est trop courte. Notre établissement fixe le minimum de nuits à :');
...
define('_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS',"Vous avez choisi plus de chambres que vous n'avez d'hôtes! Cliquez sur une chambre pour l'enlever de votre réserve");
...
define('_JOMRES_BOOKING_NUMBER','N° de réserve');
define('_JOMRES_COM_INPUTOKTOBOOK_BACKGROUND','Ok pour lancer la réserve, messages en arrière-plan');
...
define('_JOMRES_COM_LIMITROOMSLIST_DESC','Utilisez cette entrée pour limiter le nombre de chambres et de tarifs disponibles listés dans le formulaire de réserve. Indiquez 0 si vous ne voulez pas activer cette limitation.');
...
define('_JOMRES_PATHWAY_BOOKINGFORM','Formulaire de réserve');
...
define('JOMRES_MAXPEOPLEINBOOKING','Max personnes par réserve');
...
define('_JOMCOMP_MYUSER_LISTBOOKINGS','Lister les réserves');
define('_JOMCOMP_MYUSER_MYBOOKINGS','Mes réserves');
define('_JOMCOMP_MYUSER_VIEWBOOKING','Voir réserve');
...
define('JOMRES_COM_A_USE_SSL','Utiliser SSL dans le formulaire de réserve?');
...
define('_JOMCOMP_LASTMINUTE_THREASHOLD_DESC',"Si pour une réserve faite la date d'arrivée est à moins de N jours de la date de réserve, alors la remise peut être appliquée");
define('_JOMCOMP_LASTMINUTE_DISCOUNT','Remise');
define('_JOMCOMP_LASTMINUTE_DISCOUNT_DESC','En pourcentage');
define('_JOMCOMP_LASTMINUTE_BOOKINGCONFIRMATION1','Une remise a été appliquée à cette réserve!');
...
define('_JOMCOMP_LASTMINUTE_PROPERTYLIST_MID',' pourcent si vous réservez pour arriver avant le ');
define('_JOMCOMP_LASTMINUTE_ORMORE',' pourcent ou plus si vous réservez pour arriver avant le ');
define('_JOMCOMP_LASTMINUTE_PROPERTYLIST_POST','. Réservez maintenant pour bénéficier de cet offre!');
...
define('_JOMCOMP_AMEND','Modifier réserve - Sélection d\'établissement');
...
define('_JRPORTAL_PROPERTIES_NUMBEROFBOOKINGS','Nombre de réserves');
define('_JRPORTAL_PROPERTIES_VALUEOFBOOKINGS','Valeur des réserves');
...
define('_JRPORTAL_CPANEL_LISTBOOKINGS','Liste de réserves');
...
define('_JRPORTAL_LISTBOOKINGS_HEADER_BOOKINGTOTAL','Total réserve');
...
define('_JOMRES_CONFIRMATION_HEADER',"Un résumé de votre réserve est affiché ci-dessous.<br /> Pour changer la réserve, veuillez cliquer sur le bouton Modifier réserve. ");
define('_JOMRES_CONFIRMATION_AMENDTEXT',"Si vous devez modifier les informations ci-dessus, veuillez cliquer ici");
define('_JOMRES_CONFIRMATION_AMEND',"Modifier réserve");
...
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_TITLE','Remarquez que ceci n\'est pas un formulaire de réserve, mais que vous n\'envoyez qu\'un email.<br/>Introduisez le message que vous aimeriez envoyer à ');
...
define('_JOMRES_AVLCAL_QUARTER',"Quelques réserves");
...
define('_JOMRES_COM_SEF_TASK_ALIAS_DOBOOKING','\'Alias\' de tâche de réserve');
...
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERBOOKING','Par réserve');
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERPERSONPERBOOKING','Par personne par réserve');
...
define('_JOMCOMP_MYUSER_VIEWBOOKINGS_NONE','Vous n\'avez pas encore fait aucune réserve encore!');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMTYPEIMAGE','Liste de chambres du formulaire de réserve montre images des types de chambre');
...
define('_JOMRES_COM_CUSTOMFIELDS_DESC','Vous pouvez définir ici champs adaptés spécifiques qui seront affichés dans le formulaire de réserve.');
...
define('_JRPORTAL_INVOICES_PAYPAL_SETTINGS_OVERRIDE_DESC',"Si l'option de surmonter les définitions standard Paypal est réglée pour Oui, plusieurs choses arrivent:  la Configuration Générale ne montre plus aucunes définitions <i>gateway</i>, et deuxièmement si une réserve est faite les définitions réglées ici sont les valables, donc le paiement est envoyé pour l'adresse introduit ici, pas pour le prédéfini sur la Configuration Générale.");
define('_JRPORTAL_INVOICES_SHOWINVOICES',"Montrer ma facture");
define('_JRPORTAL_COUPONS_TITLE',"Coupons de rabais");
define('_JRPORTAL_COUPONS_DESC',"Codes de rabais peuvent être générés et passés aux les hôtes comme un stimulant pour faire plus de réserves. Valable dès et jusqu'au se réfèrent aux dates quand les réserves peuvent être acceptées, pas aux dates de la réserve elle-même.");
...
define('_JRPORTAL_COUPONS_ROOMONLY_DESC',"Le rabais s'applique seulement au prix de la chambre. Si défini Non, le rabais sera applicable au prix total de la réserve.");
define('_JRPORTAL_COUPONS_SQLERROR',"Erreur Sql quand essayant d'éliminer/ajouter un coupon");
define('_JOMRES_AJAXFORM_COUPON_INSTRUCTIONS','Si vous avez un code de coupon, entrez-le ici et cliquez sur le lien "garder coupon" pour sauver les détails vis à vis votre réserve.');
define('_JOMRES_AJAXFORM_COUPON_APPLYBUTTON','Garder coupon');
define('_JOMRES_AJAXFORM_COUPON_COUPONSAVED','Coupon sauvé vis à vis la réserve');
...
define('_JOMRES_AJAXFORM_COUPON_BOOKINGNOTE','Réserve rabattue. Définition du code de coupon/valeur du rabais: ');
...
define('_JOMRES_COM_MR_EDITBOOKING_ADMIN_HISTORICBOOKINGS','Réserves échues et annulées');
/*
* @ignore
*/
...
define('_JRPORTAL_NEWUSER_LOG_IN',"Veuillez vous logger pour voir vos réserves ");
...
<br/>
");
define('_JOMRES_COM_A_BOOKINGFORM_SHOWDISABLED','Liste de chambre du formulaire de réserve affiche accès indisponible');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWMAXPEOPLE','Liste de chambre du formulaire de réserve affiche max. personnes');
define('_JRPORTAL_HORIZROOMSLIST_ESTIMATEWARNING',"Veuillez remarquer que les prix des chambre montrés sont estimatifs et que le prix total de la réserve ne sera calculé que quand vous aurez ajouté une ou plusieurs chambres dans votre sélection.");
...
define('_JOMRES_COM_NEWUSER_DESC','Créez un nouveau compte d\'utilisateur lors d\'une réserve par quelq\'un pas enregistré.');
...
define('_JOMRES_FRONT_BLACKBOOKING_DESC_SRP','Sélectionez les dates dans lesquelles vous voulez appliquer l\'interdiction de réserver. Après, cliquez sur le bouton "Appliquer" pour revérifier l\'indisponibilité. <br/> 
<br/> 
Si l\'établissement a un ou plusieurs réserves pour la période mentionnée, vous ne pourrez pas annuler la réserve jusqu\'à ce que les autres réserves/indisponibilités ont été annulés/remarquées.');
...
define('_JOMRES_WARNINGS_TARIFFS_NOTARIFFS','Vous n\'avez pas encore aucun tarif configuré, donc vous ne pourrez pas avoir aucune réserve pour votre propriété.');
...
define('_JOMRES_REALESTATE_YESNO_DESC','Sélectionnz Oui8 si vous voulez vendre cette propriété, Non s\'il s\'agît d\'un établissement du type hôtel/b&b/maison d\'hôtes/villa relativement à laquelle on offre des chambres à louer et qui utilise ce système pour accepter des réserves.');
...
define('_JOMRES_SINGLEPROPERTYINSTALLATION_DESC','Si cette option est définie comme Oui, la vue <i>front end</i> de Jomres aux utilisateurs non autorisés devient très simplifiée. Les demandes à Jomres par défaut à partir d\'une option de menu, au lieu d\'avoir comme réponse une liste de propriétés, simplement emmène l\'hôte au formulaire de réserve du système. Gérants de propriété ne verront pas aussi le bouton de prévision des détails de propriété ou le bouton d\'ajouter une nouvelle propriété. L\'idéal si vous ne voulez qu\'afficher une propriété et en accepter des réserves.<br/>');
...
define('_JOMRES_MAX_GUESTS_PER_BOOKING','Hôtes par réserve : ');
...
define('_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS','Afficher le formulaire de réserve dans la page de détails de l\'établissement?');
define('_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS_DESC','Définissez Oui pour montrer le formulaire de réserve dans la page de détails de la propriété. Si vous marquez Non, un lien sera visible das cette page menant vers le formulaire.');
...
define('_JOMRES_ROOMALLOCATIONS_INFORMATION','Voici comment nous avons associé vos hôtes aux chambres. Si vous aimeriez changer cette association, vous devrez contacter l\'hôtel après avoir complété la réserve. Ceci peut entraîner des frais extra.');
...
define('_JOMRES_ROOMMSLIST_STYLE_DESC','Dans le formulaire de réserve, utilisant le type de liste de chambre "classique" vous offrez aux hôtes chambres individuelles. Avec la vue par type de chambre, les hôtes choisissent le numéro de chambres du type X (par éx., 2 x doubles)');
...
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE_DESC',"Choisissez l'option vente si vous n'offrez aucune chambre pour réserver (par éx.,. une propriété/article pour vente)");
...
define('_JOMRES_AJAXFORM_EXTRAS_SELECT','Veuillez sélectionner une option pour votre réserve');
...
define('_JOMRES_DATA_ARCHIVE_TITLE','Archive de données de réserves');
define('_JOMRES_DATA_ARCHIVE_TITLE_DESC','Cet archive est le résultat brut d\'information de réserves capturtée après que le bouton confirmer r´serve a été actionné. Détenez la souris sure une date pour voir les données. Cette information est gardée dans la table XXX__jomres_booking_data_archive.');
...
define('_JRPORTAL_INVOICES_COMMISSION_MANAGER_TRIGGERS',"Réserves de gérant originent des factures de commission?");
define('_JRPORTAL_INVOICES_COMMISSION_MANAGER_TRIGGERS_DESC',"Si un gérant fait une réserve, ceci origine un article de ligne sur une facture de commissions?");
...
define('_JOMRES_PAYPAL_REDIRECTMESSAGE','Attendez svp, votre réserve est en train d\'être processée et vous serez renvoyé(e) vers le site Paypal.');
...
// 4.7.8
define('_JRPORTAL_COUPONS_BOOKING_VALIDFROM',"Réserve valable du");
define('_JRPORTAL_COUPONS_BOOKING_VALIDTO',"Réserve valable jusqu'au");
define('_JRPORTAL_COUPONS_GUESTNAME',"Nom de l\'hôte");
define('_JRPORTAL_COUPONS_DESC_478',"Des codes d\'escompte peuvent être produits et passés aux hôtes comme un stimulant pour réserver.<br/>
Les dates de \'valable dès le et jusuqu\'au\' se réfèrent aux dates entre lesqueles un réserve peut être faite, tandis que des dates de validité de réserve dès le/jusqu\'au se réfèrent à la période pendant laquelle la réserve doit être faite pour que le coupon soit valable. Si une réserve tombe hors de cette période les taxes normales sont applicables pour les jours hors de la période définie.<br/>
Si vous voulez que la réserve soit disponible pour un hôte spécifique, choisissez son nom dans la liste <i>dropdown</i> pour limiter ce coupon a cet hôte en particulier.");
define('_JRPORTAL_COUPONS_BOOKING_DISCOUNT_FEEDBACK',"Avec votre coupon, cette réserve a été rebattue de ");
