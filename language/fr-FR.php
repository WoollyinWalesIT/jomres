...
jr_define( '_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE', 'Réservation faite auprès de : ' );
...
if ( !defined( '_PN_START' ) ) jr_define( '_PN_START', 'Début' );
if ( !defined( '_PN_PREVIOUS' ) ) jr_define( '_PN_PREVIOUS', 'Antér.' );
if ( !defined( '_PN_NEXT' ) ) jr_define( '_PN_NEXT', 'Prochain' );
if ( !defined( '_PN_END' ) ) jr_define( '_PN_END', 'Fin' );
if ( !defined( '_PN_RESULTS' ) ) jr_define( '_PN_RESULTS', 'Résultats' );
...
<br/>
Vous pouvez modifier une personnalisation existante, ou vous pouvez la supprimer. Lorsque vous supprimez une personnalisation; et qu'une autre personnalisation de ce template n'existe pas Jomres utilisera l'original du template qui est dans le répertoire:  /jomres/templates/xxx/frontend. Ceci est utile si vous avez modifié un template, mais que les changements que vous avez faits ne vous plaisent pas. Vous pouvez supprimer les personnalisations et recommencer à partir du template original.
<br/>
<br/>
