...
Puede dejar el idioma de destino establecido en su idioma actual y usar esta página para cambiar el nombre de los elementos aquí, en lugar de visitar sus páginas individuales.');
	...
	jr_define('_JOMRES_COM_A_GATEWAYLIST_INFO', 'En esta página puede configurar a través de qué pasarelas de pago desea recibir pagos de depósito. Necesitará una cuenta en la pasarela de pago. La página de configuración le proporcionará instrucciones sobre cómo configurar la pasarela.' );

	jr_define('_JOMRES_COM_A_GATEWAYLIST_TESTINGINFO', "Ha iniciado sesión como Superadministrador de propiedades. Normalmente, los administradores de propiedades no pueden usar pasarelas de pago; sin embargo, si configura el sitio en modo Desarrollo en Admin > Jomres > Configuración > pestaña Depuración, entonces podrá procesar a través de una reserva y acceda a las pasarelas de pago como lo hace un invitado. Si no desea configurar el sitio en modo de desarrollo, deberá cerrar sesión o iniciar sesión como un usuario registrado normal para probar las reservas como invitado. Cualquiera La configuración del modo de prueba en las pasarelas de pago individuales no se ve afectada por la configuración de producción o desarrollo del sitio. ");