...
jr_define ('JOMRES_COM_A_MAPSKEY_DESC', 'Ви можете отримати ключ API Google Maps з <a href = "https://developers.google.com/maps/documentation/javascript/get-api-key#get-an-api-key "target =" _ blank "> Карти Google </a>. Після того, як ви введете тут ключ своєї карти, Джомрес покаже карту на вашій сторінці" Подробиці власності ". ');
...
jr_define ('_JOMRES_DEFAULT_SHORTCODE_ALERT', 'Будь ласка, переконайтеся, що ви створили сторінку WordPress, яка містить короткий код [jomres: xx-XX] (де xx-XX-це код мови вашого сайту, наприклад [jomres: en-GB] або [ jomres: en-US]) інакше ви не зможете отримати доступ до Джомреса з інтерфейсу для управління вашими властивостями та бронюваннями. <br> Jomres побудований на основі Bootstrap, тому ви повинні використовувати його для теми на основі Bootstrap. рекомендую одну на основі Bootstrap 3. Якщо у вас немає доступу до теми, то ми рекомендуємо використовувати тему Джомреса Леотіана для Wordpress, яку можна <a href = "https://www.jomres.net/download/free- downloads/download/5-miscelleneous-downloads/11-leohtian-for-wordpress "target =" _ blank "> завантажити звідси. </a> ');
...
jr_define ('_JOMRES_CONFIG_IPINFODB_KEY_WARNING', "У вас немає набору ключів API для виявлення IP. Це потрібно, щоб система могла автоматично визначати місцезнаходження користувача та автоматично встановлювати його валюту та країну. Будь ласка, <a href = 'http: // www .jomres.net/manual/site-manager-guide/35-control-panel/main/site-configuration/128-site-configuration-currency-conversion-currency-codes-tab 'target =' _ blank '> див. наш посібник сторінку про те, як створити ключ API для виявлення IP -адрес </a> і зберегти його в Jomres> Конфігурація сайту> Перетворення валют / коди валют. ");
jr_define ('_JOMRES_CONFIG_OPENEXCHANGERATES_KEY_WARNING', "У вас немає набору ключів API курсів відкритого обміну. ​​Це потрібно для того, щоб система могла автоматично завантажувати та використовувати курси обміну валют. Будь ласка <a href = 'http: //www.jomres.net /manual/site-manager-guide/35-control-panel/main/site-configuration/128-site-configuration-currency-conversion-currency-codes-tab 'target =' _ blank '> див. сторінку нашого посібника про те, як створити ключ API для виявлення IP -адрес </a> і зберегти його в Jomres> Конфігурація сайту> Перетворення валют / коди валют. ");
...
jr_define ('_JOMRES_GUEST_BLACKLISTED_DESC', 'Якщо цей гість занесений до чорного списку, то він більше не зможе здійснювати бронювання в цій власності.'); jr_define ('_JOMRES_SESSION_HANDLER', 'Обробник сеансу');
...
jr_define ('_JOMRES_MICROMANAGE_INFO', "Дайте тарифу назву, визначте максимальну кількість ночей, а також мінімальну та максимальну кількість гостей, необхідну у формі бронювання до того, як буде запропоновано тариф. <br/> <br/> Використовуйте на панелі вибору дати, щоб додати ціни та налаштування мінімальних ночей до діапазону дат, або відредагувати вхідні дані безпосередньо. Якщо ви не хочете, щоб тариф взагалі пропонувався на певні дати, залиште ціну на 0 (нуль) на ці дати. <br/> <br/> Ви можете мати різну мінімальну кількість ночей на різні дати, тому, якщо ви хочете, щоб бронювання тривало протягом тижнів фестивалю/конференції, ви можете встановити мінімальну кількість ночей у такі періоди вище. <br/ > <br/> Якщо ви стягуєте плату за особу за тариф (PPPN), ви можете ввімкнути це налаштування в Налаштуваннях> Конфігурація власності> Тарифи та валюта, а потім створити потрібні типи гостей у Налаштування> Типи гостей. ");
...
jr_define ('JOMRES_GUEST_BOOKING_FORM_LABEL_EXTRA_ADULTS', 'Додаткові дорослі');
