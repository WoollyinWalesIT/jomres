...
Ви можете залишити цільову мову, встановлену для вашої поточної мови, і використовувати цю сторінку для перейменування елементів тут, замість того, щоб відвідувати їх окремі сторінки.');
	...
	jr_define('_JOMRES_COM_A_GATEWAYLIST_INFO', 'На цій сторінці ви можете налаштувати платіжні шлюзи, через які ви хочете отримувати депозитні платежі. Вам знадобиться обліковий запис на платіжному шлюзі. На сторінці налаштувань ви знайдете інструкції щодо налаштування шлюзу.' );

	jr_define('_JOMRES_COM_A_GATEWAYLIST_TESTINGINFO', "Ви ввійшли як Super Property Manager. Зазвичай менеджери нерухомості не можуть використовувати платіжні шлюзи, однак якщо ви встановите для сайту режим розробки в Admin > Jomres > Settings > вкладка Debugging, тоді ви зможете обробляти через шлюзи бронювання та доступу до платіжних шлюзів як гість. Якщо ви не хочете перемикати сайт у режим розробки, вам потрібно буде або вийти з системи, або увійти як звичайний зареєстрований користувач, щоб перевірити бронювання як гість. На налаштування тестового режиму в окремих платіжних шлюзах не впливають параметри виробництва або розробки на сайті. ");
