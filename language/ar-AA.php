...
jr_define ('_JOMRES_EMAIL_TEMPLATES_INSTRUCTIONS' , 'يرجى الاطلاع على هذه الصفحة للمساعدة في تخصيص رسائل البريد الإلكتروني وقائمة بالمخرجات المتاحة: <a href = "http://www.jomres.net/manual/property-managers-guide/48-your-toolbar/settings/254-email-Templates" > تعليمات قوالب البريد الإلكتروني </a> ') ;
...
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_INTRODUCTION', 'مقدمة') ;
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_WHATISJOMRES', 'ما هو جومريس؟') ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_WHATISJOMRES' , "Jomres هو نظام حجز فندقي وفيلات يعمل مع أنظمة إدارة محتوى Joomla و Wordpress. إنه نظام حجز كامل , فكر فيbooking.com أ airbnb بدون نفقات. إنها مجموعة أدوات كاملة يتيح لك إنشاء خدمة حجز فريدة عبر الإنترنت لأكبر عدد تريده من العقارات. ") ;

jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PROPERTIES', 'Properties') ;
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_ADDPROPERTIES', 'كيف أضيف خاصية جديدة؟') ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_ADDPROPERTIES' , "عندما يتم تثبيت Jomres , يتم إنشاء مستخدم المسؤول كمدير ملكية فائق. سجّل الدخول إلى الواجهة الأمامية لنظام CMS (الصفحات العامة) كمستخدم مسؤول ومن هناك يمكنك إضافة خصائص جديدة. <br / > يمكنك إنشاء مديرين جدد في صفحة مديرو العقارات إذا كنت ترغب في إضافة مدير جديد , ولكن افتراضيًا (يمكنك تعطيل هذا) أي مستخدم مسجل يقوم بإنشاء خاصية يتم إنشاؤه تلقائيًا كمدير ممتلكات للخصائص التي يقوم بإنشائها. لأسباب أمنية , لا يمكنهم إدارة ممتلكات مدير آخر. يمكن تغيير هذا عن طريق رفع هذا المستخدم إلى Super Property Manager في صفحة مديري العقارات. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_IMPORTPROPERTIES', 'هل يمكنني استيراد خصائص من نظام آخر؟') ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_IMPORTPROPERTIES' , "هناك عدد من الطرق التي يمكنك من خلالها استيراد الخصائص. يسمح لك المكوِّن الإضافي لاستيراد الخصائص باستيراد الخصائص عبر CSV. يسمح لك هذا باستيراد خصائص متعددة في آنٍ واحد , ولكنه ميزة مسؤول فقط. إذا كانت الخاصية مدير لديه حساب على Beds24 , ثم يمكنه استيراد أي خصائص حالية من حسابه هناك بمجرد ربط مفاتيح واجهة برمجة التطبيقات. وهناك طريقة أخرى تتمثل في استخدام واجهة برمجة التطبيقات , وهناك ميزة لإضافة الخصائص وإزالتها , ولكن هذا يتطلب منك أن تكون مطورًا على دراية باستخدام REST APIs لاستخدام هذه الوظيفة. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_IMPORTBOOKINGS', 'هل يمكنني استيراد الحجوزات من نظام آخر؟') ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_IMPORTBOOKINGS' , "يمكن استيراد الحجوزات إلى خاصية عن طريق مدير الممتلكات من خلال المكون الإضافي iCal , الذي يوفر ميزة لاستيراد الحجوزات في قائمة مدير العقار. أيضًا , إذا كان لدى مدير الممتلكات حساب Beds24 وممتلكاتهم بها مرتبطًا بـ Beds24 , ثم يمكنهم تنفيذ إجراء إعادة إرسال الإخطار في Beds24. ") ;
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_EMAILTEMPLATES', 'هل يمكنني تعديل قوالب البريد الإلكتروني؟');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_EMAILTEMPLATES' , "يمكن لمديري العقارات تحرير قوالب البريد الإلكتروني من خلال شريط الأدوات الخاص بهم ضمن الإعدادات> قوالب البريد الإلكتروني.") ;
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PAYMENTS', 'Payments') ;
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TAKEPAYMENTS', "كيف أسمح للممتلكات بتحصيل المدفوعات؟") ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TAKEPAYMENTS' , "ستحتاج إلى تثبيت بوابة دفع. لدى Jomres بوابتين للدفع , والتي تتصل بـ Paypal أو Stripe. كما توفر أيضًا بوابتين غير متصلتين , ويمكنك شراء بوابات دفع أخرى من شركائنا." ) ;
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_WHICHGATEWAY', 'أي بوابة يجب أن أستخدمها؟') ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_WHICHGATEWAY' , "إذا كنت تريد الحصول على نسبة مئوية من إيداع المدير لتغطية تكاليفك الخاصة , فاستخدم بوابة Stripe. إذا لم تفعل ذلك , وتنوي بدلاً من ذلك استخدام وظيفة الاشتراك و / أو العمولة , سأحتاج إلى استخدام بوابة Paypal. ") ;
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PAYMENTACCOUNTS' , "عندما يقوم الضيف بدفع مبلغ للحجز , من الذي يحصل على المال؟") ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PAYMENTACCOUNTS' , "يعتمد ذلك على كيفية إعدادك لبوابات الدفع على موقعك. إذا كنت تستخدم Paypal , يمكنك تهيئته لتجاوز جميع إعدادات الواجهة الأمامية , مما يجعل حسابك هو الحساب الوحيد الذي يتلقى المدفوعات. إذا لم تختر القيام بذلك , فحينئذٍ سيحتاج كل موقع إلى إعداد حساب بوابة الدفع الخاص به في الإعدادات> علامة التبويب Gateways. إذا كنت تستخدم Stripe , فبمجرد أن يربط مدير الممتلكات حسابه بحسابك (انظر وثائق Stripe في الدليل لمزيد من المعلومات) عندئذٍ سيحصلون على جميع الأموال , مطروحًا منها رسوم العمولة التي يمكنك تكوينها إذا اخترت القيام بذلك. ") ;
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_TROUBLESHOOTING', 'استكشاف الأخطاء وإصلاحها') ;
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TROUBLESHOOTING_EMAIL' , "لا يتم إرسال رسائل الحجز الإلكترونية.") ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TROUBLESHOOTING_EMAIL' , "إذا كنت تواجه مشكلات في إرسال رسائل البريد الإلكتروني من النظام , فيرجى التحقق من إعدادات البريد الإلكتروني لمضيفك CMS. يستخدم Jomres إعدادات Wordpress أو Joomla لإرسال رسائل البريد الإلكتروني. إذا كانت مخطئة , فلن يتمكن Jomres من ذلك إرسال رسائل البريد الإلكتروني أيضًا. ") ;
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TROUBLESHOOTING_NOGATEWAY' , "لا يمكنك رؤية بوابة الدفع بعد إجراء الحجز.") ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TROUBLESHOOTING_NOGATEWAY' , "إذا قمت بتسجيل الدخول كمدير عقارات , فلن ترى بوابة الدفع , لأنك لا تدفع لنفسك , أي سخيف. سيرى المستخدمون غير المديرين فقط البوابة عند إجراء الحجوزات.") ;
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PURCHASINGJOMRES', 'Jomres License') ;
jr_define ("_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_FORCEDTOSUBSCRIBE" , "بعد شراء ترخيص X , هل أجبرني على شراء التجديدات بمجرد انتهاء صلاحية الترخيص؟") ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_FORCEDTOSUBSCRIBE' , "لا , إذا اشتريت ترخيص Starter أو Business أو Enterprise , فيمكنك متابعة استخدام البرنامج إلى أجل غير مسمى , فلن يتم تعطيله بطريقة سحرية. الاستثناء من هذه القاعدة هو إذا اشتريت اشتراكًا. بمجرد إلغاء الاشتراك , لن تتمكن من استخدام المكونات الإضافية وستحتاج إلى إلغاء تثبيتها. ") ;
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_EXPIRED' , "انتهت صلاحية ترخيصي , هل يمكنني ترقية Jomres على أي حال؟") ;
...
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_CURRENCIES_SETUP', 'كيف يمكنني إعداد رموز العملات؟') ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_CURRENCIES_SETUP', "لا يمكنك ذلك. جميع رموز العملات مخزنة بالفعل في النظام , والأمر متروك لمديري العقارات لتحديد العملة المناسبة لهم في صفحة تكوين الخاصية.") ;
jr_define ("_JOMRES_FAQ_ADMIN_QUESTION_CURRENCIES", "كيف يمكنني تمكين عملات متعددة؟") ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_CURRENCIES' , "لدى Jomres وظيفة لتحويل الأسعار من عملة إلى أخرى تلقائيًا. تحتاج أولاً إلى زيارة علامة التبويب  تكوين الموقع > تحويل العملة. هناك ستجد ارتباطات إلى خدمتين عبر الإنترنت. الخدمة الأولى , بمجرد تم حفظ واجهة برمجة التطبيقات , مما يسمح لـ Jomres بتنزيل بيانات تحويل العملات مرة واحدة في اليوم. والثاني يتيح تحديد الموقع الجغرافي المستند إلى IP للمستخدمين. اطلب مفتاح واجهة برمجة تطبيقات مجاني من كل خدمة. ومع الجمع بين هاتين الخدمتين , يمكن لـ Jomres اكتشاف العملة المحلية للمستخدم وعرضها أسعار العقارات بالعملة المحلية للنزيل , بالإضافة إلى عملة الفندق الخاصة. إذا لم تقم بإعداد مفاتيح واجهة برمجة التطبيقات هذه , فسيتم تعيين جومرس افتراضيًا على رمز عملة اليورو. إذا كنت ترغب في ذلك , يمكنك تعيين رمز عملة عالمي. وهذا يعني أن الخاصية لن يتمكن المديرون من تحديد أي عملات أخرى , ومع ذلك سيظل بإمكان الضيوف المحتملين رؤية الأسعار بعملتهم المحلية الخاصة بهم ما لم يكونوا قد استخدموا ميزة محوّل العملات للتغيير العملة التي يتم عرض الأسعار بها. ") ;
...
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PROPERTIES_NUMBER', 'كم عدد الخصائص التي يمكنني سردها؟') ;
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PROPERTIES_NUMBER' , "لا يوجد حد مشفر لعدد الخصائص التي يمكنك سردها , القيد الوحيد يكون في القيد المادي للخادم نفسه. إذا كان خادمًا به العديد من الحسابات الأخرى , فستكون الموارد محدودة , إذا , من ناحية أخرى , فهو خادم مخصص أو افتراضي مخصص , ثم ستتمكن من سرد العديد من الخصائص. ") ;
