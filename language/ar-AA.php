...
jr_define('JOMRES_COM_A_TARIFFMODE_DESC', "<b> تحذير: قد يؤدي التبديل بين أوضاع تحرير التعريفة المختلفة إلى فقدان البيانات. انظر الملاحظة أدناه بخصوص هذا. </ b>.
<br/> <br/>
...
jr_define('_JOMRES_COM_LANGUAGE_CONTEXT_DESC', 'استخدم هذا الخيار لتغيير سياق لغة الموقع. تسمح هذه الميزة لـ Jomres باستخدام الملصقات المناسبة لكيفية استخدامك لـ Jomres ، لذلك إذا كان تركيزك منصبًا على سمسرة اليخوت ، فإن تغيير السياق سيسمح لـ Jomres بتقديم ملصقات مناسبة لليخوت. على سبيل المثال ، إذا قمت بتعيين السياق على "سمسرة اليخوت" ، فسيقوم جومريس أولاً بالعثور على اللغة الحالية ، ثم البحث في قاعدة البيانات النصية المخصصة عن السلاسل المحفوظة مع سياق لغة "سمسرة اليخوت". في حالة وجود سلاسل مخصصة للغة والسياق الحاليين ، فسيتم استخدام هذه السلاسل. إذا لم يكن الأمر كذلك ، فسيعود Jomres إلى تعريفات اللغة المستخدمة بواسطة ملفات اللغة الأساسية الخاصة به.');
// 4.7.3
...
jr_define ('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN' , "يتم تنفيذ جميع عمليات إدارة الممتلكات في الواجهة الأمامية لموقعك. لم يتم تسجيل دخولك حاليًا كمدير عقارات ، لذا يرجى تسجيل الدخول أولاً ثم ستتمكن من إدارة ممتلكاتك.") ;

jr_define ('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN_EXPOSITION_FOR_NEW_USERS_JOOMLA' , "عند تثبيت Jomres لأول مرة ، سيُنشئ Super Property Manager للمستخدم المسؤول ، وسيضيف خيارًا جديدًا إلى قائمة Do not المتوفرة يسمى زر القائمة. صفحة الحجوزات لبدء إدارة الممتلكات. ") ;
...
jr_define('_JOMRES_RUN_PLUGIN_INSTALLATION_SCRIPTS', 'تشغيل البرامج النصية لتثبيت المكونات الإضافية');
jr_define('_JOMRES_RUN_PLUGIN_INSTALLATION_SCRIPTS_INFO', 'تقوم هذه الصفحة تلقائيًا بتشغيل البرامج النصية لتثبيت المكونات الإضافية. يعد هذا مفيدًا إذا كنت تقوم بإنشاء مكونات إضافية وتحتاج إلى تشغيل المثبت دون تثبيت المكون الإضافي فعليًا من خلال مثبت المكونات الإضافية.' );
