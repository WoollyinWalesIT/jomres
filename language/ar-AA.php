...
jr_define ('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN_EXPOSITION_FOR_NEW_USERS_JOOMLA' , "عند تثبيت Jomres لأول مرة ، سيُنشئ Super Property Manager للمستخدم المسؤول ، وسيضيف خيارًا جديدًا إلى قائمة Do not المتوفرة يسمى زر القائمة. صفحة الحجوزات لبدء إدارة الممتلكات. ") ;
	...
	jr_define ('_ JOMRES_COM_A_GATEWAYLIST_INFO' , "في هذه الصفحة يمكنك تكوين بوابات الدفع التي تريد استلام مدفوعات الإيداع من خلالها. ستحتاج إلى حساب على بوابة الدفع. ستزودك صفحة الإعدادات بإرشادات حول كيفية تكوين البوابة." ) ;

jr_define ('_ JOMRES_COM_A_GATEWAYLIST_TESTINGINFO' , "لقد قمت بتسجيل الدخول بصفتك مدير عقارات فائق. عادةً لا يمكن لمديري العقارات استخدام بوابات الدفع ، ولكن إذا قمت بتعيين الموقع إلى وضع التطوير في المسؤول> Jomres> الإعدادات> علامة التبويب التصحيح ، فستتمكن من المعالجة من خلال بوابات الدفع الخاصة بالحجز والوصول كما يفعل الضيف. إذا كنت لا ترغب في تعيين الموقع على وضع التطوير ، فستحتاج إما إلى تسجيل الخروج أو تسجيل الدخول كمستخدم مسجل عادي لاختبار الحجوزات كضيف. أي لا تتأثر إعدادات وضع الاختبار في بوابات الدفع الفردية بإعدادات الإنتاج أو التطوير الخاصة بالموقع. ") ;