...
jr_define( '_JOMRES_COM_MR_GENERALCONFIGDESC', 'Tour Configuration' );
...
jr_define( '_JOMRES_COM_MR_NEWPROPERTY', 'New tour' );
jr_define( '_JOMRES_COM_MR_NEWPROPERTYFEATURE', 'New tour feature' );
...
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL', 'Default tour' );
...
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_LEVEL_ADMIN', 'Tour manager' );
...
jr_define( '_JOMRES_COM_MR_EDITBOOKING_TAB_ROOM', 'Seat' );
...
jr_define( '_JOMRES_COM_MR_EB_ROOM_NAME', 'Seat name' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_NUMBER', 'Seat' );
...
jr_define( '_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV', 'Seat/Tour type' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_CLASS_DESC', 'Seat/tour type description' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_FEATURES_LIST', 'Seat features list' );
...
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_TITLE', 'Our seats' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_PROPERTYNAME', 'Tour' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_ROOMTYPE', 'Seat/tour type' );
...
jr_define( '_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE', 'View seats & tour config' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOM', 'Seats' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOMFEATURES', 'Rm features' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_ROOMTYPES', 'Rm types' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_PROPERTYS', 'Tour' );
jr_define( '_JOMRES_COM_MR_VRCT_TAB_PROPERTYFEATURES', 'Prop feats' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_HEADER_LINK', 'Seat' );
...
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_SAVE_INSERT', 'Seat added' );
...
jr_define( '_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_INSERT', 'Seat feature added' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_UPDATE', 'Seat feature updated' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK', 'Seat type' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV', 'Seat/tour type abbreviation' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC', 'Seat/tour type description' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT', 'Seat/tour type added' );
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE', 'Seat/tour type updated' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT', 'Tour added' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_UPDATE', 'Tour updated' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_LINK', 'Tour Features' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_ABBV', 'Tour feature abbv.' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_DESC', 'Tour feature full description' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_INSERT', 'Tour feature added' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_UPDATE', 'Tour feature updated' );
...
jr_define( '_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS', 'Seat/tour type' );
...
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_PROPERTYADMIN', 'Tour admin' );
...
jr_define( '_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE', 'There are no seats available able to satisfy the parameters specified' );
...
jr_define( '_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE', 'Booking made for tour: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM', 'Booking made for seat: ' );
...
jr_define( '_JOMRES_COM_A_TARIFFS_PER_DESC', 'Select Yes if you want to charge per-person-per-night. If no, then costs will be calculated on a per-seat-per-night basis' );
...
jr_define( '_JOMRES_FRONT_MR_BOOKED', 'Seats booked' );
jr_define( '_JOMRES_COM_CONFIRMATION_TITLE', 'Confirmation letter' );
jr_define( '_JOMRES_COM_CONFIRMATION_DEAR', 'Dear ' );
jr_define( '_JOMRES_COM_CONFIRMATION_RATE_RULES', 'Cost per night - per seat ' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN', 'Your seat will be held until your arrival, and check in is after 2pm.' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE', 'No allowance can be made for meals not taken or for seats not occupied for the full period of the booking. With this in mind we strongly recommend that you use a holiday insurance facility.' );
...
jr_define( '_JOMRES_COM_MR_ROOM_UNABLETODELETE', 'Unable to remove this seat, there are bookings against it. Cancel those bookings then retry.' );
jr_define( '_JOMRES_COM_MR_ROOM_DELETED', 'Seat deleted' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_DELETE', 'Delete seat feature' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE', 'Unable to remove this seat feature, it is assigned to a seat or seats. Remove the feature from those seats and retry.' );
jr_define( '_JOMRES_COM_MR_ROOMFEATURE_DELETED', 'Seat feature deleted' );
jr_define( '_JOMRES_COM_MR_PROPERTYFEATURE_DELETE', 'Delete tour feature' );
jr_define( '_JOMRES_COM_MR_PROPERTYFEATURE_UNABLETODELETE', 'Unable to remove this tour feature, it is assigned to a tour. Remove the feature from this tour and retry.' );
jr_define( '_JOMRES_COM_MR_PROPERTYFEATURE_DELETED', 'Tour feature deleted' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_DELETE', 'Delete seat/tour type' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS', 'Unable to remove this seat/tour type, it is assigned to a seat. Try re-assigning the seat to another seat/tour type then try again.' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS', 'Unable to remove this seat/tour type, it is assigned to a tariff. Try re-assigning the tariff to another seat/tour type then try again.' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_DELETED', 'Seat/tour type deleted' );
jr_define( '_JOMRES_COM_MR_PROPERTY_DELETE', 'Delete tour' );
jr_define( '_JOMRES_COM_MR_PROPERTY_DELETED', 'Tour deleted' );
jr_define( '_JOMRES_COM_MR_PROPERTY_DELETE_NORIGHTS', 'You do not have rights to delete this tour.' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION', 'Tour description' );
...
jr_define( '_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC', 'Set this to Yes to ensure that visitors can book seats online.' );
...
jr_define( '_JOMRES_COM_A_BOOKING', 'Booking seats' );
...
jr_define( '_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC', 'EG you are renting out a tour, rather than seats in that tour. If this is the case, then you must make sure that you only have the one seat registered against each tour.' );
...
jr_define( '_JOMRES_COM_AVLCAL_INBGCOLOUR', 'Cell bgcolour for days when tour/seat is available' );
...
jr_define( '_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR', 'Cell bgcolour for provisionally booked seats (bookings for which a deposit has not been taken)' );
...
jr_define( '_JOMRES_FRONT_DELETEGUEST_UNABLETODELETEGUEST', 'Unable to delete this guest as they have bookings open against them with another tour.' );
jr_define( '_JOMRES_COM_INVOICE_ACTUALROOMCOST', 'Actual seat cost: ' );
...
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM', 'Created seat' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM', 'Updated seat' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM', 'Deleted seat' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE', 'Created seatfeature' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE', 'Updated seatfeature' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE', 'Deleted seatfeature' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE', 'Inserted seattype' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE', 'Updated seattype' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE', 'Deleted seattype' );
jr_define( '_JOMRES_MR_AUDIT_INSERT_PROPERTY', 'Created tour' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_PROPERTY', 'Updated tour' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_PROPERTY', 'Deleted tour' );
...
jr_define( '_JOMRES_MR_AUDIT_BOOKED_ROOM', 'Booked a seat' );
...
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR', 'There was an error attempting to book these seats, one or more of the seats you selected is not free.' );
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT', 'Seats included in black booking' );
...
jr_define( '_JOMRES_COM_A_ROOMTAX', 'Seat tax' );
jr_define( '_JOMRES_COM_A_ROOMTAX_DESC', 'Designed for the American market. These are the seat tax amounts that will be charged to the guest. You can charge a combination and/or of fixed and percentage figures. Note that these taxes are only applied to the cost of the seat.' );
...
jr_define( '_JOMRES_FRONT_TARIFFS_ROOMTYPE', 'Seat/tour type' );
...
jr_define( '_JOMRES_FRONT_PTYPE', 'Tour type' );
jr_define( '_JOMRES_COM_PTYPES_LIST_TITLE', 'List tour types' );
jr_define( '_JOMRES_COM_PTYPES_LIST_TITLE_EDIT', 'Edit tour type' );
jr_define( '_JOMRES_COM_PTYPES_PTYPE', 'Tour type' );
jr_define( '_JOMRES_COM_PTYPES_PTYPE_DESC', 'Tour type description' );
jr_define( '_JOMRES_COM_PTYPES_SAVED', 'Tour type saved' );
jr_define( '_JOMRES_COM_PTYPES_UNABLETO_DELETE', 'Unable to delete tour type. Tour type is assigned to one or more tours, please re-assign them before trying to delete' );
jr_define( '_JOMRES_COM_PTYPES_DELETED', 'Tour type(s) deleted' );
...
jr_define( '_JOMRES_COM_MONTHSTOSHOW_DESC', 'In the seat availability, How many months of the calendar should be shown?' );
...
<br/> 
Choose the seat(s) you wish to take out of service. <br>If a seat does not have a check mark against it, it cannot be included in the black booking until any outstanding bookings have been completed/cancelled.<br/> ' );
...
jr_define( '_JOMRES_FRONT_GALLERYLINK', 'View this tour\'s website' );
...
jr_define( '_JOMRES_JR_A_IMAGEHANDLING_BATCHUPLOAD', 'Batch tour image upload' );
...
jr_define( '_JOMRES_COM_A_SLIDESHOWS_NOIMAGES', '<br />Sorry, no images available for this tour. Please upload some images using the batch upload feature if you wish to use the slideshow feature.' );
...
jr_define( '_JOMRES_FRONT_IMAGEUPLOADS_INFO', 'Use this form to upload multiple images of this tour.<br/><b>Note</b> that any images with the same name will be overwritten. Also note that this form does not upload seat specific images or the tour header image, you will need to upload them from the Tour Admin section.<br/><b>Note</b> Images uploaded here will be written to the /jomres/uploadedimages/*tour_uid* folder. If this folder does not exist, it will be created, unless of course an alternative directory has been specified in the configuration.' );
jr_define( '_JOMRES_A_TABS_MISC', 'Misc' );
jr_define( '_JOMRES_A', 'Site configuration' );
jr_define( '_JOMRES_A_GLOBALPFEATURES', 'Use global tour features' );
jr_define( '_JOMRES_A_GLOBALPFEATURES_DESC', 'Set this to Yes if you want to force all tours to use only the tour features defined by the webmaster.' );
jr_define( '_JOMRES_A_GLOBALPFEATURES_INFO', 'To assign an image to this feature you first need to upload your tour feature images to the /jomres/uploadedimages/pfeatures/ folder. ' );
...
jr_define( '_JOMRES_FRONT_MR_MENU_BOOKAROOM', 'Book a seat' );
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS', 'Click for Seats and availability' );
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWDETAILS_TITLE', 'Show detailed tour info below this link' );
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE', 'Show seats and availability below this link' );
...
jr_define( '_JOMRES_COM_PROPERTYLISTDESC_DESC', "This limits the number of characters shown in the tour listing when drawing from the tour description." );
...
jr_define( '_JOMRES_A_GLOBALROOMTYPES', 'Use global seat/tour types' );
jr_define( '_JOMRES_A_GLOBALROOMTYPES_DESC', 'Set this to Yes if you want to force all tours to use only the seat/tour types defined by the webmaster. You need to set this to Yes if you intend to allow searching via seat/tour types.' );
jr_define( '_JOMRES_A_GLOBALROOMTYPES_INFO', 'To assign an image to this seat/tour type you first need to upload your seat/tour type images to the /images/stories/jomres/rmtypes/ folder. ' );
...
jr_define( '_JOMRES_COM_SELFREGISTRATION', 'Users can register their tours?' );
jr_define( '_JOMRES_COM_SELFREGISTRATION_DESC', 'Set this to Yes if you want users to be able to register their own tours without admin intervention.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1', 'Please provide the country and region of your tour.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_1', 'Please complete your tour details.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_2', 'Items highlighted are required.' );
jr_define( '_JOMRES_REGISTRATION_AUDIT_CREATEPROPERTY', 'Created tour' );
jr_define( '_JOMRES_REGISTRATION_NOTALLOWED', "Sorry, you can't create a tour on this system. You must be a logged in, registered user before you can proceed." );
jr_define( '_JOMRES_REGISTRATION_CREATEDPROPERTY', 'Created tour: ' );
...
jr_define( '_JOMRES_NUMBEROFROOMSAVAILABLE', 'Number of seats available' );
jr_define( '_JOMRES_BACKTOPROPERTYDETAILSLINK', 'Back to tour details' );
jr_define( '_JOMRES_FRONT_ROOMTYPES', 'Seat/tour types' );
...
jr_define( '_JOMRES_AJAXFORM_AVAILABLE_DESC', 'Select the seats that you require' );
jr_define( '_JOMRES_AJAXFORM_AVAILABLE_DESC_SRP', 'Look here to see if the tour is available at this time.' );
...
jr_define( '_JOMRES_AJAXFORM_AVAILABLEROOMS', 'Available seats' );
jr_define( '_JOMRES_AJAXFORM_SELECTEDROOMS', 'Selected seats' );
...
jr_define( '_JOMRES_VARIANCES_ISPERCENTAGE_TT', 'The figure calculated is a percentage of the Base figure calculated for the seat. If this is set to no then the figure you specify is simply added or subtracted from the base seat value.' );
jr_define( '_JOMRES_VARIANCES_POSNEG', 'Add variance?' );
jr_define( '_JOMRES_VARIANCES_POSNEG_TT', 'The figure calculated is added to or removed from the Base figure calculated for the seat. Set this to No if you want this to be a discount from the base figure. ' );
...
jr_define( '_JOMRES_COM_A_SHOWROOMSLISTLINK', 'Show link to seats list page in tour details page?' );
jr_define( '_JOMRES_COM_A_SHOWONLYAVLCAL', 'Show <b>only</b> Availability calendar?' );
jr_define( '_JOMRES_COM_A_SHOWONLYAVLCAL_DESC', 'Switch this to Yes to disable display of the tour header and details, so that only the availability calendar is viewable in the tour details section. Only really intended for users renting out single seat tours (eg apartments, cottages etc).' );
...
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO', 'Booking form seat list show seat number' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME', 'Booking form seat list show seat name' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE', 'Booking form seat list show tariff title' );
...
jr_define( '_JOMRES_COM_AVLCAL_BOOKING_KEY', 'Seat is booked' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS', 'You have chosen more seats than you have guests, click on a seat name to remove it from your selection' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS', 'Too many guests for the available beds' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS', 'You need to choose more seats' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM', 'Select a seat' );
...
jr_define( '_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET', 'No seats selected yet' );
...
jr_define( '_JOMRES_COM_LIMITROOMSLIST', 'Available seats/tariff limit' );
jr_define( '_JOMRES_COM_LIMITROOMSLIST_DESC', 'Use this input to limit the number of available seats & tariffs that are listed in the booking form. Set it to zero if you do not want limiting enabled. ' );
...
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALEDITING_DESC', 'Take care with this function. If set to Yes, then the editing mode will affect the custom text for ALL tours in the system for the constant you are editing.' );
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALCURRENCYYESNO', 'Use global currency?' );
jr_define( '_JOMRES_COM_JRCONFIG_GLOBALCURRENCYYESNO_DESC', 'Set this to yes to force all tours to use the same currency (e.g. & # 8 3 6 4 ;)' );
...
jr_define( '_JOMRES_COM_USERIS_SUPERPROPERTYMANAGER', 'Super Tour Manager' );
jr_define( '_JOMRES_COM_WEEKENDONLY', 'Weekends only' );
jr_define( '_JOMRES_COM_WEEKENDDAYS', 'Weekend days' );
jr_define( '_JOMRES_COM_WEEKENDDAYS_DESC', 'Set your weekend days. Tariffs that allow or disallow weekends will take this setting into account when generating the seats list.' );
jr_define( '_JOMRES_EDITPROPERTY_SELECTCOUNTRY', 'Select your country before adding any tour information' );
jr_define( '_JOMRES_EDITPROPERTY_SAVEBEFOREUPLOAD', 'Save your tour changes before uploading a tour image' );
...
jr_define( '_JOMRES_SEARCH_AVL_INFO', 'Please enter your intended arrival and departure dates and press the button to find tours that have accommodation available on your chosen dates.' );
jr_define( '_JOMRES_SEARCH_PTYPES', 'List all tours by tour type.' );
jr_define( '_JOMRES_SEARCH_RTYPES', 'List all tours by seat/tour type.' );
jr_define( '_JOMRES_SORTORDER_DEFAULT', 'Default' );
jr_define( '_JOMRES_SORTORDER_PROPERTYNAME', 'Tour Name' );
jr_define( '_JOMRES_SORTORDER_PROPERTYREGION', 'Tour Region' );
jr_define( '_JOMRES_SORTORDER_PROPERTYTOWN', 'Tour Town' );
jr_define( '_JOMRES_SORTORDER_STARS', 'Stars' );
jr_define( '_JOMRES_PATHWAY_PROPERTYLIST', 'Tour list' );
jr_define( '_JOMRES_PATHWAY_PROPERTYDETAILS', 'Tour details ' );
...
jr_define( '_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_RECHECKINGROOMAVIALABILITY', 'Re-checking seat availability<br/>(Seat selection will be reset)' );
...
jr_define( '_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_CHANGINGROOMSELECTION', 'Changing your seat selection' );
...
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMIMAGE', 'Seat image' );
...
Normal mode: You will have one tariff for each seat type that is valid for the next 10 years.<br/>
Micromanage: You can modify the price for each and every day for each seat/tour type. <br/>
...
Normal mode is the most simplistic but it's the easiest to understand because it will cross reference seats and tariffs to seat/tour types and allows you to configure seats and prices on the same page.<br/>
...
Advanced mode lets you create a seat and associate it with a seat type. You then create a tariff and associate THAT with a seat type. Using this method it is possible to \"layer\" tariffs over each other, for example a seat type \"Double bed\" can have one tariff for bed and breakfast, and another for bed, breakfast and evening meal. The advanced method requires a little more attention to detail because it is possible to dis-associate a seat or tariff from a seat/tour type, or to incorrectly set valid from and to dates, but it does give you configuration options that the other modes do not offer. <br/>
<br/>
Because Normal and Micromanage modes require a specific set up of seats and tariffs for the tariff mode to work the system may need to reset some data to make the current tariff configurations compatible with the current tariff editing mode.<br/>
<br/>
...
jr_define( '_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS', 'Show seats list in tour details page?' );
jr_define( 'JOMRES_PROPERTYTYPE', 'Tour type' );
jr_define( 'JOMRES_COM_A_SRPONLY', 'SRP only' );
jr_define( 'JOMRES_MAXPEOPLEINROOM', 'Max people per seat' );
...
jr_define( '_JOMCOMP_MYUSER_PROPERTYTYPE', 'Tour type' );
jr_define( '_JOMCOMP_MYUSER_PUBLISHEDPROPERTIES', 'Tours on site' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE', 'Wise price' );
jr_define( '_JOMCOMP_WISEPRICE_ACTIVE', 'Active' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE_DESC', 'This plugin allows you to enable and configure your seat prices dynamically.' );
jr_define( '_JOMCOMP_WISEPRICE_TITLE_DESC_FULL', 'Most tours will recalculate seat prices based on the number of seats of a required type that are available on a given date. This allows them to offer discounts on a seat/tour type that isn\'t busy during a given period with the aim of attracting tour that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of seats of a selected type are available in the tour on a given day.<br/> The days threshold defines the number of days that the arrival date must be within before seat prices are adjusted by this feature, then the percentages options allow you to configure the percentage of seats that can be available before a given discount is applied. Note however, if multiple seats are booked then the current level of discount will be applied to all seats and will not reduce as more seats are selected.' );
jr_define( '_JOMCOMP_WISEPRICE_THREASHOLD', 'Threshold (number of days between arrival date and today)' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE10', 'Percentage seats occupied 10% or less' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE25', 'Percentage seats occupied 25% or less' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE50', 'Percentage seats occupied 50% or less' );
jr_define( '_JOMCOMP_WISEPRICE_PERCENTAGE75', 'Percentage seats occupied 75% or less' );
...
jr_define( 'JOMRES_COM_A_MAPSKEY_DESC', 'Get can get a google maps API key from <a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google maps</a>. Once you have input your map key here, Jomres will show the map in your Tour Details page.' );
...
jr_define( 'JOMRES_COM_A_VERBOSETARIFFINTO_DESC', 'Set this to Yes to show more detailed tariff information in the tour details/tariff popup' );
jr_define( 'JOMRES_COM_A_MINIMALCONFIG', 'Minimise configuration options' );
jr_define( '_JOMCOMP_AMEND', 'Amend Booking - Tour Selection' );
jr_define( '_JOMCOMP_AMEND_SELECTPROPERTY', 'Select New Tour' );
...
jr_define( '_JRPORTAL_CONFIG_DEFAULT_CRATE_DESC', 'Choose the default commission rate that will be applied to a tour in the event that another commission rate is not otherwise set.' );
...
jr_define( '_JRPORTAL_CPANEL_LISTPROPERTIES', 'List Tours' );
jr_define( '_JRPORTAL_PROPERTIES_PROPERTYNAME', 'Tour name' );
jr_define( '_JRPORTAL_PROPERTIES_PROPERTYADDRESS', 'Tour address' );
jr_define( '_JRPORTAL_PROPERTIES_LEGEND', 'Tours who\'s background colour is red have not yet had a commission rate applied to them.' );
jr_define( '_JRPORTAL_STATS_PATETITLE', 'Statistics' );
jr_define( '_JRPORTAL_STATS_STATTYPE', 'Statistics for: ' );
jr_define( '_JRPORTAL_STATS_STATTYPE_PROPERTIES', 'Tours - Clicks' );
jr_define( '_JRPORTAL_PROPERTIES_VIEWPROPERTY', 'Tour view' );
...
jr_define( '_JRPORTAL_LISTBOOKINGS_HEADER_PROPERTY_ID', 'Tour id' );
...
jr_define( '_JRPORTAL_ADD_ADHOC_ITEM_CHOOSEPROPERTY', 'Associated tour (if applicable)' );
...
jr_define( '_JOMRES_COM_PTYPES_PTYPE_DESC_FURTHER', 'You can have tour type specific language files by setting the description to the name of a sub folder, e.g. "yachtbrokerage" and copying a language file to that subfolder. You can then modify that language file for this tour type so seats become, for example, DVDs, etc.' );
jr_define( '_JOMRES_EDITPROPERTY_CONNOTDELETE1', 'You cannot delete this tour as it is the only tour that you have access to. If you want to disable it, please use the un-publish feature in your toolbar. ' );
jr_define( '_JOMRES_EDITPROPERTY_CONNOTDELETE2', 'If this is a demo installation and you intend to upgrade to Jomres Solo (one tour only limit) then you should create a new tour first, then delete this one before changing your license key to the Solo license key that you will be assigned on purchase. ' );
...
jr_define( '_JOMRES_COM_ISTHISANMRP', "Is this tour a hotel/bed and breakfast/guest house/pension? " );
jr_define( '_JOMRES_COM_ISTHISANMRP_DESC', "Configuration options differ depending on if you are renting out seats in a tour, or the tour itself. Select MRP if you are offering seats, select SRP if you are offering the entire tour. " );
...
jr_define( '_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM', "per seat " );
...
jr_define( '_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_SUBJECT', 'Tour enquiry from ' );
jr_define( '_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_THANKS', 'Thank you for your enquiry, your message has been sent to the tour\'s contact email address, and copied to your own address for your records. They will respond to you as soon as possible with their reply.' );
...
jr_define( '_JOMRES_BOOKINGFORM_LOOKRIGHT', 'Please select your required accommodation from the list below by clicking on the seat.' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MINROOMS', 'Min seats already selected' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC', 'Minimum number of seats already selected in booking before tariff/seat type combo can be offered. Allows you to have discounted tariffs when more than N seats are already selected. ' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MAXROOMS', 'Max seats already selected' );
jr_define( '_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC', 'Maximum number of seats already selected in booking before tariff/seat combo is no longer offered. Allows you to stop offering this seat type/tariff combination once N seats have been selected in the booking form. ' );
...
jr_define( '_JOMRES_COM_SEF_TASK_ALIAS_VIEWPROPERTY', 'View tour task alias' );
...
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PTYPE', 'Add tour type to url' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PTYPE_DESC', '' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME', 'Add tour name to url' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME_DESC', '' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID', 'Append tour id to tour name' );
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID_DESC', 'if tour name is set to No then the id will not be used. If set to yes then the url will look like fawlty_towers-1' );
...
jr_define( '_JOMRES_COM_SEF_DEFAULT_COUNTRY_DESC', 'If all your tours are in one country then you will not have country in the search - enter a default country here if you want to display a country' );
...
jr_define( '_JOMRES_COM_SEF_DEFAULT_REGION_DESC', 'If all your tours are in one region then you will not have region in the search - enter a default region here if you want to display a region' );
...
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_PTYPE', 'Search URL Structure - Tour type' );
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_PTYPE_DESC', '' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_PTYPE', 'Search URL Structure - Default tour type' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_PTYPE_DESC', 'Used in url if search is for all tour types' );
...
jr_define( '_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYSPERROOM', 'Per days X seats selected' );
...
jr_define( '_JOMRES_COM_COMPOSITE_PROPERTY_DETAILS', 'Use Composite Tour details?' );
jr_define( '_JOMRES_COM_COMPOSITE_PROPERTY_DETAILS_DESC', 'Jomres 3.3 introduces the composite tour details where all of the tour details output is sent to one template file (composite_tour_details.html). If you do not wish to use this set it to No (only existing users are expected to set this to No, new users will probably want to leave it set to Yes)' );
jr_define( '_JOMRES_PROFILELIST_INSTRUCTIONS', 'This is a list of all users on the system. Non-tour managers will have a Guest icon, tour managers will have Reception/Tour Manager/Super tour manager icons.<br/>When Jomres is first installed "admin" is automatically added as a tour manager and is considered an authorised user.<br/>Non-super tour managers must be assigned to at least one tour otherwise they will see an error when they try to log on and use Jomres.<br/>Once a user is authorised then you can edit their profiles, assign them to tours or give them super tour manager rights.<br/>To authorise a user, click on the red Cross next to their name. To unauthrorise them, click the green Tick.<br/>To assign users to specific tours only, or give them super tour manager rights, authorise them then click the edit icon (which is only visible once they\'ve been authorised). Users who\'ve registered their tour(s) themselves will be automatically assigned to those tours. Super tour managers automatically have rights over all tours, and will see all configuration options even if the minimised configuration option is set in Site Config.' );
jr_define( '_JOMRES_PROFILEEDIT_INSTRUCTIONS', 'Here you can assign a manager to certain tours. Ensure, if they\'re not going to be a super tour manager, that they have rights to at least one tour otherwise they will see an error when they log in. To give a receptionist/tour manager rights over only certain tours, ensure that the Super Tour Manager dropdown is not set to Yes.' );
jr_define( '_JOMCOMP_MYUSER_VIEWBOOKINGS_NONE', 'You haven\'t made any bookings yet!' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_TAB', 'Tour type' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_TYPE', 'Edit your tour type' );
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_INFO', 'Select your tour type' );
...
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWROOMTYPEIMAGE', 'Booking form seat list show seat type image' );
jr_define( '_JOMRES_COM_A_LISTLIMIT', 'Tour List limit' );
jr_define( '_JOMRES_COM_A_LISTLIMIT_DESC', 'The number of tours to show on a page after a search' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE', 'Integrated search feature' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_TITLE_DESC', 'The Jomres integrated search feature allows your users to search through Jomres tours according to a set of functions. If you have already used the search features of Jomres in Joomla you will be familiar with these settings.<br/>This feature allows us to offer search handling within Jomres for those users who don\'t want to use Joomla search modules, or for other CMS users who\'s CMS doesn\'t have it\'s own Jomres search modules.<br/>Just remember that if you choose to search for something via a link (ie not a dropdown) then other search options will not be implemented, only the element that corresponds with the link that you clicked.<br/>Note that by default the layout of this integrated search isn\'t very pretty. That\'s because the template file that performs the layout has to include all possible options, some of which are incompatible. To improve the layout and achieve the look you desire, you will need to edit <b>srch.html</b> in the folder <b>' . JOMRES_TEMPLATEPATH_FRONTEND . '</b> ' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE', 'Activate this feature?' );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ENABLE_DESC', 'If this feature is enabled, then any call to Jomres that shows the tour list will mean that the search options are also shown.' );
...
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME', "Search by tour name" );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYNAME_DESC', "Show the search by tour name input." );
...
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE', "Search by tour type" );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_PROPERTYTYPE_DESC', "Show the search by tour type input" );
...
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE', "Search by seat type" );
jr_define( '_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE_DESC', "Show the search by seat type input" );
...
jr_define( '_JOMRES_A_GLOBAL_SEARCHOPTION_RANDOMLIMIT_DESC', 'By default, if a tour is not selected in Jomres it will perform a search. If this search was not triggered by a search module then that search will produce random results (deliberately). This option allows you to limit the number of returns in that random search.' );
...
jr_define( '_JRPORTAL_COUPONS_ROOMONLY', "Seat only" );
jr_define( '_JRPORTAL_COUPONS_ROOMONLY_DESC', "Discount is only applied to the cost of the seat. If No, then the discount is applied to the entire cost of the booking." );
...
<br/>
" );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWDISABLED', 'Booking form seat list show disabled access' );
jr_define( '_JOMRES_COM_A_BOOKINGFORM_SHOWMAXPEOPLE', 'Booking form seat list show max people' );
jr_define( '_JRPORTAL_HORIZROOMSLIST_ESTIMATEWARNING', "Please note that seat prices listed are estimates and the full price of the booking will not be calculated until you have added a seat or seats to your selection." );
...
jr_define( '_JRPORTAL_SUBSCRIPTIONS_PACKAGES_ROOMSLIMIT', "Seats limit" ); // Not currently used, saved for a rainy day
jr_define( '_JRPORTAL_SUBSCRIPTIONS_PACKAGES_PROPERTYLIMIT', "Tour limit" );
...
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES1', "You need a valid subscription to create new tours. At this moment in time, you have purchased subscriptions for " );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES2', " <i>published</i> tour(s). " );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES3', "You can increase the number of tours you can create by <a href='" . JOMRES_SITEPAGE_URL . "&task=list_subscription_packages'>purchasing more subscription packages here.</a>" );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES4', " You have used " );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES5', " tour slots. " );
jr_define( '_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES6', "To see a list of your current tours click <a href='" . JOMRES_SITEPAGE_URL . "&task=listyourtours'>here</a>. " );
...
jr_define( '_JRPORTAL_SUBSCRIPTIONS_PUBLISHERROR', "Unfortunately, you cannot publish this tour as you have reached your maximum number of available tour slots." );
jr_define( '_JRPORTAL_SUBSCRIBERS_SUBSCRIBED', "Thank you for creating a subscription to list your tour on our server. Once your invoice is marked as paid (there may be a delay depending on Paypal) please <a href='" . JOMRES_SITEPAGE_URL . "&task=registerProp_step1'>click here to continue creating your tour(s).</a>" );
...
jr_define( '_JRPORTAL_SUBSCRIBERS_CANNOT_PUBLISH', "We are sorry, but you've met the limit of the number of tours that you can have published on this system at any one time. You can raise the number of tours that you can publish by <a href='" . JOMRES_SITEPAGE_URL . "&task=list_subscription_packages&Itemid=" . $Itemid . "'>purchasing more subscription packages here.</a> " );
...
jr_define( '_JOMRES_CLICKTOREGISTER', 'Click here to register your tour' );
...
jr_define( '_JOMRES_LATLONG_DESC', "Use your mouse to move around the map, and drag the pointer to the location of your tour to set the latitude and longitude." );
...
jr_define( '_JOMRES_USER_LISTMYPROPERTY', 'Add my tour to this site' );
...
<br/> 
If the tour has one or more bookings for the period selected, then you will not be able to book it out until the other bookings/black bookings, have been cancelled/booked out.' );
jr_define( '_JOMRES_FRONT_BLACKBOOKING_SRP_CANNOTBLACKBOOK', 'Sorry, you cannot black book this tour for those dates.' );
jr_define( '_JOMRES_FRONT_BLACKBOOKING_SRP_CANBLACKBOOK', 'You can blackbook this tour for those dates.' );
jr_define( '_JOMRES_WARNINGS_PERPERSONPERNIGHT_NOGUESTTYPES', 'Your tour is configured to charge per person per night but you do not have any guest types created or published, please create and publish one or more guest types. ' );
jr_define( '_JOMRES_WARNINGS_TARIFFS_NOTARIFFS', 'You don\'t have any tariffs configured yet, you will not be able take any bookings for your tour.' );
...
jr_define( '_JOMRES_CONTACTOWNER_TO_ADMIN_DESC', 'Set this option to Yes if you want Contact Owner emails to be sent to the below input. Leave it set to No to send the emails to the email address defined in the tour configuration area.' );
...
jr_define( '_JOMRES_REALESTATE_YESNO', 'Is this tour a for sale listing?' );
jr_define( '_JOMRES_REALESTATE_YESNO_DESC', 'Select Yes if you are selling the tour, select No if it is a listing where you will be offering short term rentals and will be using this system for taking bookings.' );
...
jr_define( '_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO', 'Limit tour registration to one country?' );
jr_define( '_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_YESNO_DESC', 'You can ensure that tour registrations are limited to just one country by setting this option to Yes and setting the country in the following option.' );
jr_define( '_JOMRES_ADMIN_REGISTRATION_LIMITPROPERTY_COUNTRY', 'Tours are located in this country : ' );
jr_define( '_JOMRES_JQUERYTHEME', 'Jquery theme' );
jr_define( '_JOMRES_JQUERYTHEME_DESC', 'Choose a jquery theme to use for the tour details tabs.' );
jr_define( '_JOMRES_PROPERTYNOTOUBLISHED', 'We are sorry, but that tour is not currently available.' );
jr_define( '_JOMRES_REVIEWS', 'Reviews' );
jr_define( '_JOMRES_REVIEWS_TITLE', 'Review title' );
jr_define( '_JOMRES_REVIEWS_DATE', 'posted on ' );
jr_define( '_JOMRES_REVIEWS_NOREVIEWS', 'There are no reviews for this tour yet.' );
jr_define( '_JOMRES_REVIEWS_NOREVIEWS_BETHEFIRST', 'Would you like to be the first to review this tour?' );
...
jr_define( '_JOMRES_REVIEWS_REVIEWBODY', 'Tell us what you think about this tour : ' );
...
jr_define( '_JOMRES_REVIEWS_ALREADYREVIEWED', 'You have already reviewed this tour, you can\'t post another review about it.' );
...
jr_define( '_JOMRES_REVIEWS_ADDREVIEW_ERROR_PROS', 'Please enter the good parts of your experience of being a guest at this tour' );
...
jr_define( '_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_2', 'Please rate your opinion of the tour\s locale' );
jr_define( '_JOMRES_REVIEWS_ADDREVIEW_ERROR_RATING_3', 'Please provide your opinion of the cleanliness of the tour' );
...
jr_define( '_JOMRES_REVIEWS_ADMIN_TESTMODE_DESC', 'Normally tour managers cannot review tours. With test mode enabled, they can. Naturally this is not ideal in a production environment.' );
jr_define( '_JOMRES_REVIEWS_ADMIN_PROPERTYLISTINFO', 'This is a list of all tours. To see a tour\'s reviews, click on that tour. From there you will be able to publish or delete a review.' );
...
jr_define( '_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS', 'Show Booking form in tour details page?' );
jr_define( '_JOMRES_COM_A_SHOWBOOKINGFORMINPROPERTYDETAILS_DESC', 'Set this to Yes to show the booking form in the tour details page. If you set it to No, then a link will appear in the tour details page instead pointing to the booking form.' );
...
jr_define( '_JOMRES_ROOMALLOCATIONS_ROOM', 'Seat ' );
jr_define( '_JOMRES_ROOMALLOCATIONS_GUESTS', 'guest(s). ' );
jr_define( '_JOMRES_ROOMALLOCATIONS_INFORMATION', 'This how we have assigned your guest numbers to their seats. If you would like to change this allocation, you will need to contact the hotel after making the booking. Extra charges may apply if you change your assignments.' );
jr_define( '_JOMRES_SANITY_CHECK_NOT_PUBLISHED', "Note that your tour is not yet published, only you can see the tour, site visitors will not see it" );
...
jr_define( '_JOMRES_ROOMMSLIST_STYLE', 'Seats list style' );
jr_define( '_JOMRES_ROOMMSLIST_STYLE_DESC', 'In the booking form, using the "classic" seats list style you offer individual seats to guests. With the seat type view, guests choose the number of seats of type X (eg. 2 x doubles) instead' );
jr_define( '_JOMRES_ROOMMSLIST_STYLE_CLASSIC', 'Classic' );
jr_define( '_JOMRES_ROOMMSLIST_STYLE_ROOMTYPES', 'Seat types' );
jr_define( '_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_START', '(Re)checking availability' );
jr_define( '_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_REBUILDING_AVAILABLEROOMS', 'Rebuilding available seats list' );
...
jr_define( '_JOMRES_REVIEWS_ADMIN_GUESTSONLY', 'Only tour guests can review?' );
jr_define( '_JOMRES_REVIEWS_ADMIN_GUESTSONLY_DESC', 'Set this to Yes if you want to restrict reviews to only those users who have been a guest already in this tour.' );
jr_define( '_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERROOMPERBOOKING', 'Per seat' );

jr_define( '_JOMRES_MAX_GUESTS_PER_ROOM', 'Guests per seat : ' );
jr_define( '_JOMRES_MAX_GUESTS_PER_BOOKING', 'Guests per booking : ' );
jr_define( '_JOMRES_NUMBER_OF_ROOMS', 'Number of seats' );
...
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS', "Tour management process" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_DESC', "There are different management processes depending on the way you want to list your tour/tour." );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL', "Rental" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL_DESC', "Choose the rental option if you are booking out seats in a tour (eg. Hotel/B&B/Villa/Apartment)" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE', "Realestate/simple listing" );
jr_define( '_JOMRES_PROPERTYMANAGEMENTPROCESS_REALESTATE_DESC', "Choose the real estate option if you are not offering any booking functionality at all, (eg. A tour/item for sale)" );

jr_define( 'JOMRES_COM_A_MINIMALCONFIG_DESC', 'Set this to Yes to reduce the number of options available to tour managers in the General Configuration section. This is useful if you do not want tour managers to play around with too many settings, instead you can edit jomres_config.php to define default tour options.' );
jr_define( '_JOMRES_AJAXFORM_EXTRAS_SELECT', 'Please select an option for your booking' );
jr_define( '_JOMRES_COM_ALLOWHTMLEDITOR_DESC', 'Switches on html editors in tour details editing page. Additionally, if this is set to No, then all html except p and br is stripped from all entered and displayed text.' );
...
jr_define( '_JOMRES_COM_TIMEZONE_SWITCHER', "Show the timezone switcher in the tour manager's toolbar?" );

jr_define( '_JOMRES_PARTNER_DISCOUNT', "Partner discount " );
jr_define( '_JOMRES_PARTNER_CHOOSE_SEARCHTITLE', "Search user" );
jr_define( '_JOMRES_PARTNER_CHOOSE_SEARCH_INSTRUCTIONS', "Enter a few characters to search for a user.<br/> When you select a user you will automatically add them as a Partner and you will be taken to the next page where you can assign tours and discounts to the user." );
...
jr_define( '_JOMRES_PARTNER_SHOW_SEARCHTITLE', "Search for a tour" );
jr_define( '_JOMRES_PARTNER_SHOW_SEARCHINSTRUCTIONS', "Enter a few characters from the tour name and select a tour.<br/> When you select the tour you will add it to the partner's portfolio, however they will not yet enjoy any discounts, you will need to set those youself." );
jr_define( '_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES', "Current tours" );
jr_define( '_JOMRES_PARTNER_SHOW_CURRENTPROPERTIES_INSTRUCTIONS', "Click on a tour to edit the partner's discount settings for that tour." );

// 4.6
jr_define( '_JOMRES_SUSPENSIONS_TITLE', "Suspended? <br/>(click to suspend a manager, this will auto-unpublish all of their tours ) " );
jr_define( '_JOMRES_SUSPENSIONS_MANAGERLIST_INFO', "Click on the Suspend Icon (the icon with the man and the green tick) to suspend a manager. This means that the manager will not be able to perform tour management functions and all of their tours will be unpublished. Super tour managers cannot be suspended." );
...
jr_define( '_JOMRES_SUSPENSIONS_MANAGER_SUSPENDED_EMAIL', "Please note that your tour manager account has been suspended. You will not be able to perform any tour management functions until the account has been restored." );
jr_define( '_JOMRES_SUSPENSIONS_MANAGER_UNSUSPENDED_EMAIL', "Please note that your tour manager account is now active. You may continue to perform any tour management functions. Please log into your account and ensure that the approprite propert(ies) have been published. Thank you." );
...
jr_define( '_JOMRES_MANAGER_CHOOSE_SEARCH_INSTRUCTIONS', "Enter a few characters from their username to search for a user.<br/> When you select a user you will automatically add them as a Manager and you will be taken to the next page where you can assign tours and access rights to the user." );
...
jr_define( '_JOMRES_CHOOSEMANAGER_NUMBEROFPROPERTIES_ASSIGNED', "Number of tours" );
...
jr_define( '_JOMRES_COM_THUMBNAIL_SMALL_WIDTH_DESC', 'Small thumbnails are used in the tour list whereas medium sized thumbnails are used in the tour header.' );
...
jr_define( '_JOMRES_BOOKINGORM_MODALPOPUP_DESC', 'If the option to show the booking form in the tour details is set to No, then when the booking form page is opened Jomres can show the booking form in a modal popup. This allows you to include much more information in the booking form without overwhelming the customer by having too many elements on the screen (as they\'re hidden behind the popup)' );
...
jr_define( '_JOMRES_AJAXFORM_BILLING_TAX_ACCOM', 'Seat tax:' );

jr_define( '_JOMRES_AJAXFORM_BUTTON_OPEN_BOOKINGFORM', 'Open the booking form' );

jr_define( '_JOMRES_AJAXFORM_BUTTON_BACK_TO_PROPERTY_DETAILS', 'Back to tour details' );
...
jr_define( '_JOMRES_BOOKINGORM_ROOMFEATURE_FILTER', 'Filter seats based on their features.' );
...
jr_define( '_JOMRES_COM_A_TARIFFS_PER_DESC_WHOLEDAY', 'Select Yes if you want to charge per-person-per-day. If no, then costs will be calculated on a per-seat-per-day basis' );
...
jr_define( '_JOMCOMP_WISEPRICE_TITLE_DESC_FULL_WHOLEDAY', 'Most tours will recalculate seat prices based on the number of seats of a required type that are available on a given date. This allows them to offer discounts on a seat/tour type that isn\'t busy during a given period with the aim of attracting tour that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of seats of a selected type are available in the tour on a given day.<br/> The days threshold defines the number of days that the pickup date must be within before seat prices are adjusted by this feature, then the percentages options allow you to configure the percentage of seats that can be available before a given discount is applied. Note however, if multiple seats are booked then the current level of discount will be applied to all seats and will not reduce as more seats are selected.' );
...
jr_define( '_JOMRES_PROPERTY_TYPE_ASSIGNMENT', 'Tour type relationship' );
jr_define( '_JOMRES_IMAGE', 'Image' );
jr_define( '_JOMRES_FEATURE_PROPERTY_TYPE_ASSIGNMENT', 'Tour types that can show this feature' );
jr_define( '_JOMRES_CRATES_CLICKINITIAL', 'Click on a letter to show all tours with that first character. Once you have a list of properties you can assign commission rates to those properties, or click on their "edit" icon to view the tour\'s statistics.' );
...
jr_define( '_JOMRES_PRODUCT_INFORMATION', 'Welcome to Jomres, we hope you enjoy using Joomla\'s favourite booking system. If you would like to purchase a Jomres Zero, Solo, Silver or Jomres Gold license, <a href="http://www.jomres.net/prices" target="_blank"> please visit our site</a> for information on how you can upgrade.' );
jr_define( '_JOMRES_PRODUCT_INFORMATION2', 'This system is ideal for any scenario, be it a simple booking form for a single tour, right up to a site that has multiple users, in multiple languages, with multiple properties. Please see the "Help" section to the left, including the "Getting Started" page which will guide you through your first steps.' );

jr_define( '_JOMRES_ROBBED_PORTALUI_CURRENT_PROPERTY', "Active tour" );
jr_define( '_JOMRES_ROBBED_PORTALUI_SWITCH_PROPERTY', "Change your active tour" );
jr_define( '_JOMRES_ROBBED_PORTALUI_CLICKINITIAL', "Click a character to reveal all properties that start with that character. Once revealed, click on that tour's name to change it to your active tour." );
...
jr_define( '_JOMRES_ACCESS_CONTROL_DESC_FULL', "<strong>This feature is for advanced users only. If you do not know what it is for, and don't have a specific reason to use it, please return to Site Configuration and set the Full Access Control option to No.</strong><br/>
	...
	In Jomres access levels follow a pyramid, so Super Tour Managers are greater than Managers. In short Super Manager > Manager > Receptionist > Registered > Unregistered. So, if a Registered user has access to a minicomponent, so do Receptionists,  Managers and Super Managers.<br/>
...
jr_define( '_JOMRES_SHOWPROFILES_USERSWITHACCESS', "Users with admin rights to this tour" );
...
jr_define( '_JOMRES_REGISTRATION_STEP_1_OF_2', "Add your tour : Step 1 of 2" );
jr_define( '_JOMRES_REGISTRATION_STEP_2_OF_2', "Add your tour : Step 2 of 2" );

jr_define( '_JOMRES_MYPROPERTIES', 'My tours' );
