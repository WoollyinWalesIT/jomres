...
define('_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE','Created vehicle feature');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE','Updated vehicle feature');
define('_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE','Deleted vehicle feature');
define('_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE','Inserted vehicle type');
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE','Updated vehicle type');
define('_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE','Deleted vehicle type');
...
define('_JOMRES_A_GLOBALROOMTYPES_DESC','Set this to Yes if you want to force all businesses to use only the vehicle types defined by the webmaster. You need to set this to Yes if you intend to allow searching via vehicle types.');
...
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Switch this to Yes to disable display of the business header and details, so that only the vehicles list/availability calendar is viewable in the business details section. Only really intended for users renting out single vehicle businesses (eg apartments, cottages etc).');
...
define('_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS','Too many persons for the available seats');
...
define('_JOMRES_COM_WEEKENDDAYS_DESC','Set your weekend days. Tariffs that allow or disallow weekends will take this setting into account when generating the vehicles list.');
...
define('_JOMRES_SEARCH_RTYPES','List all businesses by vehicle type.');
...
define('_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS','Show vehicles list in business details page?');
define('JOMRES_PROPERTYTYPE','Business type');
define('JOMRES_COM_A_SRPONLY','SRP only');
define('JOMRES_MAXPEOPLEINROOM','Max people per vehicle');
...
define('_JOMCOMP_WISEPRICE_NOTDISCOUNTED',' Vehicle price not discounted ');
...
define('_JOMCOMP_LASTMINUTE_PROPERTYLIST_PRE','This business offers a last minute discount of  ');
...
define('_JOMRES_COM_ISTHISANMRP_DESC',"Configuration options differ depending on if you are renting out vehicles in a business, or the business itself. Select MRP if you are offering vehicles, select SRP if you are offering the entire business.ring the entire business. ");
// Jomres v3.0.6
...
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM',"per vehicle ");
...
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS','Min vehicles already selected');
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC','Minimum number of vehicles already selected in booking before tariff/vehicle type combo can be offered. Allows you to have discounted tariffs when more than N vehicles are already selected. ');
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS','Max vehicles already selected');
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC','Maximum number of vehicles already selected in booking before tariff/vehicle combo is no longer offered. Allows you to stop offering this vehicle type/tariff combination once N vehicles have been selected in the booking form. ');
...
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYSPERROOM','Per days X vehicles selected');
...
define('_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE',"Search by vehicle type");
define('_JOMRES_COM_A_INTEGRATEDSEARCH_ROOMTYPE_DESC',"Show the search by vehicle type input");
...
define('_JRPORTAL_COUPONS_ROOMONLY',"Vehicle only");
define('_JRPORTAL_COUPONS_ROOMONLY_DESC',"Discount is only applied to the cost of the vehicle. If No, then the discount is applied to the entire cost of the booking.");
...
<br/>
");
define('_JOMRES_COM_A_BOOKINGFORM_SHOWDISABLED','Booking form vehicle list show disabled access');
define('_JOMRES_COM_A_BOOKINGFORM_SHOWMAXPEOPLE','Booking form vehicle list show max people');
define('_JRPORTAL_HORIZROOMSLIST_ESTIMATEWARNING',"Please note that vehicle prices listed are estimates and the full price of the booking will not be calculated until you have added a vehicle or vehicles to your selection.");
...
define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_ROOMSLIMIT',"Vehicles limit"); // Not currently used, saved for a rainy day
...
define('_JRPORTAL_SUBSCRIBERS_AVAILABLE_PROPERTIES2'," published business(s). ");
...
define('_JOMRES_REALESTATE_YESNO','Is this business a Real estate listing?');
define('_JOMRES_REALESTATE_YESNO_DESC','Select Yes if you are selling the business, select No if it is a hotel/b&b/guest house/villa type business where you will be offering the business or vehicles in the business for short term rental and will be using this system for taking bookings.');
...
define('_JOMRES_REVIEWS_ADMIN_TESTMODE_DESC','Normally business managers cannot review businesss. With test mode enabled, they can. Naturally this is not ideal in a production environment.');
...
define('_JOMRES_ROOMALLOCATIONS_ROOM','Vehicle ');
define('_JOMRES_ROOMALLOCATIONS_GUESTS','guest(s). ');
define('_JOMRES_ROOMALLOCATIONS_INFORMATION','This how we have assigned your guest numbers to their vehicles. If you would like to change this allocation, you will need to contact the hotel after making the booking. Extra charges may apply if you change your assignments.');
...
define('_JOMRES_ROOMMSLIST_STYLE','Vehicles list style');
define('_JOMRES_ROOMMSLIST_STYLE_DESC','In the booking form, using the "classic" vehicles list style you offer individual vehicles to guests. With the vehicle type view, guests choose the number of vehicles of type X (eg. 2 x doubles) instead');
define('_JOMRES_ROOMMSLIST_STYLE_CLASSIC','Classic');
define('_JOMRES_ROOMMSLIST_STYLE_ROOMTYPES','Vehicle types');
define('_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_START','(Re)checking availability');
define('_JOMRES_BOOKINGFORM_PROGRESSMESSAGE_REBUILDING_AVAILABLEROOMS','Rebuilding available vehicles list');
...
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERROOMPERBOOKING','Per vehicle');
define('_JOMRES_MAX_GUESTS_PER_ROOM','Guests per vehicle : ');
define('_JOMRES_MAX_GUESTS_PER_BOOKING','Guests per booking : ');
define('_JOMRES_NUMBER_OF_ROOMS','Number of vehicles');
...
define('_JOMRES_PROPERTYMANAGEMENTPROCESS_RENTAL_DESC',"Choose the rental option if you are booking out vehicles in a business (eg. Hotel/B&B/Villa/Apartment)");
