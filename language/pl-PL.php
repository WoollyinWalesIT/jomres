 ...
 * @Aktualizacja wersji językowej z 15-05-2013r.
 **/
...
if ( !defined( '_PN_PREVIOUS' ) ) jr_define( '_PN_PREVIOUS', 'Wstecz' );

if ( !defined( '_PN_NEXT' ) ) jr_define( '_PN_NEXT', 'Dalej' );

if ( !defined( '_PN_END' ) ) jr_define( '_PN_END', 'Koniec' );

if ( !defined( '_PN_RESULTS' ) ) jr_define( '_PN_RESULTS', 'Wyniki' );
