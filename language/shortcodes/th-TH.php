...
jr_define('_JOMRES_SHORTCODES_06001SHOW_SYNDICATED_PROPERTIES_ARG_MRPSRP', 'จะแสดง MRP (โรงแรม/ที่พักและอาหารเช้า) หรือ SRP (กระท่อม/อพาร์ตเมนต์/วิลล่า) ค่าเริ่มต้นจะพิจารณาจากคุณสมบัติปัจจุบันของ uid หรือไม่ ถ้านั่นไม่ใช่ MRP แสดง หากต้องการเลือกประเภทเฉพาะ ให้ตั้งค่านี้เป็น 0 สำหรับ srps หรือ 1 สำหรับ mrps');
	...
	jr_define('_JOMRES_SHORTCODES_06000PROPERTY_WIDGET', "แสดงเอาต์พุตประเภทโมดูลคุณสมบัติสำหรับการจัดวางด้วยรหัสย่อ เอาต์พุตโมดูลคุณสมบัติเป็นส่วนย่อยเล็กๆ ของรายละเอียดคุณสมบัติที่ออกแบบมาเพื่อแสดงในตำแหน่งต่างๆ ในหน้า");
	jr_define('_JOMRES_SHORTCODES_06000PROPERTY_WIDGET_ARG_PROPERTY_UID', 'ตัวเลือก ID ของพร็อพเพอร์ตี้ ถ้าไม่ได้ตั้งค่า uid ของพร็อพเพอร์ตี้ พร็อพเพอร์ตี้ที่เผยแพร่แบบสุ่มจะแสดงขึ้น');
	jr_define('_JOMRES_SHORTCODES_06000PROPERTY_WIDGET_ARG_ALT_TEMPLATE_NAME', 'ไม่บังคับ ชื่อเทมเพลตทางเลือก โดยไม่มี ".html" เทมเพลตต้องมีอยู่ในไดเรกทอรีแทนที่เทมเพลต ซึ่งช่วยให้คุณใช้ "basic_module_output.html" เวอร์ชันที่กำหนดเองได้ในตำแหน่งต่างๆ ในหน้าของคุณ ' );
