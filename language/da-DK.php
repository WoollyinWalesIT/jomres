...
jr_define('_JOMRES_WARNINGS_GLOBALEDITINGMODE', 'Bemærk, du bruger redigeringstilstand med den globale redigeringsfunktion aktiveret. Dette er fint, hvis du forstår, hvad global redigeringstilstand betyder, men hvis du ikke gør det, kan du forårsage problemer selv. Hvis du er usikker. hvis du skulle bruge Jomres på denne måde, kan du se <a href = "https://www.jomres.net/manual/developers-guide/53-customising-jomres/editing-labels-languages/268-editing-mode" target="_blank "> den manuelle side i redigeringstilstand </a> for flere oplysninger om dette emne. ');
...
jr_define('_JOMRES_IP_DETECTION_API_KEY_DESC', 'For automatisk at indstille rullemenuen for valutakode kan Jomres bruge en gratis tjeneste kaldet IPinfoDB til at registrere besøgendes land, men du skal registrere en API -nøgle på <a href = "https://www.ipinfodb.com/login" target ="_blank"> IPinfoDB </a> først. ');
...
jr_define('_JOMRES_EMAIL_TEMPLATES_INSTRUCTIONS', 'Se venligst denne side for at få hjælp til at tilpasse e-mails og en liste over det tilgængelige output: <a href = "https://www.jomres.net/manual/property-managers-guide/48-your -toolbar/settings/254-email-templates" target ="_blank"> Hjælp til e-mailskabeloner </a> ');
...
jr_define('_JOMRES_CONFIG_GMAP_KEY_WARNING', "Du har ikke en Google Maps -nøgle. På grund af de seneste ændringer i Google maps har alle nye websteder brug for en API -nøgle for at kunne bruge Google maps funktioner. <a href = 'https://www.jomres.net/manual/site-managers-guide/14-getting-started/338-google-maps-api-key' target ='_blank '> se vores manual side om, hvordan du opretter en API-nøgle < /a> og gem nøglen i Jomres. ");
...
jr_define('_JOMRES_GUEST_BLACKLISTED_DESC', 'Hvis denne gæst er sortlistet, vil de ikke længere være i stand til at foretage bookinger i denne ejendom.');
...
Du kan lade målsproget være indstillet til dit nuværende sprog og bruge denne side til at omdøbe elementer her, i stedet for at besøge deres individuelle sider.');
	...
	jr_define('API_CLIENTS_INFO', 'API-klienter er klient-id/hemmelige nøglepar, der tillader fjernsystemer at bruge API-funktioner, som du giver dem tilladelse til at bruge. På denne side kan du oprette så mange klient/hemmelige nøglepar, som du har brug for, hver med enhver kombination af tilladelser, som du har brug for.');
	...
	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN', "Al ejendomsadministration udføres i frontend af dit websted. Du er i øjeblikket ikke logget ind som ejendomsadministrator, så log venligst først ind, og derefter vil du være i stand til at administrere dine ejendomme.");

	jr_define('JOMRES_COM_TRANSITION_FROM_ADMIN_TO_BACKEND_NOT_LOGGED_IN_EXPOSITION_FOR_NEW_USERS_JOOMLA', "Når Jomres installeres første gang, vil den oprette en Super Property Manager for administratorbrugeren og tilføje en ny mulighed til hovedmenuen kaldet \"Bestillinger\". Log indslet ved hjælp af dette element, og slet ikke. siden Bookinger for at begynde at administrere egenskaber. ");

	jr_define('_JOMRES_COM_A_GATEWAYLIST_INFO', 'På denne side kan du konfigurere, hvilke betalingsgateways du ønsker at modtage indbetalinger via. Du skal bruge en konto på betalingsgatewayen. Siden med indstillinger giver dig instruktioner om, hvordan du konfigurerer gatewayen.' );

	jr_define('_JOMRES_COM_A_GATEWAYLIST_TESTINGINFO', "Du er logget ind som en Super Property Manager. Normalt kan ejendomsadministratorer ikke bruge betalingsgateways, men hvis du indstiller webstedet til udviklingstilstand i Admin > Jomres > Indstillinger > Debugging fanen, så vil du være i stand til at behandle gennem en booking og få adgang til betalingsgateways, som en gæst gør. Hvis du ikke ønsker at indstille siden til udviklingstilstand, skal du enten være logget ud eller logget ind som en normal registreret bruger for at teste bookinger som gæst. Indstillinger for testtilstand i individuelle betalingsgateways påvirkes ikke af webstedets produktions- eller udviklingsindstilling. ");
