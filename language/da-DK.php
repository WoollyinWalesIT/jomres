...
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_INTRODUCTION', 'Introduktion');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_WHATISJOMRES', 'Hvad er Jomres?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_WHATISJOMRES', "Jomres er et hotel- og villa -bookingsystem, der fungerer sammen med Joomla og Wordpress Content Management Systems. Det er et fuldt bookingsystem, tænk 'booking.com' eller 'airbnb' uden omkostninger. Det er et komplet værktøjskasse det giver dig mulighed for at opbygge en unik online bookingtjeneste for så mange ejendomme, som du ønsker. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_USERSADD', 'Kan brugere registrere sig på mit Jomres -websted og tilføje deres egne ejendomme?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_USERSADD', 'Ja. Som standard tillader Jomres registrerede brugere at tilføje deres egne ejendomme til dit websted. Du kan deaktivere dette under fanen Webstedskonfiguration> Diverse, hvis du har brug for det.');
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PROPERTIES', 'Egenskaber');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_ADDPROPERTIES', 'Hvordan tilføjer jeg en ny ejendom?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_ADDPROPERTIES', "Når Jomres er installeret, oprettes administratorbrugeren som en Super Property Manager. Log ind på frontend af dit CMS (de offentlige sider) som administratorbruger, og derfra kan du tilføje nye egenskaber. <br/ > Du kan oprette nye ledere på siden Ejendomsadministratorer, hvis du vil tilføje en ny leder, men som standard (du kan deaktivere dette) oprettes enhver registreret bruger, der opretter en ejendom, automatisk som ejendomsadministrator for de ejendomme, de opretter. For af sikkerhedsmæssige årsager kan de ikke administrere andre leders ejendomme. Dette kan ændres ved at hæve denne bruger til en Super Property Manager på siden Ejendomsadministratorer. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_IMPORTPROPERTIES', 'Kan jeg importere egenskaber fra et andet system?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_IMPORTPROPERTIES', "Der er en række måder, du kan importere ejendomme på. Ejendomsimport -plugin giver dig mulighed for at importere ejendomme via CSV. Dette giver dig mulighed for at importere flere ejendomme på én gang, men er kun en administratorfunktion. Hvis ejendommen har egenskaben. manager har en Beds24 -konto, så kan de importere eksisterende ejendomme fra deres konto der, når de har knyttet API -nøgler. En anden måde er at bruge API'en, der er en funktion til at tilføje og fjerne ejendomme, men dette ville kræve, at du er udvikler fortrolig med at bruge REST API'er til at bruge denne funktionalitet. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_IMPORTBOOKINGS', 'Kan jeg importere bookinger fra et andet system?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_IMPORTBOOKINGS', "Bookinger kan importeres til en ejendom af en ejendomsadministrator via iCal -plugin, som tilbyder en funktion til import af bookinger i ejendomsadministratorens menu. Også hvis en ejendomsadministrator har en Beds24 -konto, og deres ejendom har været forbundet med Beds24, så kan de udføre en genoplysnings -handling i Beds24. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_EMAILTEMPLATES', 'Kan jeg redigere e -mail -skabeloner?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_EMAILTEMPLATES', 'Ejendomsadministratorer kan redigere e -mail -skabeloner via deres værktøjslinje under Indstillinger> E -mail -skabeloner.');
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PAYMENTS', 'Betalinger');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TAKEPAYMENTS', 'Hvordan tillader jeg ejendomme at betale?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TAKEPAYMENTS', 'Du bliver nødt til at installere en betalingsgateway. Jomres har to betalingsgateways, der opretter forbindelse til Paypal eller Stripe. Det tilbyder også et par offline -gateways, og du kan købe andre betalingsgateways fra vores partnere.' );
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_WHICHGATEWAY', 'Hvilken gateway skal jeg bruge?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_WHICHGATEWAY', "Hvis du vil tage en procentdel af en managers indbetaling til dine egne omkostninger, skal du derefter bruge Stripe -gatewayen. Hvis du ikke gør det, og i stedet har til hensigt at bruge abonnements- og/eller kommissionsfunktionen, skal du skal bruge Paypal -gatewayen. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PAYMENTACCOUNTS', 'Hvem får pengene, når en gæst foretager en betaling for en reservation?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PAYMENTACCOUNTS', "Det afhænger af, hvordan du har konfigureret betalingsgateways på dit websted. Hvis du bruger Paypal, kan du konfigurere det til at tilsidesætte alle frontend -indstillinger, hvilket hovedsageligt gør din konto til den eneste konto, der modtager betalinger. Hvis hvis du ikke vælger at gøre det, skal hver ejendom konfigurere deres betalingsgateway -konto i fanen Indstillinger> Gateways. Hvis du bruger Stripe, skal ejendomsadministratoren, når ejendomsadministratoren har forbundet deres konto til din (se Stripedokumentationen i manualen for mere information) så modtager de alle midler minus et provisiongebyr, som du kan konfigurere, hvis du vælger at gøre det. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_TROUBLESHOOTING', 'Fejlfinding');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TROUBLESHOOTING_EMAIL', "Booking -e -mails sendes ikke.");
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TROUBLESHOOTING_EMAIL', "Hvis du har problemer med at sende e -mails fra systemet, skal du kontrollere dit værts CMS's e -mail -indstillinger. Jomres bruger Wordpress eller Joomla -indstillingerne til at sende e -mails. Hvis de tager fejl, kan Jomres ikke kunne send enten e -mails. ");
...
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TROUBLESHOOTING_NOGATEWAY', "Hvis du er logget ind som en ejendomsadministrator, ser du ikke betalingsgatewayen, fordi du ikke betaler dig selv, fjollet. Kun ikke-manager-brugere kan se gatewayen, når de foretager reservationer.") ;
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PURCHASINGJOMRES', 'Jomres License');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_FORCEDTOSUBSCRIBE', 'Efter at have købt X -licens, er jeg tvunget til at købe fornyelser, når licensen er udløbet?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_FORCEDTOSUBSCRIBE', "Nej, hvis du har købt en Starter-, Business- eller Enterprise -licens, kan du fortsætte med at bruge softwaren på ubestemt tid, den bliver ikke magisk krypteret. Undtagelsen fra denne regel er, hvis du køber et abonnement. Når et abonnement er blevet annulleret, vil du ikke længere kunne bruge plugins, og du skal afinstallere dem. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_EXPIRED', 'Min licens er udløbet, kan jeg alligevel opgradere Jomres?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_EXPIRED', "Selvom du fysisk kan, kan det ikke anbefales, at du gør det. Når en licens er udløbet, vil du ikke længere kunne drage fordel af support eller download af opdateringer til plugins til din Jomres -installation. Det betyder, at du bør < i> ikke </i> opgrader din Jomres -installation, efter at licensen er udløbet. Dette skyldes, at plugins regelmæssigt skal opdateres for at fungere med nuværende versioner af systemet, så ofte fungerer dine ældre plugins ikke på en nyere version af systemet . Hvis du stadig vil opgradere for at drage fordel af ny funktionalitet, bør du købe en fornyelseslicens, som faktisk er en normal licens med 50% rabat. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PURCHASINGJOMRES_SOFTWARELICENSE', 'Hvilken softwarelicens er Jomres frigivet under?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PURCHASINGJOMRES_SOFTWARELICENSE', "Jomres er licenseret under både MIT- og GPL -licenser. Plugins, der downloades af Starter, Business og Enterprise -licenser, frigives under samme licens og er helt gratis og open source -licenser. ikke frigivet under GPL- eller MIT -licenser og er Ioncube -kodet. Denne tilgang giver os mulighed for at tilbyde dig en række forskellige licenser, der passer til alles lommer. ");
...
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_EXTRAS', "Ekstra kan tilføjes til bookinger og konfigureres i Indstillinger> Ekstra. Disse kan enten være valgfri eller 'tvunget', med andre ord kan gæsten ikke fravælge dem i reservationen. Du kan tilbyde forskellige metoder af gebyrer for ekstraudstyr, og om de er vist på din ejendomsoplysningsside eller ej. Fordi ekstramateriale kun kan vises, hvis en reservation er inden for bestemte datoer (f.eks. for sæsonbetonede frugter), bør du sikre dig, at du har angivet datoerne Gyldig fra og Til. Når du har oprettet ekstraudstyr, kan du uploade billeder til dem via Media Manager. ");
...
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_DISCOUNTS', "Der kan gives rabatter, der er en række forskellige måder dette kan gøres på. Hvis du foretager en reservation på vegne af en kunde, kan du angive dine egne indbetalings- og bookingtotaler i reservationsformularen , ved hjælp af felterne \"Tilsidesæt indkvartering i alt \" og \"Tilsidesæt indbetaling \" (gæster kan ikke bruge denne funktion). En anden måde at give en gæst rabat på er at oprette rabatkuponer, som kan konfigureres, så de kan kun bruges mellem bestemte datoer (Gyldig fra/til) eller kun anvendes, når reservationen falder mellem bestemte datoer (Booking gyldig fra/til). Disse rabatkuponer kan tildeles kun en gæst, eller hvis du vil, kan du udskrive kuponer. Udskriften indeholder en QR -kode, som gæsterne kan scanne ind på deres telefoner, der fører dem til din bookingformular med rabatkoden, der allerede er gældende. ");
...
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_MEDIACENTRE_RESOURCEFEATURES', "Rumfunktioner kan oprettes af brugere af Micromanage eller Avancerede takstredigeringsmetoder. Disse kan forbindes til et eller flere værelser og vises i reservationsformularen. Når du har oprettet en rumfunktion, kan du uploade et billede til denne funktion ved først at vælge Ikoner for rumfunktioner i rullemenuen i Media Center og derefter vælge rumfunktionens navn fra rullemenuen, der vises nedenfor. ");
jr_define ('_JOMRES_FAQ_MANAGER_QUESTION_MEDIACENTRE_ROOMS', 'Hvordan uploader jeg rumbilleder?');
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_MEDIACENTRE_RESOURCEFEATURES', 'Værelser kan oprettes af brugere af Micromanage eller Avancerede takstredigeringsmetoder. Når et eller flere rum er oprettet, kan du uploade flere billeder for hvert værelse via Media Center (vælg rumnavnet/nummeret efter at vælge værelsebilleder i rullemenuen). Disse billeder kan ses i et diasshow ved at se siden Preview og vælge fanen Our Rooms og derefter klikke på linket Tilgængelighed. ');
...
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_CURRENCIES_SETUP', 'Hvordan konfigurerer jeg valutasymboler?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_CURRENCIES_SETUP', "Det gør du ikke. Alle valutasymboler er allerede gemt i systemet, og det er op til ejendomsadministratorer at vælge den valuta, der er den rigtige for dem på ejendomskonfigurationssiden.");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_CURRENCIES', 'Hvordan aktiverer jeg flere valutaer?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_CURRENCIES', "Jomres har funktionalitet til automatisk at konvertere priser fra en valuta til en anden. Først skal du besøge fanen Webstedskonfiguration> Valutaomregning. Her finder du links til to onlinetjenester. Den første service, når API er blevet gemt, gør det muligt for Jomres at downloade valutaomregningsdata en gang om dagen. Den anden muliggør IP -baseret geolocation for brugere. Anmod om en gratis API -nøgle fra hver service. Med disse to tjenester kombineret kan Jomres registrere brugerens lokale valuta og vise priser på ejendomme i både gæstens lokale valuta plus hotellets egen valuta. Hvis du ikke konfigurerer disse API -nøgler, vil Jomres som standard anvende euro -valutasymbolet. Hvis du vil, kan du angive en global valutakode. Det betyder, at ejendommen ledere vil ikke være i stand til at vælge andre valutaer, men potentielle gæster vil stadig se priser i deres egen lokale valuta, medmindre de har brugt valutaomskifterfunktionen til at ændre den valuta, som priserne vises i. ");
...
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_PROPERTIES_NUMBER', 'Hvor mange ejendomme kan jeg angive?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_PROPERTIES_NUMBER', "Der er ingen kodet grænse for det antal ejendomme, du kan liste, den eneste begrænsning er i den fysiske begrænsning af selve serveren. Hvis det er en server med mange andre konti på, vil ressourcer være begrænset, hvis , på den anden side er det en dedikeret eller virtuel dedikeret server, så vil du være i stand til at liste mange flere egenskaber. ");
...
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_GUESTTYPES', "I fanen Indstillinger> Ejendomskonfiguration> Tariffer og valutaer kan du beslutte, om du vil opkræve per person per nat. Hvis du opkræver per person per nat, skal du oprette en eller flere gæstetyper. Du kan oprette en simpel gæstetype, hvor du bare giver dem en beskrivelse (f.eks. 'Personer'), eller du kan oprette flere forskellige gæstetyper, f.eks. 'Voksne' og 'Børn under 10'. For børnene, hvis du vil for at tilbyde en rabat på 50%, så ville du indstille 'Er procentdel' til Ja og afvigelsesværdien til 50. Værelserne har grundpriser, denne indstilling giver dig mulighed for at justere prisen på værelset baseret på gæstetypen. ") ;
jr_define ('_JOMRES_FAQ_MANAGER_QUESTION_ROOMFEATURES', 'Hvad er rumfunktioner?');
jr_define ('_JOMRES_FAQ_MANAGER_ANSWER_ROOMFEATURES', "Værelsesfunktioner er ting, der får rummet til at skille sig ud. Det kan være noget simpelt som te- og kaffefaciliteter, eller det kan være ting, der virkelig får rummet til at hæve sig over de andre, f.eks. Udsigt over bay '. Når du har oprettet en rumfunktion, kan du uploade billeder for denne funktion i Media Center. Disse rumfunktioner kan ses på værelsets tilgængelighedsside, og hvis du har konfigureret din ejendom til at vise klassiske værelser -listestil (hvor gæsterne kan vælge præcis hvilket værelse, de vil booke), så kan de bruge værelsesfunktionerne til at filtrere ooms vist i reservationsformularen. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_PROFILES', 'Kan jeg gøre en bruger til ejendomsadministrator?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_PROFILES', "Ja det kan du via ejendomsadministrator -siden under Brugeradministration. Hvis brugeren allerede er registreret, skal du indtaste de første få tegn i deres brugernavn og deres brugernavn i input øverst på siden Ejendomsadministratorer. vises nedenunder. Klik på deres brugernavn, og du vil blive taget til en side, hvor du kan konfigurere, hvilke egenskaber de har adgang til. Hvis de ikke allerede er registreret, skal du først bruge dit værts -CMSs brugeradministrationssider til at tilføje dem som bruger til CMS. <br/> <br/> Et råd: Hvis du har til hensigt at opkræve ejendomsadministratorer for at notere deres ejendomme på dit websted, enten ved at tage kommission via Stripe -gateway eller abonnementer/provision -funktionalitet, vi anbefaler ikke, at du tilføjer brugere på denne måde. I dette tilfælde bør der kun tilføjes super ejendomsadministratorer ved hjælp af denne proces, og når de tilføjes, bør du ikke vælge nogen egenskaber på listen herunder. Alt andet brugere bør tilskyndes til selv at oprette ejendomme i frontend. Dette tilføjer dem som ejendomsadministratorer automatisk og sikrer, at den korrekte bruger bliver faktureret. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_PLUGINS', 'Plugins');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_GENERAL_PLUGINS', 'Hvad er Plugin Manager til?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_GENERAL_PLUGINS', 'Plugin Manager er et vigtigt værktøj i Jomres. Det giver os mulighed for at distribuere den mest opdaterede version af Jomres-plugins til dig via en automatisk download- og installationsfunktion.');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_GENERAL_PLUGINS_IONCUBE', 'Hvorfor får jeg vist en advarsel om Ioncube Loaders, når jeg klikker på siden Plugin Manager?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_GENERAL_PLUGINS_IONCUBE', "Du har gemt en prøvelicensnøgle i webstedskonfiguration, men din webserver tilbyder ikke de nyeste Ioncube Loaders. Spørg dine værter om at installere læsserne, som kan findes <a href = 'http://www.ioncube.com/loaders.php' target ='_blank'> på denne side. </a> Hvis du har købt en fuld licens uden abonnement, og du tror, ​​at du ser dette ved en fejl, kan du muligvis har glemt at indtaste din fulde licensnøgle på siden Konfiguration af websted. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_GENERAL_PLUGINS_INSTALLATION', 'Hvordan installerer jeg et plugin?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_GENERAL_PLUGINS_INSTALLATION', "Forudsat at du har gemt et gyldigt licensnøglenummer i sitekonfiguration, skal du blot klikke på knappen Installer ved siden af ​​pluginnavnet i pluginhåndteringen. Jomres installerer plugin for dig og bringer med dig du vender tilbage til pluginsiden bagefter. Nogle gange kan du i stedet blive taget til en Discovery -side, hvis du kører Jomres i Joomla. Klik bare på knappen Discover for at installere plugin'et. <br/> <br/> NOTE Don ' t installere alle plugins, de fungerer ikke alle sammen (efter design). Du kan ende med tomme sider i reservationsformularen. I stedet identificere de plugins, du har brug for, og eksperimentere med hver enkelt. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_SITESTRUCTURE', 'Site Structure');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_INTRO', 'Hvad betyder webstedsstruktur?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_INTRO', "Sitestruktur i Jomres refererer til de forskellige elementer på dit websted, der gør det unikt. Det definerer de ejendomstyper, du viser til (f.eks. villaer eller hoteller) og værelsestypen/undertyperne for disse ejendomstyper. Så , hvis du sælger ferieboliger med egen forplejning, vil du sælge huslejer af noget som en hytte eller villa. <em> i </em> ejendommen, og de ville være soveværelser med dobbeltsenge, singler osv. For at afklare dette har en standardinstallation allerede oprettet flere værelser og ejendomstyper, så du kan forstå. Hvis du vil sælge Ture, prøv ikke at oprette en ny ejendomstype uden først at læse afsnittet om ture. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_PROPERTYTYPES', 'Hvad er ejendomstyper?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_PROPERTYTYPES', 'I dette system refererer en egenskabstype til bogstaveligt talt ejendomstypen. Dette kan være et hotel, en villa, en lejlighed. Ejendomsforvaltere kan ikke oprette ejendomstyper, fordi ejendomstyper er en vare, der kan blive søgt af gæster. For at sikre, at din søgefunktionalitet forbliver pæn og pæn, er det kun webstedsadministratorer, der kan oprette ejendomstyper. ');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_PROPERTYFEATURES', 'Hvad er egenskabsfunktioner?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_PROPERTYFEATURES', "Egenskabsfunktioner er ting, der gør en ejendom unik. F.eks. kan en ejendomsfunktion være, at det er 'Tæt på stranden', mens et andet hotel kan have funktionen, at det er inde i en nationalpark, der tilbyder bro, sådan noget. Ligesom ejendomstyper kan ledere ikke oprette nye funktioner, de kan kun vælge mellem dem, du opretter. Ejendomsfunktioner kan have billeder tildelt dem. Først skal du uploade funktionsbilleder via Site Strucutre> Media Center> Ejendomsfunktion Ikoner dropdown. Upload så mange funktionsikoner som du vil, så når du opretter en egenskabsfunktion, kan du vælge det billede. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_PROPERTYFEATURECATEGORIES', 'Hvad er egenskabskategorier?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_PROPERTYFEATURECATEGORIES', "Egenskabsfunktioner vises på siden Ejendomsoplysninger blandt andet. På ejendomsdetaljesiden kan funktioner vises grupperet efter kategorier, f.eks. 'Opholdsområde', 'Tilgængelighed' osv.)");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_ROOMFEATURES', 'Hvad er rumfunktioner?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_ROOMFEATURES', "Ejendomsadministratorer, der bruger Micromanage eller Avanceret takstredigeringsfunktion, kan redigere deres værelser direkte. De kan også oprette ting kaldet Værelsesfunktioner, der vises på siden Værelsestilgængelighed for hver ejendom. Hvis de brug visningen af ​​klassiske værelser i reservationsformularen, så kan gæsterne bruge Værelsesfunktioner til at filtrere værelser ud, før de vælger et eller flere. kan ses i alle ejendomsbestillingsformularer, hvor ejendommen bruger listen over klassiske værelser. Grundlæggende er det en global værelsesfunktion. Disse rumfunktioner kan konfigureres til kun at blive vist for bestemte ejendomstyper, og billeder for disse rumfunktioner kan uploades via webstedsstrukturen> Media Center -siden. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_SITESTRUCTURE_COUNTRIES', 'Hvorfor er der en side til redigering af lande/regioner?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_SITESTRUCTURE_COUNTRIES', "Du skulle tro, at en liste over lande var temmelig uforanderlig, men du ville tage fejl. I årenes løb har vi set mange ændringer i løbet af årene, og derfor har vi set lært, at det var nemmest at tillade webstedsadministratorer at definere de lande, de gerne vil vise på webstedet. Dette gør det muligt for den hårdføre catalan at vise deres provins som et unikt land, hvis det er den erklæring, de gerne vil komme med. Det samme gælder for andre regioner i verden. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_LOCALISATION', 'Lokalisering/oversættelse');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_LOCALISATION_INTRO', 'Hvordan oversætter jeg ting?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_LOCALISATION_INTRO', "Oversættelse af etiketter/strenge udføres via menuindstillingerne Sprog, hovedsageligt siderne Oversæt sprogfil/Oversæt lokaliteter. Fordi sprogfilerne er meget store, kan de tage et stykke tid at klikke på denne side, når du klikker på denne side load. <br/> <br/> Lad os se på et eksempel. Lad os sige, at du vil oversætte Tyskland til Deutschland. Klik først på Oversæt lokaliteter. Kontroller derefter rullemenuen med sprog øverst til højre fra engelsk til tysk. Rul derefter ned på siden, indtil du kommer til Tyskland. Du kan se, at den har en stiplet understregning. Det betyder, at du kan oversætte det. Klik på ordet, du vil se en popup, der indeholder ordet 'Tyskland'. Skift dette til 'Deutschland', og klik på det grønne flueben. Hvis dit værts-CMS er konfigureret til at tilbyde sidebesøgende tysksprogede sider, vil ordet 'Tyskland' nu blive vist som 'Deutschland'. Dette koncept gælder gennemgående Jomres. <br/> <br/> På ejendomsadministrator -siderne kan ejendomsadministratorer også se rullelisten Etiketredigeringstilstand øverst på deres sider. Når dette er sat til Til, vil de også være i stand til at foretage ændringer i frontend, men disse ændringer vil kun påvirke deres aktuelt aktive ejendom, så de kan f.eks. Nemt ændre ordet Tariffer til Priser for kun en ejendom, hvis det er det påkrævet. ");
jr_define ('_JOMRES_FAQ_ADMIN_CATEGORY_TOURS', 'Tours');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_INTRO', 'Hvad er ture?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_INTRO', "Det lyder måske som et fjollet spørgsmål, men det er det faktisk ikke. I årenes løb har vi lært, at forskellige kulturer har forskellige opfattelser af, hvad en 'tour' er. Som følge heraf forventninger om salg af ture variere meget, så før vi diskuterer ture, definerer vi først, hvad vi synes om ture. <br/> En tur er en simpel rejse eller et besøg for at se en attraktion eller et monument. Et ophold på et hotel er dog ikke en tur ture kan deltages i mens du bor på et hotel. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_HOWTOSELL', 'Hvordan bruger jeg Jomres til at sælge ture?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_HOWTOSELL', 'For at løse spørgsmålet om salg af ture i Jomres skal du først installere Jintour -pluginet. Dette plugin giver dig mulighed for at oprette ture, der sælges som en del af ferieboliger. Det giver dig også mulighed for at oprette ejendomme der udelukkende er til salg af ture. Når dette plugin er installeret, kan ejendomsadministratorer oprette Tours og Tour -ejendomme i frontend. ');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_WHATISJINTOUR', 'Hvad er Jintour -pluginet?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_WHATISJINTOUR', 'Jintour står for Jomres Integrerede TURER. Det giver dig mulighed for at oprette enkle, begrænsede ressourcer, der kan reserveres, som ikke er lokaler i en ejendom. Mens plugin et primært er designet til at tillade bookinger af ture kan bruges til mange ting, ikke kun ture. De kan f.eks. bruges af en skihytte, der ønsker at leje ski og grej ud. Da dette udstyr vil have begrænset tilgængelighed, kan du bruge Jintour -pluginet til at give gæsterne mulighed for at reserver og betal for dette gear ved bookingtidspunktet. ');
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_SAMEBOOKING', 'Hvordan sælger jeg ture og ferieboliger i samme booking?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_SAMEBOOKING', "I dette scenario har du et hotel, og du vil sælge ture til en lokal attraktion. Log ind på frontend og gå til hotellet, du har oprettet. Klik derefter på Indstillinger> Tour /Aktivitetsstyring. På denne side skal du følge instruktionerne på skærmen for først at oprette en turprofil og derefter generere ture. Når det er gjort, kan du sælge både ture og værelsesreservationer og ekstraudstyr ved siden af ​​hinanden i den samme reservationsformular . ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_STANDALONETOURS', 'Hvad med hvis jeg kun vil sælge ture?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_STANDALONETOURS', "Først skal du oprette en ny ejendom i frontend. Når du gør det, skal du sørge for at angive 'Egenskabstype' til Tour. Når du har oprettet denne nye ejendom, vil du kunne for at oprette ture igen via siden Indstillinger> Tour/Aktivitetsstyring. Du vil også kunne tilbyde ekstraudstyr som i normale ejendomme, det eneste du ikke vil være i stand til at konfigurere værelser, rumfunktioner eller takster som dig ' sælger ikke værelser i denne ejendom. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_TOURS_GLOBALTOURS', 'Hvordan kan jeg oprette en rundvisning/reserverbar ressource, der kan ses i alle ejendomsreservationsformularer?');
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_TOURS_GLOBALTOURS', "I administratorområdet på dit websted skal du besøge siden Portal> Funktionalitetstur/aktivitetsstyring. Turprofilen/generationsprocessen er den samme som bruges i frontend, men alle genererede ture ses her på siden frontend. Et typisk scenario, hvor dette kan bruges, er, hvis webstedsadministratoren arrangerer begivenheder rundt om i landet, og de vil sælge hotelreservationer. De ville oprette de deltagende hoteller i frontend som normalt, fastsætte værelsespriser osv., derefter ture 'i dette tilfælde ville faktisk være fremmødegebyret for selve arrangementet. ");
jr_define ('_JOMRES_FAQ_ADMIN_QUESTION_INTRODUCTION_FIRSTTHINGSFIRST', "Ok, jeg har installeret Jomres, hvad så?");
jr_define ('_JOMRES_FAQ_ADMIN_ANSWER_INTRODUCTION_FIRSTTHINGSFIRST', "Det allerførste, du skal gøre, nu hvor du har installeret Jomres, er at klikke på Hjælp i menuen til venstre, derefter klikke på Kom godt i gang. Alvorligt, gå væk og gør det nu.") ;
