...
jr_define( '_JOMRES_FRONT_IMAGEUPLOADS_INFO', '
...
jr_define( '_JOMRES_A_GLOBALPFEATURES_INFO', 'כדי להקצות תמונה למאפיין הזה, יש קודם לעלות תמונת נכס ל-/images/stories/jomres/pfeatures/' );
...
jr_define( 'JOMRES_COM_A_MAPSKEY_DESC', 'פקודת GET יכולה לקבל ממשק למפת גוגל מהאתר<a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google maps</a>. לאחר שהכנסת את מפתח המפה שלך במקום זה, גומרס יראה את המפה בדף פרטי הנכס שלך' );
