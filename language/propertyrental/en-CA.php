...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_REQUIRED_REGION', 'Province is required' );
...
jr_define( '_JOMRES_SORTORDER_PROPERTYREGION', 'Property Province' );
...
jr_define( '_JOMRES_COM_SEF_PROPERTY_URL_REGION', 'Add Province to url' );
...
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_REGION', 'Search URL Structure - Add Province to url' );
jr_define( '_JOMRES_COM_SEF_SEARCH_URL_REGION_DESC', '' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_REGION', 'Search URL Structure - Default Province' );
jr_define( '_JOMRES_COM_SEF_DEFAULT_REGION_DESC', 'If all your properties are in one Province then you will not have Province in the search - enter a default Province here if you want to display a Province' );
