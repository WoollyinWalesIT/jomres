...
jr_define( '_JOMRES_COM_MR_NEWPROPERTYFEATURE', 'Nové vybavenie ubytovacieho zariadenia' );
...
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_TITLE', 'Priradenie užívateľských profilov' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_ID', 'ID' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_NAME', 'Meno' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_USERNAME', 'Užívateľské meno' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDHOTELUSER', 'Aktuálne autorizované' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL', 'Prednastavené ubytovacie zariadenie' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDCHANGETHIS', 'Zmeniť' );
...
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_LEVEL_RECEPTION', 'Recepcia' );
jr_define( '_JOMRES_COM_MR_ASSIGNUSER_LEVEL_ADMIN', 'Manažér ubytovacích zariadení' );
// Edit bookings
jr_define( '_JOMRES_COM_MR_EDITBOOKING_ADMIN_TITLE', 'Vsetky rezervácie' );
jr_define( '_JOMRES_COM_MR_EDITBOOKING_ADMIN_NEWBOOKINGS', 'Nové rezervácie (bez zálohy)' );
...
jr_define( '_JOMRES_COM_MR_DISPGUEST_CCARDNO', 'Číslo kreditnej karty' );
jr_define( '_JOMRES_COM_MR_DISPGUEST_CCARDISS', 'Karta vystavená' );
jr_define( '_JOMRES_COM_MR_DISPGUEST_CCARDEXPIRE', 'Platnosť kreditnej karty do' );
jr_define( '_JOMRES_COM_MR_DISPGUEST_CCARISSNO', 'Číslo karty' );
jr_define( '_JOMRES_COM_MR_DISPGUEST_CCARDNAME', 'Meno uvedené na karte' );
...
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP4_NUMBEROFGUESTS', 'Počet hostí' );
...
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_HEADER_DISABLEDACCESS', 'Pre hendikep.?' );
...
jr_define( '_JOMRES_COM_MR_VRCT_ROOM_SAVE_INSERT', 'Izba pridaná' );
...
jr_define( '_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE', 'Typ izby aktualizovaný' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT', 'Ubytovacie zariadenie pridané' );
...
jr_define( '_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_INSERT', 'Vybavenie ubyt. zariadenia pridané' );
...
jr_define( '_JOMRES_COM_MR_LISTTARIFF_SAVE_INSERT', 'Cenník pridaný' );
jr_define( '_JOMRES_COM_MR_LISTTARIFF_SAVE_UPDATE', 'Cenník aktualizovaný' );
...
jr_define( '_JOMRES_COM_MR_PUBLICHOLIDAY_TITLE', 'Štátny sviatok' );
...
jr_define( '_JOMRES_FRONT_MR_MENU_ADMIN_LISTNEWBOOKINGS', 'NOVÉ rezervácie' );
...
jr_define( '_JOMRES_FRONT_MR_SUBMITBUTTON_CONFIRMYOURDETAILS', 'Potvdenie zadaných údajov' );
...
jr_define( '_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE', 'Rezervácia na: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM', 'Rezervácia izby: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_ARRIVAL', 'Príchod: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_DEPARTURE', 'Odchod: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_NAME', 'Meno: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_LANDLINE', 'Telefón - pevná: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_MOBILE', 'Telefón - mobil: ' );
jr_define( '_JOMRES_FRONT_MR_EMAIL_TEXT_TOTAL', 'Cena objednávky: ' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_TITLE', 'Ubytovanie hosťa' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_SELECTBUTTON', 'Vybrať hosťa' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_GUESTBOOKEDIN', 'Hosť ubytovaný' );
jr_define( '_JOMRES_FRONT_MR_BOOKIN_NOGUESTSDUEIN', 'Dnes už nezostávajú žiadni neubytovaní dnes prichádzajúci hostia' );
jr_define( '_JOMRES_FRONT_MR_BOOKOUT_TITLE', 'Ukončiť ubytovanie hosťa' );
jr_define( '_JOMRES_FRONT_MR_BOOKOUT_NOGUESTSDUEOUT', 'K dnešnému dňu už nezostávajú žiadni dnes odchádzajúci hostia' );
// Config panel
jr_define( '_JOMRES_COM_A_SUPPLIMENTS', 'Príplatky' );
jr_define( '_JOMRES_COM_A_TARIFFS', 'Cenníky & meny' );
jr_define( '_JOMRES_COM_A_DISCOUNTS', 'Zľavy' );
jr_define( '_JOMRES_COM_A_JOMRES_FILE_UPLOADS', 'Upload súboru' );
jr_define( '_JOMRES_COM_A_CURRENT_SETTINGS', 'Aktuálne nastavenie' );
jr_define( '_JOMRES_COM_A_EXPLANATION', 'Vysvetlenie' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_TITLE', 'Potvrdenie rezervácie' );
jr_define( '_JOMRES_COM_CONFIRMATION_DEAR', 'Vážený(-á) ' );
jr_define( '_JOMRES_COM_CONFIRMATION_RATE_RULES', 'Cena za noc - za izbu ' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_DETAILS', 'Detaily objednávky' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_INTRO1', 'Ďakujeme za Vašu rezerváciu v' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_INTRO2', '. Nižšie uvedený je sumár Vašej rezervácie. Prosíme overte, či sú uvedené informácie, hlavne kontaktné, v poriadku a ak nie, dejte nám prosím obratom vedieť.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN', 'Vaša izba Vám je k dispozicií ihneď po Vašom príchode, od 14.00 hod.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_LOOKFORWARD', 'Tešíme sa na stretnutie' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_HAVEAPLEASANTSTAY', 'Dúfame, že sa Vám bude pobyt páčiť.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINTINTRO', 'Teraz prosím venujte pozornosť podmienkam.' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE', 'Neposkytujú sa žiadne kompenzácie v prípade neobsadenia rezervovaných izieb, či neskonzumovania objednaných jedál. Pre tieto prípady odporúčame využiť poisťovacie služby.' );
...
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_30DAYSPLUS', '30 dní a viac' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_DEPOSITONLY', ' Iba záloha.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_1530DAYS', '15 až 30 dní' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_50PERCENT', ' 50% z celkovej sumy.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_ARRIVALDATETO14DAYS', 'Deň príchodu do 14 dní' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_100_PERCENT', ' 100% z celkovej sumy.' );
jr_define( '_JOMRES_COM_CONFIRMATION_RESERVATION_VAT', 'DPH 19%. Každá zmena sa odrazí na cene.' );
...
jr_define( '_JOMRES_COM_INVOICE_CONTRACTAGREED', 'Zmluva uzavretá: ' );
jr_define( '_JOMRES_COM_INVOICE_COSTPERNIGHT', 'Cena za noc: ' );
jr_define( '_JOMRES_COM_INVOICE_LETTER_GRANDTOTAL', 'Spolu' );
jr_define( '_JOMRES_COM_INVOICE_LETTER_INTRO1', 'Ďakujeme za Váš pobyt v ' );
jr_define( '_JOMRES_COM_INVOICE_LETTER_HOPEYOUENJOYEDSTAY', 'Dúfame, že aj nabudúce využijete naše služby.' );
...
jr_define( '_JOMRES_COM_ADDSERVICE_TOTALVALUE', 'Ostatné účtované položky, spolu: ' );
...
jr_define( '_JOMRES_FILE_ERROR_TYPE', 'Môžete uploadovat iba súbory typu type:\n' );
jr_define( '_JOMRES_FILE_ERROR_EMPTY', 'Pred uploadom najprv vyberte požadovaý súbor.' );
jr_define( '_JOMRES_FILE_ERROR_NAME', 'Názov súboru musí obsahovať len alfanumerické znaky a žiadne medzery.' );
jr_define( '_JOMRES_FILE_ERROR_SIZE', 'Veľkosť súboru prekračuje maximálnu veľkosť nastavenú administrátorom.' );
jr_define( '_JOMRES_FILE_NOT_UPLOADED', 'Súbor aleboL nahraný.' );
jr_define( '_JOMRES_FILE_UPDATED', 'Súbor bol úspešne nahraný.' );
jr_define( '_JOMRES_COM_A_JSCALENDAR', 'JS kalendár' );
jr_define( '_JOMRES_COM_A_CALENDARLANGUAGE', 'Jazyk JS kalen.' );
jr_define( '_JOMRES_COM_A_CALENDARLANGUAGE_DESC', 'Vyberte požadovaný jazykový súbor JS kalendára. Upozornenie - niektoré kalendáre môžu obsahovať chyby, viac informácií na http://sourceforge.net/tracker/?group_id=75569&atid=544287' );
jr_define( '_JOMRES_COM_A_CALENDARCSS', 'JS kalendár CSS súboru' );
jr_define( '_JOMRES_COM_A_CALENDARCSS_DESC', 'Zvoľte CSS súbor pre použitie s JS kalendárom' );
...
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS', 'Typ izby nemožno odstrániť kvôli existujúcim väzbám. Zrušte väzby na typ izby a skúste znovu.' );
jr_define( '_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS', 'Vybavenie izby nemožno odstrániť kvôli existujúcim väzbám cenníku. Zmeňte cenníkové väzby a skúste znovu.' );
...
jr_define( '_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC', 'Vhodné pri prenájme celého ubyt. zariadenia, nielen jednotlivých izieb v ňom. V tomto prípade sa uistite, že ubyt. zariadenie má v systéme len jednu izbu.' );
...
jr_define( '_JOMRES_COM_INVOICE_ACTUALROOMCOST', 'Aktuálna cena izby: ' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_HELLO', 'Dobrý deň' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_THANKS', 'Ďakujeme za rezerváciu v' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_SUMMARY', 'Nasleduje zhrnutie rezervácie:' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_ANYQUESTIONS', 'Ak máte akékoľvek otázky týkajúce sa  rezervácie, alebo iných služieb, neváhajte a kontaktujte nás.' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_TELEPHONE', 'Naše telefónne číslo je' );
jr_define( '_JOMRES_FRONT_GUEST_EMAIL_TEXT_EMAIL', 'Prípadne nás kontaktujte emailom' );
jr_define( '_JOMRES_COM_MR_QUICKRES_STEP2_ROOMSMOKING', 'Fajčiar? ' );
jr_define( '_JOMRES_FRONT_ROOMSMOKING_EITHER', 'Ľubovoľné' );
jr_define( '_JOMRES_COM_CALENDAROUTPUT', 'Formát výstupu kalendára' );
jr_define( '_JOMRES_COM_CALENDAROUTPUT_DESC', 'Umožňuje užívateľovi meniť formát výstupu kalendára Jomres.' );
...
jr_define( '_JOMRES_MR_AUDIT_LISTING_OPERATION', 'Činnosť' );
jr_define( '_JOMRES_MR_AUDIT_LISTING_VIEWSQL', 'Zobraziť detaily' );
jr_define( '_JOMRES_MR_AUDIT_LISTING_FILTER_DATE', 'Podľa dátumu' );
jr_define( '_JOMRES_MR_AUDIT_LISTING_FILTER_USERNAME', 'Podľa užívateľa' );
jr_define( '_JOMRES_MR_AUDIT_LISTING_FILTER_OPERATION', 'Podľa činnosti' );
...
jr_define( '_JOMRES_MR_AUDIT_UNKNOWNUSER', 'Neznámy užívatel' );
...
jr_define( '_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE', 'Vytvor. typ izby' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE', 'Aktualiz. typ izby' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE', 'Odstrán. typ izby' );
...
jr_define( '_JOMRES_MR_AUDIT_INSERT_PROPERTY_FEATURE', 'Vytvorenie vybavenia ubyt. zariadenia' );
jr_define( '_JOMRES_MR_AUDIT_UPDATE_PROPERTY_FEATURE', 'Aktualizácia vybavenia ubyt. zariadenia' );
jr_define( '_JOMRES_MR_AUDIT_DELETE_PROPERTY_FEATURE', 'Odstránenie vybavenia ubyt. zariadenia' );
...
jr_define( '_JOMRES_MR_AUDIT_DELETE_TARIFF', 'Odstránený cenník' );
jr_define( '_JOMRES_MR_AUDIT_ADDSERVICE', 'Pridaná cena služieb' );
jr_define( '_JOMRES_MR_AUDIT_BOOKEDGUESTIN', 'Ubytovaný hosť' );
jr_define( '_JOMRES_MR_AUDIT_BOOKEDGUESTOUT', 'Odhlásený hosť' );
...
jr_define( '_JOMRES_MR_AUDIT_DELETE_GUEST', 'Odstránený hosť' );
...
jr_define( '_JOMRES_COM_MR_BLACKBOOKINGS_VIEWBLACKBOOKING', 'Zobraziť čierne rezervácie' );
...
jr_define( '_JOMRES_COM_A_SMOKING', 'Zobraziť fajčiarske?' );
jr_define( '_JOMRES_COM_A_SMOKING_DESC', 'Na zobrazenie fajčiarskych priestorov nastavte ÁNO.' );
...
jr_define( '_JOMRES_COM_A_SMOKING_OPTION', 'Východzia hodnota poľa "Fajčiar"' );
jr_define( '_JOMRES_COM_A_CURRENCYSYMBOL', 'Symbol meny' );
jr_define( '_JOMRES_COM_A_CURRENCYSYMBOL_DESC', 'Napr.&amp&euro;&#59; Na zobrazenie meny použite HTML kód podľa danej entity, viac informácií na <a href="http://www.w3schools.com/tags/ref_entities.asp">w3schools</a>' );
jr_define( '_JOMRES_COM_A_CURRENCYCODE', 'Kód meny' );
jr_define( '_JOMRES_COM_A_CURRENCYCODE_DESC', 'Napr. SKK. Tento symbol bude použitý v emaile potvrdzujúcom rezerváciu.' );
...
jr_define( '_JOMRES_COM_A_TAX_WARNING', '<font color=red>UPOZORNENIE: Nastavenie oboch hodnôt na ÁNO sa nedoporúča, vyberte jednu z ponúknutých daňových schém tak, aby zodpovedala podmienkam Vášho trhu.</FONT>' );
jr_define( '_JOMRES_COM_FRONT_ROOMTAX', 'Daň' );
jr_define( '_JOMRES_COM_A_ROOMTAX', 'Daň za izbu' );
jr_define( '_JOMRES_COM_A_ROOMTAX_DESC', 'Vytvorené pre americký trh, kde sa používa daň za izbu. Vyberte buď fixnú, alebo percentuálnu daň (% z ceny izby).' );
...
jr_define( '_JOMRES_MR_AUDIT_ARCHIVED_MESSAGE', ' Záznamy zálohované' );
jr_define( '_JOMRES_MR_AUDIT_ARCHIVED_AUDIT', 'Systém zarchivoval auditované záznamy' );
...
jr_define( '_JOMRES_COM_A_EDITING_CURRENTTEXT', 'Aktuálny text' );
...
jr_define( '_JOMRES_COM_A_AUDITING_SHOWING', 'Počet nezarchivovaných záznamov: ' );
...
jr_define( '_JOMRES_COM_PTYPES_UNABLETO_DELETE', 'Odstránenie typu ubyt. zariadenia neúspešné. Typ ubyt. zariadenia je priradený k jednému alebo viecerým ubyt. zariadeniam. Pred odstránením je nutné im priradiť iný platný typ ubyt. zariadenia.' );
...
jr_define( '_JOMRES_INVOICE_SIGNEDONBEHALFOF', 'V mene spoločnosti podpísaný' );
// V1.4
...
jr_define( '_JOMRES_COM_A_GATEWAY_USEGATEWAYS_DESC', 'Ak chcete používať online platobné brány, zadajte hodnotu ÁNO.<b>Upozornenie:</b>Toto nevypína kalkulácie záloh, ktoré prebiehajú počas rezervácie, vypnúť kalkulácie je možné len odstránením elementov záloh priamo v šablónach izieb.' );
...
jr_define( '_JOMRES_MR_AUDIT_CREDITCARD_VIEWED', 'Zobrazené kreditné karty' );
jr_define( '_JOMRES_MR_AUDIT_CREDITCARD_UPDATED', 'Aktualizované kreditné karty' );
jr_define( '_JOMRES_MR_CREDITCARD_EDIT', 'Upraviť kreditnú kartu' );
jr_define( '_JOMRES_COM_A_EDITICON', 'Upraviť veľkosť ikon' );
jr_define( '_JOMRES_JR_A_IMAGEHANDLING_BATCHUPLOAD', 'Dávkový upload obrázkov ubyt. zariadenia' );
jr_define( '_JOMRES_JR_A_IMAGEHANDLING_IMAGESALREADYINDIR', 'Obrázky už existujú' );
...
jr_define( '_JOMRES_COM_A_SLIDESHOW_THUMBSIZE', 'Výška náhľadu prezentácie' );
jr_define( '_JOMRES_FRONT_SLIDESHOW', 'Prezentácia' );
jr_define( '_JOMRES_COM_A_SLIDESHOWS_NOIMAGES', '<br />Prepáčte, k danému ubyt. zariadeniu niesú k dispozícií žiadne obrázky. Na nahratie obrázku použite dávkový upload obrázkov.' );
...
jr_define( '_JOMRES_COM_A_POPUPSALLOWED_DESC', 'Ak nastavíte NIE, budú linky otvorené inline namiesto v pop-up oknách. EXPERIMENTÁLNE! ' );
jr_define( '_JOMRES_FRONT_IMAGEUPLOADS', 'Upload obrázkov prezentácie' );
jr_define( '_JOMRES_FRONT_IMAGEUPLOADS_INFO', 'Na upload obrázkov tohoto ubyt. zariadenia použite formulár. <br/><b>Upozornenie:</b> Akékoľvek obrázky rovnakého názvu budú prepísané novšími. Tento formulár nenahráva obrázky konkrétnych izieb, či záhlavia ubyt. zariadení. Na to slúži sekcia Správa ubyt. zariadení. <br/><b>Poznámka:</b> Nahrané obrázky budú uložené do adresára /images/stories/jomres/*property_uid*. Ak adresár neexistuje, bude vytvorený.' );
...
jr_define( '_JOMRES_A_GLOBALPFEATURES_DESC', 'Ak chcete, aby všetky ubyt. zariadenia používali len vybavenie zadané webmasterom, vyberte hodnotu ÁNO.' );
jr_define( '_JOMRES_A_GLOBALPFEATURES_INFO', 'Na priradenie obrázku k tomuto vybaveniu musíte najskôr nahrať obrázky ubyt. zariadenia do adresára /images/stories/jomres/pfeatures/' );
...
jr_define( '_JOMRES_COM_MR_DISPGUEST_CCV', 'CCV bezpečnostný kód' );
//v1.4c
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWTARIFFS', 'Zobraziť ceny' );
...
jr_define( '_JOMRES_COM_A_BASICTEMPLATE_SHOWTARIFFS_TITLE', 'Zobraziť cenníky pod touto linkou' );
...
jr_define( '_JOMRES_A_GLOBALROOMTYPES_DESC', 'Ak chcete použiť obecné nastavenia typu izieb nastavené webmasterom pri všetkých izbách, zadajte hodnotu ÁNO. Toto nastavenie je nutné aj v prípade, ak chcete vyhľadávať podľa typu izby.' );
...
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1', 'Uveďte krajinu a región ubyt. zariadenia.' );
jr_define( '_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_1', 'Uveďte všetky detaily Vášho ubyt. zariadenia.' );
...
jr_define( '_JOMRES_REGISTRATION_NOTALLOWED', "Prepáčte, pred pridaním ubyt. zariadenia sa musíte prihlásiť do systému a nemať ešte vytvorenú žiadne iné." );
jr_define( '_JOMRES_REGISTRATION_CREATEDPROPERTY', 'Vytvorené ubyt. zariadenie: ' );
jr_define( '_JOMRES_REGISTRATION_CREATEDPROPERTY_FORUSER', 'Užívateľovi: ' );
// v1.4i
...
jr_define( '_JOMRES_MR_AUDIT_PUBLISH_CUSTOMERTYPE', 'Publikovaný typ hostí' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_SMOKING_INVALID', 'Fajčiar - neplatné' );
...
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_EMAIL_INVALID', 'E-mailová adresa neplatná' );
jr_define( '_JOMRES_BOOKINGFORM_MONITORING_CANNOT_VALIDATE_EMAIL', 'Overenie emailovej domény neúspešné' );
...
jr_define( '_JOMRES_COM_USERIS_SUPERPROPERTYMANAGER', 'Super manažér ubytovacích zariadení' );
...
jr_define( '_JOMRES_PATHWAY_PROPERTYLIST', 'Zoznam ubytovacích zariadení' );
