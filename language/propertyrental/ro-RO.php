...
// Jomres 3.1.11
// Jomres 3.1.13
if ( !defined( '_PN_OF' ) ) jr_define( '_PN_OF', 'din' );
if ( !defined( '_PN_START' ) ) jr_define( '_PN_START', 'Start' );
if ( !defined( '_PN_PREVIOUS' ) ) jr_define( '_PN_PREVIOUS', 'Precedent' );
if ( !defined( '_PN_NEXT' ) ) jr_define( '_PN_NEXT', 'Urmator' );
if ( !defined( '_PN_END' ) ) jr_define( '_PN_END', 'Sfarsit' );
if ( !defined( '_PN_RESULTS' ) ) jr_define( '_PN_RESULTS', 'Rezultate' );
