...
if ( !defined( '_PN_START' ) ) jr_define( '_PN_START', 'Başla' );
if ( !defined( '_PN_PREVIOUS' ) ) jr_define( '_PN_PREVIOUS', 'Əvvəlki' );
if ( !defined( '_PN_NEXT' ) ) jr_define( '_PN_NEXT', 'Sonrakı' );
if ( !defined( '_PN_END' ) ) jr_define( '_PN_END', 'Son' );
if ( !defined( '_PN_RESULTS' ) ) jr_define( '_PN_RESULTS', 'Nəticə' );
...
jr_define('TOUR_ID_TOUR_TARGET_MEDIACENTRE_INTRODUCTION_TITLE' , "Media Mərkəzi." );
