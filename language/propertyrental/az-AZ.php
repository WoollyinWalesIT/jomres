...
jr_define('_JOMRES_COM_MR_NEWPROPERTYFEATURE', 'Yeni evin xüsusiyyətiləri');
...
jr_define('_JOMRES_COM_MR_ASSIGNUSER_NAME', 'Ad');
...
jr_define('_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL', 'Mövcud olan ev');
jr_define('_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDCHANGETHIS', 'Bunu dəyişdirin');
...
jr_define('_JOMRES_COM_MR_ASSIGNUSER_LEVEL_RECEPTION', 'Qəbul');
jr_define('_JOMRES_COM_MR_ASSIGNUSER_LEVEL_ADMIN', 'Evin meneceri');
jr_define('_JOMRES_COM_MR_EDITBOOKING_ADMIN_TITLE', 'Bütün bronlar');
jr_define('_JOMRES_COM_MR_EDITBOOKING_ADMIN_NEWBOOKINGS', 'Yeni bronlar');
...
jr_define('_JOMRES_COM_MR_DISPGUEST_CCARDNO', 'Kredit Kard nö.');
...
jr_define('_JOMRES_COM_MR_DISPGUEST_CCARDNAME', 'Kartın üzərindəki ad');
jr_define('_JOMRES_COM_MR_QUICKRES_STEP4_TITLE', 'Seçiminizi edin');
jr_define('_JOMRES_COM_MR_QUICKRES_STEP4_STAYDAYS', 'Gecə');
jr_define('_JOMRES_COM_MR_QUICKRES_STEP4_NUMBEROFGUESTS', 'Qonaqları sayı');
...
jr_define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_DISABLEDACCESS', 'Əlillər üçün giriş?');
...
jr_define('_JOMRES_COM_MR_VRCT_ROOM_SAVE_INSERT', 'Otaq əlavə edildi');
...
jr_define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE', 'Otaq / evin növü yenilənir');
...
jr_define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT', 'Ev əlavə olundu');
...
jr_define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_INSERT', 'Ev xüsusiyyətlərinə əlavə');
...
jr_define('_JOMRES_COM_MR_LISTTARIFF_SAVE_INSERT', 'Tarifə əlavə');
jr_define('_JOMRES_COM_MR_LISTTARIFF_SAVE_UPDATE', 'Tarif yenilənir');
...
jr_define('_JOMRES_COM_MR_PUBLICHOLIDAY_TITLE', 'Bayram günləri');
...
jr_define('_JOMRES_FRONT_MR_MENU_ADMIN_LISTNEWBOOKINGS', 'Yeni bronlar');
...
jr_define('_JOMRES_FRONT_MR_SUBMITBUTTON_CONFIRMYOURDETAILS', 'Məlumatları təsdiq et');
...
jr_define('_JOMRES_FRONT_MR_BOOKIN_SELECTBUTTON', 'Qonağı seçin ');
jr_define('_JOMRES_FRONT_MR_BOOKIN_GUESTBOOKEDIN', 'Qonaq bronlaşması ');
jr_define('_JOMRES_FRONT_MR_BOOKIN_NOGUESTSDUEIN', 'Bu gün heç bir qonağın gəlməsi gözlənilmir');
jr_define('_JOMRES_FRONT_MR_BOOKOUT_TITLE', 'Book out guest ');
jr_define('_JOMRES_FRONT_MR_BOOKOUT_NOGUESTSDUEOUT', 'Bu gün heç bir qonaq yola düşmür');
...
jr_define('_JOMRES_COM_A_EXPLANATION', 'Şərh');
...
jr_define('_JOMRES_FILE_ERROR_EMPTY', 'Yükləmədən əvvəl bir fayl seçin');
jr_define('_JOMRES_FILE_ERROR_NAME', 'The file must only contain alphanumeric characters and no spaces please.');
jr_define('_JOMRES_FILE_ERROR_SIZE', 'fayl ölçüsü Administrator təyin etdiyinənə maksimum çoxdur.');
jr_define('_JOMRES_FILE_NOT_UPLOADED', 'Fayl yüklənmədi.');
jr_define('_JOMRES_FILE_UPDATED', 'Fayl qəbul edilmişdir.');
jr_define('_JOMRES_COM_A_JSCALENDAR', 'JS Təqvim');
jr_define('_JOMRES_COM_A_CALENDARLANGUAGE', 'JS Təqvimin dili faylı');
...
jr_define('_JOMRES_COM_MR_QUICKRES_STEP2_ROOMSMOKING', 'Siqaret');
...
jr_define('_JOMRES_MR_AUDIT_LISTING_OPERATION', 'Əməliyyat');
jr_define('_JOMRES_MR_AUDIT_LISTING_VIEWSQL', 'İncəliklərə bax');
jr_define('_JOMRES_MR_AUDIT_LISTING_FILTER_DATE', 'Tarixə görə filtr');
jr_define('_JOMRES_MR_AUDIT_LISTING_FILTER_USERNAME', 'Ada görə filtr');
jr_define('_JOMRES_MR_AUDIT_LISTING_FILTER_OPERATION', 'Əməliyyata görə filtr');
...
jr_define('_JOMRES_MR_AUDIT_UNKNOWNUSER', 'Naməlum istifadəçi');
...
jr_define('_JOMRES_MR_AUDIT_DELETE_TARIFF', 'Silinmiş tarif');
...
jr_define('_JOMRES_MR_AUDIT_DELETE_GUEST', 'Qonaq silindi');
...
jr_define('_JOMRES_COM_MR_BLACKBOOKINGS_VIEWBLACKBOOKING', 'Qara bronlara baxış');
...
jr_define('_JOMRES_COM_A_SMOKING_OPTION', 'Mövcud siqaret çəkmək ');
...
jr_define('_JOMRES_MR_AUDIT_ARCHIVED_MESSAGE', ' Qeydlər arxivləşdi');
...
jr_define('_JOMRES_COM_A_EDITING_CURRENTTEXT', 'Cari mətn');
jr_define('_JOMRES_COM_A_EDITING_NEWTEXT', 'Yeni mətn');
...
jr_define('_JOMRES_COM_PTYPES_UNABLETO_DELETE', 'Unable to delete property type. Property type is assigned to one or more businesses, please re-assign them before trying to delete');
...
jr_define('_JOMRES_INVOICE_SIGNEDONBEHALFOF', 'Adınıza imzalanmış ');
...
jr_define('_JOMRES_MR_AUDIT_CREDITCARD_VIEWED', 'Baxılan kredit kart');
jr_define('_JOMRES_MR_AUDIT_CREDITCARD_UPDATED', 'Kredit kartı yenilənib');
...
jr_define('_JOMRES_JR_A_IMAGEHANDLING_IMAGESALREADYINDIR', 'Şəkil kataloqda artıq mövcutdur');
...
jr_define('_JOMRES_A_GLOBALPFEATURES_DESC', 'Set this to Yes if you want to force all businesses to use only the property features defined by the webmaster.');
...
jr_define('_JOMRES_COM_MR_DISPGUEST_CCV', 'Təhlükəsizlik nömrəsi');
...
jr_define('_JOMRES_COM_A_BASICTEMPLATE_SHOWTARIFFS', 'Tarif məlumatlarını göstər');
...
jr_define('_JOMRES_A_GLOBALROOMTYPES_DESC', 'Set this to Yes if you want to force all businesses to use only the resource/property types defined by the webmaster. You need to set this to Yes if you intend to allow searching via resource/property types.');
...
jr_define('_JOMRES_REGISTRATION_CREATEDPROPERTY', 'Biznes yaradılması: ');
jr_define('_JOMRES_REGISTRATION_CREATEDPROPERTY_FORUSER', 'İstifadəçilər üçün: ');
...
jr_define('_JOMRES_MR_AUDIT_PUBLISH_CUSTOMERTYPE', 'Müştəri növünü göstər');
...
jr_define('_JOMRES_BOOKINGFORM_MONITORING_EMAIL_INVALID', 'Email ünvanı mövcud deyil');
jr_define('_JOMRES_BOOKINGFORM_MONITORING_CANNOT_VALIDATE_EMAIL', 'Emailin domenini yoxlamaq mümkün deyil');
...
jr_define('_JOMRES_PATHWAY_PROPERTYLIST', 'Evin siyahısı');
...
jr_define('_JOMCOMP_MYUSER_MENUTITLE', 'Mənim tənzimləmələrim');
...
jr_define('_JOMCOMP_MYUSER_ADDTOFAVOURITES', 'Seçilmişlərə əlavə et');
...
jr_define('_JRPORTAL_STATS_STATTYPE', 'üçün Statistika: ');
jr_define('_JRPORTAL_STATS_STATTYPE_PROPERTIES', 'Propertys - Clicks');
jr_define('_JRPORTAL_PROPERTIES_VIEWPROPERTY', 'Evə baxmaq');
jr_define('_JRPORTAL_PROPERTIES_NUMBEROFBOOKINGS', 'Bronun Nömrəsi');
jr_define('_JRPORTAL_PROPERTIES_VALUEOFBOOKINGS', 'Bronların Dəyəri');
jr_define('_JRPORTAL_PROPERTIES_COMMISSIONESTIMATE', 'Təxmini komissiya');
...
jr_define('_JRPORTAL_LISTBOOKINGS_HEADER_GUEST_ID', 'Qonaq id');
jr_define('_JRPORTAL_LISTBOOKINGS_HEADER_AFFILIATE_ID', 'Filial id');
...
jr_define('_JRPORTAL_LISTBOOKINGS_HEADER_CONTRACT_ID', 'Müqavilə id');
jr_define('_JRPORTAL_LISTBOOKINGS_HEADER_CONTRACT_NUMBER', 'Müqavilə nömrəsi');
jr_define('_JRPORTAL_LISTBOOKINGS_HEADER_CURRENCYCODE', 'Valyuta Kodu');
jr_define('_JRPORTAL_LISTBOOKINGS_HEADER_CREATED', 'Yaradılmış');
jr_define('_JRPORTAL_LISTBOOKINGS_HEADER_ARCHIVED', 'Arxivləşdirilmiş');
...
jr_define('_JRPORTAL_ADD_ADHOC_ITEM_VALUE', 'Dəyər');
...
jr_define('_JRPORTAL_ADD_ADHOC_ITEM_VIEWNBILLORDERS', 'Sifarişlərə baxmaq');
...
jr_define('_JOMRES_FRONT_MR_MENU_CAPTCHA_BUTTONTEXT', 'göndər');
jr_define('_JOMRES_FRONT_MR_MENU_CAPTCHA_REFRESHBUTTONTEXT', 'yeni şəkil ');
...
jr_define('_JOMRES_COM_SEF_URL_PREFIX', 'Url prefiks');
...
jr_define('_JOMRES_COM_SEF_SEARCH_URL_PTYPE', 'Search URL Structure - Əmlakın növü');
...
jr_define('_JOMRES_COM_MR_VRCT_PROPERTY_TYPE_TAB', 'Evin növü');
...
jr_define('_JOMRES_COM_LOGGING_SYSTEM', 'Çeşidli ');
...
jr_define('_JRPORTAL_INVOICES_LINEITEMS_RECUR_PRICE', 'Təkrarlanan Qiymət');
jr_define('_JRPORTAL_INVOICES_LINEITEMS_RECUR_QTY', 'Recurring quantity');
jr_define('_JRPORTAL_INVOICES_LINEITEMS_RECUR_DISCOUNT', 'Təkrarlanan endirim');
...
jr_define('_JRPORTAL_INVOICES_PAYPAL_SETTINGS_PAYPALEMAIL', 'Sizin paypal e-mailiniz');
...
jr_define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_TRIALPERIOD', 'Sınaq müddəti');
...
jr_define('_JRPORTAL_SUBSCRIPTIONS_PACKAGES_ROOMSLIMIT', 'Odalarımız məhdutdur'); // Not currently used, saved for a rainy day
...
jr_define('_JRPORTAL_SUBSCRIBERS_SURNAME', 'Soyadı');
jr_define('_JRPORTAL_SUBSCRIBERS_ADDRESS', 'Ünvan');
jr_define('_JRPORTAL_SUBSCRIBERS_COUNTRY', 'Ölkə');
jr_define('_JRPORTAL_SUBSCRIBERS_POSTCODE', 'Poçt kodu');
...
jr_define('_JRPORTAL_SUBSCRIBERS_SUBSCRIBED', "Thank you for creating a subscription to list your property on our server. Once your invoice is marked as paid (there may be a delay depending on Paypal) please <a href='".JOMRES_SITEPAGE_URL."&task=new_property'>click here to continue creating your business(s).</a>");
...
jr_define('_JOMRES_CALENDAR_TODAY', 'bu gün');
jr_define('_JOMRES_CALENDAR_PREV', 'Previous');
jr_define('_JOMRES_CALENDAR_NEXT', 'sonrakı');
...
jr_define('_JOMRES_MANAGER_CHOOSE_SEARCHTITLE', 'İstifadəçiləri axtar');
...
jr_define('_JOMRES_DEBUGGING_SUBJECT', 'Mövzu');
jr_define('_JOMRES_DEBUGGING_FULLNAME', 'Tam adı');
...
jr_define('_JOMRES_CUSTOMCODE_MENUCATEGORIES_BOOKINGS', 'bronlaşma');
...
jr_define('JOMRES_NON_REGISTERED_USER', 'Qeydiyyatdan keçməmiş istifadəçi');
...
jr_define('TOUR_ID_TOUR_TARGET_MAIN_MENU_TITLE', 'Əmlakınıza xoş gəldiniz');
...
jr_define('TOUR_ID_GALLERYWRAPPER_TITLE', 'Sizin Foto qalereya.');
...
jr_define('TOUR_ID_TAB_YOURBUSINESSDETAILS_TITLE', 'Your Property details.');
...
jr_define('TOUR_ID_TAB_TARIFFSCURRENCY_TITLE', 'Tariflər');
...
jr_define('TOUR_ID_TOUR_TARGET_REGISTRATION_2_NAME_ADDRESS_TITLE', 'Əmlakın adı və ünvanı.');
...
jr_define('TOUR_ID_TOUR_TARGET_REGISTRATION_2_STARS_TITLE', 'Ulduzların sayı.');
...
jr_define('TOUR_ID_TOUR_TARGET_REGISTRATION_2_LATLONG_TITLE', 'Xəritədə yeri.');
...
jr_define('TOUR_ID_TOUR_TARGET_REGISTRATION_2_FEATURES_TITLE', 'Əmlakın xüsusiyyətləri.');
...
jr_define('TOUR_ID_TOUR_TARGET_REGISTRATION_2_DESCRIPTION_TITLE', 'Əmlakınız haqqında məlumat.');
...
jr_define('TOUR_ID_TOUR_TARGET_LISTALL_BOOKINGS_TITLE', 'Bronların siyahısı.');
...
jr_define('TOUR_ID_TOUR_TARGET_LISTNEW_BOOKINGS_TITLE', 'Yeni bronların siyahısı.');
...
jr_define('TOUR_ID_TOUR_TARGET_LISTOLD_BOOKINGS_TITLE', 'Köhnə bronların siyahısı.');
...
jr_define('TOUR_ID_TOUR_TARGET_LIST_GUESTS_TITLE', 'Qonaqların siyahısı.');
...
jr_define('TOUR_ID_TOUR_TARGET_BOOKING_PARTICULARS_TITLE', 'Özəlliklər.');
...
jr_define('TOUR_ID_TOUR_TARGET_BOOKING_ROOM_FEATURES_TITLE', 'Otağın filter xüsusiyyətləri.');
...
jr_define('TOUR_ID_TOUR_TARGET_BOOKING_EXISTING_GUESTS_TITLE', 'Mövcud qonaqlar.');
...
jr_define('TOUR_ID_TOUR_TARGET_BOOKING_REQUIRED_TITLE', 'Qonaqlar haqqında.');
...
jr_define('TOUR_ID_TOUR_TARGET_LIST_BLACKBOOKINGS_TITLE', 'Qara bronlaşma.');
...
jr_define('TOUR_ID_TOUR_TARGET_REGISTRATION_2_REALESTATE_DESCRIPTION_TITLE', 'Əmlak haqqında məlumat.');
...
jr_define('TOUR_ID_TOUR_TARGET_LISTTARIFFS_NORMAL_MRP_TITLE', 'Normal rejimli tariflər.');
...
jr_define('TOUR_ID_TOUR_TARGET_LISTTARIFFS_NORMAL_SRP_TITLE', 'Normal rejimli tariflər.');
...
jr_define('TOUR_ID_TOUR_TARGET_ROOMSANDTARIFFS_MRP_TITLE', 'Otaqlar və tariflər.');
...
jr_define('TOUR_ID_TOUR_TARGET_ROOMSANDTARIFFS_SRP_TITLE', 'Otaqlar və tariflər.');
jr_define('TOUR_ID_TOUR_TARGET_ROOMSANDTARIFFS_SRP_CONTENT', 'On this page you can edit your property type and your tariffs.');

jr_define('TOUR_ID_TOUR_TARGET_GUEST_TYPES_TITLE', 'Qonaq növləri.');
...
jr_define('TOUR_ID_TOUR_TARGET_MEDIACENTRE_RESOURCEPICKER_TITLE', 'Room picker.');
...
jr_define('TOUR_ID_TOUR_TARGET_MEDIACENTRE_EXISTINGIMAGES_TITLE', 'Mövcud görünüşlərinin şəkilləri.');
...
jr_define('TOUR_ID_TOUR_TARGET_MEDIACENTRE_UPLOADCONTROLS_TITLE', 'Yükləməyə nəzarət.');
...
jr_define('TOUR_ID_TOUR_TARGET_MEDIACENTRE_SELECTEDIMAGES_TITLE', 'Seçilmiş şəkillər.');
...
jr_define('_JOMRES_STATUS_CONFIRMED', 'Bronun təsdiqi');
...
jr_define('TOUR_ID_TOUR_TARGET_EDIT_GUEST_TOP_TITLE', 'Qonaqları redaktə et.');
...
jr_define('TOUR_ID_TOUR_TARGET_EDIT_GUEST_DISCOUNT_TITLE', 'Endirim.');
...
jr_define('_JOMRES_ONLINE_PARTNERS', 'Partnyorlar');
...
For Low Season Weekend and Mid-Week Rentals an earlier Giriş and later Check-out may be possible (usually In from [Time] and out by [Time])
...
jr_define('_JOMRES_NUMBER_OF_BEDROOMS', 'Yataq otağı');
